...
pub unsafe extern "C" fn PWR_DeInit() {
    RCC_APB1PeriphResetCmd(0x10000000i32 as uint32_t, ENABLE);
    RCC_APB1PeriphResetCmd(0x10000000i32 as uint32_t, DISABLE);
}
/* *
...
pub unsafe extern "C" fn PWR_BackupAccessCmd(mut NewState: FunctionalState) {
    ...
    ::core::ptr::write_volatile((0x42000000i32 as
                                     uint32_t).wrapping_add((0x40000000i32 as
                                                                 uint32_t).wrapping_add(0x7000i32
                                                                                            as
...
pub unsafe extern "C" fn PWR_PVDLevelConfig(mut PWR_PVDLevel: uint32_t) {
    ...
    /* Check the parameters */
    tmpreg =
        (*((0x40000000i32 as uint32_t).wrapping_add(0x7000i32 as libc::c_uint)
               as *mut PWR_TypeDef)).CR;
    /* Clear PLS[7:5] bits */
    tmpreg &= 0xffffff1fu32;
...
/* *
  ...
  */
#[no_mangle]
pub unsafe extern "C" fn PWR_WakeUpPinCmd(mut PWR_WakeUpPin: uint32_t,
    ...
    if NewState as libc::c_uint != DISABLE as libc::c_int as libc::c_uint {
        ...
        let ref mut fresh0 =
            (*((0x40000000i32 as
                    uint32_t).wrapping_add(0x7000i32 as libc::c_uint) as
                   *mut PWR_TypeDef)).CSR;
        ::core::ptr::write_volatile(fresh0,
                                    (::core::ptr::read_volatile::<uint32_t>(fresh0
                                                                                as
                                                                                *const uint32_t)
                                         as libc::c_uint | PWR_WakeUpPin) as
...
/* *
  ...
  */
#[no_mangle]
pub unsafe extern "C" fn PWR_EnterSleepMode(mut PWR_SLEEPEntry: uint8_t) {
    /* Check the parameters */
    ...
    ::core::ptr::write_volatile(fresh2,
                                (::core::ptr::read_volatile::<uint32_t>(fresh2
                                                                            ...
                                                                            *const uint32_t)
                                     as libc::c_uint &
                                     !((1u64 << 2u32) as uint32_t)) as
                                    uint32_t as uint32_t);
    /* Select SLEEP mode entry -------------------------------------------------*/
    if PWR_SLEEPEntry as libc::c_int == 0x1i32 as uint8_t as libc::c_int {
...
pub unsafe extern "C" fn PWR_EnterSTOPMode(mut PWR_Regulator: uint32_t,
    ...
    ::core::ptr::write_volatile(fresh3,
                                (::core::ptr::read_volatile::<uint32_t>(fresh3
                                                                            as
                                                                            *const uint32_t)
                                     as libc::c_ulong | 1u64 << 2u32) as
                                    uint32_t as uint32_t);
    /* Select STOP mode entry --------------------------------------------------*/
    if PWR_STOPEntry as libc::c_int == 0x1i32 as uint8_t as libc::c_int {
        /* Request Wait For Interrupt */
        asm!("wfi" : : : : "volatile")
    } else {
        /* Request Wait For Event */
...
pub unsafe extern "C" fn PWR_EnterSTANDBYMode() {
    ...
    ::core::ptr::write_volatile(fresh5,
                                (::core::ptr::read_volatile::<uint32_t>(fresh5
                                                                            ...
                                                                            *const uint32_t)
                                     as libc::c_uint |
                                     0x4i32 as uint16_t as libc::c_uint) as
                                    uint32_t as uint32_t);
    /* Select STANDBY mode */
    let ref mut fresh6 =
        (*((0x40000000i32 as uint32_t).wrapping_add(0x7000i32 as libc::c_uint)
    ...
    ::core::ptr::write_volatile(fresh6,
                                (::core::ptr::read_volatile::<uint32_t>(fresh6
                                                                            ...
                                                                            *const uint32_t)
                                     as libc::c_uint |
                                     0x2i32 as uint16_t as libc::c_uint) as
                                    uint32_t as uint32_t);
    /* Set SLEEPDEEP bit of Cortex System Control Register */
    let ref mut fresh7 =
        (*(0xe000e000u64.wrapping_add(0xd00u64) as *mut SCB_Type)).SCR;
...
pub unsafe extern "C" fn PWR_GetFlagStatus(mut PWR_FLAG: uint32_t)
 -> FlagStatus {
    ...
    /* Check the parameters */
    if (*((0x40000000i32 as uint32_t).wrapping_add(0x7000i32 as libc::c_uint)
...
pub unsafe extern "C" fn PWR_ClearFlag(mut PWR_FLAG: uint32_t) {
    ...
    ::core::ptr::write_volatile(fresh8,
                                (::core::ptr::read_volatile::<uint32_t>(fresh8
                                                                            as
                                                                            *const uint32_t)
                                     as libc::c_uint | PWR_FLAG << 2i32) as
                                    uint32_t as uint32_t);
}
