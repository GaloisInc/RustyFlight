...
pub unsafe extern "C" fn I2C_DeInit(mut I2Cx: *mut I2C_TypeDef) {
    ...
    if I2Cx ==
           (0x40000000i32 as uint32_t).wrapping_add(0x5400i32 as libc::c_uint)
               as *mut I2C_TypeDef {
        /* Enable I2C1 reset state */
        RCC_APB1PeriphResetCmd(0x200000i32 as uint32_t, ENABLE);
        /* Release I2C1 from reset state */
        RCC_APB1PeriphResetCmd(0x200000i32 as uint32_t, DISABLE);
    } else {
        /* Enable I2C2 reset state */
        RCC_APB1PeriphResetCmd(0x400000i32 as uint32_t, ENABLE);
        /* Release I2C2 from reset state */
        RCC_APB1PeriphResetCmd(0x400000i32 as uint32_t, DISABLE);
    };
}
/* *
...
pub unsafe extern "C" fn I2C_Init(mut I2Cx: *mut I2C_TypeDef,
  ...
  /* Get the I2Cx CR1 value */
    ...
    tmpreg &= 0xcfe0ffi32 as uint32_t;
    /* Configure I2Cx: analog and digital filter */
  /* Set ANFOFF bit according to I2C_AnalogFilter value */
  /* Set DFN bits according to I2C_DigitalFilter value */
    tmpreg |=
        (*I2C_InitStruct).I2C_AnalogFilter |
            (*I2C_InitStruct).I2C_DigitalFilter << 8i32;
    /* Write to I2Cx CR1 */
  ...
  /* Write to I2Cx TIMING */
    ::core::ptr::write_volatile(&mut (*I2Cx).TIMINGR as *mut uint32_t,
                                (*I2C_InitStruct).I2C_Timing & 0xf0ffffffu32);
  ...
  /* Set OA1 bits according to I2C_OwnAddress1 value */
    ...
    ::core::ptr::write_volatile(&mut (*I2Cx).OAR1 as *mut uint32_t,
                                (::core::ptr::read_volatile::<uint32_t>(&(*I2Cx).OAR1
                                                                            as
                                                                            *const uint32_t)
                                     as libc::c_uint | 0x8000i32 as uint32_t)
                                    as uint32_t as uint32_t);
  ...
  /* Get the I2Cx CR2 value */
    ...
    tmpreg &= 0x7ff7fffi32 as uint32_t;
...
pub unsafe extern "C" fn I2C_StructInit(mut I2C_InitStruct:
  ...
  /* Initialize the I2C_Timing member */
    (*I2C_InitStruct).I2C_Timing = 0i32 as uint32_t;
    /* Initialize the I2C_AnalogFilter member */
    (*I2C_InitStruct).I2C_AnalogFilter = 0i32 as uint32_t;
    /* Initialize the I2C_DigitalFilter member */
    (*I2C_InitStruct).I2C_DigitalFilter = 0i32 as uint32_t;
    /* Initialize the I2C_Mode member */
    (*I2C_InitStruct).I2C_Mode = 0i32 as uint32_t;
    /* Initialize the I2C_OwnAddress1 member */
    (*I2C_InitStruct).I2C_OwnAddress1 = 0i32 as uint32_t;
    /* Initialize the I2C_Ack member */
    (*I2C_InitStruct).I2C_Ack = 0x8000i32 as uint32_t;
    /* Initialize the I2C_AcknowledgedAddress member */
    (*I2C_InitStruct).I2C_AcknowledgedAddress = 0i32 as uint32_t;
}
/* *
    ...
    if NewState as libc::c_uint != DISABLE as libc::c_int as libc::c_uint {
        ...
        ::core::ptr::write_volatile(&mut (*I2Cx).CR1 as *mut uint32_t,
                                    (::core::ptr::read_volatile::<uint32_t>(&(*I2Cx).CR1
                                                                                ...
                                                                                *const uint32_t)
                                         as libc::c_uint |
                                         0x20000i32 as uint32_t) as uint32_t
                                        as uint32_t)
    };
}
/* *
...
pub unsafe extern "C" fn I2C_OwnAddress2Config(mut I2Cx: *mut I2C_TypeDef,
    ...
    tmpreg &= !(0xfei32 as uint32_t | 0x700i32 as uint32_t);
    /* Set I2Cx SADD */
    tmpreg |=
        Address as uint32_t & 0xfei32 as uint32_t |
            (Mask as uint32_t) << 8i32 & 0x700i32 as uint32_t;
...
pub unsafe extern "C" fn I2C_SlaveAddressConfig(mut I2Cx: *mut I2C_TypeDef,
    ...
    tmpreg &= !(0x3ffi32 as uint32_t);
    /* Set I2Cx SADD */
    tmpreg |= Address as uint32_t & 0x3ffi32 as uint32_t;
    /* Store the new register value */
    ::core::ptr::write_volatile(&mut (*I2Cx).CR2 as *mut uint32_t, tmpreg);
}
/* *
...
pub unsafe extern "C" fn I2C_NumberOfBytesConfig(mut I2Cx: *mut I2C_TypeDef,
    ...
    tmpreg &= !(0xff0000i32 as uint32_t);
    /* Set I2Cx Nbytes */
    tmpreg |= (Number_Bytes as uint32_t) << 16i32 & 0xff0000i32 as uint32_t;
    /* Store the new register value */
    ::core::ptr::write_volatile(&mut (*I2Cx).CR2 as *mut uint32_t, tmpreg);
}
/* *
...
pub unsafe extern "C" fn I2C_MasterRequestConfig(mut I2Cx: *mut I2C_TypeDef,
    ...
    if I2C_Direction as libc::c_int == 0i32 as uint16_t as libc::c_int {
...
pub unsafe extern "C" fn I2C_GetAddressMatched(mut I2Cx: *mut I2C_TypeDef)
 -> uint8_t {
    ...
    return (((*I2Cx).ISR & 0xfe0000i32 as uint32_t) >> 16i32) as uint8_t;
}
/* *
...
pub unsafe extern "C" fn I2C_GetTransferDirection(mut I2Cx: *mut I2C_TypeDef)
 -> uint16_t {
    let mut tmpreg: uint32_t = 0i32 as uint32_t;
    let mut direction: uint16_t = 0i32 as uint16_t;
    /* Check the parameters */
    /* Return the slave matched address in the SR1 register */
    tmpreg = (*I2Cx).ISR & 0x10000i32 as uint32_t;
    /* If write transfer is requested */
    if tmpreg == 0i32 as libc::c_uint {
        /* write transfer is requested */
        direction = 0i32 as uint16_t
    } else {
        /* Read transfer is requested */
        direction = 0x400i32 as uint16_t
    }
    return direction;
}
/* *
...
pub unsafe extern "C" fn I2C_TransferHandling(mut I2Cx: *mut I2C_TypeDef,
    ...
    tmpreg &=
        !(0x3ffi32 as uint32_t | 0xff0000i32 as uint32_t |
              0x1000000i32 as uint32_t | 0x2000000i32 as uint32_t |
              0x400i32 as uint32_t | 0x2000i32 as uint32_t |
              0x4000i32 as uint32_t);
    /* update tmpreg */
    tmpreg |=
        Address as uint32_t & 0x3ffi32 as uint32_t |
            (Number_Bytes as uint32_t) << 16i32 & 0xff0000i32 as uint32_t |
            ReloadEndMode | StartStopMode;
    /* update CR2 register */
    ::core::ptr::write_volatile(&mut (*I2Cx).CR2 as *mut uint32_t, tmpreg);
}
/* *
...
pub unsafe extern "C" fn I2C_TimeoutAConfig(mut I2Cx: *mut I2C_TypeDef,
    ...
    tmpreg &= !(0xfffi32 as uint32_t);
    /* Set I2Cx TIMEOUTA */
    tmpreg |= Timeout as uint32_t & 0xfffi32 as uint32_t;
    /* Store the new register value */
    ::core::ptr::write_volatile(&mut (*I2Cx).TIMEOUTR as *mut uint32_t,
                                tmpreg);
}
...
pub unsafe extern "C" fn I2C_TimeoutBConfig(mut I2Cx: *mut I2C_TypeDef,
    ...
    tmpreg &= !(0xfff0000i32 as uint32_t);
    /* Set I2Cx TIMEOUTB */
    tmpreg |= (Timeout as uint32_t) << 16i32 & 0xfff0000i32 as uint32_t;
    /* Store the new register value */
    ::core::ptr::write_volatile(&mut (*I2Cx).TIMEOUTR as *mut uint32_t,
                                tmpreg);
}
    ...
    if NewState as libc::c_uint != DISABLE as libc::c_int as libc::c_uint {
        ...
        ::core::ptr::write_volatile(&mut (*I2Cx).CR1 as *mut uint32_t,
                                    (::core::ptr::read_volatile::<uint32_t>(&(*I2Cx).CR1
                                                                                ...
                                                                                *const uint32_t)
                                         as libc::c_uint |
                                         0x4000000i32 as uint32_t) as uint32_t
                                        as uint32_t)
    } else {
...
pub unsafe extern "C" fn I2C_GetPEC(mut I2Cx: *mut I2C_TypeDef) -> uint8_t {
    /* Check the parameters */
    /* Return the slave matched address in the SR1 register */
    return ((*I2Cx).PECR & 0xffi32 as uint32_t) as uint8_t;
}
/* *
  * @}
  */
...
pub unsafe extern "C" fn I2C_GetITStatus(mut I2Cx: *mut I2C_TypeDef,
  ...
  /* If Error interrupt */
    if I2C_IT & 0x3f00i32 as uint32_t != 0 {
        enablestatus = 0x80i32 as uint32_t & (*I2Cx).CR1
    } else if I2C_IT & 0xc0i32 as uint32_t != 0 {
        enablestatus = 0x40i32 as uint32_t & (*I2Cx).CR1
