...
c2rust transpile --emit-no-std --emit-build-files --binary main -o transpiled/$1 cleanflight/compile_commands.json 2>&1 | tee c2rust-logs/$1_log_$(date +"%F_%H%M%S").txt
