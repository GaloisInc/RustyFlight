...
pub static mut telemetryConfig_Registry: pgRegistry_t =
    unsafe {
        {
            let mut init =
                pgRegistry_s{pgn: (31i32 | 2i32 << 12i32) as pgn_t,
                             size:
...
pub static mut pgResetTemplate_telemetryConfig: telemetryConfig_t =
    {
        let mut init =
            telemetryConfig_s{gpsNoFixLatitude: 0i32 as int16_t,
                              gpsNoFixLongitude: 0i32 as int16_t,
                              telemetry_inverted: 0i32 as uint8_t,
                              halfDuplex: 1i32 as uint8_t,
                              frsky_coordinate_format: FRSKY_FORMAT_DMS,
                              frsky_unit: FRSKY_UNIT_METRICS,
                              frsky_vfas_precision: 0i32 as uint8_t,
                              hottAlarmSoundInterval: 5i32 as uint8_t,
                              pidValuesAsTelemetry: 0i32 as uint8_t,
                              report_cell_voltage: 0i32 as uint8_t,
                              flysky_sensors:
