...
#[no_mangle]
pub static mut spiDefaultConfig: [spiDefaultConfig_t; 1] =
    [{
         let mut init =
             spiDefaultConfig_s{device: SPIDEV_2,
                                sck: (1i32 + 1i32 << 4i32 | 13i32) as ioTag_t,
                                miso:
                                    (1i32 + 1i32 << 4i32 | 14i32) as ioTag_t,
                                mosi:
                                    (1i32 + 1i32 << 4i32 | 15i32) as
                                        ioTag_t,};
         init
     }];
                 ...
                 reset:
                     C2RustUnnamed_0{ptr:
                                         0 as *const libc::c_void as
                                             *mut libc::c_void,},};
#[no_mangle]
pub static mut spiPinConfig_CopyArray: [spiPinConfig_t; 3] =
    [spiPinConfig_t{ioTagSck: 0, ioTagMiso: 0, ioTagMosi: 0,}; 3];
#[no_mangle]
pub static mut spiPinConfig_SystemArray: [spiPinConfig_t; 3] =
    [spiPinConfig_t{ioTagSck: 0, ioTagMiso: 0, ioTagMosi: 0,}; 3];
#[no_mangle]
pub unsafe extern "C" fn pgResetFn_spiPinConfig(mut spiPinConfig:
    ...
    while i <
              (::core::mem::size_of::<[spiDefaultConfig_t; 1]>() as
...
pub static mut preinitIPUList: [ioTag_t; 11] =
    [(1i32 + 1i32 << 4i32 | 12i32) as ioTag_t, 0i32 as ioTag_t, 0, 0, 0, 0, 0,
     0, 0, 0, 0];
#[no_mangle]
pub unsafe extern "C" fn pgResetFn_spiPreinitIPUConfig(mut config:
                                                           *mut spiCs_t) {
    let mut puPins: libc::c_int = 0i32;
...
unsafe extern "C" fn run_static_initializers() {
    spiPinConfig_Registry =
        {
            let mut init =
                pgRegistry_s{pgn: (520i32 | 1i32 << 12i32) as pgn_t,
                             size:
                             ...
                             address:
                                 &mut spiPinConfig_SystemArray as
                                     *mut [spiPinConfig_t; 3] as *mut uint8_t,
                             copy:
    ...
    spiPreinitIPUConfig_Registry =
        {
            let mut init =
                pgRegistry_s{pgn: (535i32 | 0i32 << 12i32) as pgn_t,
                             size:
                                 ((::core::mem::size_of::<spiCs_t>() as
                                       libc::c_ulong).wrapping_mul(11i32 as
                                                                       libc::c_ulong)
                                      |
                                      PGR_SIZE_SYSTEM_FLAG as libc::c_int as
                                          libc::c_ulong) as uint16_t,
                                                     ...
                                                     ::core::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                              ...
                                                                              Option<unsafe extern "C" fn(_:
                                                                                                          ...
                                                                                                          _:
                                                                                                              libc::c_int)
                                                                                         ->
                                                                                             ()>>(Some(pgResetFn_spiPreinitIPUConfig
                                                                                                           as
                                                                                                           unsafe extern "C" fn(_:
                                                                                                                                    *mut spiCs_t)
                                                                                                               ->
    ...
    spiPreinitOPUConfig_Registry =
        {
            let mut init =
                pgRegistry_s{pgn: (536i32 | 0i32 << 12i32) as pgn_t,
                             size:
                                 ((::core::mem::size_of::<spiCs_t>() as
