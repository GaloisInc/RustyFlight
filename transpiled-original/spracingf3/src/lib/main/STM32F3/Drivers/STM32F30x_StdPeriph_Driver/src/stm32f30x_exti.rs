...
pub unsafe extern "C" fn EXTI_DeInit() {
    ::core::ptr::write_volatile(&mut (*((0x40000000i32 as
                                    ...
                                    *mut uint32_t, 0x1f800000i32 as uint32_t);
    ::core::ptr::write_volatile(&mut (*((0x40000000i32 as
                                             uint32_t).wrapping_add(0x10000i32
                                                                        as
                                                                        libc::c_uint).wrapping_add(0x400i32
    ...
    ::core::ptr::write_volatile(&mut (*((0x40000000i32 as
                                    ...
                                    *mut uint32_t, 0xci32 as uint32_t);
    ::core::ptr::write_volatile(&mut (*((0x40000000i32 as
                                             uint32_t).wrapping_add(0x10000i32
                                                                        as
                                                                        libc::c_uint).wrapping_add(0x400i32
    ...
    ::core::ptr::write_volatile(&mut (*((0x40000000i32 as
                                    ...
                                    *mut uint32_t, 0x3i32 as uint32_t);
}
/* *
...
pub unsafe extern "C" fn EXTI_StructInit(mut EXTI_InitStruct:
                                             *mut EXTI_InitTypeDef) {
    (*EXTI_InitStruct).EXTI_Line = 0i32 as uint32_t;
    ...
    if *((&mut (*((0x40000000i32 as
              ...
              uint32_t).wrapping_add((EXTI_Line >>
                                          5i32).wrapping_mul(0x20i32 as
                                                                 libc::c_uint))
             as *mut uint32_t) &
           (1i32 << (EXTI_Line & 0x1fi32 as libc::c_uint)) as uint32_t !=
...
pub unsafe extern "C" fn EXTI_ClearFlag(mut EXTI_Line: uint32_t) {
    ...
    ::core::ptr::write_volatile((&mut (*((0x40000000i32 as
                                    ...
                                    as *mut uint32_t,
                                (1i32 <<
                                     (EXTI_Line & 0x1fi32 as libc::c_uint)) as
                                    uint32_t);
}
/* *
