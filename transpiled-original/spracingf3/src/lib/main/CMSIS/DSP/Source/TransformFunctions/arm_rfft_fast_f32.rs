...
pub unsafe extern "C" fn stage_rfft_f32(mut S:
    ...
    k = ((*S).Sint.fftLen as libc::c_int - 1i32) as uint32_t;
    ...
    *fresh3 = 0.5f32 * (t1a - t1b);
    ...
    pB = p.offset((2i32 as libc::c_uint).wrapping_mul(k) as isize);
    pA = pA.offset(2);
    loop  {
        /*
...
pub unsafe extern "C" fn arm_rfft_fast_f32(mut S:
    ...
    (*Sint).fftLen = ((*S).fftLenRFFT as libc::c_int / 2i32) as uint16_t;
    /* Calculation of Real FFT */
    if ifftFlag != 0 {
        /*  Real FFT compression */
        merge_rfft_f32(S, p, pOut);
        /* Complex radix-4 IFFT process */
        arm_cfft_f32(Sint, pOut, ifftFlag, 1i32 as uint8_t);
    } else {
        /* Calculation of RFFT of input */
        arm_cfft_f32(Sint, p, ifftFlag, 1i32 as uint8_t);
        /*  Real FFT extraction */
