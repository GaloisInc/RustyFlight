...
pub unsafe extern "C" fn arm_rfft_fast_init_f32(mut S:
 ...
 -> arm_status {
    ...
    Sint = &mut (*S).Sint;
    (*Sint).fftLen = (fftLen as libc::c_int / 2i32) as uint16_t;
    (*S).fftLenRFFT = fftLen;
    ...
    /*  Initialise the bit reversal table length */
            (*Sint).bitRevLength = 3808i32 as uint16_t;
        ...
        1024 => {
            (*Sint).bitRevLength = 1800i32 as uint16_t;
            (*Sint).pBitRevTable =
        ...
        512 => {
            (*Sint).bitRevLength = 448i32 as uint16_t;
            (*Sint).pBitRevTable =
        ...
        256 => {
            (*Sint).bitRevLength = 440i32 as uint16_t;
            (*Sint).pBitRevTable =
        ...
        128 => {
            (*Sint).bitRevLength = 208i32 as uint16_t;
            (*Sint).pBitRevTable =
        ...
        64 => {
            (*Sint).bitRevLength = 56i32 as uint16_t;
            (*Sint).pBitRevTable =
        ...
        32 => {
            (*Sint).bitRevLength = 48i32 as uint16_t;
            (*Sint).pBitRevTable =
        ...
        16 => {
            (*Sint).bitRevLength = 20i32 as uint16_t;
            (*Sint).pBitRevTable =
