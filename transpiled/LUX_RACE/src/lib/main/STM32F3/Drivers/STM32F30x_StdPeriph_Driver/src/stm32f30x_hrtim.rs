...
static mut TimerIdxToTimerId: [uint32_t; 6] =
    [0x20000 as libc::c_int as uint32_t, 0x40000 as libc::c_int as uint32_t,
     0x80000 as libc::c_int as uint32_t, 0x100000 as libc::c_int as uint32_t,
     0x200000 as libc::c_int as uint32_t, 0x10000 as libc::c_int as uint32_t];
...
pub unsafe extern "C" fn HRTIM_SimpleBase_Init(mut HRTIMx: *mut HRTIM_TypeDef,
    ...
    if TimerIdx == 0x5 as libc::c_int as uint32_t {
...
pub unsafe extern "C" fn HRTIM_DeInit(mut HRTIMx: *mut HRTIM_TypeDef) {
    /* Check the parameters */
    RCC_APB2PeriphResetCmd(0x20000000 as libc::c_int as uint32_t, ENABLE);
    RCC_APB2PeriphResetCmd(0x20000000 as libc::c_int as uint32_t, DISABLE);
}
/* *
...
pub unsafe extern "C" fn HRTIM_DLLCalibrationStart(mut HRTIMx:
    ...
    if CalibrationRate == 0xffffffff as libc::c_uint {
        /* One shot DLL calibration */
        HRTIM_dllcr &= !(0x2 as libc::c_int as uint32_t);
        HRTIM_dllcr |= 0x1 as libc::c_int as uint32_t
    } else {
        /* Periodic DLL calibration */
        HRTIM_dllcr &=
            !(0xc as libc::c_int as uint32_t |
                  0x1 as libc::c_int as uint32_t);
        HRTIM_dllcr |= CalibrationRate | 0x2 as libc::c_int as uint32_t
    }
...
pub unsafe extern "C" fn HRTIM_SimpleBaseStop(mut HRTIMx: *mut HRTIM_TypeDef,
    ...
    if TimerIdxToTimerId[TimerIdx as usize] &
...
pub unsafe extern "C" fn HRTIM_SimpleCaptureStop(mut HRTIMx:
    ...
    /* Disable the timer counter */
    if (*HRTIMx).HRTIM_TIMERx[TimerIdx as usize].CPT1xCR ==
           0 as libc::c_int as uint32_t &&
...
pub unsafe extern "C" fn HRTIM_SimpleOCChannelConfig(mut HRTIMx:
    ...
    let mut CompareUnit: uint32_t = 0x1 as libc::c_int as uint32_t;
    ...
    match OCChannel {
        1 | 4 | 16 | 64 | 256 => {
            CompareUnit = 0x1 as libc::c_int as uint32_t
        }
        2 | 8 | 32 | 128 | 512 => {
            CompareUnit = 0x2 as libc::c_int as uint32_t
        }
        _ => { }
    }
    CompareCfg.CompareValue = (*pBasicOCChannelCfg).Pulse;
    CompareCfg.AutoDelayedMode = 0 as libc::c_int as uint32_t;
    CompareCfg.AutoDelayedTimeout = 0 as libc::c_int as uint32_t;
    ...
    OutputCfg.FaultState = 0 as libc::c_int as uint32_t;
    OutputCfg.IdleMode = 0 as libc::c_int as uint32_t;
    OutputCfg.ChopperModeEnable = 0 as libc::c_int as uint32_t;
    OutputCfg.BurstModeEntryDelayed = 0 as libc::c_int as uint32_t;
    match (*pBasicOCChannelCfg).Mode {
        1 => {
            if CompareUnit == 0x1 as libc::c_int as uint32_t {
                OutputCfg.SetSource = 0x8 as libc::c_int as uint32_t
            } else { OutputCfg.SetSource = 0x10 as libc::c_int as uint32_t }
        ...
        3 => {
            ...
            OutputCfg.ResetSource = 0 as libc::c_int as uint32_t
        }
        2 => {
            if CompareUnit == 0x1 as libc::c_int as uint32_t {
                OutputCfg.ResetSource = 0x8 as libc::c_int as uint32_t
            } else { OutputCfg.ResetSource = 0x10 as libc::c_int as uint32_t }
            OutputCfg.SetSource = 0 as libc::c_int as uint32_t
        }
        _ => { }
    }
...
pub unsafe extern "C" fn HRTIM_SimplePWMChannelConfig(mut HRTIMx:
    ...
    OutputCfg.ResetSource = 0x4 as libc::c_int as uint32_t;
...
pub unsafe extern "C" fn HRTIM_SimpleCaptureChannelConfig(mut HRTIMx:
    ...
    EventCfg.FastMode = 0 as libc::c_int as uint32_t;
    ...
    EventCfg.Source = 0 as libc::c_int as uint32_t;
...
pub unsafe extern "C" fn HRTIM_WaveformTimerConfig(mut HRTIMx:
    ...
    HRTIM_timcr &= !(0x40 as libc::c_int as uint32_t);
    HRTIM_timcr |= (*pTimerCfg).PushPull;
    /* Enable/Disable registers update on timer counter reset */
    HRTIM_timcr &= !(0x40000 as libc::c_int as uint32_t);
    ...
    HRTIM_timfltr &=
        !(0x1 as libc::c_int as uint32_t | 0x2 as libc::c_int as uint32_t |
    ...
    HRTIM_timfltr &= !(0x80000000 as libc::c_uint);
    HRTIM_timfltr |= (*pTimerCfg).FaultLock;
    /* Enable/Disable dead time insertion at timer level */
    HRTIM_timoutr &= !(0x100 as libc::c_int as uint32_t);
    HRTIM_timoutr |= (*pTimerCfg).DeadTimeInsertion;
    /* Enable/Disable delayed protection at timer level */
    HRTIM_timoutr &=
        !(0x1c00 as libc::c_int as uint32_t |
              0x200 as libc::c_int as uint32_t);
    ...
    match CompareUnit {
        ...
        2 => {
            ...
            ::core::ptr::write_volatile(&mut (*HRTIMx).HRTIM_TIMERx[TimerIdx
                                            ...
                                            as *mut uint32_t,
                                        (*pCompareCfg).CompareValue);
            if (*pCompareCfg).AutoDelayedMode != 0 as libc::c_int as uint32_t
               {
                /* Configure auto-delayed mode */
                HRTIM_timcr =
                    (*HRTIMx).HRTIM_TIMERx[TimerIdx as usize].TIMxCR;
                HRTIM_timcr &= !(0x3000 as libc::c_int as uint32_t);
            ...
            if (*pCompareCfg).AutoDelayedMode != 0 as libc::c_int as uint32_t
               {
                ...
                HRTIM_timcr =
                    (*HRTIMx).HRTIM_TIMERx[TimerIdx as usize].TIMxCR;
                HRTIM_timcr &= !(0xc000 as libc::c_int as uint32_t);
                HRTIM_timcr |=
                    (*pCompareCfg).AutoDelayedMode << 2 as libc::c_int;
                ::core::ptr::write_volatile(&mut (*HRTIMx).HRTIM_TIMERx[TimerIdx
                                                                            as
                                                                            usize].TIMxCR
                                                as *mut uint32_t,
...
pub unsafe extern "C" fn HRTIM_TimerEventFilteringConfig(mut HRTIMx:
    ...
    match Event {
        ...
        1 => {
            ...
            HRTIM_eefr &=
                !(0x1e as libc::c_int as uint32_t |
                      0x1 as libc::c_int as uint32_t);
            HRTIM_eefr |=
        ...
        2 => {
            ...
            HRTIM_eefr |=
                ((*pTimerEventFilteringCfg).Filter |
                     (*pTimerEventFilteringCfg).Latch) << 6 as libc::c_int;
            ::core::ptr::write_volatile(&mut (*HRTIMx).HRTIM_TIMERx[TimerIdx
                                                                        as
                                                                        usize].EEFxR1
                                            as *mut uint32_t, HRTIM_eefr)
        ...
        4 => {
            ...
            HRTIM_eefr |=
                ((*pTimerEventFilteringCfg).Filter |
                     (*pTimerEventFilteringCfg).Latch) << 12 as libc::c_int;
            ::core::ptr::write_volatile(&mut (*HRTIMx).HRTIM_TIMERx[TimerIdx
                                                                        as
                                                                        usize].EEFxR1
                                            as *mut uint32_t, HRTIM_eefr)
        ...
        8 => {
            ...
            HRTIM_eefr |=
                ((*pTimerEventFilteringCfg).Filter |
                     (*pTimerEventFilteringCfg).Latch) << 18 as libc::c_int;
            ::core::ptr::write_volatile(&mut (*HRTIMx).HRTIM_TIMERx[TimerIdx
                                                                        as
                                                                        usize].EEFxR1
                                            as *mut uint32_t, HRTIM_eefr)
        ...
        16 => {
            HRTIM_eefr = (*HRTIMx).HRTIM_TIMERx[TimerIdx as usize].EEFxR1;
            HRTIM_eefr &=
                !(0x1e000000 as libc::c_int as uint32_t |
                      0x1000000 as libc::c_int as uint32_t);
            HRTIM_eefr |=
                ((*pTimerEventFilteringCfg).Filter |
                     (*pTimerEventFilteringCfg).Latch) << 24 as libc::c_int;
            ::core::ptr::write_volatile(&mut (*HRTIMx).HRTIM_TIMERx[TimerIdx
                                                                        as
                                                                        usize].EEFxR1
                                            as *mut uint32_t, HRTIM_eefr)
...
pub unsafe extern "C" fn HRTIM_DeadTimeConfig(mut HRTIMx: *mut HRTIM_TypeDef,
    ...
    HRTIM_dtr &=
        !(0x1ff as libc::c_int as uint32_t | 0x200 as libc::c_int as uint32_t
              | 0x1c00 as libc::c_int as uint32_t |
    ...
    HRTIM_dtr |= (*pDeadTimeCfg).Prescaler << 10 as libc::c_int;
    ...
    HRTIM_dtr |= (*pDeadTimeCfg).FallingValue << 16 as libc::c_int;
...
pub unsafe extern "C" fn HRTIM_ChopperModeConfig(mut HRTIMx:
    ...
    HRTIM_chpr &=
        !(0xf as libc::c_int as uint32_t | 0x70 as libc::c_int as uint32_t |
              0x780 as libc::c_int as uint32_t);
    /* Set timer chopper mode configuration */
    HRTIM_chpr |= (*pChopperModeCfg).CarrierFreq;
    HRTIM_chpr |= (*pChopperModeCfg).DutyCycle << 4 as libc::c_int;
    HRTIM_chpr |= (*pChopperModeCfg).StartPulse << 7 as libc::c_int;
    /* Update the HRTIMx registers */
    ::core::ptr::write_volatile(&mut (*HRTIMx).HRTIM_TIMERx[TimerIdx as
                                                                usize].CHPxR
...
pub unsafe extern "C" fn HRTIM_SynchronizationConfig(mut HRTIMx:
    ...
    HRTIM_mcr &= !(0x300 as libc::c_int as uint32_t);
    HRTIM_mcr |= (*pSynchroCfg).SyncInputSource;
    /* Set the event to be sent on the synchronization output */
    HRTIM_mcr &= !(0xc000 as libc::c_int as uint32_t);
    HRTIM_mcr |= (*pSynchroCfg).SyncOutputSource;
    /* Set the polarity of the synchronization output */
    HRTIM_mcr &= !(0x3000 as libc::c_int as uint32_t);
...
pub unsafe extern "C" fn HRTIM_EventPrescalerConfig(mut HRTIMx:
    ...
    HRTIM_eecr3 &= !(0xc0000000 as libc::c_uint);
        ...
        2 => {
            HRTIM_fltinr1 &=
                !(0x200 as libc::c_int as uint32_t |
                      ...
                      0x8000 as libc::c_int as uint32_t);
            HRTIM_fltinr1 |= (*pFaultCfg).Polarity << 8 as libc::c_int;
            HRTIM_fltinr1 |= (*pFaultCfg).Source << 8 as libc::c_int;
            HRTIM_fltinr1 |= (*pFaultCfg).Filter << 8 as libc::c_int;
            HRTIM_fltinr1 |= (*pFaultCfg).Lock << 8 as libc::c_int
        }
        4 => {
            HRTIM_fltinr1 &=
                !(0x20000 as libc::c_int as uint32_t |
                      ...
                      0x780000 as libc::c_int as uint32_t |
                      0x800000 as libc::c_int as uint32_t);
            HRTIM_fltinr1 |= (*pFaultCfg).Polarity << 16 as libc::c_int;
            HRTIM_fltinr1 |= (*pFaultCfg).Source << 16 as libc::c_int;
            HRTIM_fltinr1 |= (*pFaultCfg).Filter << 16 as libc::c_int;
            HRTIM_fltinr1 |= (*pFaultCfg).Lock << 16 as libc::c_int
        }
        8 => {
            HRTIM_fltinr1 &=
                !(0x2000000 as libc::c_int as uint32_t |
                      ...
                      0x80000000 as libc::c_uint);
            HRTIM_fltinr1 |= (*pFaultCfg).Polarity << 24 as libc::c_int;
            HRTIM_fltinr1 |= (*pFaultCfg).Source << 24 as libc::c_int;
            HRTIM_fltinr1 |= (*pFaultCfg).Filter << 24 as libc::c_int;
            HRTIM_fltinr1 |= (*pFaultCfg).Lock << 24 as libc::c_int
        }
        16 => {
            HRTIM_fltinr2 &=
                !(0x2 as libc::c_int as uint32_t |
...
pub unsafe extern "C" fn HRTIM_FaultPrescalerConfig(mut HRTIMx:
    ...
    /* Set the external event prescaler */
    HRTIM_fltinr2 = (*HRTIMx).HRTIM_COMMON.FLTINxR2;
    HRTIM_fltinr2 &= !(0x3000000 as libc::c_int as uint32_t);
...
pub unsafe extern "C" fn HRTIM_FaultModeCtl(mut HRTIMx: *mut HRTIM_TypeDef,
    ...
    match Fault {
        1 => {
            HRTIM_fltinr1 &= !(0x1 as libc::c_int as uint32_t);
            HRTIM_fltinr1 |= Enable
        }
        2 => {
            HRTIM_fltinr1 &= !(0x100 as libc::c_int as uint32_t);
            HRTIM_fltinr1 |= Enable << 8 as libc::c_int
        }
        4 => {
            HRTIM_fltinr1 &= !(0x10000 as libc::c_int as uint32_t);
            HRTIM_fltinr1 |= Enable << 16 as libc::c_int
        }
        8 => {
            HRTIM_fltinr1 &= !(0x1000000 as libc::c_int as uint32_t);
            HRTIM_fltinr1 |= Enable << 24 as libc::c_int
        }
        16 => {
            HRTIM_fltinr2 &= !(0x1 as libc::c_int as uint32_t);
...
pub unsafe extern "C" fn HRTIM_ADCTriggerConfig(mut HRTIMx:
    ...
    match ADCTrigger {
        1 => {
            HRTIM_cr1 &= !(0x70000 as libc::c_int as uint32_t);
        ...
        2 => {
            HRTIM_cr1 &= !(0x380000 as libc::c_int as uint32_t);
            HRTIM_cr1 |= (*pADCTriggerCfg).UpdateSource << 3 as libc::c_int;
        ...
        4 => {
            HRTIM_cr1 &= !(0x1c00000 as libc::c_int as uint32_t);
            HRTIM_cr1 |= (*pADCTriggerCfg).UpdateSource << 6 as libc::c_int;
    ...
    match current_block_18 {
        13144893622685093897 => {
            HRTIM_cr1 &= !(0xe000000 as libc::c_int as uint32_t);
            HRTIM_cr1 |= (*pADCTriggerCfg).UpdateSource << 9 as libc::c_int;
...
pub unsafe extern "C" fn HRTIM_BurstModeCtl(mut HRTIMx: *mut HRTIM_TypeDef,
    ...
    HRTIM_bmcr = (*HRTIMx).HRTIM_COMMON.BMCR;
    HRTIM_bmcr &= !(0x1 as libc::c_int as uint32_t);
    HRTIM_bmcr |= Enable;
    /* Update the HRTIMx registers */
    ::core::ptr::write_volatile(&mut (*HRTIMx).HRTIM_COMMON.BMCR as
                                    *mut uint32_t, HRTIM_bmcr);
...
pub unsafe extern "C" fn HRTIM_WaveformSetOutputLevel(mut HRTIMx:
    ...
    match Output {
        1 | 4 | 16 | 64 | 256 => {
            if OutputLevel == 0x1 as libc::c_int as uint32_t {
...
pub unsafe extern "C" fn HRTIM_GetCapturedValue(mut HRTIMx:
                                                ...
                                                mut CaptureUnit: uint32_t)
 -> uint32_t {
    let mut captured_value: uint32_t = 0 as libc::c_int as uint32_t;
    /* Check parameters */
    /* Read captured value */
    match CaptureUnit {
        1 => {
...
pub unsafe extern "C" fn HRTIM_WaveformGetOutputLevel(mut HRTIMx:
                                                      ...
                                                      mut Output: uint32_t)
 -> uint32_t {
    let mut output_level: uint32_t = 0x2 as libc::c_int as uint32_t;
    /* Check parameters */
    ...
    match Output {
        1 | 4 | 16 | 64 | 256 => {
            if (*HRTIMx).HRTIM_TIMERx[TimerIdx as usize].TIMxISR &
                   0x100000 as libc::c_int as uint32_t !=
                   RESET as libc::c_int as libc::c_uint {
                output_level = 0x1 as libc::c_int as uint32_t
            } else { output_level = 0x2 as libc::c_int as uint32_t }
        }
        2 | 8 | 32 | 128 | 512 => {
            if (*HRTIMx).HRTIM_TIMERx[TimerIdx as usize].TIMxISR &
                   0x200000 as libc::c_int as uint32_t !=
...
pub unsafe extern "C" fn HRTIM_WaveformGetOutputState(mut HRTIMx:
                                                      ...
                                                      mut Output: uint32_t)
 -> uint32_t {
    let mut output_bit: uint32_t = 0 as libc::c_int as uint32_t;
    let mut output_state: uint32_t = 0x1 as libc::c_int as uint32_t;
    /* Check parameters */
    /* Set output state according to output control status and output disable status */
    match Output {
        1 => { output_bit = 0x1 as libc::c_int as uint32_t }
        2 => { output_bit = 0x2 as libc::c_int as uint32_t }
        4 => { output_bit = 0x4 as libc::c_int as uint32_t }
        8 => { output_bit = 0x8 as libc::c_int as uint32_t }
        16 => { output_bit = 0x10 as libc::c_int as uint32_t }
        32 => { output_bit = 0x20 as libc::c_int as uint32_t }
        64 => { output_bit = 0x40 as libc::c_int as uint32_t }
        128 => { output_bit = 0x80 as libc::c_int as uint32_t }
        256 => { output_bit = 0x100 as libc::c_int as uint32_t }
        512 => { output_bit = 0x200 as libc::c_int as uint32_t }
        _ => { }
    }
    if (*HRTIMx).HRTIM_COMMON.OENR & output_bit !=
           RESET as libc::c_int as libc::c_uint {
        /* Output is enabled: output in RUN state (whatever ouput disable status is)*/
        output_state = 0x2 as libc::c_int as uint32_t
    } else if (*HRTIMx).HRTIM_COMMON.ODSR & output_bit !=
                  RESET as libc::c_int as libc::c_uint {
        /* Output is disabled: output in FAULT state */
        output_state = 0x3 as libc::c_int as uint32_t
    } else {
        /* Output is disabled: output in IDLE state */
        output_state = 0x1 as libc::c_int as uint32_t
    }
    return output_state;
}
/* *
...
pub unsafe extern "C" fn HRTIM_GetDelayedProtectionStatus(mut HRTIMx:
                                                          ...
                                                          mut Output:
                                                              uint32_t)
 -> uint32_t {
    let mut delayed_protection_status: uint32_t =
        0x2 as libc::c_int as uint32_t;
    /* Check parameters */
    ...
    match Output {
        1 | 4 | 16 | 64 | 256 => {
            if (*HRTIMx).HRTIM_TIMERx[TimerIdx as usize].TIMxISR &
                ...
                delayed_protection_status = 0x1 as libc::c_int as uint32_t
            } else {
                /* Output 1 was inactive when the delayed idle protection was triggered */
                delayed_protection_status = 0x2 as libc::c_int as uint32_t
            }
        }
        2 | 8 | 32 | 128 | 512 => {
            if (*HRTIMx).HRTIM_TIMERx[TimerIdx as usize].TIMxISR &
...
pub unsafe extern "C" fn HRTIM_GetBurstStatus(mut HRTIMx: *mut HRTIM_TypeDef)
 -> uint32_t {
    ...
    burst_mode_status =
        (*HRTIMx).HRTIM_COMMON.BMCR & 0x80000000 as libc::c_uint;
...
unsafe extern "C" fn HRTIM_MasterBase_Config(mut HRTIMx: *mut HRTIM_TypeDef,
    ...
    ::core::ptr::write_volatile(&mut (*HRTIMx).HRTIM_MASTER.MCR as
                                ...
                                (::core::ptr::read_volatile::<uint32_t>(&(*HRTIMx).HRTIM_MASTER.MCR
                                                                            ...
                                                                            *const uint32_t)
                                     as libc::c_uint &
                                     !(0x7 as libc::c_int as uint32_t)) as
                                    uint32_t as uint32_t);
    ::core::ptr::write_volatile(&mut (*HRTIMx).HRTIM_MASTER.MCR as
                                    *mut uint32_t,
                                (::core::ptr::read_volatile::<uint32_t>(&(*HRTIMx).HRTIM_MASTER.MCR
...
unsafe extern "C" fn HRTIM_MasterWaveform_Config(mut HRTIMx:
    ...
    HRTIM_mcr &= !(0x20 as libc::c_int as uint32_t);
    HRTIM_mcr |= (*pTimerInit).HalfModeEnable;
    /* Enable/Disable the timer start upon synchronization event reception */
    HRTIM_mcr &= !(0x800 as libc::c_int as uint32_t);
    HRTIM_mcr |= (*pTimerInit).StartOnSync;
    /* Enable/Disable the timer reset upon synchronization event reception */
    HRTIM_mcr &= !(0x400 as libc::c_int as uint32_t);
    HRTIM_mcr |= (*pTimerInit).ResetOnSync;
    /* Enable/Disable the DAC synchronization event generation */
    HRTIM_mcr &= !(0x6000000 as libc::c_int as uint32_t);
    HRTIM_mcr |= (*pTimerInit).DACSynchro;
    /* Enable/Disable preload mechanism for timer registers */
    HRTIM_mcr &= !(0x8000000 as libc::c_int as uint32_t);
    HRTIM_mcr |= (*pTimerInit).PreloadEnable;
    /* Master timer registers update handling */
    HRTIM_mcr &= !(0xc0000000 as libc::c_uint);
    HRTIM_mcr |= (*pTimerInit).UpdateGating << 2 as libc::c_int;
    /* Enable/Disable registers update on repetition */
    HRTIM_mcr &= !(0x20000000 as libc::c_int as uint32_t);
    HRTIM_mcr |= (*pTimerInit).RepetitionUpdate;
    /* Set the timer burst mode */
    HRTIM_bmcr &= !(0x10000 as libc::c_int as uint32_t);
...
unsafe extern "C" fn HRTIM_TimingUnitWaveform_Config(mut HRTIMx:
    ...
    HRTIM_bmcr = (*HRTIMx).HRTIM_COMMON.BMCR;
    /* Enable/Disable the half mode */
    HRTIM_timcr &= !(0x20 as libc::c_int as uint32_t);
    HRTIM_timcr |= (*pTimerInit).HalfModeEnable;
    /* Enable/Disable the timer start upon synchronization event reception */
    HRTIM_timcr &= !(0x800 as libc::c_int as uint32_t);
    HRTIM_timcr |= (*pTimerInit).StartOnSync;
    /* Enable/Disable the timer reset upon synchronization event reception */
    HRTIM_timcr &= !(0x400 as libc::c_int as uint32_t);
    HRTIM_timcr |= (*pTimerInit).ResetOnSync;
    /* Enable/Disable the DAC synchronization event generation */
    HRTIM_timcr &= !(0x6000000 as libc::c_int as uint32_t);
    HRTIM_timcr |= (*pTimerInit).DACSynchro;
    /* Enable/Disable preload mechanism for timer registers */
    HRTIM_timcr &= !(0x8000000 as libc::c_int as uint32_t);
    HRTIM_timcr |= (*pTimerInit).PreloadEnable;
    /* Timing unit registers update handling */
    HRTIM_timcr &= !(0xf0000000 as libc::c_uint);
    HRTIM_timcr |= (*pTimerInit).UpdateGating;
    /* Enable/Disable registers update on repetition */
    HRTIM_timcr &= !(0x20000 as libc::c_int as uint32_t);
    if (*pTimerInit).RepetitionUpdate == 0x20000000 as libc::c_int as uint32_t
       {
        HRTIM_timcr |= 0x20000 as libc::c_int as uint32_t
    }
    /* Set the timer burst mode */
    match TimerIdx {
        0 => {
            HRTIM_bmcr &= !(0x20000 as libc::c_int as uint32_t);
            HRTIM_bmcr |= (*pTimerInit).BurstMode << 1 as libc::c_int
        }
        1 => {
            HRTIM_bmcr &= !(0x40000 as libc::c_int as uint32_t);
            HRTIM_bmcr |= (*pTimerInit).BurstMode << 2 as libc::c_int
        }
        2 => {
            HRTIM_bmcr &= !(0x80000 as libc::c_int as uint32_t);
            HRTIM_bmcr |= (*pTimerInit).BurstMode << 3 as libc::c_int
        }
        3 => {
            HRTIM_bmcr &= !(0x100000 as libc::c_int as uint32_t);
            HRTIM_bmcr |= (*pTimerInit).BurstMode << 4 as libc::c_int
        }
        4 => {
            HRTIM_bmcr &= !(0x200000 as libc::c_int as uint32_t);
            HRTIM_bmcr |= (*pTimerInit).BurstMode << 5 as libc::c_int
        }
        _ => { }
    }
    /* Update the HRTIMx registers */
...
unsafe extern "C" fn HRTIM_CaptureUnitConfig(mut HRTIMx: *mut HRTIM_TypeDef,
                                             ...
                                             mut CaptureUnit: uint32_t,
                                             mut Event: uint32_t) {
    let mut CaptureTrigger: uint32_t = 0x4 as libc::c_int as uint32_t;
    match Event {
        1 => { CaptureTrigger = 0x4 as libc::c_int as uint32_t }
        2 => { CaptureTrigger = 0x8 as libc::c_int as uint32_t }
        4 => { CaptureTrigger = 0x10 as libc::c_int as uint32_t }
        8 => { CaptureTrigger = 0x20 as libc::c_int as uint32_t }
        16 => { CaptureTrigger = 0x40 as libc::c_int as uint32_t }
        32 => { CaptureTrigger = 0x80 as libc::c_int as uint32_t }
        64 => { CaptureTrigger = 0x100 as libc::c_int as uint32_t }
        128 => { CaptureTrigger = 0x200 as libc::c_int as uint32_t }
        256 => { CaptureTrigger = 0x400 as libc::c_int as uint32_t }
        512 => { CaptureTrigger = 0x800 as libc::c_int as uint32_t }
        _ => { }
    }
    match CaptureUnit {
        1 => {
...
unsafe extern "C" fn HRTIM_OutputConfig(mut HRTIMx: *mut HRTIM_TypeDef,
    ...
    let mut shift: uint32_t = 0 as libc::c_int as uint32_t;
    ...
    match Output {
        1 | 4 | 16 | 64 | 256 => {
            ...
            shift = 0 as libc::c_int as uint32_t
        }
        2 | 8 | 32 | 128 | 512 => {
            /* Set the output set/reset crossbar */
            ::core::ptr::write_volatile(&mut (*HRTIMx).HRTIM_TIMERx[TimerIdx
            ...
            ::core::ptr::write_volatile(&mut (*HRTIMx).HRTIM_TIMERx[TimerIdx
                                            ...
                                            as *mut uint32_t,
                                        (*pOutputCfg).ResetSource);
            shift = 16 as libc::c_int as uint32_t
        }
        _ => { }
    }
    /* Clear output config */
    HRTIM_outr &=
        !((0x2 as libc::c_int as uint32_t | 0x4 as libc::c_int as uint32_t |
               ...
               0x40 as libc::c_int as uint32_t |
               0x80 as libc::c_int as uint32_t) << shift);
    /* Set the polarity */
...
unsafe extern "C" fn HRTIM_ExternalEventConfig(mut HRTIMx: *mut HRTIM_TypeDef,
    ...
    match Event {
        ...
        2 => {
            ...
            hrtim_eecr1 |= (*pEventCfg).Source << 6 as libc::c_int;
            hrtim_eecr1 |= (*pEventCfg).Polarity << 6 as libc::c_int;
            hrtim_eecr1 |= (*pEventCfg).Sensitivity << 6 as libc::c_int;
            /* Update the HRTIM registers (all bit fields but EE2FAST bit) */
            ::core::ptr::write_volatile(&mut (*HRTIMx).HRTIM_COMMON.EECR1 as
                                            *mut uint32_t, hrtim_eecr1);
            /* Update the HRTIM registers (EE2FAST bit) */
            hrtim_eecr1 |= (*pEventCfg).FastMode << 6 as libc::c_int;
            ::core::ptr::write_volatile(&mut (*HRTIMx).HRTIM_COMMON.EECR1 as
                                            *mut uint32_t, hrtim_eecr1)
        }
        4 => {
            hrtim_eecr1 &=
                !(0x3000 as libc::c_int as uint32_t |
                      ...
                      0x20000 as libc::c_int as uint32_t);
            hrtim_eecr1 |= (*pEventCfg).Source << 12 as libc::c_int;
            hrtim_eecr1 |= (*pEventCfg).Polarity << 12 as libc::c_int;
            hrtim_eecr1 |= (*pEventCfg).Sensitivity << 12 as libc::c_int;
            /* Update the HRTIM registers (all bit fields but EE3FAST bit) */
            ::core::ptr::write_volatile(&mut (*HRTIMx).HRTIM_COMMON.EECR1 as
                                            *mut uint32_t, hrtim_eecr1);
            /* Update the HRTIM registers (EE3FAST bit) */
            hrtim_eecr1 |= (*pEventCfg).FastMode << 12 as libc::c_int;
            ::core::ptr::write_volatile(&mut (*HRTIMx).HRTIM_COMMON.EECR1 as
                                            *mut uint32_t, hrtim_eecr1)
        }
        8 => {
            hrtim_eecr1 &=
                !(0xc0000 as libc::c_int as uint32_t |
                      0x100000 as libc::c_int as uint32_t |
                      0x600000 as libc::c_int as uint32_t |
                      0x800000 as libc::c_int as uint32_t);
            hrtim_eecr1 |= (*pEventCfg).Source << 18 as libc::c_int;
            hrtim_eecr1 |= (*pEventCfg).Polarity << 18 as libc::c_int;
            hrtim_eecr1 |= (*pEventCfg).Sensitivity << 18 as libc::c_int;
            /* Update the HRTIM registers (all bit fields but EE4FAST bit) */
            ::core::ptr::write_volatile(&mut (*HRTIMx).HRTIM_COMMON.EECR1 as
                                            *mut uint32_t, hrtim_eecr1);
            /* Update the HRTIM registers (EE4FAST bit) */
            hrtim_eecr1 |= (*pEventCfg).FastMode << 18 as libc::c_int;
            ::core::ptr::write_volatile(&mut (*HRTIMx).HRTIM_COMMON.EECR1 as
                                            *mut uint32_t, hrtim_eecr1)
        }
        16 => {
            ...
            hrtim_eecr1 |= (*pEventCfg).Source << 24 as libc::c_int;
            hrtim_eecr1 |= (*pEventCfg).Polarity << 24 as libc::c_int;
            hrtim_eecr1 |= (*pEventCfg).Sensitivity << 24 as libc::c_int;
            /* Update the HRTIM registers (all bit fields but EE5FAST bit) */
            ::core::ptr::write_volatile(&mut (*HRTIMx).HRTIM_COMMON.EECR1 as
                                            *mut uint32_t, hrtim_eecr1);
            /* Update the HRTIM registers (EE5FAST bit) */
            hrtim_eecr1 |= (*pEventCfg).FastMode << 24 as libc::c_int;
            ::core::ptr::write_volatile(&mut (*HRTIMx).HRTIM_COMMON.EECR1 as
                                            *mut uint32_t, hrtim_eecr1)
        }
        32 => {
            ...
            hrtim_eecr3 &= !(0xf as libc::c_int as uint32_t);
        ...
        64 => {
            hrtim_eecr2 &=
                !(0xc0 as libc::c_int as uint32_t |
                      0x100 as libc::c_int as uint32_t |
                      0x600 as libc::c_int as uint32_t);
            hrtim_eecr2 |= (*pEventCfg).Source << 6 as libc::c_int;
            hrtim_eecr2 |= (*pEventCfg).Polarity << 6 as libc::c_int;
            hrtim_eecr2 |= (*pEventCfg).Sensitivity << 6 as libc::c_int;
            hrtim_eecr3 &= !(0x3c0 as libc::c_int as uint32_t);
            hrtim_eecr3 |= (*pEventCfg).Filter << 6 as libc::c_int;
            /* Update the HRTIM registers */
            ::core::ptr::write_volatile(&mut (*HRTIMx).HRTIM_COMMON.EECR2 as
                                            *mut uint32_t, hrtim_eecr2);
            ::core::ptr::write_volatile(&mut (*HRTIMx).HRTIM_COMMON.EECR3 as
        ...
        128 => {
            hrtim_eecr2 &=
                !(0x3000 as libc::c_int as uint32_t |
                      0x4000 as libc::c_int as uint32_t |
                      0x18000 as libc::c_int as uint32_t);
            hrtim_eecr2 |= (*pEventCfg).Source << 12 as libc::c_int;
            hrtim_eecr2 |= (*pEventCfg).Polarity << 12 as libc::c_int;
            hrtim_eecr2 |= (*pEventCfg).Sensitivity << 12 as libc::c_int;
            hrtim_eecr3 &= !(0xf000 as libc::c_int as uint32_t);
            hrtim_eecr3 |= (*pEventCfg).Filter << 12 as libc::c_int;
            /* Update the HRTIM registers */
            ::core::ptr::write_volatile(&mut (*HRTIMx).HRTIM_COMMON.EECR2 as
                                            *mut uint32_t, hrtim_eecr2);
            ::core::ptr::write_volatile(&mut (*HRTIMx).HRTIM_COMMON.EECR3 as
        ...
        256 => {
            hrtim_eecr2 &=
                !(0xc0000 as libc::c_int as uint32_t |
                      0x100000 as libc::c_int as uint32_t |
                      0x600000 as libc::c_int as uint32_t);
            hrtim_eecr2 |= (*pEventCfg).Source << 18 as libc::c_int;
            hrtim_eecr2 |= (*pEventCfg).Polarity << 18 as libc::c_int;
            hrtim_eecr2 |= (*pEventCfg).Sensitivity << 18 as libc::c_int;
            hrtim_eecr3 &= !(0x3c0000 as libc::c_int as uint32_t);
            hrtim_eecr3 |= (*pEventCfg).Filter << 18 as libc::c_int;
            /* Update the HRTIM registers */
            ::core::ptr::write_volatile(&mut (*HRTIMx).HRTIM_COMMON.EECR2 as
                                            *mut uint32_t, hrtim_eecr2);
            ::core::ptr::write_volatile(&mut (*HRTIMx).HRTIM_COMMON.EECR3 as
        ...
        512 => {
            hrtim_eecr2 &=
                !(0x3000000 as libc::c_int as uint32_t |
                      0x4000000 as libc::c_int as uint32_t |
                      0x18000000 as libc::c_int as uint32_t);
            hrtim_eecr2 |= (*pEventCfg).Source << 24 as libc::c_int;
            hrtim_eecr2 |= (*pEventCfg).Polarity << 24 as libc::c_int;
            hrtim_eecr2 |= (*pEventCfg).Sensitivity << 24 as libc::c_int;
            hrtim_eecr3 &= !(0xf000000 as libc::c_int as uint32_t);
            hrtim_eecr3 |= (*pEventCfg).Filter << 24 as libc::c_int;
            /* Update the HRTIM registers */
            ::core::ptr::write_volatile(&mut (*HRTIMx).HRTIM_COMMON.EECR2 as
                                            *mut uint32_t, hrtim_eecr2);
            ::core::ptr::write_volatile(&mut (*HRTIMx).HRTIM_COMMON.EECR3 as
