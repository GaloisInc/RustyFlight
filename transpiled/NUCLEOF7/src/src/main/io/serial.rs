 ...
 * If not, see <http://www.gnu.org/licenses/>.
 */
static mut serialPortUsageList: [serialPortUsage_t; 10] =
    [serialPortUsage_t{serialPort:
                           0 as *const serialPort_t as *mut serialPort_t,
                       function: FUNCTION_NONE,
                       identifier: SERIAL_PORT_USART1,}; 10];
#[no_mangle]
pub static mut serialPortIdentifiers: [serialPortIdentifier_e; 10] =
    [SERIAL_PORT_USB_VCP, SERIAL_PORT_USART2, SERIAL_PORT_USART3,
     SERIAL_PORT_UART4, SERIAL_PORT_UART5, SERIAL_PORT_USART6,
     SERIAL_PORT_USART7, SERIAL_PORT_USART8, SERIAL_PORT_SOFTSERIAL1,
...
pub unsafe extern "C" fn serialInit(mut softserialEnabled: bool,
                                    mut serialPortToDisable:
                                        serialPortIdentifier_e) {
    serialPortCount = 10 as libc::c_int as uint8_t;
    memset(&mut serialPortUsageList as *mut [serialPortUsage_t; 10] as
               *mut libc::c_void, 0 as libc::c_int,
           ::core::mem::size_of::<[serialPortUsage_t; 10]>() as
               libc::c_ulong);
    let mut index: libc::c_int = 0 as libc::c_int;
    while index < 10 as libc::c_int {
