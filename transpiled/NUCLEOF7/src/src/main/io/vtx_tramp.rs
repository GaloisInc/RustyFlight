...
pub static mut trampPowerTable: [uint16_t; 5] =
    [25 as libc::c_int as uint16_t, 100 as libc::c_int as uint16_t,
     200 as libc::c_int as uint16_t, 400 as libc::c_int as uint16_t,
...
#[no_mangle]
pub static mut trampSetByFreqFlag: bool = 0 as libc::c_int != 0;
//false = set via band/channel
#[no_mangle]
pub static mut trampCurFreq: uint32_t = 0 as libc::c_int as uint32_t;
#[no_mangle]
pub static mut trampBand: uint8_t = 0 as libc::c_int as uint8_t;
#[no_mangle]
pub static mut trampChannel: uint8_t = 0 as libc::c_int as uint8_t;
#[no_mangle]
pub static mut trampPower: uint16_t = 0 as libc::c_int as uint16_t;
// Actual transmitting power
#[no_mangle]
pub static mut trampConfiguredPower: uint16_t = 0 as libc::c_int as uint16_t;
// Configured transmitting power
#[no_mangle]
pub static mut trampTemperature: int16_t = 0 as libc::c_int as int16_t;
#[no_mangle]
pub static mut trampPitMode: uint8_t = 0 as libc::c_int as uint8_t;
#[no_mangle]
pub static mut trampConfFreq: uint32_t = 0 as libc::c_int as uint32_t;
#[no_mangle]
pub static mut trampFreqRetries: uint8_t = 0 as libc::c_int as uint8_t;
#[no_mangle]
pub static mut trampConfPower: uint16_t = 0 as libc::c_int as uint16_t;
#[no_mangle]
pub static mut trampPowerRetries: uint8_t = 0 as libc::c_int as uint8_t;
unsafe extern "C" fn trampWriteBuf(mut buf: *mut uint8_t) {
    serialWriteBuf(trampSerialPort, buf,
                   16 as libc::c_int); //set freq via MHz value
}
unsafe extern "C" fn trampChecksum(mut trampBuf: *mut uint8_t) -> uint8_t {
    let mut cksum: uint8_t =
        0 as libc::c_int as uint8_t; //set freq via band/channel
...
pub unsafe extern "C" fn trampCmdU16(mut cmd: uint8_t, mut param: uint16_t) {
    ...
    memset(trampReqBuffer.as_mut_ptr() as *mut libc::c_void, 0 as libc::c_int,
           (::core::mem::size_of::<[uint8_t; 16]>() as
                libc::c_ulong).wrapping_div(::core::mem::size_of::<uint8_t>()
                                                as libc::c_ulong));
    trampReqBuffer[0 as libc::c_int as usize] = 15 as libc::c_int as uint8_t;
    trampReqBuffer[1 as libc::c_int as usize] = cmd;
    trampReqBuffer[2 as libc::c_int as usize] =
        (param as libc::c_int & 0xff as libc::c_int) as uint8_t;
    trampReqBuffer[3 as libc::c_int as usize] =
        (param as libc::c_int >> 8 as libc::c_int & 0xff as libc::c_int) as
            uint8_t;
    trampReqBuffer[14 as libc::c_int as usize] =
        trampChecksum(trampReqBuffer.as_mut_ptr());
...
unsafe extern "C" fn trampDevSetFreq(mut freq: uint16_t) {
    ...
    if trampConfFreq != trampCurFreq {
        trampFreqRetries = 2 as libc::c_int as uint8_t
    };
}
#[no_mangle]
pub unsafe extern "C" fn trampSetFreq(mut freq: uint16_t) {
    trampSetByFreqFlag = 1 as libc::c_int != 0;
...
pub unsafe extern "C" fn trampSetBandAndChannel(mut band: uint8_t,
                                                mut channel: uint8_t) {
    trampSetByFreqFlag = 0 as libc::c_int != 0;
...
pub unsafe extern "C" fn trampSetRFPower(mut level: uint16_t) {
    ...
    if trampConfPower as libc::c_int != trampPower as libc::c_int {
        trampPowerRetries = 2 as libc::c_int as uint8_t
    };
}
#[no_mangle]
...
unsafe extern "C" fn trampDevSetPowerByIndex(mut index: uint8_t) -> bool {
    if index as libc::c_int > 0 as libc::c_int &&
        ...
        trampSetRFPower(trampPowerTable[(index as libc::c_int -
...
pub unsafe extern "C" fn trampHandleResponse() -> libc::c_char {
    let respCode: uint8_t = trampRespBuffer[1 as libc::c_int as usize];
    match respCode as libc::c_int {
        114 => {
            let min_freq: uint16_t =
                (trampRespBuffer[2 as libc::c_int as usize] as libc::c_int |
                     (trampRespBuffer[3 as libc::c_int as usize] as
                          libc::c_int) << 8 as libc::c_int) as uint16_t;
            if min_freq as libc::c_int != 0 as libc::c_int {
                trampRFFreqMin = min_freq as uint32_t;
                trampRFFreqMax =
                    (trampRespBuffer[4 as libc::c_int as usize] as libc::c_int
                         |
                         (trampRespBuffer[5 as libc::c_int as usize] as
                              libc::c_int) << 8 as libc::c_int) as uint32_t;
                trampRFPowerMax =
                    (trampRespBuffer[6 as libc::c_int as usize] as libc::c_int
                         |
                         (trampRespBuffer[7 as libc::c_int as usize] as
                              libc::c_int) << 8 as libc::c_int) as uint32_t;
        ...
        118 => {
            let freq: uint16_t =
                (trampRespBuffer[2 as libc::c_int as usize] as libc::c_int |
                     (trampRespBuffer[3 as libc::c_int as usize] as
                          libc::c_int) << 8 as libc::c_int) as uint16_t;
            if freq as libc::c_int != 0 as libc::c_int {
                ...
                trampConfiguredPower =
                    (trampRespBuffer[4 as libc::c_int as usize] as libc::c_int
                         ...
                         (trampRespBuffer[5 as libc::c_int as usize] as
                              libc::c_int) << 8 as libc::c_int) as uint16_t;
                trampPitMode = trampRespBuffer[7 as libc::c_int as usize];
                trampPower =
                    (trampRespBuffer[8 as libc::c_int as usize] as libc::c_int
                         |
                         (trampRespBuffer[9 as libc::c_int as usize] as
                              libc::c_int) << 8 as libc::c_int) as uint16_t;
                // throw bytes echoed from tx to rx in bidirectional mode away
                ...
                if trampConfFreq == 0 as libc::c_int as libc::c_uint {
                    trampConfFreq = trampCurFreq
                }
                if trampConfPower as libc::c_int == 0 as libc::c_int {
        ...
        115 => {
            let temp: uint16_t =
                (trampRespBuffer[6 as libc::c_int as usize] as libc::c_int |
                     (trampRespBuffer[7 as libc::c_int as usize] as
                          libc::c_int) << 8 as libc::c_int) as int16_t as
                    uint16_t;
...
static mut trampReceivePos: libc::c_int = 0 as libc::c_int;
unsafe extern "C" fn trampResetReceiver() {
    trampReceiveState = S_WAIT_LEN;
    trampReceivePos = 0 as libc::c_int;
}
...
unsafe extern "C" fn trampReceive(mut currentTimeUs: uint32_t)
 -> libc::c_char {
    if trampSerialPort.is_null() { return 0 as libc::c_int as libc::c_char }
    while serialRxBytesWaiting(trampSerialPort) != 0 {
        ...
        match trampReceiveState as libc::c_uint {
            0 => {
                if c as libc::c_int == 0xf as libc::c_int {
                    trampReceiveState = S_WAIT_CODE
                } else { trampReceivePos = 0 as libc::c_int }
            }
            1 => {
            ...
            2 => {
                if trampReceivePos == 16 as libc::c_int {
                    let mut cksum: uint8_t =
                        trampChecksum(trampRespBuffer.as_mut_ptr());
                    trampResetReceiver();
                    if trampRespBuffer[14 as libc::c_int as usize] as
                           libc::c_int == cksum as libc::c_int &&
                           trampRespBuffer[15 as libc::c_int as usize] as
...
pub unsafe extern "C" fn trampQuery(mut cmd: uint8_t) {
    trampResetReceiver();
    trampCmdU16(cmd, 0 as libc::c_int as uint16_t);
}
#[no_mangle]
...
unsafe extern "C" fn vtxTrampProcess(mut vtxDevice: *mut vtxDevice_t,
    ...
    static mut lastQueryTimeUs: timeUs_t = 0 as libc::c_int as timeUs_t;
    static mut initSettingsDoneFlag: bool = 0 as libc::c_int != 0;
        ...
        114 => {
            if trampStatus as libc::c_int <=
                ...
                if !initSettingsDoneFlag {
                    initSettingsDoneFlag = 1 as libc::c_int != 0
    ...
    match trampStatus as libc::c_int {
        0 | 1 => {
            if cmp32(currentTimeUs, lastQueryTimeUs) >
                ...
                if trampStatus as libc::c_int ==
                    ...
                    static mut cnt: libc::c_uint =
                        0 as libc::c_int as libc::c_uint;
                    let fresh1 = cnt;
                    cnt = cnt.wrapping_add(1);
                    if fresh1 & 1 as libc::c_int as libc::c_uint ==
                           0 as libc::c_int as libc::c_uint {
                        trampQueryV();
                    } else { trampQueryS(); }
                }
        ...
        2 => {
            let mut done: bool = 1 as libc::c_int != 0;
            ...
            if !done {
                ...
                lastQueryTimeUs =
                    currentTimeUs.wrapping_add((300 as libc::c_int *
                ...
                trampConfFreq = trampCurFreq;
                trampConfPower = trampPower;
                trampPowerRetries = 0 as libc::c_int as uint8_t;
...
unsafe extern "C" fn vtxTrampGetBandAndChannel(mut vtxDevice:
 ...
 -> bool {
    if !vtxTrampIsReady(vtxDevice) { return 0 as libc::c_int != 0 }
    ...
    if trampConfiguredPower as libc::c_int > 0 as libc::c_int {
        ...
        while (i as libc::c_ulong) <
            ...
            if trampConfiguredPower as libc::c_int <=
                ...
                *pIndex = (i as libc::c_int + 1 as libc::c_int) as uint8_t;
                break ;
    ...
    if !portConfig.is_null() {
        ...
        trampSerialPort =
            openSerialPort((*portConfig).identifier, FUNCTION_VTX_TRAMP, None,
                           ...
                           9600 as libc::c_int as uint32_t, MODE_RXTX,
                           portOptions)
    }
    if trampSerialPort.is_null() { return 0 as libc::c_int != 0 }
