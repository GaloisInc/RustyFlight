 ...
 -> libc::c_int {
    ...
    match adjustmentFunction as libc::c_int {
        1 | 25 => {
            ...
            } else { current_block_82 = 15554594890419171686; }
        }
        26 => { current_block_82 = 15554594890419171686; }
        2 | 27 => {
            newValue =
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 = 15447629348493591490;
            } else { current_block_82 = 2303068089157008420; }
        }
        28 => { current_block_82 = 2303068089157008420; }
        3 => {
            newValue =
        ...
        4 | 13 => {
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 = 15447629348493591490;
            } else { current_block_82 = 3852715590670456118; }
        }
        14 => { current_block_82 = 3852715590670456118; }
        5 => {
            newValue =
        ...
        6 | 15 => {
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 =
                    3892196170197732966; // FIXME magic numbers repeated in cli.c
            }
        }
        18 => { current_block_82 = 3892196170197732966; }
        7 | 16 => {
            newValue =
                constrain((*pidProfile).pid[PID_PITCH as libc::c_int as
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 =
                    13798541321612611286; // FIXME magic numbers repeated in cli.c
            }
        }
        19 => { current_block_82 = 13798541321612611286; }
        8 | 17 => {
            newValue =
                constrain((*pidProfile).pid[PID_PITCH as libc::c_int as
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 =
                    13660949454107760907; // FIXME magic numbers repeated in cli.c
            }
        }
        20 => {
            current_block_82 =
        ...
        22 | 30 => {
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 = 15447629348493591490;
            } else { current_block_82 = 18312244078037461235; }
        }
        31 => { current_block_82 = 18312244078037461235; }
        32 => {
            newValue =
 ...
 -> libc::c_int {
    ...
    match adjustmentFunction as libc::c_uint {
        1 | 25 => {
            ...
            } else { current_block_84 = 1655177079473908222; }
        }
        26 => { current_block_84 = 1655177079473908222; }
        2 | 27 => {
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                current_block_84 = 5265702136860997526;
            } else { current_block_84 = 4168319483053129256; }
        }
        28 => { current_block_84 = 4168319483053129256; }
        3 => {
            newValue = constrain(value, 0 as libc::c_int, 100 as libc::c_int);
            (*controlRateConfig).thrExpo8 = newValue as uint8_t;
            initRcProcessing();
        ...
        4 | 13 => {
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                current_block_84 = 5265702136860997526;
            } else { current_block_84 = 11902231341186987652; }
        }
        14 => { current_block_84 = 11902231341186987652; }
        5 => {
            newValue = constrain(value, 0 as libc::c_int, 255 as libc::c_int);
            (*controlRateConfig).rates[FD_YAW as libc::c_int as usize] =
                newValue as uint8_t;
        ...
        6 | 15 => {
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                // fall through for combined ADJUSTMENT_PITCH_ROLL_P
                current_block_84 =
                    2580683596681381401; // FIXME magic numbers repeated in cli.c
            }
        }
        18 => { current_block_84 = 2580683596681381401; }
        7 | 16 => {
            newValue = constrain(value, 0 as libc::c_int, 200 as libc::c_int);
            (*pidProfile).pid[PID_PITCH as libc::c_int as usize].I =
                newValue as uint8_t;
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                // fall through for combined ADJUSTMENT_PITCH_ROLL_I
                current_block_84 =
                    5513094344543372995; // FIXME magic numbers repeated in cli.c
            }
        }
        19 => { current_block_84 = 5513094344543372995; }
        8 | 17 => {
            newValue = constrain(value, 0 as libc::c_int, 200 as libc::c_int);
            (*pidProfile).pid[PID_PITCH as libc::c_int as usize].D =
                newValue as uint8_t;
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                // fall through for combined ADJUSTMENT_PITCH_ROLL_D
                current_block_84 =
                    4084340067042820539; // FIXME magic numbers repeated in cli.c
            }
        }
        20 => {
            current_block_84 =
        ...
        22 | 30 => {
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                current_block_84 = 5265702136860997526;
            } else { current_block_84 = 9997336337435972907; }
        }
        31 => { current_block_84 = 9997336337435972907; }
        32 => {
            newValue =
                constrain(value, 0 as libc::c_int, 2000 as libc::c_int);
            (*pidProfile).pid[PID_YAW as libc::c_int as usize].F =
