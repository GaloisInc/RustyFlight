...
pub unsafe extern "C" fn initRcProcessing() {
    ...
    match (*rxConfig()).rcInterpolationChannels as libc::c_int {
        2 => {
            ...
            current_block_22 = 4284526350069498071;
        }
        1 => { current_block_22 = 4284526350069498071; }
        0 => { current_block_22 = 2930104739197832390; }
        4 => {
            interpolationChannels =
                (interpolationChannels as libc::c_int |
                     (ROLL_FLAG as libc::c_int | PITCH_FLAG as libc::c_int))
                    as uint8_t;
            current_block_22 = 2354941040710910325;
        }
        3 => { current_block_22 = 2354941040710910325; }
    ...
    match current_block_22 {
        4284526350069498071 => {
            ...
            current_block_22 = 2930104739197832390;
        }
        2354941040710910325 => {
            interpolationChannels =
                (interpolationChannels as libc::c_int |
