...
pub unsafe extern "C" fn enableGPIOPowerUsageAndNoiseReductions() {
    ...
    ::core::ptr::write_volatile(fresh41,
                                (::core::ptr::read_volatile::<uint32_t>(fresh41
                                     ...
                                     as libc::c_uint |
                                     (0x1 as libc::c_uint) <<
                                         26 as libc::c_uint) as uint32_t as
                                    uint32_t);
    ...
    ::core::ptr::write_volatile(fresh53,
                                (::core::ptr::read_volatile::<uint32_t>(fresh53
                                    ...
                                    uint32_t);
    ::core::ptr::write_volatile(&mut tmpreg_52 as *mut uint32_t,
                                (*((0x40000000 as
                                        libc::c_uint).wrapping_add(0x20000 as
                                                                       libc::c_uint).wrapping_add(0x3800
                                                                                                      as
    ...
    ::core::ptr::write_volatile(fresh54,
                                (::core::ptr::read_volatile::<uint32_t>(fresh54
                                     ...
                                     (0x1 as libc::c_uint) <<
                                         17 as libc::c_uint) as uint32_t as
                                    uint32_t);
    ::core::ptr::write_volatile(&mut tmpreg_53 as *mut uint32_t,
                                (*((0x40000000 as
                                        libc::c_uint).wrapping_add(0x20000 as
                                                                       libc::c_uint).wrapping_add(0x3800
                                                                                                      as
    ...
    ::core::ptr::write_volatile(fresh55,
                                (::core::ptr::read_volatile::<uint32_t>(fresh55
                                     ...
                                     (0x1 as libc::c_uint) <<
                                         18 as libc::c_uint) as uint32_t as
                                    uint32_t);
    ::core::ptr::write_volatile(&mut tmpreg_54 as *mut uint32_t,
                                (*((0x40000000 as
                                        libc::c_uint).wrapping_add(0x20000 as
                                                                       libc::c_uint).wrapping_add(0x3800
                                                                                                      as
    ...
    ::core::ptr::write_volatile(fresh56,
                                (::core::ptr::read_volatile::<uint32_t>(fresh56
                                     ...
                                     (0x1 as libc::c_uint) <<
                                         20 as libc::c_uint) as uint32_t as
                                    uint32_t);
    ::core::ptr::write_volatile(&mut tmpreg_55 as *mut uint32_t,
                                (*((0x40000000 as
                                        libc::c_uint).wrapping_add(0x20000 as
                                                                       libc::c_uint).wrapping_add(0x3800
                                                                                                      as
    ...
    ::core::ptr::write_volatile(fresh57,
                                (::core::ptr::read_volatile::<uint32_t>(fresh57
                                     ...
                                     (0x1 as libc::c_uint) <<
                                         22 as libc::c_uint) as uint32_t as
                                    uint32_t);
    ::core::ptr::write_volatile(&mut tmpreg_56 as *mut uint32_t,
                                (*((0x40000000 as
                                        libc::c_uint).wrapping_add(0x20000 as
                                                                       libc::c_uint).wrapping_add(0x3800
                                                                                                      as
    ...
    ::core::ptr::write_volatile(fresh58,
                                (::core::ptr::read_volatile::<uint32_t>(fresh58
                                     ...
                                     (0x1 as libc::c_uint) <<
                                         23 as libc::c_uint) as uint32_t as
                                    uint32_t);
    ::core::ptr::write_volatile(&mut tmpreg_57 as *mut uint32_t,
                                (*((0x40000000 as
                                        libc::c_uint).wrapping_add(0x20000 as
                                                                       libc::c_uint).wrapping_add(0x3800
                                                                                                      as
    ...
    ::core::ptr::write_volatile(fresh59,
                                (::core::ptr::read_volatile::<uint32_t>(fresh59
                                     ...
                                     (0x1 as libc::c_uint) <<
                                         21 as libc::c_uint) as uint32_t as
                                    uint32_t);
    ::core::ptr::write_volatile(&mut tmpreg_58 as *mut uint32_t,
                                (*((0x40000000 as
                                        libc::c_uint).wrapping_add(0x20000 as
                                                                       libc::c_uint).wrapping_add(0x3800
                                                                                                      as
