                             ...
                             reset:
                                 C2RustUnnamed_0{fn_0:
                                                     ::core::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                         ...
                                                                                         ->
                                                                                             ()>,
                                                                              Option<pgResetFunc>>(Some(pgResetFn_pwmConfig
                                                                                                            as
...
pub unsafe extern "C" fn pgResetFn_pwmConfig(mut pwmConfig:
    ...
    let mut inputIndex: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    while inputIndex < 8 as libc::c_int as libc::c_uint {
                             ...
                             reset:
                                 C2RustUnnamed_0{fn_0:
                                                     ::core::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                                         ...
                                                                                         ->
                                                                                             ()>,
                                                                              Option<pgResetFunc>>(Some(pgResetFn_ppmConfig
                                                                                                            as
                                                                                                            unsafe extern "C" fn(_:
                                                                                                                                     *mut ppmConfig_t)
                                                                                                                ->
...
pub unsafe extern "C" fn pgResetFn_ppmConfig(mut ppmConfig:
                                                 *mut ppmConfig_t) {
    (*ppmConfig).ioTag =
        timerioTagGetByUsage(TIM_USE_PPM, 0 as libc::c_int as uint8_t);
}
