...
pub unsafe extern "C" fn arm_cfft_radix8by2_f32(mut S:
    ...
    l = L >> 2 as libc::c_int; // col 1
    while l > 0 as libc::c_int as libc::c_uint {
        t1[0 as libc::c_int as usize] =
            *p1.offset(0 as libc::c_int as isize); // for col 2
        t1[1 as libc::c_int as usize] =
            *p1.offset(1 as libc::c_int as isize); // col 1
        t1[2 as libc::c_int as usize] =
            *p1.offset(2 as libc::c_int as isize); // for col 2
        t1[3 as libc::c_int as usize] = *p1.offset(3 as libc::c_int as isize);
        t2[0 as libc::c_int as usize] = *p2.offset(0 as libc::c_int as isize);
        t2[1 as libc::c_int as usize] = *p2.offset(1 as libc::c_int as isize);
        t2[2 as libc::c_int as usize] = *p2.offset(2 as libc::c_int as isize);
        t2[3 as libc::c_int as usize] = *p2.offset(3 as libc::c_int as isize);
        t3[0 as libc::c_int as usize] =
            *pMid1.offset(0 as libc::c_int as isize);
        t3[1 as libc::c_int as usize] =
            *pMid1.offset(1 as libc::c_int as isize);
        t3[2 as libc::c_int as usize] =
            *pMid1.offset(2 as libc::c_int as isize);
        t3[3 as libc::c_int as usize] =
            *pMid1.offset(3 as libc::c_int as isize);
        t4[0 as libc::c_int as usize] =
            *pMid2.offset(0 as libc::c_int as isize);
        t4[1 as libc::c_int as usize] =
            *pMid2.offset(1 as libc::c_int as isize);
        t4[2 as libc::c_int as usize] =
            *pMid2.offset(2 as libc::c_int as isize);
        t4[3 as libc::c_int as usize] =
            *pMid2.offset(3 as libc::c_int as isize);
        let fresh0 = p1;
        p1 = p1.offset(1);
        *fresh0 =
            t1[0 as libc::c_int as usize] + t2[0 as libc::c_int as usize];
        let fresh1 = p1;
        p1 = p1.offset(1);
        *fresh1 =
            t1[1 as libc::c_int as usize] + t2[1 as libc::c_int as usize];
        let fresh2 = p1;
        p1 = p1.offset(1);
        *fresh2 =
            t1[2 as libc::c_int as usize] + t2[2 as libc::c_int as usize];
        let fresh3 = p1;
        p1 = p1.offset(1);
        *fresh3 =
            t1[3 as libc::c_int as usize] + t2[3 as libc::c_int as usize];
        t2[0 as libc::c_int as usize] =
            t1[0 as libc::c_int as usize] - t2[0 as libc::c_int as usize];
        t2[1 as libc::c_int as usize] =
            t1[1 as libc::c_int as usize] - t2[1 as libc::c_int as usize];
        t2[2 as libc::c_int as usize] =
            t1[2 as libc::c_int as usize] - t2[2 as libc::c_int as usize];
        t2[3 as libc::c_int as usize] =
            t1[3 as libc::c_int as usize] - t2[3 as libc::c_int as usize];
        let fresh4 = pMid1;
        pMid1 = pMid1.offset(1);
        *fresh4 =
            t3[0 as libc::c_int as usize] + t4[0 as libc::c_int as usize];
        let fresh5 = pMid1;
        pMid1 = pMid1.offset(1);
        *fresh5 =
            t3[1 as libc::c_int as usize] + t4[1 as libc::c_int as usize];
        let fresh6 = pMid1;
        pMid1 = pMid1.offset(1);
        *fresh6 =
            t3[2 as libc::c_int as usize] + t4[2 as libc::c_int as usize];
        let fresh7 = pMid1;
        pMid1 = pMid1.offset(1);
        *fresh7 =
            t3[3 as libc::c_int as usize] + t4[3 as libc::c_int as usize];
        t4[0 as libc::c_int as usize] =
            t4[0 as libc::c_int as usize] - t3[0 as libc::c_int as usize];
        t4[1 as libc::c_int as usize] =
            t4[1 as libc::c_int as usize] - t3[1 as libc::c_int as usize];
        t4[2 as libc::c_int as usize] =
            t4[2 as libc::c_int as usize] - t3[2 as libc::c_int as usize];
        t4[3 as libc::c_int as usize] =
            t4[3 as libc::c_int as usize] - t3[3 as libc::c_int as usize];
        let fresh8 = tw;
        tw = tw.offset(1);
        twR = *fresh8;
        let fresh9 = tw;
        ...
        m0 = t2[0 as libc::c_int as usize] * twR;
        m1 = t2[1 as libc::c_int as usize] * twI;
        m2 = t2[1 as libc::c_int as usize] * twR;
        m3 = t2[0 as libc::c_int as usize] * twI;
        // R  =  R  *  Tr - I * Ti
        let fresh10 = p2;
        p2 = p2.offset(1);
        *fresh10 = m0 + m1;
        ...
        *fresh11 = m2 - m3;
        ...
        m0 = t4[0 as libc::c_int as usize] * twI;
        m1 = t4[1 as libc::c_int as usize] * twR;
        m2 = t4[1 as libc::c_int as usize] * twI;
        m3 = t4[0 as libc::c_int as usize] * twR;
        let fresh12 = pMid2;
        ...
        *fresh13 = m2 + m3;
        ...
        tw = tw.offset(1);
        twI = *fresh15;
        m0 = t2[2 as libc::c_int as usize] * twR;
        m1 = t2[3 as libc::c_int as usize] * twI;
        m2 = t2[3 as libc::c_int as usize] * twR;
        m3 = t2[2 as libc::c_int as usize] * twI;
        let fresh16 = p2;
        p2 = p2.offset(1);
        *fresh16 = m0 + m1;
        let fresh17 = p2;
        p2 = p2.offset(1);
        *fresh17 = m2 - m3;
        m0 = t4[2 as libc::c_int as usize] * twI;
        m1 = t4[3 as libc::c_int as usize] * twR;
        m2 = t4[3 as libc::c_int as usize] * twI;
        m3 = t4[2 as libc::c_int as usize] * twR;
        let fresh18 = pMid2;
        pMid2 = pMid2.offset(1);
        *fresh18 = m0 - m1;
        let fresh19 = pMid2;
...
pub unsafe extern "C" fn arm_cfft_radix8by4_f32(mut S:
                                                ...
                                                mut p1: *mut float32_t) {
    let mut L: uint32_t =
        ((*S).fftLen as libc::c_int >> 1 as libc::c_int) as
    ...
    pCol3 = p3;
    pCol4 = p4;
    pEnd1 = p2.offset(-(1 as libc::c_int as isize));
    pEnd2 = p3.offset(-(1 as libc::c_int as isize));
    pEnd3 = p4.offset(-(1 as libc::c_int as isize));
    ...
    twMod2 = 2 as libc::c_int as uint32_t;
    twMod3 = 4 as libc::c_int as uint32_t;
    twMod4 = 6 as libc::c_int as uint32_t;
    // TOP
    p1ap3_0 =
        *p1.offset(0 as libc::c_int as isize) +
            *p3.offset(0 as libc::c_int as isize);
    p1sp3_0 =
        *p1.offset(0 as libc::c_int as isize) -
            *p3.offset(0 as libc::c_int as isize);
    p1ap3_1 =
    ...
    // col 2
    t2[0 as libc::c_int as usize] =
        p1sp3_0 + *p2.offset(1 as libc::c_int as isize) -
            *p4.offset(1 as libc::c_int as isize);
    t2[1 as libc::c_int as usize] =
        p1sp3_1 - *p2.offset(0 as libc::c_int as isize) +
            *p4.offset(0 as libc::c_int as isize);
    // col 3
    t3[0 as libc::c_int as usize] =
        p1ap3_0 - *p2.offset(0 as libc::c_int as isize) -
            *p4.offset(0 as libc::c_int as isize);
    t3[1 as libc::c_int as usize] =
        p1ap3_1 - *p2.offset(1 as libc::c_int as isize) -
            *p4.offset(1 as libc::c_int as isize);
    // col 4
    t4[0 as libc::c_int as usize] =
        p1sp3_0 - *p2.offset(1 as libc::c_int as isize) +
    ...
    *fresh21 =
    ...
    let fresh22 = p2;
    p2 = p2.offset(1);
    *fresh22 = t2[0 as libc::c_int as usize];
    let fresh23 = p2;
    p2 = p2.offset(1);
    *fresh23 = t2[1 as libc::c_int as usize];
    let fresh24 = p3;
    p3 = p3.offset(1);
    *fresh24 = t3[0 as libc::c_int as usize];
    let fresh25 = p3;
    p3 = p3.offset(1);
    *fresh25 = t3[1 as libc::c_int as usize];
    let fresh26 = p4;
    p4 = p4.offset(1);
    *fresh26 = t4[0 as libc::c_int as usize];
    let fresh27 = p4;
    p4 = p4.offset(1);
    *fresh27 = t4[1 as libc::c_int as usize];
    tw2 = tw2.offset(twMod2 as isize);
    tw3 = tw3.offset(twMod3 as isize);
    tw4 = tw4.offset(twMod4 as isize);
    l = L.wrapping_sub(2 as libc::c_int as libc::c_uint) >> 1 as libc::c_int;
    while l > 0 as libc::c_int as libc::c_uint {
        // TOP
        p1ap3_0 =
            *p1.offset(0 as libc::c_int as isize) +
        ...
        *fresh29 =
        ...
        // BOTTOM
        p1ap3_1 =
            *pEnd1.offset(-(1 as libc::c_int) as isize) +
                *pEnd3.offset(-(1 as libc::c_int) as isize);
        p1sp3_1 =
            *pEnd1.offset(-(1 as libc::c_int) as isize) -
                *pEnd3.offset(-(1 as libc::c_int) as isize);
        p1ap3_0 =
            *pEnd1.offset(0 as libc::c_int as isize) +
                *pEnd3.offset(0 as libc::c_int as isize);
        p1sp3_0 =
            *pEnd1.offset(0 as libc::c_int as isize) -
                *pEnd3.offset(0 as libc::c_int as isize);
        // col 2
        t2[2 as libc::c_int as usize] =
            *pEnd2.offset(0 as libc::c_int as isize) -
                *pEnd4.offset(0 as libc::c_int as isize) + p1sp3_1;
        t2[3 as libc::c_int as usize] =
            *pEnd1.offset(0 as libc::c_int as isize) -
                *pEnd3.offset(0 as libc::c_int as isize) -
                *pEnd2.offset(-(1 as libc::c_int) as isize) +
                *pEnd4.offset(-(1 as libc::c_int) as isize);
        // col 3
        t3[2 as libc::c_int as usize] =
            p1ap3_1 - *pEnd2.offset(-(1 as libc::c_int) as isize) -
                *pEnd4.offset(-(1 as libc::c_int) as isize);
        t3[3 as libc::c_int as usize] =
            p1ap3_0 - *pEnd2.offset(0 as libc::c_int as isize) -
                *pEnd4.offset(0 as libc::c_int as isize);
        // col 4
        t4[2 as libc::c_int as usize] =
            *pEnd2.offset(0 as libc::c_int as isize) -
                *pEnd4.offset(0 as libc::c_int as isize) - p1sp3_1;
        t4[3 as libc::c_int as usize] =
            *pEnd4.offset(-(1 as libc::c_int) as isize) -
                *pEnd2.offset(-(1 as libc::c_int) as isize) - p1sp3_0;
        // col 1 - Bottom
        let fresh30 = pEnd1;
        ...
        *fresh35 = m2 - m3;
        ...
        // Bottom
        m0 = t2[3 as libc::c_int as usize] * twI;
        m1 = t2[2 as libc::c_int as usize] * twR;
        m2 = t2[2 as libc::c_int as usize] * twI;
        m3 = t2[3 as libc::c_int as usize] * twR;
        let fresh36 = pEnd2;
        ...
        *fresh37 = m2 + m3;
        // COL 3
        twR = *tw3.offset(0 as libc::c_int as isize);
        twI = *tw3.offset(1 as libc::c_int as isize);
        tw3 = tw3.offset(twMod3 as isize);
        // Top
        m0 = t3[0 as libc::c_int as usize] * twR;
        m1 = t3[1 as libc::c_int as usize] * twI;
        m2 = t3[1 as libc::c_int as usize] * twR;
        m3 = t3[0 as libc::c_int as usize] * twI;
        let fresh38 = p3;
        p3 = p3.offset(1);
        *fresh38 = m0 + m1;
        let fresh39 = p3;
        ...
        *fresh39 = m2 - m3;
        ...
        // Bottom
        m0 = -t3[3 as libc::c_int as usize] * twR;
        m1 = t3[2 as libc::c_int as usize] * twI;
        m2 = t3[2 as libc::c_int as usize] * twR;
        m3 = t3[3 as libc::c_int as usize] * twI;
        let fresh40 = pEnd3;
        ...
        *fresh41 = m3 - m2;
        // COL 4
        twR = *tw4.offset(0 as libc::c_int as isize);
        twI = *tw4.offset(1 as libc::c_int as isize);
        tw4 = tw4.offset(twMod4 as isize);
        // Top
        m0 = t4[0 as libc::c_int as usize] * twR;
        m1 = t4[1 as libc::c_int as usize] * twI;
        m2 = t4[1 as libc::c_int as usize] * twR;
        m3 = t4[0 as libc::c_int as usize] * twI;
        let fresh42 = p4;
        p4 = p4.offset(1);
        *fresh42 = m0 + m1;
        let fresh43 = p4;
        ...
        *fresh43 = m2 - m3;
        ...
        // Bottom
        m0 = t4[3 as libc::c_int as usize] * twI;
        m1 = t4[2 as libc::c_int as usize] * twR;
        m2 = t4[2 as libc::c_int as usize] * twI;
        m3 = t4[3 as libc::c_int as usize] * twR;
        let fresh44 = pEnd4;
    ...
    *fresh47 =
        p1ap3_1 + *p2.offset(1 as libc::c_int as isize) +
            *p4.offset(1 as libc::c_int as isize);
    // COL 2
    twR = *tw2.offset(0 as libc::c_int as isize);
    twI = *tw2.offset(1 as libc::c_int as isize);
    m0 = t2[0 as libc::c_int as usize] * twR;
    m1 = t2[1 as libc::c_int as usize] * twI;
    m2 = t2[1 as libc::c_int as usize] * twR;
    m3 = t2[0 as libc::c_int as usize] * twI;
...
pub unsafe extern "C" fn arm_cfft_f32(mut S: *const arm_cfft_instance_f32,
    ...
    if ifftFlag as libc::c_uint == 1 as libc::c_uint {
        /*  Conjugate input data  */
        pSrc = p1.offset(1 as libc::c_int as isize);
        l = 0 as libc::c_int as uint32_t;
        while l < L {
            *pSrc = -*pSrc;
            pSrc = pSrc.offset(2 as libc::c_int as isize);
            l = l.wrapping_add(1)
        }
    }
    match L {
