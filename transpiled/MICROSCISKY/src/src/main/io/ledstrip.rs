...
pub const timIndicator: timId_e = 5;
...
pub const timTimerCount: timId_e = 7;
pub const timRing: timId_e = 6;
...
static mut timerVal: [timeUs_t; 7] = [0; 7];
static mut disabledTimerMask: uint16_t = 0;
static mut layerTable: [Option<applyLayerFn_timed>; 7] =
...
pub unsafe extern "C" fn ledStripUpdate(mut currentTimeUs: timeUs_t) {
    ...
    while (timId_0 as libc::c_ulong) <
              (::core::mem::size_of::<[Option<applyLayerFn_timed>; 7]>() as
