...
pub const BEEPER_RC_SMOOTHING_INIT_FAIL: C2RustUnnamed_8 = 23;
pub const BEEPER_CAM_CONNECTION_CLOSE: C2RustUnnamed_8 = 22;
pub const BEEPER_CAM_CONNECTION_OPEN: C2RustUnnamed_8 = 21;
pub const BEEPER_CRASH_FLIP_MODE: C2RustUnnamed_8 = 20;
pub const BEEPER_BLACKBOX_ERASE: C2RustUnnamed_8 = 19;
pub const BEEPER_USB: C2RustUnnamed_8 = 18;
pub const BEEPER_SYSTEM_INIT: C2RustUnnamed_8 = 17;
pub const BEEPER_ARMED: C2RustUnnamed_8 = 16;
pub const BEEPER_DISARM_REPEAT: C2RustUnnamed_8 = 15;
pub const BEEPER_MULTI_BEEPS: C2RustUnnamed_8 = 14;
pub const BEEPER_READY_BEEP: C2RustUnnamed_8 = 13;
pub const BEEPER_ACC_CALIBRATION_FAIL: C2RustUnnamed_8 = 12;
pub const BEEPER_ACC_CALIBRATION: C2RustUnnamed_8 = 11;
pub const BEEPER_RX_SET: C2RustUnnamed_8 = 10;
pub const BEEPER_GPS_STATUS: C2RustUnnamed_8 = 9;
pub const BEEPER_BAT_LOW: C2RustUnnamed_8 = 8;
pub const BEEPER_BAT_CRIT_LOW: C2RustUnnamed_8 = 7;
pub const BEEPER_ARMING_GPS_FIX: C2RustUnnamed_8 = 6;
pub const BEEPER_ARMING: C2RustUnnamed_8 = 5;
pub const BEEPER_DISARMING: C2RustUnnamed_8 = 4;
pub const BEEPER_RX_LOST_LANDING: C2RustUnnamed_8 = 3;
pub const BEEPER_RX_LOST: C2RustUnnamed_8 = 2;
pub const BEEPER_GYRO_CALIBRATED: C2RustUnnamed_8 = 1;
/*
 * This file is part of Cleanflight and Betaflight.
 *
 * Cleanflight and Betaflight are free software. You can redistribute
...
pub const BEEPER_ALL: C2RustUnnamed_8 = 24;
pub const BEEPER_SILENCE: C2RustUnnamed_8 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub static mut pgResetTemplate_systemConfig: systemConfig_t =
    {
        let mut init =
            systemConfig_s{pidProfileIndex: 0 as libc::c_int as uint8_t,
                           ...
                           boardIdentifier: [77, 83, 75, 89, 0, 0],};
        init
    };
#[no_mangle]
...
unsafe extern "C" fn validateAndFixConfig() {
    ...
    if !(featureConfigured(FEATURE_RX_PARALLEL_PWM as libc::c_int as uint32_t)
             ...
             featureConfigured(FEATURE_RX_SPI as libc::c_int as uint32_t) as
                 libc::c_int != 0) {
        featureSet(FEATURE_RX_SERIAL as libc::c_int as uint32_t);
    }
    ...
    // USE_SOFTSPI
    if (*rxConfigMutable()).rssi_channel as libc::c_int != 0 ||
           featureConfigured(FEATURE_RX_PPM as libc::c_int as uint32_t) as
               libc::c_int != 0 ||
    ...
    if (*gyroConfig()).gyro_use_32khz != 0 {
        ...
        (*gyroConfigMutable()).gyro_sync_denom =
            ({
                 ...
                 let mut _b: libc::c_int = 16 as libc::c_int;
