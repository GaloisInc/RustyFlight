...
pub const THROTTLE_FLAG: C2RustUnnamed_8 = 8;
pub const PITCH_FLAG: C2RustUnnamed_8 = 2;
pub const ROLL_FLAG: C2RustUnnamed_8 = 1;
pub const YAW_FLAG: C2RustUnnamed_8 = 4;
...
pub unsafe extern "C" fn processRcCommand() {
    ...
    match (*rxConfig()).rc_smoothing_type as libc::c_int { 0 | _ => { } }
    // USE_RC_SMOOTHING_FILTER
    updatedChannel =
        processRcInterpolation(); // throttle channel doesn't require rate calculation
...
pub unsafe extern "C" fn initRcProcessing() {
    ...
    match (*rxConfig()).rcInterpolationChannels as libc::c_int {
        2 => {
            ...
            current_block_22 = 9075632168174047357;
        }
        1 => { current_block_22 = 9075632168174047357; }
        0 => { current_block_22 = 13219891651893971665; }
        4 => {
            interpolationChannels =
                (interpolationChannels as libc::c_int |
                     (ROLL_FLAG as libc::c_int | PITCH_FLAG as libc::c_int))
                    as uint8_t;
            current_block_22 = 10394275422501516080;
        }
        3 => { current_block_22 = 10394275422501516080; }
    ...
    match current_block_22 {
        9075632168174047357 => {
            ...
            current_block_22 = 13219891651893971665;
        }
        10394275422501516080 => {
            interpolationChannels =
                (interpolationChannels as libc::c_int |
                     THROTTLE_FLAG as libc::c_int) as uint8_t;
...
pub unsafe extern "C" fn rcSmoothingIsEnabled() -> bool {
    return !((*rxConfig()).rcInterpolation as libc::c_int ==
