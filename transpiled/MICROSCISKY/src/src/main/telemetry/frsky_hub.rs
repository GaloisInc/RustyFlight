...
pub const TELEMETRY_STATE_INITIALIZED_SERIAL: C2RustUnnamed_5 = 1;
pub const TELEMETRY_STATE_UNINITIALIZED: C2RustUnnamed_5 = 0;
pub const TELEMETRY_STATE_INITIALIZED_EXTERNAL: C2RustUnnamed_5 = 2;
...
unsafe extern "C" fn sendTemperature1() {
    let mut data: int16_t = 0 as libc::c_int as int16_t;
    data =
        ((baro.baroTemperature + 50 as libc::c_int) / 100 as libc::c_int) as
            int16_t;
