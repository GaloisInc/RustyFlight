 ...
 -> bool {
    ...
    match baroHardware as libc::c_uint {
        0 | 2 => {
            ...
            } else { current_block_23 = 17206264471816292918; }
        }
        3 => { current_block_23 = 17206264471816292918; }
        5 | 4 => { current_block_23 = 12180568866067053773; }
        6 | 1 => { current_block_23 = 916363241452857900; }
        _ => { current_block_23 = 11048769245176032998; }
    }
    match current_block_23 {
        17206264471816292918 => {
            if ms5611Detect(dev) {
                baroHardware = BARO_MS5611;
                current_block_23 = 11048769245176032998;
            } else { current_block_23 = 12180568866067053773; }
        }
        _ => { }
    }
    match current_block_23 {
        12180568866067053773 => {
            if bmp280Detect(dev) {
                baroHardware = BARO_BMP280;
                current_block_23 = 11048769245176032998;
            } else { current_block_23 = 916363241452857900; }
        }
        _ => { }
    }
    match current_block_23 {
        916363241452857900 => { baroHardware = BARO_NONE }
        _ => { }
    }
