...
pub unsafe extern "C" fn compassDetect(mut dev: *mut magDev_t) -> bool {
    ...
    match (*compassConfig()).mag_hardware as libc::c_int {
        0 | 2 => {
            ...
            } else { current_block_29 = 18142858874531570687; }
        }
        5 => { current_block_29 = 18142858874531570687; }
        3 | 4 | 1 => { current_block_29 = 9194693572089422614; }
        _ => { current_block_29 = 13131896068329595644; }
    }
    match current_block_29 {
        18142858874531570687 => {
            if (*busdev).bustype as libc::c_uint ==
                   BUSTYPE_I2C as libc::c_int as libc::c_uint {
                (*busdev).busdev_u.i2c.address =
                    (*compassConfig()).mag_i2c_address
            ...
            if qmc5883lDetect(dev) {
                ...
                current_block_29 = 13131896068329595644;
            } else { current_block_29 = 9194693572089422614; }
        }
        _ => { }
    }
    match current_block_29 {
        9194693572089422614 => { magHardware = MAG_NONE }
        _ => { }
    }
