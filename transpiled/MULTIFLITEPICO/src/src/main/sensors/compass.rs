...
pub unsafe extern "C" fn compassDetect(mut dev: *mut magDev_t) -> bool {
    ...
    match (*compassConfig()).mag_hardware as libc::c_int {
        0 | 2 => {
            ...
            } else { current_block_33 = 6439058677418489788; }
        }
        5 => { current_block_33 = 6439058677418489788; }
        3 => { current_block_33 = 2221166960709316415; }
        4 | 1 => { current_block_33 = 16979226728283739186; }
    ...
    match current_block_33 {
        6439058677418489788 => {
            ...
            if qmc5883lDetect(dev) {
                ...
                current_block_33 = 1622411330066726685;
            } else { current_block_33 = 2221166960709316415; }
        }
        _ => { }
    }
    match current_block_33 {
        2221166960709316415 => {
            ...
            if ak8975Detect(dev) {
                ...
                current_block_33 = 1622411330066726685;
            } else { current_block_33 = 16979226728283739186; }
        }
        _ => { }
    }
    match current_block_33 {
        16979226728283739186 => { magHardware = MAG_NONE }
        _ => { }
    }
