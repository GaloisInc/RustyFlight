...
pub unsafe extern "C" fn processRcStickPositions() {
    ...
    if rcSticks as libc::c_int ==
           (3i32 << 2i32 * THROTTLE as libc::c_int) +
               (2i32 << 2i32 * YAW as libc::c_int) +
               (3i32 << 2i32 * PITCH as libc::c_int) +
               (3i32 << 2i32 * ROLL as libc::c_int) {
        cameraControlKeyPress(CAMERA_CONTROL_KEY_ENTER, 0i32 as uint32_t);
        rcDelayMs = (rcDelayMs as libc::c_int - 3i32 * 50i32) as int16_t;
        doNotRepeat = 0i32 != 0
    } else if rcSticks as libc::c_int ==
                  (3i32 << 2i32 * THROTTLE as libc::c_int) +
                      (3i32 << 2i32 * YAW as libc::c_int) +
                      (3i32 << 2i32 * PITCH as libc::c_int) +
                      (1i32 << 2i32 * ROLL as libc::c_int) {
        cameraControlKeyPress(CAMERA_CONTROL_KEY_LEFT, 0i32 as uint32_t);
        rcDelayMs = (rcDelayMs as libc::c_int - 3i32 * 50i32) as int16_t;
        doNotRepeat = 0i32 != 0
    } else if rcSticks as libc::c_int ==
                  (3i32 << 2i32 * THROTTLE as libc::c_int) +
                      ...
                      (2i32 << 2i32 * PITCH as libc::c_int) +
                      (3i32 << 2i32 * ROLL as libc::c_int) {
        cameraControlKeyPress(CAMERA_CONTROL_KEY_UP, 0i32 as uint32_t);
        rcDelayMs = (rcDelayMs as libc::c_int - 3i32 * 50i32) as int16_t;
        doNotRepeat = 0i32 != 0
    } else if rcSticks as libc::c_int ==
                  (3i32 << 2i32 * THROTTLE as libc::c_int) +
                      ...
                      (3i32 << 2i32 * PITCH as libc::c_int) +
                      (2i32 << 2i32 * ROLL as libc::c_int) {
        cameraControlKeyPress(CAMERA_CONTROL_KEY_RIGHT, 0i32 as uint32_t);
        rcDelayMs = (rcDelayMs as libc::c_int - 3i32 * 50i32) as int16_t;
        doNotRepeat = 0i32 != 0
    } else if rcSticks as libc::c_int ==
                  (3i32 << 2i32 * THROTTLE as libc::c_int) +
                      ...
                      (1i32 << 2i32 * PITCH as libc::c_int) +
                      (3i32 << 2i32 * ROLL as libc::c_int) {
        cameraControlKeyPress(CAMERA_CONTROL_KEY_DOWN, 0i32 as uint32_t);
        rcDelayMs = (rcDelayMs as libc::c_int - 3i32 * 50i32) as int16_t;
        doNotRepeat = 0i32 != 0
    } else if rcSticks as libc::c_int ==
                  (1i32 << 2i32 * THROTTLE as libc::c_int) +
                      ...
                      (2i32 << 2i32 * PITCH as libc::c_int) +
                      (3i32 << 2i32 * ROLL as libc::c_int) {
        cameraControlKeyPress(CAMERA_CONTROL_KEY_UP, 2000i32 as uint32_t);
    };
}
#[no_mangle]
