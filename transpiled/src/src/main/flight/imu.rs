...
pub unsafe extern "C" fn imuInit() {
    ...
    accVelScale =
        9.80665f32 / acc.dev.acc_1G as libc::c_int as libc::c_float /
            10000.0f32;
    canUseGPSHeading = 1 as libc::c_int != 0;
...
unsafe extern "C" fn imuMahonyAHRSupdate(mut dt: libc::c_float,
    ...
    if useMag as libc::c_int != 0 && recipMagNorm > 0.01f32 {
        ...
        let hx: libc::c_float =
            rMat[0 as libc::c_int as usize][0 as libc::c_int as usize] * mx +
                rMat[0 as libc::c_int as usize][1 as libc::c_int as usize] *
                    my +
                rMat[0 as libc::c_int as usize][2 as libc::c_int as usize] *
                    mz;
        let hy: libc::c_float =
            rMat[1 as libc::c_int as usize][0 as libc::c_int as usize] * mx +
                rMat[1 as libc::c_int as usize][1 as libc::c_int as usize] *
                    my +
                rMat[1 as libc::c_int as usize][2 as libc::c_int as usize] *
                    mz;
...
unsafe extern "C" fn imuCalculateEstimatedAttitude(mut currentTimeUs:
    ...
    if !useMag &&
           ...
           gpsSol.groundSpeed as libc::c_int >= 500 as libc::c_int {
...
pub unsafe extern "C" fn imuSetAttitudeRPY(mut roll: libc::c_float,
    ...
    pthread_mutex_lock(&mut imuUpdateLock);
    attitude.values.roll =
        (roll * 10 as libc::c_int as libc::c_float) as int16_t;
    attitude.values.pitch =
        (pitch * 10 as libc::c_int as libc::c_float) as int16_t;
    attitude.values.yaw =
        (yaw * 10 as libc::c_int as libc::c_float) as int16_t;
    pthread_mutex_unlock(&mut imuUpdateLock);
}
// in deg
#[no_mangle]
