...
static mut serialDefaultPin: [serialDefaultPin_t; 5] =
    [{
         let mut init =
             serialDefaultPin_s{ident: SERIAL_PORT_USART1,
                                rxIO:
                                    (0i32 + 1i32 << 4i32 | 10i32) as ioTag_t,
                                txIO: (0i32 + 1i32 << 4i32 | 9i32) as ioTag_t,
                                inverterIO: 0i32 as ioTag_t,};
         init
     },
     {
         let mut init =
     ...
     },
     {
         let mut init =
             serialDefaultPin_s{ident: SERIAL_PORT_SOFTSERIAL1,
                                rxIO: (1i32 + 1i32 << 4i32 | 4i32) as ioTag_t,
                                txIO: (1i32 + 1i32 << 4i32 | 5i32) as ioTag_t,
                                inverterIO: 0i32 as ioTag_t,};
         init
     },
     {
         let mut init =
             serialDefaultPin_s{ident: SERIAL_PORT_SOFTSERIAL2,
                                rxIO: (1i32 + 1i32 << 4i32 | 0i32) as ioTag_t,
                                txIO: (1i32 + 1i32 << 4i32 | 1i32) as ioTag_t,
                                inverterIO: 0i32 as ioTag_t,};
         init
     }];
#[no_mangle]
...
pub static mut serialPinConfig_Registry: pgRegistry_t =
    unsafe {
        {
            let mut init =
                pgRegistry_s{pgn: (509i32 | 0i32 << 12i32) as pgn_t,
                             size:
                                                     ...
                                                     ::core::mem::transmute::<Option<unsafe extern "C" fn(_:
                                                                              ...
                                                                              Option<unsafe extern "C" fn(_:
                                                                                                          ...
                                                                                                          _:
                                                                                                              libc::c_int)
                                                                                         ->
                                                                                             ()>>(Some(pgResetFn_serialPinConfig
                                                                                                           as
...
pub unsafe extern "C" fn pgResetFn_serialPinConfig(mut serialPinConfig:
    ...
    while index <
              (::core::mem::size_of::<[serialDefaultPin_t; 5]>() as
