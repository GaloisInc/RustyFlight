...
pub unsafe extern "C" fn SPI_I2S_DeInit(mut SPIx: *mut SPI_TypeDef) {
    ...
    if SPIx ==
        ...
        RCC_APB2PeriphResetCmd(0x1000i32 as uint32_t, ENABLE);
        /* Release SPI1 from reset state */
        RCC_APB2PeriphResetCmd(0x1000i32 as uint32_t, DISABLE);
    } else if SPIx ==
                  (0x40000000i32 as
                       uint32_t).wrapping_add(0x3800i32 as libc::c_uint) as
                      *mut SPI_TypeDef {
        /* Enable SPI2 reset state */
        RCC_APB1PeriphResetCmd(0x4000i32 as uint32_t, ENABLE);
        /* Release SPI2 from reset state */
        RCC_APB1PeriphResetCmd(0x4000i32 as uint32_t, DISABLE);
    } else if SPIx ==
                  (0x40000000i32 as
                       uint32_t).wrapping_add(0x3c00i32 as libc::c_uint) as
                      *mut SPI_TypeDef {
        /* Enable SPI3 reset state */
        RCC_APB1PeriphResetCmd(0x8000i32 as uint32_t, ENABLE);
        /* Release SPI3 from reset state */
        RCC_APB1PeriphResetCmd(0x8000i32 as uint32_t, DISABLE);
    };
}
/* *
...
pub unsafe extern "C" fn SPI_StructInit(mut SPI_InitStruct:
  ...
  /* Initialize the SPI_Direction member */
    (*SPI_InitStruct).SPI_Direction = 0i32 as uint16_t;
    /* Initialize the SPI_Mode member */
    (*SPI_InitStruct).SPI_Mode = 0i32 as uint16_t;
    /* Initialize the SPI_DataSize member */
    (*SPI_InitStruct).SPI_DataSize = 0x700i32 as uint16_t;
    /* Initialize the SPI_CPOL member */
    (*SPI_InitStruct).SPI_CPOL = 0i32 as uint16_t;
    /* Initialize the SPI_CPHA member */
    (*SPI_InitStruct).SPI_CPHA = 0i32 as uint16_t;
    /* Initialize the SPI_NSS member */
    (*SPI_InitStruct).SPI_NSS = 0i32 as uint16_t;
    /* Initialize the SPI_BaudRatePrescaler member */
    (*SPI_InitStruct).SPI_BaudRatePrescaler = 0i32 as uint16_t;
    /* Initialize the SPI_FirstBit member */
    (*SPI_InitStruct).SPI_FirstBit = 0i32 as uint16_t;
    /* Initialize the SPI_CRCPolynomial member */
    (*SPI_InitStruct).SPI_CRCPolynomial = 7i32 as uint16_t;
}
/* *
...
pub unsafe extern "C" fn SPI_Init(mut SPIx: *mut SPI_TypeDef,
    ...
    let mut tmpreg: uint16_t = 0i32 as uint16_t;
    /* check the parameters */
    /* Configuring the SPI in master mode */
    if (*SPI_InitStruct).SPI_Mode as libc::c_int ==
           0x104i32 as uint16_t as libc::c_int {
        /*---------------------------- SPIx CR1 Configuration ------------------------*/
    /* Get the SPIx CR1 value */
        tmpreg = (*SPIx).CR1;
        /* Clear BIDIMode, BIDIOE, RxONLY, SSM, SSI, LSBFirst, BR, MSTR, CPOL and CPHA bits */
        tmpreg =
            (tmpreg as libc::c_int & 0x3040i32 as uint16_t as libc::c_int) as
                uint16_t;
    ...
    /* Get the SPIx CR2 value */
        ...
        tmpreg =
            (tmpreg as libc::c_int &
                 !(0xf00i32 as uint16_t as libc::c_int) as uint16_t as
    ...
    ::core::ptr::write_volatile(&mut (*SPIx).I2SCFGR as *mut uint16_t,
                                (::core::ptr::read_volatile::<uint16_t>(&(*SPIx).I2SCFGR
                                                                            ...
                                                                            *const uint16_t)
                                     as libc::c_int &
                                     !(0x800i32 as uint16_t as libc::c_int) as
...
pub unsafe extern "C" fn I2S_StructInit(mut I2S_InitStruct:
  ...
  /* Initialize the I2S_Mode member */
    (*I2S_InitStruct).I2S_Mode = 0i32 as uint16_t;
    /* Initialize the I2S_Standard member */
    (*I2S_InitStruct).I2S_Standard = 0i32 as uint16_t;
    /* Initialize the I2S_DataFormat member */
    (*I2S_InitStruct).I2S_DataFormat = 0i32 as uint16_t;
    /* Initialize the I2S_MCLKOutput member */
    (*I2S_InitStruct).I2S_MCLKOutput = 0i32 as uint16_t;
    /* Initialize the I2S_AudioFreq member */
    (*I2S_InitStruct).I2S_AudioFreq = 2i32 as uint32_t;
    /* Initialize the I2S_CPOL member */
    (*I2S_InitStruct).I2S_CPOL = 0i32 as uint16_t;
}
/* *
  * @brief  Initializes the SPIx peripheral according to the specified 
...
pub unsafe extern "C" fn I2S_Init(mut SPIx: *mut SPI_TypeDef,
    ...
    let mut tmpreg: uint16_t = 0i32 as uint16_t;
    let mut i2sdiv: uint16_t = 2i32 as uint16_t;
    let mut i2sodd: uint16_t = 0i32 as uint16_t;
    let mut packetlength: uint16_t = 1i32 as uint16_t;
    ...
    let mut sourceclock: uint32_t = 0i32 as uint32_t;
  ...
  /* Clear I2SMOD, I2SE, I2SCFG, PCMSYNC, I2SSTD, CKPOL, DATLEN and CHLEN bits */
    ::core::ptr::write_volatile(&mut (*SPIx).I2SCFGR as *mut uint16_t,
                                (::core::ptr::read_volatile::<uint16_t>(&(*SPIx).I2SCFGR
                                                                            ...
                                                                            *const uint16_t)
                                     as libc::c_int &
                                     0xf040i32 as uint16_t as libc::c_int) as
    ...
    if (*I2S_InitStruct).I2S_AudioFreq == 2i32 as uint32_t {
        i2sodd = 0i32 as uint16_t;
        i2sdiv = 2i32 as uint16_t
    } else {
        ...
        if (*I2S_InitStruct).I2S_DataFormat as libc::c_int ==
            ...
            packetlength = 1i32 as uint16_t
        } else {
            /* Packet length is 32 bits */
            packetlength = 2i32 as uint16_t
        }
        RCC_GetClocksFreq(&mut RCC_Clocks);
        sourceclock = RCC_Clocks.SYSCLK_Frequency;
        if (*I2S_InitStruct).I2S_MCLKOutput as libc::c_int ==
               0x200i32 as uint16_t as libc::c_int {
            /* I2S Clock source is System clock: Get System Clock frequency */
            /* Get the source clock value: based on System Clock value */
            /* MCLK output is enabled */
            tmp =
                sourceclock.wrapping_div(256i32 as
                                             libc::c_uint).wrapping_mul(10i32
                                                                            as
                                                                            libc::c_uint).wrapping_div((*I2S_InitStruct).I2S_AudioFreq).wrapping_add(5i32
                                                                                                                                                         as
                                                                                                                                                         libc::c_uint)
            ...
            tmp =
                sourceclock.wrapping_div((32i32 * packetlength as libc::c_int)
                                             as
                                             libc::c_uint).wrapping_mul(10i32
                                                                            as
                                                                            libc::c_uint).wrapping_div((*I2S_InitStruct).I2S_AudioFreq).wrapping_add(5i32
        ...
        tmp = tmp.wrapping_div(10i32 as libc::c_uint);
        i2sodd = (tmp & 0x1i32 as uint16_t as libc::c_uint) as uint16_t;
        i2sdiv =
            tmp.wrapping_sub(i2sodd as
                                 libc::c_uint).wrapping_div(2i32 as
                                                                libc::c_uint)
                as uint16_t;
        i2sodd = ((i2sodd as libc::c_int) << 8i32) as uint16_t
    }
    ...
    if (i2sdiv as libc::c_int) < 2i32 || i2sdiv as libc::c_int > 0xffi32 {
    ...
    if NewState as libc::c_uint != DISABLE as libc::c_int as libc::c_uint {
        ...
        ::core::ptr::write_volatile(&mut (*SPIx).CR1 as *mut uint16_t,
                                    (::core::ptr::read_volatile::<uint16_t>(&(*SPIx).CR1
                                                                                ...
                                                                                *const uint16_t)
                                         as libc::c_int |
                                         0x40i32 as uint16_t as libc::c_int)
    ...
    if NewState as libc::c_uint != DISABLE as libc::c_int as libc::c_uint {
        ...
        ::core::ptr::write_volatile(&mut (*SPIx).I2SCFGR as *mut uint16_t,
                                    (::core::ptr::read_volatile::<uint16_t>(&(*SPIx).I2SCFGR
                                                                                ...
                                                                                *const uint16_t)
                                         as libc::c_int |
                                         0x400i32 as uint16_t as libc::c_int)
                                        as uint16_t as uint16_t)
    } else {
...
pub unsafe extern "C" fn SPI_RxFIFOThresholdConfig(mut SPIx: *mut SPI_TypeDef,
    ...
    ::core::ptr::write_volatile(&mut (*SPIx).CR2 as *mut uint16_t,
                                (::core::ptr::read_volatile::<uint16_t>(&(*SPIx).CR2
                                                                            ...
                                                                            *const uint16_t)
                                     as libc::c_int &
                                     !(0x1000i32 as uint16_t as libc::c_int)
                                         as uint16_t as libc::c_int) as
                                    uint16_t as uint16_t);
...
pub unsafe extern "C" fn SPI_BiDirectionalLineConfig(mut SPIx:
                                                     ...
                                                     mut SPI_Direction:
                                                         uint16_t) {
    /* Check the parameters */
    if SPI_Direction as libc::c_int == 0x4000i32 as uint16_t as libc::c_int {
        ...
        ::core::ptr::write_volatile(&mut (*SPIx).CR1 as *mut uint16_t,
                                    (::core::ptr::read_volatile::<uint16_t>(&(*SPIx).CR1
                                                                                ...
                                                                                *const uint16_t)
                                         as libc::c_int &
                                         0xbfffi32 as uint16_t as libc::c_int)
                                        as uint16_t as uint16_t)
    };
}
/* *
...
pub unsafe extern "C" fn SPI_NSSInternalSoftwareConfig(mut SPIx:
    ...
    if SPI_NSSInternalSoft as libc::c_int !=
           0xfeffi32 as uint16_t as libc::c_int {
        ...
        ::core::ptr::write_volatile(&mut (*SPIx).CR1 as *mut uint16_t,
                                    (::core::ptr::read_volatile::<uint16_t>(&(*SPIx).CR1
                                                                                ...
                                                                                *const uint16_t)
                                         as libc::c_int |
                                         0x100i32 as uint16_t as libc::c_int)
                                        as uint16_t as uint16_t)
    } else {
  ...
  /* Clear I2SMOD, I2SE, I2SCFG, PCMSYNC, I2SSTD, CKPOL, DATLEN and CHLEN bits */
    ...
    if (*I2S_InitStruct).I2S_Mode as libc::c_int ==
           ...
           (*I2S_InitStruct).I2S_Mode as libc::c_int ==
               0i32 as uint16_t as libc::c_int {
        tmp = 0x100i32 as uint16_t
    } else if (*I2S_InitStruct).I2S_Mode as libc::c_int ==
                  0x300i32 as uint16_t as libc::c_int ||
                  (*I2S_InitStruct).I2S_Mode as libc::c_int ==
                      0x100i32 as uint16_t as libc::c_int {
        tmp = 0i32 as uint16_t
    }
    /* Configure the I2S with the SPI_InitStruct values */
    tmpreg =
        (tmpreg as libc::c_int |
...
pub unsafe extern "C" fn SPI_SendData8(mut SPIx: *mut SPI_TypeDef,
                                       mut Data: uint8_t) {
    let mut spixbase: uint32_t = 0i32 as uint32_t;
    /* Check the parameters */
    spixbase = SPIx as uint32_t;
    spixbase =
        (spixbase as libc::c_uint).wrapping_add(0xci32 as libc::c_uint) as
...
pub unsafe extern "C" fn SPI_TransmitCRC(mut SPIx: *mut SPI_TypeDef) {
    ...
    ::core::ptr::write_volatile(&mut (*SPIx).CR1 as *mut uint16_t,
                                (::core::ptr::read_volatile::<uint16_t>(&(*SPIx).CR1
                                                                            ...
                                                                            *const uint16_t)
                                     as libc::c_int |
                                     0x1000i32 as uint16_t as libc::c_int) as
                                    uint16_t as uint16_t);
}
/* *
...
pub unsafe extern "C" fn SPI_GetCRC(mut SPIx: *mut SPI_TypeDef,
    ...
    let mut crcreg: uint16_t = 0i32 as uint16_t;
    /* Check the parameters */
    if SPI_CRC as libc::c_int != 0x1i32 as uint8_t as libc::c_int {
...
pub unsafe extern "C" fn SPI_LastDMATransferCmd(mut SPIx: *mut SPI_TypeDef,
    ...
    ::core::ptr::write_volatile(&mut (*SPIx).CR2 as *mut uint16_t,
                                (::core::ptr::read_volatile::<uint16_t>(&(*SPIx).CR2
                                                                            ...
                                                                            *const uint16_t)
                                     as libc::c_int &
                                     0x9fffi32 as uint16_t as libc::c_int) as
                                    uint16_t as uint16_t);
...
pub unsafe extern "C" fn SPI_I2S_ITConfig(mut SPIx: *mut SPI_TypeDef,
                                          ...
                                          mut NewState: FunctionalState) {
    let mut itpos: uint16_t = 0i32 as uint16_t;
    let mut itmask: uint16_t = 0i32 as uint16_t;
    /* Check the parameters */
    /* Get the SPI IT index */
    itpos = (SPI_I2S_IT as libc::c_int >> 4i32) as uint16_t;
    /* Set the IT mask */
    itmask =
        ((1i32 as uint16_t as libc::c_int) << itpos as libc::c_int) as
            uint16_t;
    if NewState as libc::c_uint != DISABLE as libc::c_int as libc::c_uint {
...
pub unsafe extern "C" fn SPI_GetTransmissionFIFOStatus(mut SPIx:
 ...
 -> uint16_t {
    ...
    return ((*SPIx).SR as libc::c_int & 0x1800i32 as uint16_t as libc::c_int)
               as uint16_t;
}
/* *
...
pub unsafe extern "C" fn SPI_GetReceptionFIFOStatus(mut SPIx:
 ...
 -> uint16_t {
    ...
    return ((*SPIx).SR as libc::c_int & 0x600i32 as uint16_t as libc::c_int)
               as uint16_t;
}
/* *
...
pub unsafe extern "C" fn SPI_I2S_GetITStatus(mut SPIx: *mut SPI_TypeDef,
 ...
 -> ITStatus {
    ...
    let mut itpos: uint16_t = 0i32 as uint16_t;
    let mut itmask: uint16_t = 0i32 as uint16_t;
    let mut enablestatus: uint16_t = 0i32 as uint16_t;
    /* Check the parameters */
    /* Get the SPI_I2S_IT index */
    itpos = (0x1i32 << (SPI_I2S_IT as libc::c_int & 0xfi32)) as uint16_t;
    /* Get the SPI_I2S_IT IT mask */
    itmask = (SPI_I2S_IT as libc::c_int >> 4i32) as uint16_t;
    /* Set the IT mask */
    itmask = (0x1i32 << itmask as libc::c_int) as uint16_t;
