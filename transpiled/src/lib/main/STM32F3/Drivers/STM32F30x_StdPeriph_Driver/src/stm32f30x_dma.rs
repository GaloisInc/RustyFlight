        ...
        ::core::ptr::write_volatile(fresh0,
                                    (::core::ptr::read_volatile::<uint32_t>(fresh0
                                         ...
                                         (0x1i32 as uint32_t |
                                              0x2i32 as uint32_t |
                                              0x4i32 as uint32_t |
                                              0x8i32 as uint32_t)) as uint32_t
                                        as uint32_t)
...
pub unsafe extern "C" fn DMA_StructInit(mut DMA_InitStruct:
  ...
  /* Initialize the DMA_PeripheralBaseAddr member */
    (*DMA_InitStruct).DMA_PeripheralBaseAddr = 0i32 as uint32_t;
    /* Initialize the DMA_MemoryBaseAddr member */
    (*DMA_InitStruct).DMA_MemoryBaseAddr = 0i32 as uint32_t;
    /* Initialize the DMA_DIR member */
    (*DMA_InitStruct).DMA_DIR = 0i32 as uint32_t;
    /* Initialize the DMA_BufferSize member */
    (*DMA_InitStruct).DMA_BufferSize = 0i32 as uint16_t;
    /* Initialize the DMA_PeripheralInc member */
    (*DMA_InitStruct).DMA_PeripheralInc = 0i32 as uint32_t;
    /* Initialize the DMA_MemoryInc member */
    (*DMA_InitStruct).DMA_MemoryInc = 0i32 as uint32_t;
    /* Initialize the DMA_PeripheralDataSize member */
    (*DMA_InitStruct).DMA_PeripheralDataSize = 0i32 as uint32_t;
    /* Initialize the DMA_MemoryDataSize member */
    (*DMA_InitStruct).DMA_MemoryDataSize = 0i32 as uint32_t;
    /* Initialize the DMA_Mode member */
    (*DMA_InitStruct).DMA_Mode = 0i32 as uint32_t;
    /* Initialize the DMA_Priority member */
    (*DMA_InitStruct).DMA_Priority = 0i32 as uint32_t;
    /* Initialize the DMA_M2M member */
    (*DMA_InitStruct).DMA_M2M = 0i32 as uint32_t;
}
/* *
...
pub unsafe extern "C" fn DMA_GetFlagStatus(mut DMAy_FLAG: uint32_t)
 -> FlagStatus {
    ...
    if DMAy_FLAG & 0x10000000i32 as uint32_t !=
...
pub unsafe extern "C" fn DMA_GetITStatus(mut DMAy_IT: uint32_t) -> ITStatus {
    ...
    if DMAy_IT & 0x10000000i32 as uint32_t != RESET as libc::c_int as uint32_t
       {
        /* Get DMA2 ISR register value */
        tmpreg =
            (*((0x40000000i32 as
