    ...
    match baroHardware as libc::c_uint {
        0 | 2 | 3 => {
            if ms5611Detect(dev) {
                ...
                current_block_19 = 11932355480408055363;
            } else { current_block_19 = 2804054684600424018; }
        }
        5 | 4 => { current_block_19 = 2804054684600424018; }
        6 | 1 => { current_block_19 = 7496146604568314438; }
        _ => { current_block_19 = 11932355480408055363; }
    }
    match current_block_19 {
        2804054684600424018 => {
            if bmp280Detect(dev) {
                ...
                current_block_19 = 11932355480408055363;
            } else { current_block_19 = 7496146604568314438; }
        }
        _ => { }
    }
    match current_block_19 {
        7496146604568314438 => { baroHardware = BARO_NONE }
        _ => { }
    }
