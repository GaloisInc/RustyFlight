...
#[no_mangle]
pub static mut lookupTables: [lookupTableEntry_t; 42] =
    [lookupTableEntry_t{values: 0 as *const *const libc::c_char,
                        valueCount: 0,}; 42];
#[no_mangle]
pub static mut valueTable: [clivalue_t; 380] =
    [{
         let mut init =
             clivalue_s{name:
     ...
     },
     {
         let mut init =
             clivalue_s{name:
                        ...
                        offset: 134 as libc::c_ulong as uint16_t,};
         init
     },
     {
         let mut init =
             clivalue_s{name:
                        ...
                        pgn: 13 as libc::c_int as pgn_t,
                        offset: 132 as libc::c_ulong as uint16_t,};
         init
     },
     {
         let mut init =
...
unsafe extern "C" fn run_static_initializers() {
    ...
    valueTableEntryCount =
        (::core::mem::size_of::<[clivalue_t; 380]>() as
