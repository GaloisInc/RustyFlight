...
static mut serialDefaultPin: [serialDefaultPin_t; 10] =
    [{
         let mut init =
     ...
     {
         let mut init =
             serialDefaultPin_s{ident: SERIAL_PORT_USART7,
                                rxIO:
     ...
     {
         let mut init =
             serialDefaultPin_s{ident: SERIAL_PORT_USART8,
                                rxIO:
                                    ((4 as libc::c_int + 1 as libc::c_int) <<
...
pub unsafe extern "C" fn pgResetFn_serialPinConfig(mut serialPinConfig:
    ...
    while index <
              (::core::mem::size_of::<[serialDefaultPin_t; 10]>() as
