 ...
 -> libc::c_int {
    ...
    match adjustmentFunction as libc::c_int {
        1 | 25 => {
            ...
            } else { current_block_82 = 14408250472763556188; }
        }
        26 => { current_block_82 = 14408250472763556188; }
        2 | 27 => {
            newValue =
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 = 15447629348493591490;
            } else { current_block_82 = 15318724879624799740; }
        }
        28 => { current_block_82 = 15318724879624799740; }
        3 => {
            newValue =
        ...
        4 | 13 => {
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 = 15447629348493591490;
            } else { current_block_82 = 4417385918448270161; }
        }
        14 => { current_block_82 = 4417385918448270161; }
        5 => {
            newValue =
        ...
        6 | 15 => {
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 =
                    725893498083550083; // FIXME magic numbers repeated in cli.c
            }
        }
        18 => { current_block_82 = 725893498083550083; }
        7 | 16 => {
            newValue =
                constrain((*pidProfile).pid[PID_PITCH as libc::c_int as
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 =
                    17561879031245045231; // FIXME magic numbers repeated in cli.c
            }
        }
        19 => { current_block_82 = 17561879031245045231; }
        8 | 17 => {
            newValue =
                constrain((*pidProfile).pid[PID_PITCH as libc::c_int as
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 =
                    10329286773989817551; // FIXME magic numbers repeated in cli.c
            }
        }
        20 => {
            current_block_82 =
        ...
        22 | 30 => {
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 = 15447629348493591490;
            } else { current_block_82 = 10586389440365353555; }
        }
        31 => { current_block_82 = 10586389440365353555; }
        32 => {
            newValue =
