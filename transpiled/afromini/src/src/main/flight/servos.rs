...
pub static mut servoConfig_Registry: pgRegistry_t =
    unsafe {
        {
            let mut init =
                pgRegistry_s{pgn: (52i32 | 0i32 << 12i32) as pgn_t,
                             size:
...
pub unsafe extern "C" fn pgResetFn_servoConfig(mut servoConfig_0:
                                                   *mut servoConfig_t) {
    (*servoConfig_0).dev.servoCenterPulse = 1500i32 as uint16_t;
    (*servoConfig_0).dev.servoPwmRate = 50i32 as uint16_t;
    (*servoConfig_0).tri_unarmed_servo = 1i32 as uint8_t;
    (*servoConfig_0).servo_lowpass_freq = 0i32 as uint16_t;
    (*servoConfig_0).channelForwardingStartChannel =
        AUX1 as libc::c_int as uint8_t;
    let mut servoIndex: libc::c_uint = 0i32 as libc::c_uint;
        ...
        static mut _reset_template_88: servoParam_t =
            {
                let mut init =
                    servoParam_s{reversedSources: 0,
                                 min: 1000i32 as int16_t,
                                 max: 2000i32 as int16_t,
                                 middle: 1500i32 as int16_t,
                                 rate: 100i32 as int8_t,
                                 forwardFromChannel:
                                     0xffi32 as uint8_t as int8_t,};
                init
            };
...
pub static mut gimbalConfig_Registry: pgRegistry_t =
    unsafe {
        {
            let mut init =
                pgRegistry_s{pgn: (3i32 | 0i32 << 12i32) as pgn_t,
                             size:
...
static mut servoRuleCount: uint8_t = 0i32 as uint8_t;
    ...
    [{
         let mut init =
             servoMixer_s{targetChannel:
                          ...
                          rate: 100i32 as int8_t,
                          speed: 0i32 as uint8_t,
                          min: 0i32 as int8_t,
                          max: 100i32 as int8_t,
                          box_0: 0i32 as uint8_t,};
         init
     },
     {
         let mut init =
...
pub unsafe extern "C" fn servoDirection(mut servoIndex: libc::c_int,
 ...
 -> libc::c_int {
    ...
    if (*servoParams(servoIndex)).reversedSources &
           (1i32 << inputSource) as libc::c_uint != 0 {
        return -1i32
    } else { return 1i32 };
}
#[no_mangle]
pub unsafe extern "C" fn servosInit() {
    ...
    while (i as libc::c_int) < 8i32 {
        servo[i as usize] = 1500i32 as int16_t;
        i = i.wrapping_add(1)
    }
...
pub unsafe extern "C" fn loadCustomServoMixer() {
    // reset settings
    servoRuleCount = 0i32 as uint8_t;
    memset(currentServoMixer.as_mut_ptr() as *mut libc::c_void, 0i32,
           ::core::mem::size_of::<[servoMixer_t; 16]>() as libc::c_ulong);
    // load custom mixer into currentServoMixer
    let mut i: libc::c_int = 0i32;
    while i < 2i32 * 8i32 {
        // check if done
        if (*customServoMixers(i)).rate as libc::c_int == 0i32 { break ; }
...
unsafe extern "C" fn forwardAuxChannelsToServos(mut firstServoIndex:
    ...
    let mut servoOffset: libc::c_int = 0i32;
    while servoOffset < 18i32 - 4i32 && channelOffset < 18i32 {
...
unsafe extern "C" fn updateGimbalServos(mut firstServoIndex: uint8_t) {
    pwmWriteServo((firstServoIndex as libc::c_int + 0i32) as uint8_t,
                  servo[SERVO_GIMBAL_PITCH as libc::c_int as usize] as
                      libc::c_float);
    pwmWriteServo((firstServoIndex as libc::c_int + 1i32) as uint8_t,
...
pub unsafe extern "C" fn writeServos() {
    ...
    match currentMixerMode as libc::c_uint {
        1 | 25 => {
            if servosTricopterIsEnabledServoUnarmed() {
                ...
                servoIndex = servoIndex.wrapping_add(1);
                pwmWriteServo(fresh6, 0i32 as libc::c_float);
            }
        }
        8 => {
        ...
        19 => {
            ...
            while i_0 < 8i32 {
                ...
                servoIndex = servoIndex.wrapping_add(1);
                pwmWriteServo(fresh10, servo[i_0 as usize] as libc::c_float);
                i_0 += 1
            }
        }
        _ => { }
    ...
    if feature(FEATURE_SERVO_TILT as libc::c_int as uint32_t) as libc::c_int
        ...
        servoIndex = (servoIndex as libc::c_int + 2i32) as uint8_t
    }
    ...
    if feature(FEATURE_CHANNEL_FORWARDING as libc::c_int as uint32_t) {
        ...
        servoIndex = (servoIndex as libc::c_int + (18i32 - 4i32)) as uint8_t
    };
}
#[no_mangle]
pub unsafe extern "C" fn servoMixer() {
        ...
        if feature(FEATURE_3D as libc::c_int as uint32_t) as libc::c_int != 0
            ...
            input[INPUT_STABILIZED_YAW as libc::c_int as usize] =
                (input[INPUT_STABILIZED_YAW as libc::c_int as usize] as
                     libc::c_int * -1i32) as int16_t
        }
    } // Since it derives from rcCommand or mincommand and must be [-500:+500]
    input[INPUT_GIMBAL_PITCH as libc::c_int as usize] =
        scaleRange(attitude.values.pitch as libc::c_int, -1800i32, 1800i32,
                   -500i32, 500i32) as int16_t;
    input[INPUT_GIMBAL_ROLL as libc::c_int as usize] =
        scaleRange(attitude.values.roll as libc::c_int, -1800i32, 1800i32,
                   -500i32, 500i32) as int16_t;
    input[INPUT_STABILIZED_THROTTLE as libc::c_int as usize] =
        (motor[0] - 1000i32 as libc::c_float - 500i32 as libc::c_float) as
            int16_t;
    ...
    input[INPUT_RC_AUX4 as libc::c_int as usize] =
        (rcData[AUX4 as libc::c_int as usize] as libc::c_int -
             (*rxConfig()).midrc as libc::c_int) as int16_t;
    let mut i: libc::c_int = 0i32;
    while i < 8i32 { servo[i as usize] = 0i32 as int16_t; i += 1 }
    // mix servos according to rules
    let mut i_0: libc::c_int = 0i32;
    while i_0 < servoRuleCount as libc::c_int {
        // consider rule if no box assigned or box is active
        if currentServoMixer[i_0 as usize].box_0 as libc::c_int == 0i32 ||
               IS_RC_MODE_ACTIVE((BOXSERVO1 as libc::c_int +
                                      currentServoMixer[i_0 as usize].box_0 as
                                          libc::c_int - 1i32) as boxId_e) as
                   libc::c_int != 0 {
            ...
            let mut min: int16_t =
                (currentServoMixer[i_0 as usize].min as libc::c_int *
                     servo_width as libc::c_int / 100i32 -
                     servo_width as libc::c_int / 2i32) as int16_t;
            let mut max: int16_t =
                (currentServoMixer[i_0 as usize].max as libc::c_int *
                     servo_width as libc::c_int / 100i32 -
                     servo_width as libc::c_int / 2i32) as int16_t;
            if currentServoMixer[i_0 as usize].speed as libc::c_int == 0i32 {
            ...
            servo[target as usize] =
                (servo[target as usize] as libc::c_int +
                    ...
                    int16_t
        } else { currentOutput[i_0 as usize] = 0i32 as int16_t }
        i_0 += 1
    }
...
unsafe extern "C" fn servoTable() {
    ...
    match currentMixerMode as libc::c_uint {
        ...
        19 => {
            ...
            while i <
                      ({
                           let mut _a: libc::c_int = 8i32;
                           let mut _b: libc::c_int = 18i32;
                           (if _a < _b { _a } else { _b })
                       }) {
            ...
            if (*gimbalConfig()).mode as libc::c_int ==
                ...
                servo[SERVO_GIMBAL_PITCH as libc::c_int as usize] =
                    (servo[SERVO_GIMBAL_PITCH as libc::c_int as usize] as
                         ...
                         (-((*servoParams(SERVO_GIMBAL_PITCH as
                              ...
                              attitude.values.pitch as libc::c_int / 50i32 -
                ...
                servo[SERVO_GIMBAL_PITCH as libc::c_int as usize] =
                    (servo[SERVO_GIMBAL_PITCH as libc::c_int as usize] as
                         ...
                         (*servoParams(SERVO_GIMBAL_PITCH as
                                           libc::c_int)).rate as int32_t *
                             attitude.values.pitch as libc::c_int / 50i32) as
                        int16_t;
                servo[SERVO_GIMBAL_ROLL as libc::c_int as usize] =
                    (servo[SERVO_GIMBAL_ROLL as libc::c_int as usize] as
                         libc::c_int +
...
pub unsafe extern "C" fn servosFilterInit() {
    if (*servoConfig()).servo_lowpass_freq != 0 {
        let mut servoIdx: libc::c_int = 0i32;
        while servoIdx < 8i32 {
...
unsafe extern "C" fn run_static_initializers() {
    customServoMixers_Registry =
        {
            let mut init =
                pgRegistry_s{pgn: (21i32 | 0i32 << 12i32) as pgn_t,
                             size:
    ...
    servoParams_Registry =
        {
            let mut init =
                pgRegistry_s{pgn: (42i32 | 0i32 << 12i32) as pgn_t,
                             size:
    ...
    servoMixers =
        [{
             let mut init =
                 mixerRules_s{servoRuleCount: 0i32 as uint8_t,
