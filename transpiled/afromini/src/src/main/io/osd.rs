 ...
 */
/* Created by jflyper */
// used for custom frequency selection mode
//max freq (in MHz) for 'vtx_freq' setting
...
static mut compassBar: [libc::c_char; 24] =
    [0x1bi32 as libc::c_char, 0x1di32 as libc::c_char,
     0x1ci32 as libc::c_char, 0x1di32 as libc::c_char,
     0x18i32 as libc::c_char, 0x1di32 as libc::c_char,
     0x1ci32 as libc::c_char, 0x1di32 as libc::c_char,
     0x1ai32 as libc::c_char, 0x1di32 as libc::c_char,
     0x1ci32 as libc::c_char, 0x1di32 as libc::c_char,
     0x19i32 as libc::c_char, 0x1di32 as libc::c_char,
     0x1ci32 as libc::c_char, 0x1di32 as libc::c_char,
     0x1bi32 as libc::c_char, 0x1di32 as libc::c_char,
     0x1ci32 as libc::c_char, 0x1di32 as libc::c_char,
     0x18i32 as libc::c_char, 0x1di32 as libc::c_char,
...
unsafe extern "C" fn osdGetBatteryAverageCellVoltage() -> libc::c_int {
    return getBatteryVoltage() as libc::c_int * 10i32 /
        ...
        let symOffset: libc::c_int =
            scaleRange(cellVoltage,
                       ...
                       (*batteryConfig()).vbatmaxcellvoltage as libc::c_int *
                           10i32, 0i32, 7i32);
        return (0x96i32 - constrain(symOffset, 0i32, 6i32)) as libc::c_char
    };
}
/* *
...
unsafe extern "C" fn osdConvertTemperatureToSelectedUnit(mut tempInDeciDegrees:
 ...
 -> libc::c_int {
    match (*osdConfig()).units as libc::c_uint {
        0 => { return tempInDeciDegrees * 9i32 / 5i32 + 320i32 }
...
unsafe extern "C" fn osdGetHeadingIntoDiscreteDirections(mut heading:
 ...
 -> uint8_t {
    ...
    let mut direction: libc::c_int =
        (heading as
             libc::c_uint).wrapping_mul(directions).wrapping_add((360i32 /
                                                                      2i32) as
                                                                     libc::c_uint).wrapping_div(360i32
                                                                                                    as
                                                                                                    libc::c_uint)
...
unsafe extern "C" fn osdGetDirectionSymbolFromHeading(mut heading:
 ...
 -> uint8_t {
    heading =
        osdGetHeadingIntoDiscreteDirections(heading, 16i32 as libc::c_uint) as
            libc::c_int;
    ...
    heading = 16i32 - heading;
    heading = (heading + 8i32) % 16i32;
    return (0x60i32 + heading) as uint8_t;
}
...
unsafe extern "C" fn osdFormatMessage(mut buff: *mut libc::c_char,
    ...
    memset(buff as *mut libc::c_void, 0x20i32, size);
    if !message.is_null() {
        memcpy(buff as *mut libc::c_void, message as *const libc::c_void,
               strlen(message));
    }
    // Ensure buff is zero terminated
    *buff.offset(size.wrapping_sub(1i32 as libc::c_ulong) as isize) =
        '\u{0}' as i32 as libc::c_char; // change range
}
#[no_mangle]
...
unsafe extern "C" fn osdDrawSingleElement(mut item: uint8_t) -> bool {
    if (*osdConfig()).item_pos[item as usize] as libc::c_int & 0x800i32 == 0
           ||
           blinkBits[(item as libc::c_int / 32i32) as usize] &
               (1i32 << item as libc::c_int % 32i32) as libc::c_uint != 0 &&
               blinkState as libc::c_int != 0 {
        return 0i32 != 0
    }
    let mut elemPosX: uint8_t =
        ((*osdConfig()).item_pos[item as usize] as libc::c_int &
             (1i32 << 5i32) - 1i32) as uint8_t;
    let mut elemPosY: uint8_t =
        ((*osdConfig()).item_pos[item as usize] as libc::c_int >> 5i32 &
             (1i32 << 5i32) - 1i32) as uint8_t;
    ...
    match item as libc::c_int {
        0 => {
            let mut osdRssi: uint16_t =
                (getRssi() as libc::c_int * 100i32 / 1024i32) as uint16_t;
            if osdRssi as libc::c_int >= 100i32 {
                osdRssi = 99i32 as uint16_t
            }
            tfp_sprintf(buff.as_mut_ptr(),
                        b"%c%2d\x00" as *const u8 as *const libc::c_char,
                        0x1i32, osdRssi as libc::c_int);
        }
        1 => {
            buff[0] = osdGetBatterySymbol(osdGetBatteryAverageCellVoltage());
            tfp_sprintf(buff.as_mut_ptr().offset(1),
        ...
        11 => {
            ...
            tfp_sprintf(buff.as_mut_ptr(),
                        ...
                        abs(amperage) / 100i32, abs(amperage) % 100i32,
                        0x9ai32);
        }
        12 => {
            tfp_sprintf(buff.as_mut_ptr(),
        ...
        34 => {
            ...
            memcpy(buff.as_mut_ptr() as *mut libc::c_void,
                   compassBar.as_ptr().offset(osdGetHeadingIntoDiscreteDirections(attitude.values.yaw
                       ...
                       *const libc::c_void, 9i32 as libc::c_ulong);
            buff[9] = 0i32 as libc::c_char
        }
        15 => {
        ...
        5 | 6 => {
            osdFormatTimer(buff.as_mut_ptr(), 1i32 != 0, 1i32 != 0,
                           item as libc::c_int -
        ...
        //TODO: When iterative updating is implemented, change this so the craft name is only printed once whenever the OSD 'flight' screen is entered.
            if strlen((*pilotConfig()).name.as_ptr()) == 0i32 as libc::c_ulong
               {
                strcpy(buff.as_mut_ptr(),
        ...
        9 => {
            buff[0] = 0x4i32 as libc::c_char;
            buff[1] = 0x5i32 as libc::c_char;
            tfp_sprintf(buff.as_mut_ptr().offset(2),
                        b"%3d\x00" as *const u8 as *const libc::c_char,
                        (constrain(rcData[THROTTLE as libc::c_int as usize] as
                                       libc::c_int, 1000i32, 2000i32) -
                             1000i32) * 100i32 / (2000i32 - 1000i32));
        }
        10 => {
        ...
        2 => {
            buff[0] = 0x26i32 as libc::c_char;
            buff[1] = 0x7ei32 as libc::c_char;
            buff[2] = 0x27i32 as libc::c_char;
            buff[3] = 0i32 as libc::c_char
        }
        3 => {
            // Get pitch and roll limits in tenths of degrees
            let maxPitch: libc::c_int =
                (*osdConfig()).ahMaxPitch as libc::c_int * 10i32;
            let maxRoll: libc::c_int =
                (*osdConfig()).ahMaxRoll as libc::c_int * 10i32;
            ...
            pitchAngle =
                pitchAngle * 25i32 / maxPitch -
                    41i32; // 41 = 4 * AH_SYMBOL_COUNT + 5
            let mut x: libc::c_int = -4i32;
            while x <= 4i32 {
                let y: libc::c_int = -rollAngle * x / 64i32 - pitchAngle;
                if y >= 0i32 && y <= 81i32 {
                    displayWriteChar(osdDisplayPort,
                                     (elemPosX as libc::c_int + x) as uint8_t,
                                     (elemPosY as libc::c_int + y / 9i32) as
                                         uint8_t,
                                     (0x80i32 + y % 9i32) as uint8_t);
                }
                x += 1
            }
            return 1i32 != 0
        ...
        4 => {
            // Draw AH sides
            let hudwidth: int8_t = 7i32 as int8_t;
            let hudheight: int8_t = 3i32 as int8_t;
            ...
            displayWriteChar(osdDisplayPort,
                             (elemPosX as libc::c_int -
                                  hudwidth as libc::c_int + 1i32) as uint8_t,
                             elemPosY, 0x3i32 as uint8_t);
            displayWriteChar(osdDisplayPort,
                             (elemPosX as libc::c_int +
                                  hudwidth as libc::c_int - 1i32) as uint8_t,
                             elemPosY, 0x2i32 as uint8_t);
            return 1i32 != 0
        }
        42 => {
            let mut osdGForce: libc::c_float = 0i32 as libc::c_float;
            ...
            tfp_sprintf(buff.as_mut_ptr(),
                        ...
                        (osdGForce * 10i32 as libc::c_float) as libc::c_int %
                            10i32);
        }
        16 => {
        ...
        20 => {
            tfp_sprintf(buff.as_mut_ptr(),
                        ...
                        getCurrentPidProfileIndex() as libc::c_int + 1i32,
                ...
                if armingDelayTime as libc::c_double >=
                    ...
                    osdFormatMessage(buff.as_mut_ptr(),
                          ...
                          batteryState as libc::c_uint ==
                              BATTERY_CRITICAL as libc::c_int as libc::c_uint
             {
                osdFormatMessage(buff.as_mut_ptr(), (11i32 + 1i32) as size_t,
                ...
                if feature(FEATURE_ESC_SENSOR as libc::c_int as uint32_t) as
                    ...
                    while i_0 < getMotorCount() as libc::c_uint &&
                              pos < (11i32 + 1i32 - 1i32) as libc::c_uint {
                    ...
                    if escWarningCount > 0i32 as libc::c_uint {
                        osdFormatMessage(buff.as_mut_ptr(),
                                         (11i32 + 1i32) as size_t,
                                         escWarningMsg.as_mut_ptr());
                        current_block_160 = 6678684093116635837;
                    } else { current_block_160 = 1606838685604807701; }
                } else { current_block_160 = 1606838685604807701; }
                match current_block_160 {
                    ...
                    // Warn when in flip over after crash mode
                    {
                        ...
                        } else if osdWarnGetState(OSD_WARNING_RC_SMOOTHING as
        ...
        22 => {
            ...
            tfp_sprintf(buff.as_mut_ptr().offset(1),
                        ...
                        cellV / 100i32, cellV % 100i32, 0x6i32);
        }
        25 => {
            tfp_sprintf(buff.as_mut_ptr(),
                        b"DBG %5d %5d %5d %5d\x00" as *const u8 as
                            *const libc::c_char, debug[0] as libc::c_int,
                        debug[1] as libc::c_int, debug[2] as libc::c_int,
                        debug[3] as libc::c_int);
        }
        26 | 27 => {
            ...
            tfp_sprintf(buff.as_mut_ptr(),
                        b"%c%02d.%01d\x00" as *const u8 as
                            *const libc::c_char,
                        if angle < 0i32 { '-' as i32 } else { ' ' as i32 },
                        abs(angle / 10i32), abs(angle % 10i32));
        }
        28 => {
            ...
            let mAhUsedProgress: uint8_t =
                ceilf(value /
                          ((*batteryConfig()).batteryCapacity as libc::c_int /
                               11i32) as libc::c_float) as uint8_t;
            // Create empty battery indicator bar
            buff[0] = 0x8ai32 as libc::c_char;
            let mut i_2: libc::c_int = 1i32;
            while i_2 <= 11i32 {
                buff[i_2 as usize] =
                    if i_2 <= mAhUsedProgress as libc::c_int {
                        0x8bi32
                    } else { 0x8di32 } as libc::c_char;
                i_2 += 1
            }
            buff[(11i32 + 1i32) as usize] = 0x8fi32 as libc::c_char;
            if mAhUsedProgress as libc::c_int > 0i32 &&
                   (mAhUsedProgress as libc::c_int) < 11i32 {
                buff[(1i32 + mAhUsedProgress as libc::c_int) as usize] =
                    0x8ei32 as libc::c_char
            }
            buff[(11i32 + 2i32) as usize] = '\u{0}' as i32 as libc::c_char
        }
        29 => {
        ...
        33 => {
            ...
            let directionSymbol: libc::c_char =
                if verticalSpeed < 0i32 { 0x60i32 } else { 0x68i32 } as
                    libc::c_char;
            tfp_sprintf(buff.as_mut_ptr(),
                        b"%c%01d.%01d\x00" as *const u8 as
                            *const libc::c_char,
                        directionSymbol as libc::c_int,
                        abs(verticalSpeed / 100i32),
                        abs(verticalSpeed % 100i32 / 10i32));
        }
        35 => {
...
pub unsafe extern "C" fn osdInit(mut osdDisplayPortToUse:
    ...
    displayWrite(osdDisplayPort, 7i32 as uint8_t, 8i32 as uint8_t,
                 b"MENU:THR MID\x00" as *const u8 as *const libc::c_char);
    displayWrite(osdDisplayPort, 11i32 as uint8_t, 9i32 as uint8_t,
                 b"+ YAW LEFT\x00" as *const u8 as *const libc::c_char);
    displayWrite(osdDisplayPort, 11i32 as uint8_t, 10i32 as uint8_t,
...
unsafe extern "C" fn osdShowStats(mut endBatteryVoltage: uint16_t) {
    ...
    displayWrite(osdDisplayPort, 2i32 as uint8_t, fresh8,
    ...
    if osdStatGetState(OSD_STAT_RTC_DATE_TIME as libc::c_int as uint8_t) {
        ...
        let fresh9 = top;
        top = top.wrapping_add(1);
        displayWrite(osdDisplayPort, 2i32 as uint8_t, fresh9,
                     buff.as_mut_ptr());
    }
...
pub unsafe extern "C" fn osdUpdate(mut currentTimeUs: timeUs_t) {
    ...
    if armingFlags as libc::c_int & ARMED as libc::c_int == 0 {
        let fresh23 = idlecounter;
        idlecounter = idlecounter.wrapping_add(1);
        if fresh23.wrapping_rem(4i32 as libc::c_uint) != 0i32 as libc::c_uint
           {
            return
        }
    }
