...
static mut roll_data: OSD_INT16_t =
    OSD_INT16_t{val: 0 as *const int16_t as *mut int16_t,
                min: 0,
                max: 0,
                step: 0,};
// Initialized in run_static_initializers
static mut pitch_data: OSD_INT16_t =
    OSD_INT16_t{val: 0 as *const int16_t as *mut int16_t,
                min: 0,
                max: 0,
                step: 0,};
// Initialized in run_static_initializers
static mut thr_data: OSD_INT16_t =
    OSD_INT16_t{val: 0 as *const int16_t as *mut int16_t,
                min: 0,
                max: 0,
                step: 0,};
// Initialized in run_static_initializers
static mut yaw_data: OSD_INT16_t =
    OSD_INT16_t{val: 0 as *const int16_t as *mut int16_t,
                min: 0,
                max: 0,
                step: 0,};
// Initialized in run_static_initializers
static mut aux1_data: OSD_INT16_t =
    OSD_INT16_t{val: 0 as *const int16_t as *mut int16_t,
                min: 0,
                max: 0,
                step: 0,};
// Initialized in run_static_initializers
static mut aux2_data: OSD_INT16_t =
    OSD_INT16_t{val: 0 as *const int16_t as *mut int16_t,
                min: 0,
                max: 0,
                step: 0,};
// Initialized in run_static_initializers
static mut aux3_data: OSD_INT16_t =
    OSD_INT16_t{val: 0 as *const int16_t as *mut int16_t,
                min: 0,
                max: 0,
                step: 0,};
// Initialized in run_static_initializers
static mut aux4_data: OSD_INT16_t =
    OSD_INT16_t{val: 0 as *const int16_t as *mut int16_t,
                min: 0,
                max: 0,
                step: 0,};
...
// RC preview
//
static mut cmsx_menuRcEntries: [OSD_Entry; 11] =
    unsafe {
        [{
             let mut init =
                 OSD_Entry{text:
                               b"-- RC PREV --\x00" as *const u8 as
                                   *const libc::c_char,
                           type_0: OME_Label,
                           func: None,
                           data:
         ...
         },
         {
             let mut init =
                 OSD_Entry{text:
                               b"ROLL\x00" as *const u8 as
                                   *const libc::c_char,
                           type_0: OME_INT16,
                           func: None,
                           data:
                               &roll_data as *const OSD_INT16_t as
         ...
         },
         {
             let mut init =
                 OSD_Entry{text:
                           ...
                           func: None,
                           data:
                               &pitch_data as *const OSD_INT16_t as
                                   *mut OSD_INT16_t as *mut libc::c_void,
                           flags: 0x4i32 as uint8_t,};
             init
         },
         {
             let mut init =
                 OSD_Entry{text:
                               b"THR\x00" as *const u8 as *const libc::c_char,
                           type_0: OME_INT16,
                           func: None,
                           data:
                               &thr_data as *const OSD_INT16_t as
                                   *mut OSD_INT16_t as *mut libc::c_void,
                           flags: 0x4i32 as uint8_t,};
             init
         },
         {
             let mut init =
                 OSD_Entry{text:
                           ...
                           func: None,
                           data:
                               &yaw_data as *const OSD_INT16_t as
                                   *mut OSD_INT16_t as *mut libc::c_void,
                           flags: 0x4i32 as uint8_t,};
             init
         },
         {
             let mut init =
                 OSD_Entry{text:
                               b"AUX1\x00" as *const u8 as
                                   *const libc::c_char,
                           type_0: OME_INT16,
                           func: None,
                           data:
                               &aux1_data as *const OSD_INT16_t as
                                   *mut OSD_INT16_t as *mut libc::c_void,
                           flags: 0x4i32 as uint8_t,};
             init
         },
         {
             let mut init =
                 OSD_Entry{text:
                               b"AUX2\x00" as *const u8 as
                                   *const libc::c_char,
                           type_0: OME_INT16,
                           func: None,
                           data:
                               &aux2_data as *const OSD_INT16_t as
                                   *mut OSD_INT16_t as *mut libc::c_void,
                           flags: 0x4i32 as uint8_t,};
             init
         },
         {
             let mut init =
                 OSD_Entry{text:
                               b"AUX3\x00" as *const u8 as
                                   *const libc::c_char,
                           type_0: OME_INT16,
                           func: None,
                           data:
                               &aux3_data as *const OSD_INT16_t as
                                   *mut OSD_INT16_t as *mut libc::c_void,
                           flags: 0x4i32 as uint8_t,};
             init
         },
         {
             let mut init =
                 OSD_Entry{text:
                               b"AUX4\x00" as *const u8 as
                                   *const libc::c_char,
                           type_0: OME_INT16,
                           func: None,
                           data:
                               &aux4_data as *const OSD_INT16_t as
                                   *mut OSD_INT16_t as *mut libc::c_void,
                           flags: 0x4i32 as uint8_t,};
             init
         },
...
unsafe extern "C" fn cmsx_menuMiscOnEnter() -> libc::c_long {
    ...
    motorConfig_digitalIdleOffsetValue =
        ((*motorConfig()).digitalIdleOffsetValue as libc::c_int / 10i32) as
            uint8_t;
...
unsafe extern "C" fn cmsx_menuMiscOnExit(mut self_0: *const OSD_Entry)
 -> libc::c_long {
    ...
    (*motorConfigMutable()).digitalIdleOffsetValue =
        (10i32 * motorConfig_digitalIdleOffsetValue as libc::c_int) as
            uint16_t;
    (*systemConfigMutable()).debug_mode = systemConfig_debug_mode as uint8_t;
    return 0i32 as libc::c_long;
}
static mut min_thr_data: OSD_UINT16_t =
    unsafe {
        {
            let mut init =
                OSD_UINT16_t{val:
                                 &motorConfig_minthrottle as *const uint16_t
                                     as *mut uint16_t,
...
static mut digital_idle_data: OSD_UINT8_t =
    unsafe {
        {
            let mut init =
                OSD_UINT8_t{val:
                                &motorConfig_digitalIdleOffsetValue as
...
static mut debug_mode_data: OSD_TAB_t =
    unsafe {
        {
            let mut init =
                OSD_TAB_t{val:
                              &systemConfig_debug_mode as *const debugType_e
                                  as *mut debugType_e as *mut uint8_t,
                          max: (DEBUG_COUNT as libc::c_int - 1i32) as uint8_t,
                          names: debugModeNames.as_ptr(),};
            init
        }
    };
static mut menuMiscEntries: [OSD_Entry; 7] =
    unsafe {
        [{
             let mut init =
                 OSD_Entry{text:
         ...
         },
         {
             let mut init =
                 OSD_Entry{text:
                               b"MIN THR\x00" as *const u8 as
                                   *const libc::c_char,
                           type_0: OME_UINT16,
                           func: None,
                           data:
                               &min_thr_data as *const OSD_UINT16_t as
         ...
         },
         {
             let mut init =
                 OSD_Entry{text:
                               b"DIGITAL IDLE\x00" as *const u8 as
                                   *const libc::c_char,
                           type_0: OME_UINT8,
                           func: None,
                           data:
                               &digital_idle_data as *const OSD_UINT8_t as
         ...
         },
         {
             let mut init =
                 OSD_Entry{text:
                               b"DEBUG MODE\x00" as *const u8 as
                                   *const libc::c_char,
                           type_0: OME_TAB,
                           func: None,
                           data:
                               &debug_mode_data as *const OSD_TAB_t as
                           ...
                           func:
                               Some(cmsMenuChange as
                                        unsafe extern "C" fn(_:
                                            ...
                                            -> libc::c_long),
                           data:
                               &cmsx_menuRcPreview as *const CMS_Menu as
    ...
    roll_data =
        {
            let mut init =
                OSD_INT16_t{val:
                                &mut *rcData.as_mut_ptr().offset(ROLL as
                                                                     libc::c_int
                                                                     as isize)
                                    as *mut int16_t,
                            min: 1i32 as int16_t,
                            max: 2500i32 as int16_t,
                            step: 0i32 as int16_t,};
            init
        };
    pitch_data =
        {
            let mut init =
                OSD_INT16_t{val:
                                &mut *rcData.as_mut_ptr().offset(PITCH as
                                                                     libc::c_int
                                                                     as isize)
                                    as *mut int16_t,
                            min: 1i32 as int16_t,
    ...
    thr_data =
        {
            let mut init =
                OSD_INT16_t{val:
                                &mut *rcData.as_mut_ptr().offset(THROTTLE as
                                                                     libc::c_int
                                                                     as isize)
                                    as *mut int16_t,
                            min: 1i32 as int16_t,
    ...
    yaw_data =
        {
            let mut init =
                OSD_INT16_t{val:
                                &mut *rcData.as_mut_ptr().offset(YAW as
                                                                     libc::c_int
                                                                     as isize)
                                    as *mut int16_t,
                            min: 1i32 as int16_t,
    ...
    aux1_data =
        {
            let mut init =
                OSD_INT16_t{val:
                                &mut *rcData.as_mut_ptr().offset(AUX1 as
                                                                     libc::c_int
                                                                     as isize)
                                    as *mut int16_t,
                            min: 1i32 as int16_t,
    ...
    aux2_data =
        {
            let mut init =
                OSD_INT16_t{val:
                                &mut *rcData.as_mut_ptr().offset(AUX2 as
                                                                     libc::c_int
                                                                     as isize)
                                    as *mut int16_t,
                            min: 1i32 as int16_t,
    ...
    aux3_data =
        {
            let mut init =
                OSD_INT16_t{val:
                                &mut *rcData.as_mut_ptr().offset(AUX3 as
                                                                     libc::c_int
                                                                     as isize)
                                    as *mut int16_t,
                            min: 1i32 as int16_t,
    ...
    aux4_data =
        {
            let mut init =
                OSD_INT16_t{val:
                                &mut *rcData.as_mut_ptr().offset(AUX4 as
                                                                     libc::c_int
                                                                     as isize)
                                    as *mut int16_t,
                            min: 1i32 as int16_t,
