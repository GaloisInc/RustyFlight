...
pub static mut lookupTables: [lookupTableEntry_t; 37] =
    [lookupTableEntry_t{values: 0 as *const *const libc::c_char,
                        valueCount: 0,}; 37];
#[no_mangle]
pub static mut valueTable: [clivalue_t; 333] =
    [{
         let mut init =
             clivalue_s{name:
...
unsafe extern "C" fn run_static_initializers() {
    ...
    valueTableEntryCount =
        (::core::mem::size_of::<[clivalue_t; 333]>() as
