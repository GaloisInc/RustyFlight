 ...
 -> libc::c_float {
    let mut RC: libc::c_float =
        1i32 as libc::c_float /
            (2i32 as libc::c_float * 3.14159265358979323846f32 *
...
pub unsafe extern "C" fn biquadFilterInit(mut filter: *mut biquadFilter_t,
    ...
    let mut b0: libc::c_float = 0i32 as libc::c_float;
    let mut b1: libc::c_float = 0i32 as libc::c_float;
    let mut b2: libc::c_float = 0i32 as libc::c_float;
    let mut a0: libc::c_float = 0i32 as libc::c_float;
    let mut a1: libc::c_float = 0i32 as libc::c_float;
    let mut a2: libc::c_float = 0i32 as libc::c_float;
    match filterType as libc::c_uint {
        0 => {
            // 2nd order Butterworth (with Q=1/sqrt(2)) / Butterworth biquad section with Q
        // described in http://www.ti.com/lit/an/slaa447/slaa447.pdf
            b0 = (1i32 as libc::c_float - cs) * 0.5f32;
            b1 = 1i32 as libc::c_float - cs;
            b2 = (1i32 as libc::c_float - cs) * 0.5f32;
            a0 = 1i32 as libc::c_float + alpha;
            a1 = -2i32 as libc::c_float * cs;
            a2 = 1i32 as libc::c_float - alpha
        }
        1 => {
            b0 = 1i32 as libc::c_float;
            b1 = -2i32 as libc::c_float * cs;
            b2 = 1i32 as libc::c_float;
            a0 = 1i32 as libc::c_float + alpha;
            a1 = -2i32 as libc::c_float * cs;
            a2 = 1i32 as libc::c_float - alpha
        }
    ...
    (*filter).x2 = 0i32 as libc::c_float;
    (*filter).x1 = (*filter).x2;
    (*filter).y2 = 0i32 as libc::c_float;
    (*filter).y1 = (*filter).y2;
}
#[no_mangle]
...
pub unsafe extern "C" fn laggedMovingAverageInit(mut filter:
                                                 ...
                                                 mut buf:
                                                     *mut libc::c_float) {
    (*filter).movingWindowIndex = 0i32 as uint16_t;
    (*filter).windowSize = windowSize;
    (*filter).buf = buf;
    (*filter).primed = 0i32 != 0;
}
#[no_mangle]
