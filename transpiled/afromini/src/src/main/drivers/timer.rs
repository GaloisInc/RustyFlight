...
#[no_mangle]
pub static mut timerChannelInfo: [timerChannelInfo_t; 17] =
    [timerChannelInfo_t{type_0: TYPE_FREE,}; 17];
#[no_mangle]
...
unsafe extern "C" fn lookupTimerIndex(mut tim: *const TIM_TypeDef)
 -> uint8_t {
    ...
    match tim as libc::c_uint >> 10i32 {
        1048651 => {
            return ((((1i32 << 1i32) - 1i32 &
                          (1i32 << 1i32 | 1i32 << 2i32 | 1i32 << 3i32 |
                               1i32 << 4i32 | 1i32 << 15i32 | 1i32 << 16i32 |
                               1i32 << 17i32)) -
                         (((1i32 << 1i32) - 1i32 &
                               (1i32 << 1i32 | 1i32 << 2i32 | 1i32 << 3i32 |
                                    1i32 << 4i32 | 1i32 << 15i32 |
                                    1i32 << 16i32 | 1i32 << 17i32)) >> 1i32 &
                              0x77777777i32) -
                         (((1i32 << 1i32) - 1i32 &
                               (1i32 << 1i32 | 1i32 << 2i32 | 1i32 << 3i32 |
                                    1i32 << 4i32 | 1i32 << 15i32 |
                                    1i32 << 16i32 | 1i32 << 17i32)) >> 2i32 &
                              0x33333333i32) -
                         (((1i32 << 1i32) - 1i32 &
                               (1i32 << 1i32 | 1i32 << 2i32 | 1i32 << 3i32 |
                                    1i32 << 4i32 | 1i32 << 15i32 |
                                    1i32 << 16i32 | 1i32 << 17i32)) >> 3i32 &
                              0x11111111i32) +
                         (((1i32 << 1i32) - 1i32 &
                               (1i32 << 1i32 | 1i32 << 2i32 | 1i32 << 3i32 |
                                    1i32 << 4i32 | 1i32 << 15i32 |
                              ...
                              (((1i32 << 1i32) - 1i32 &
                                    (1i32 << 1i32 | 1i32 << 2i32 |
                                         ...
                                         1i32 << 15i32 | 1i32 << 16i32 |
                                         1i32 << 17i32)) >> 3i32 &
                                   0x11111111i32) >> 4i32) & 0xf0f0f0fi32) %
                        255i32) as uint8_t
            // make sure final index is out of range
        }
        1048576 => {
            return ((((1i32 << 2i32) - 1i32 &
                          (1i32 << 1i32 | 1i32 << 2i32 | 1i32 << 3i32 |
                               1i32 << 4i32 | 1i32 << 15i32 | 1i32 << 16i32 |
                               1i32 << 17i32)) -
                         (((1i32 << 2i32) - 1i32 &
...
#[no_mangle]
pub static mut usedTimers: [*mut TIM_TypeDef; 7] =
    [0 as *const TIM_TypeDef as *mut TIM_TypeDef; 7];
// Map timer index to timer number (Straight copy of usedTimers array)
#[no_mangle]
pub static mut timerNumbers: [int8_t; 7] =
    [1i32 as int8_t, 2i32 as int8_t, 3i32 as int8_t, 4i32 as int8_t,
     15i32 as int8_t, 16i32 as int8_t, 17i32 as int8_t];
#[no_mangle]
pub unsafe extern "C" fn timerGetTIMNumber(mut tim: *const TIM_TypeDef)
 -> int8_t {
    ...
    if (index as libc::c_int) <
           ((1i32 << 1i32 | 1i32 << 2i32 | 1i32 << 3i32 | 1i32 << 4i32 |
                 1i32 << 15i32 | 1i32 << 16i32 | 1i32 << 17i32) -
                ((1i32 << 1i32 | 1i32 << 2i32 | 1i32 << 3i32 | 1i32 << 4i32 |
                      1i32 << 15i32 | 1i32 << 16i32 | 1i32 << 17i32) >> 1i32 &
                     0x77777777i32) -
                ((1i32 << 1i32 | 1i32 << 2i32 | 1i32 << 3i32 | 1i32 << 4i32 |
                      1i32 << 15i32 | 1i32 << 16i32 | 1i32 << 17i32) >> 2i32 &
                     0x33333333i32) -
                ((1i32 << 1i32 | 1i32 << 2i32 | 1i32 << 3i32 | 1i32 << 4i32 |
                      1i32 << 15i32 | 1i32 << 16i32 | 1i32 << 17i32) >> 3i32 &
                     0x11111111i32) +
                ((1i32 << 1i32 | 1i32 << 2i32 | 1i32 << 3i32 | 1i32 << 4i32 |
                      1i32 << 15i32 | 1i32 << 16i32 | 1i32 << 17i32) -
                     ((1i32 << 1i32 | 1i32 << 2i32 | 1i32 << 3i32 |
                           1i32 << 4i32 | 1i32 << 15i32 | 1i32 << 16i32 |
                           1i32 << 17i32) >> 1i32 & 0x77777777i32) -
                     ((1i32 << 1i32 | 1i32 << 2i32 | 1i32 << 3i32 |
                           1i32 << 4i32 | 1i32 << 15i32 | 1i32 << 16i32 |
                           1i32 << 17i32) >> 2i32 & 0x33333333i32) -
                     ((1i32 << 1i32 | 1i32 << 2i32 | 1i32 << 3i32 |
                           1i32 << 4i32 | 1i32 << 15i32 | 1i32 << 16i32 |
                           1i32 << 17i32) >> 3i32 & 0x11111111i32) >> 4i32) &
                0xf0f0f0fi32) % 255i32 {
        return timerNumbers[index as usize]
    } else { return 0i32 as int8_t };
}
#[inline]
unsafe extern "C" fn lookupChannelIndex(channel: uint16_t) -> uint8_t {
    return (channel as libc::c_int >> 2i32) as uint8_t;
}
#[no_mangle]
...
pub unsafe extern "C" fn timerRCC(mut tim: *mut TIM_TypeDef)
 -> rccPeriphTag_t {
    let mut i: libc::c_int = 0i32; // AKA TIMx_ARR
    while i < 10i32 {
...
pub unsafe extern "C" fn configTimeBase(mut tim: *mut TIM_TypeDef,
    ...
    TIM_TimeBaseStructure.TIM_Period =
        (period as libc::c_int - 1i32 & 0xffffi32) as uint32_t;
    // "The counter clock frequency (CK_CNT) is equal to f CK_PSC / (PSC[15:0] + 1)." - STM32F10x Reference Manual 14.4.11
    // Thus for 1Mhz: 72000000 / 1000000 = 72, 72 - 1 = 71 = TIM_Prescaler
    TIM_TimeBaseStructure.TIM_Prescaler =
        timerClock(tim).wrapping_div(hz).wrapping_sub(1i32 as libc::c_uint) as
            uint16_t;
...
pub unsafe extern "C" fn timerChInit(mut timHw: *const timerHardware_t,
    ...
    let mut channel: libc::c_uint =
        timHw.wrapping_offset_from(timerHardware.as_ptr()) as libc::c_long as
            libc::c_uint;
    if channel >= 17i32 as libc::c_uint { return }
           ...
           (((1i32 << 1i32 | 1i32 << 2i32 | 1i32 << 3i32 | 1i32 << 4i32 |
                 ...
                 ((1i32 << 1i32 | 1i32 << 2i32 | 1i32 << 3i32 | 1i32 << 4i32 |
                      ...
                      ((1i32 << 1i32 | 1i32 << 2i32 | 1i32 << 3i32 |
                            1i32 << 4i32 | 1i32 << 15i32 | 1i32 << 16i32 |
                            1i32 << 17i32) >> 3i32 & 0x11111111i32) >> 4i32) &
                 0xf0f0f0fi32) % 255i32) as libc::c_uint {
        return
    }
    if irqPriority < timerInfo[timer as usize].priority as libc::c_int {
        ...
        configTimeBase(usedTimers[timer as usize], 0i32 as uint16_t,
                       1i32 as uint32_t);
...
unsafe extern "C" fn timerChConfig_UpdateOverflow(mut cfg: *mut timerConfig_t,
    ...
    TIM_ITConfig(tim, 0x1i32 as uint16_t,
    ...
    if edgeCallback.is_null() {
        ...
        TIM_ITConfig((*timHw).tim,
                     ((0x2i32 as uint16_t as libc::c_int) <<
                          (*timHw).channel as libc::c_int / 4i32) as uint16_t,
                     DISABLE);
    }
    // setup callback info
...
pub unsafe extern "C" fn timerChConfigCallbacksDual(mut timHw:
    ...
    let mut chHi: uint16_t =
        ((*timHw).channel as libc::c_int | 0x4i32 as uint16_t as libc::c_int)
            as uint16_t;
    ...
    if edgeCallbackLo.is_null() {
        ...
        TIM_ITConfig((*timHw).tim,
                     ((0x2i32 as uint16_t as libc::c_int) <<
                          chLo as libc::c_int / 4i32) as uint16_t, DISABLE);
    }
    if edgeCallbackHi.is_null() {
        // disable irq before changing setting callback to NULL
        TIM_ITConfig((*timHw).tim,
                     ((0x2i32 as uint16_t as libc::c_int) <<
                          chHi as libc::c_int / 4i32) as uint16_t, DISABLE);
    }
    // setup callback info
    timerConfig[timerIndex as usize].edgeCallback[channelIndex as usize] =
        edgeCallbackLo;
    timerConfig[timerIndex as
                    usize].edgeCallback[(channelIndex as libc::c_int + 1i32)
                                            as usize] = edgeCallbackHi;
    timerConfig[timerIndex as usize].overflowCallback[channelIndex as usize] =
        overflowCallback;
    timerConfig[timerIndex as
    ...
    if !edgeCallbackLo.is_null() {
        TIM_ClearFlag((*timHw).tim,
                      ((0x2i32 as uint16_t as libc::c_int) <<
                           chLo as libc::c_int / 4i32) as uint16_t);
        TIM_ITConfig((*timHw).tim,
                     ((0x2i32 as uint16_t as libc::c_int) <<
                          chLo as libc::c_int / 4i32) as uint16_t, ENABLE);
    }
    if !edgeCallbackHi.is_null() {
        TIM_ClearFlag((*timHw).tim,
                      ((0x2i32 as uint16_t as libc::c_int) <<
                           chHi as libc::c_int / 4i32) as uint16_t);
        TIM_ITConfig((*timHw).tim,
                     ((0x2i32 as uint16_t as libc::c_int) <<
                          chHi as libc::c_int / 4i32) as uint16_t, ENABLE);
    }
    timerChConfig_UpdateOverflow(&mut *timerConfig.as_mut_ptr().offset(timerIndex
                                                                           as
                                                                           isize),
...
pub unsafe extern "C" fn timerChITConfigDualLo(mut timHw:
    ...
    TIM_ITConfig((*timHw).tim,
                 ((0x2i32 as uint16_t as libc::c_int) <<
                      ((*timHw).channel as libc::c_int &
                           !(0x4i32 as uint16_t as libc::c_int)) / 4i32) as
                     uint16_t, newState);
}
// enable or disable IRQ
#[no_mangle]
...
pub unsafe extern "C" fn timerChConfigGPIO(mut timHw: *const timerHardware_t,
                                           mut mode: ioConfig_t) {
    IOInit(IOGetByTag((*timHw).tag), OWNER_TIMER, 0i32 as uint8_t);
...
unsafe extern "C" fn getFilter(mut ticks: libc::c_uint) -> libc::c_uint {
    static mut ftab: [libc::c_uint; 16] =
        [(1i32 * 1i32) as libc::c_uint, (1i32 * 2i32) as libc::c_uint,
         (1i32 * 4i32) as libc::c_uint, (1i32 * 8i32) as libc::c_uint,
         (2i32 * 6i32) as libc::c_uint, (2i32 * 8i32) as libc::c_uint,
         (4i32 * 6i32) as libc::c_uint, (4i32 * 8i32) as libc::c_uint,
         (8i32 * 6i32) as libc::c_uint, (8i32 * 8i32) as libc::c_uint,
         (16i32 * 5i32) as libc::c_uint, (16i32 * 6i32) as libc::c_uint,
         (16i32 * 8i32) as libc::c_uint, (32i32 * 5i32) as libc::c_uint,
         (32i32 * 6i32) as libc::c_uint, (32i32 * 8i32) as libc::c_uint];
    ...
    while (i as libc::c_ulong) <
        ...
        if ftab[i as usize] > ticks {
            return i.wrapping_sub(1i32 as libc::c_uint)
        }
        i = i.wrapping_add(1)
    }
    return 0xfi32 as libc::c_uint;
}
...
pub unsafe extern "C" fn timerChConfigIC(mut timHw: *const timerHardware_t,
    ...
    TIM_ICInitStructure.TIM_ICPolarity =
        ...
        } else { 0x2i32 as uint16_t as libc::c_int } as uint16_t;
    TIM_ICInitStructure.TIM_ICSelection = 0x1i32 as uint16_t;
    TIM_ICInitStructure.TIM_ICPrescaler = 0i32 as uint16_t;
...
pub unsafe extern "C" fn timerChConfigICDual(mut timHw:
    ...
    let mut directRising: bool =
        if (*timHw).channel as libc::c_int & 0x4i32 as uint16_t as libc::c_int
               != 0 {
    ...
    TIM_ICInitStructure.TIM_Channel =
        ((*timHw).channel as libc::c_int ^ 0x4i32 as uint16_t as libc::c_int)
            as uint16_t; // get opposite channel no
    TIM_ICInitStructure.TIM_ICPolarity =
        if directRising as libc::c_int != 0 {
            0x2i32 as uint16_t as libc::c_int
        } else { 0i32 as uint16_t as libc::c_int } as uint16_t;
    TIM_ICInitStructure.TIM_ICSelection = 0x2i32 as uint16_t;
    TIM_ICInit((*timHw).tim, &mut TIM_ICInitStructure);
}
#[no_mangle]
pub unsafe extern "C" fn timerChICPolarity(mut timHw: *const timerHardware_t,
    ...
    tmpccer &= !((0x2i32 as uint32_t) << (*timHw).channel as libc::c_int);
    tmpccer |=
        if polarityRising as libc::c_int != 0 {
            ((0i32 as uint16_t as libc::c_int)) <<
                (*timHw).channel as libc::c_int
...
pub unsafe extern "C" fn timerChConfigOC(mut timHw: *const timerHardware_t,
    ...
    if outEnable {
        TIM_OCInitStructure.TIM_OCMode = 0x20i32 as uint32_t;
    ...
    } else { TIM_OCInitStructure.TIM_OCMode = 0i32 as uint32_t }
    match (*timHw).channel as libc::c_int {
        0 => {
            TIM_OC1Init((*timHw).tim, &mut TIM_OCInitStructure);
            TIM_OC1PreloadConfig((*timHw).tim, 0i32 as uint16_t);
        }
        4 => {
            TIM_OC2Init((*timHw).tim, &mut TIM_OCInitStructure);
            TIM_OC2PreloadConfig((*timHw).tim, 0i32 as uint16_t);
        }
        8 => {
            TIM_OC3Init((*timHw).tim, &mut TIM_OCInitStructure);
            TIM_OC3PreloadConfig((*timHw).tim, 0i32 as uint16_t);
        }
        12 => {
            TIM_OC4Init((*timHw).tim, &mut TIM_OCInitStructure);
            TIM_OC4PreloadConfig((*timHw).tim, 0i32 as uint16_t);
        }
        _ => { }
    };
}
unsafe extern "C" fn timCCxHandler(mut tim: *mut TIM_TypeDef,
    ...
    while tim_status != 0 {
        ...
        let mut mask: libc::c_uint = !(0x80000000u32 >> bit);
        ...
        match bit {
            31 => {
                if (*timerConfig_0).forcedOverflowTimerValue !=
                       0i32 as libc::c_uint {
                    capture =
                        (*timerConfig_0).forcedOverflowTimerValue.wrapping_sub(1i32
                                                                                   as
                                                                                   libc::c_uint)
                            as uint16_t;
            ...
            30 => {
                (*(*timerConfig_0).edgeCallback[0]).fn_0.expect("non-null function pointer")((*timerConfig_0).edgeCallback[0],
                                                                                             (*tim).CCR1
                                                                                                 as
                                                                                                 uint16_t);
            }
            29 => {
                (*(*timerConfig_0).edgeCallback[1]).fn_0.expect("non-null function pointer")((*timerConfig_0).edgeCallback[1],
                                                                                             (*tim).CCR2
                                                                                                 as
                                                                                                 uint16_t);
            }
            28 => {
                (*(*timerConfig_0).edgeCallback[2]).fn_0.expect("non-null function pointer")((*timerConfig_0).edgeCallback[2],
                                                                                             (*tim).CCR3
                                                                                                 as
                                                                                                 uint16_t);
            }
            27 => {
                (*(*timerConfig_0).edgeCallback[3]).fn_0.expect("non-null function pointer")((*timerConfig_0).edgeCallback[3],
                                                                                             (*tim).CCR4
                                                                                                 as
                                                                                                 uint16_t);
            }
...
pub unsafe extern "C" fn TIM1_CC_IRQHandler() {
    timCCxHandler((0x40000000i32 as
                       uint32_t).wrapping_add(0x10000i32 as
                                                  libc::c_uint).wrapping_add(0x2c00i32
                                                                                 as
                                                                                 libc::c_uint)
                      as *mut TIM_TypeDef,
                  &mut *timerConfig.as_mut_ptr().offset(((((1i32 << 1i32) -
                                                               1i32 &
                                                               (1i32 << 1i32 |
                                                                    1i32 <<
                                                                        2i32 |
    ...
    timCCxHandler((0x40000000i32 as
                       uint32_t).wrapping_add(0x10000i32 as
                                                  libc::c_uint).wrapping_add(0x4400i32
                                                                                 ...
                                                                                 libc::c_uint)
                      as *mut TIM_TypeDef,
                  &mut *timerConfig.as_mut_ptr().offset(((((1i32 << 16i32) -
                                                               1i32 &
                                                               (1i32 << 1i32 |
                                                                    1i32 <<
                                                                        2i32 |
...
pub unsafe extern "C" fn TIM2_IRQHandler() {
    timCCxHandler((0x40000000i32 as
                      ...
                      *mut TIM_TypeDef,
                  &mut *timerConfig.as_mut_ptr().offset(((((1i32 << 2i32) -
                                                               1i32 &
                                                               (1i32 << 1i32 |
                                                                    1i32 <<
                                                                        2i32 |
...
pub unsafe extern "C" fn TIM3_IRQHandler() {
    timCCxHandler((0x40000000i32 as
                      ...
                      *mut TIM_TypeDef,
                  &mut *timerConfig.as_mut_ptr().offset(((((1i32 << 3i32) -
                                                               1i32 &
                                                               (1i32 << 1i32 |
                                                                    1i32 <<
                                                                        2i32 |
...
pub unsafe extern "C" fn TIM4_IRQHandler() {
    timCCxHandler((0x40000000i32 as
                      ...
                      *mut TIM_TypeDef,
                  &mut *timerConfig.as_mut_ptr().offset(((((1i32 << 4i32) -
                                                               1i32 &
                                                               (1i32 << 1i32 |
                                                                    1i32 <<
                                                                        2i32 |
    ...
    timCCxHandler((0x40000000i32 as
                       uint32_t).wrapping_add(0x10000i32 as
                                                  libc::c_uint).wrapping_add(0x4000i32
                                                                                 ...
                                                                                 libc::c_uint)
                      as *mut TIM_TypeDef,
                  &mut *timerConfig.as_mut_ptr().offset(((((1i32 << 15i32) -
                                                               1i32 &
                                                               (1i32 << 1i32 |
                                                                    1i32 <<
                                                                        2i32 |
...
#[no_mangle]
pub unsafe extern "C" fn TIM1_TRG_COM_TIM17_IRQHandler() {
    timCCxHandler((0x40000000i32 as
                       uint32_t).wrapping_add(0x10000i32 as
                                                  libc::c_uint).wrapping_add(0x4800i32
                                                                                 ...
                                                                                 libc::c_uint)
                      as *mut TIM_TypeDef,
                  &mut *timerConfig.as_mut_ptr().offset(((((1i32 << 17i32) -
                                                               1i32 &
                                                               (1i32 << 1i32 |
                                                                    1i32 <<
                                                                        2i32 |
...
pub unsafe extern "C" fn timerInit() {
    memset(timerConfig.as_mut_ptr() as *mut libc::c_void, 0i32,
    ...
    let mut timerIndex: libc::c_uint = 0i32 as libc::c_uint;
    while timerIndex < 17i32 as libc::c_uint {
    ...
    while i_0 < 17i32 as libc::c_uint {
              ...
              (((1i32 << 1i32 | 1i32 << 2i32 | 1i32 << 3i32 | 1i32 << 4i32 |
                    ...
                    ((1i32 << 1i32 | 1i32 << 2i32 | 1i32 << 3i32 |
                         ...
                         ((1i32 << 1i32 | 1i32 << 2i32 | 1i32 << 3i32 |
                               1i32 << 4i32 | 1i32 << 15i32 | 1i32 << 16i32 |
                               1i32 << 17i32) >> 3i32 & 0x11111111i32) >>
                         4i32) & 0xf0f0f0fi32) % 255i32) as libc::c_uint {
        timerInfo[i_1 as usize].priority = !0i32 as uint8_t;
...
pub unsafe extern "C" fn timerForceOverflow(mut tim: *mut TIM_TypeDef) {
    ...
    while __ToDo != 0 {
        ...
        timerConfig[timerIndex as usize].forcedOverflowTimerValue =
            (*tim).CNT.wrapping_add(1i32 as libc::c_uint);
        ...
        ::core::ptr::write_volatile(&mut (*tim).EGR as *mut uint32_t,
                                    (::core::ptr::read_volatile::<uint32_t>(&(*tim).EGR
                                                                                ...
                                                                                *const uint32_t)
                                         as libc::c_uint |
                                         0x1i32 as uint16_t as libc::c_uint)
...
pub unsafe extern "C" fn timerDmaSource(mut channel: uint8_t) -> uint16_t {
    match channel as libc::c_int {
        0 => { return 0x200i32 as uint16_t }
        4 => { return 0x400i32 as uint16_t }
        8 => { return 0x800i32 as uint16_t }
        12 => { return 0x1000i32 as uint16_t }
        _ => { }
    }
...
pub unsafe extern "C" fn timerGetPeriodByPrescaler(mut tim: *mut TIM_TypeDef,
                                                   ...
                                                   mut hz: uint32_t)
 -> uint16_t {
    return timerClock(tim).wrapping_div((prescaler as libc::c_int + 1i32) as
...
pub unsafe extern "C" fn timerGetPrescalerByDesiredHertz(mut tim:
 ...
 -> uint16_t {
    ...
    if hz > timerClock(tim) { return 0i32 as uint16_t }
    return (timerClock(tim).wrapping_add(hz.wrapping_div(2i32 as
                                                             libc::c_uint)).wrapping_div(hz)
                as uint16_t as libc::c_int - 1i32) as uint16_t;
}
        ...
        [(0x40000000i32 as
              uint32_t).wrapping_add(0x10000i32 as
                                         libc::c_uint).wrapping_add(0x2c00i32
                                                                        ...
                                                                        libc::c_uint)
             as *mut TIM_TypeDef,
         (0x40000000i32 as uint32_t).wrapping_add(0i32 as libc::c_uint) as
             *mut TIM_TypeDef,
         (0x40000000i32 as uint32_t).wrapping_add(0x400i32 as libc::c_uint) as
             *mut TIM_TypeDef,
         (0x40000000i32 as uint32_t).wrapping_add(0x800i32 as libc::c_uint) as
             *mut TIM_TypeDef,
         (0x40000000i32 as
              uint32_t).wrapping_add(0x10000i32 as
                                         libc::c_uint).wrapping_add(0x4000i32
