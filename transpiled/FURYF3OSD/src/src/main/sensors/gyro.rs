...
unsafe extern "C" fn gyroDetect(mut dev: *mut gyroDev_t) -> gyroSensor_e {
    ...
    match gyroHardware as libc::c_uint {
        1 | 6 => {
            ...
            } else { current_block_19 = 13116890281527953803; }
        }
        7 | 9 | 10 | 11 => { current_block_19 = 13116890281527953803; }
        13 => { current_block_19 = 5381297608968995174; }
        _ => { current_block_19 = 7679224362344455344; }
    }
    match current_block_19 {
        13116890281527953803 => {
            if mpu6500GyroDetect(dev) as libc::c_int != 0 ||
                ...
                current_block_19 = 8704759739624374314;
            } else { current_block_19 = 5381297608968995174; }
        }
        _ => { }
    }
    match current_block_19 {
        5381297608968995174 => {
            if icm20689SpiGyroDetect(dev) {
                ...
                (*dev).gyroAlign = CW180_DEG;
                current_block_19 = 8704759739624374314;
            } else { current_block_19 = 7679224362344455344; }
        }
        _ => { }
    }
    match current_block_19 {
        7679224362344455344 => { gyroHardware = GYRO_NONE }
        _ => { }
    }
