...
pub unsafe extern "C" fn blackboxFinish() {
    ...
    match blackboxState as libc::c_uint {
        ...
        10 | 9 => {
            ...
            current_block_3 = 11733110709953722034;
        }
        _ => { current_block_3 = 11733110709953722034; }
    }
    match current_block_3 {
        11733110709953722034 => {
...
unsafe extern "C" fn blackboxGetStartDateTime(mut buf: *mut libc::c_char)
 -> *mut libc::c_char {
    buf =
        b"0000-01-01T00:00:00.000\x00" as *const u8 as *const libc::c_char as
            *mut libc::c_char;
    return buf;
}
/* *
