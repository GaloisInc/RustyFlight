...
pub const FRSKY_VFAS_PRECISION_HIGH: C2RustUnnamed_1 = 1;
pub const FRSKY_VFAS_PRECISION_LOW: C2RustUnnamed_1 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
...
#[no_mangle]
pub static mut lookupTables: [lookupTableEntry_t; 25] =
    [lookupTableEntry_t{values: 0 as *const *const libc::c_char,
                        valueCount: 0,}; 25];
#[no_mangle]
pub static mut valueTable: [clivalue_t; 193] =
    [{
         let mut init =
             clivalue_s{name:
...
unsafe extern "C" fn run_static_initializers() {
    ...
    valueTableEntryCount =
        (::core::mem::size_of::<[clivalue_t; 193]>() as
