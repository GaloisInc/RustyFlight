...
unsafe extern "C" fn gyroDetect(mut dev: *mut gyroDev_t) -> gyroSensor_e {
    ...
    match gyroHardware as libc::c_uint {
        1 | 6 => {
            ...
            } else { current_block_15 = 7313372418977344583; }
        }
        7 | 9 | 10 | 11 => { current_block_15 = 7313372418977344583; }
        _ => { current_block_15 = 14497649454555770874; }
    }
    match current_block_15 {
        7313372418977344583 => {
            if mpu6500GyroDetect(dev) as libc::c_int != 0 ||
                ...
                (*dev).gyroAlign = CW270_DEG;
                current_block_15 = 14763689060501151050;
            } else { current_block_15 = 14497649454555770874; }
        }
        _ => { }
    }
    match current_block_15 {
        14497649454555770874 => { gyroHardware = GYRO_NONE }
        _ => { }
    }
