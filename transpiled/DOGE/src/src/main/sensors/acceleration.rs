    ...
    loop  {
        ...
        match accHardwareToUse as libc::c_uint {
            0 | 7 => {
                ...
                } else { current_block_15 = 4430710693022035025; }
            }
            8 | 10 | 11 | 12 => { current_block_15 = 4430710693022035025; }
            1 | _ => { current_block_15 = 15985561811352476301; }
        }
        match current_block_15 {
            4430710693022035025 => {
                if mpu6500AccDetect(dev) as libc::c_int != 0 ||
                    ...
                    current_block_15 = 15345278821338558188;
                } else { current_block_15 = 15985561811352476301; }
            }
            _ => { }
        }
        match current_block_15 {
            15985561811352476301 => {
                // disable ACC
