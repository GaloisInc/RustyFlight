...
pub unsafe extern "C" fn initRcProcessing() {
    ...
    match (*rxConfig()).rcInterpolationChannels as libc::c_int {
        2 => {
            ...
            current_block_22 = 17915723760883356422;
        }
        1 => { current_block_22 = 17915723760883356422; }
        0 => { current_block_22 = 1599364584035205390; }
        4 => {
            interpolationChannels =
                (interpolationChannels as libc::c_int |
                     (ROLL_FLAG as libc::c_int | PITCH_FLAG as libc::c_int))
                    as uint8_t;
            current_block_22 = 1194332198938067867;
        }
        3 => { current_block_22 = 1194332198938067867; }
        _ => { current_block_22 = 5689316957504528238; }
    }
    match current_block_22 {
        17915723760883356422 => {
            interpolationChannels =
                (interpolationChannels as libc::c_int |
                     YAW_FLAG as libc::c_int) as uint8_t;
            current_block_22 = 1599364584035205390;
        }
        1194332198938067867 => {
            interpolationChannels =
                (interpolationChannels as libc::c_int |
