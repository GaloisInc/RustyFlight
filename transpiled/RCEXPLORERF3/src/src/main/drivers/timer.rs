...
#[no_mangle]
pub static mut timerChannelInfo: [timerChannelInfo_t; 7] =
    [timerChannelInfo_t{type_0: TYPE_FREE,}; 7];
#[no_mangle]
...
pub static mut timerNumbers: [int8_t; 4] =
    [1 as libc::c_int as int8_t, 2 as libc::c_int as int8_t,
     3 as libc::c_int as int8_t, 17 as libc::c_int as int8_t];
#[no_mangle]
...
pub unsafe extern "C" fn timerChInit(mut timHw: *const timerHardware_t,
    ...
    let mut channel: libc::c_uint =
        timHw.wrapping_offset_from(timerHardware.as_ptr()) as libc::c_long as
            libc::c_uint;
    if channel >= 7 as libc::c_int as libc::c_uint { return }
...
pub unsafe extern "C" fn timerInit() {
    ...
    while timerIndex < 7 as libc::c_int as libc::c_uint {
    ...
    while i_0 < 7 as libc::c_int as libc::c_uint {
