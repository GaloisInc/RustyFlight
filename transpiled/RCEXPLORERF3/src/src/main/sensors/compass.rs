...
pub unsafe extern "C" fn compassDetect(mut dev: *mut magDev_t) -> bool {
    ...
    match (*compassConfig()).mag_hardware as libc::c_int {
        0 | 2 => {
            ...
            } else { current_block_28 = 5994951606885230396; }
        }
        5 | 3 => { current_block_28 = 5994951606885230396; }
        4 | 1 => { current_block_28 = 15274472712294785679; }
    ...
    match current_block_28 {
        5994951606885230396 => {
            ...
            if ak8975Detect(dev) {
                ...
                current_block_28 = 7659304154607701039;
            } else { current_block_28 = 15274472712294785679; }
        }
        _ => { }
    }
    match current_block_28 {
        15274472712294785679 => { magHardware = MAG_NONE }
        _ => { }
    }
