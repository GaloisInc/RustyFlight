 ...
 -> bool {
    ...
    match baroHardware as libc::c_uint {
        0 | 2 | 3 => {
            ...
            } else { current_block_22 = 2804054684600424018; }
        }
        5 | 4 => { current_block_22 = 2804054684600424018; }
        6 | 1 => { current_block_22 = 7496146604568314438; }
    ...
    match current_block_22 {
        2804054684600424018 => {
            if bmp280Detect(dev) {
                ...
                current_block_22 = 1538046216550696469;
            } else { current_block_22 = 7496146604568314438; }
        }
        _ => { }
    }
    match current_block_22 {
