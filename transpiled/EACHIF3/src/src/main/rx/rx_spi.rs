 ...
 */
    ...
    #[no_mangle]
    fn flySkyInit(rxConfig: *const rxSpiConfig_s,
                  rxRuntimeConfig: *mut rxRuntimeConfig_s) -> bool;
    #[no_mangle]
    fn flySkySetRcDataFromPayload(rcData: *mut uint16_t,
                                  payload: *const uint8_t);
    #[no_mangle]
    fn flySkyDataReceived(payload: *mut uint8_t) -> rx_spi_received_e;
}
