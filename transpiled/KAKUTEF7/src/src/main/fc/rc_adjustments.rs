 ...
 -> libc::c_int {
    ...
    match adjustmentFunction as libc::c_int {
        1 | 25 => {
            ...
            } else { current_block_82 = 15081854813182891140; }
        }
        26 => { current_block_82 = 15081854813182891140; }
        2 | 27 => {
            newValue =
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 = 15447629348493591490;
            } else { current_block_82 = 10344325682565458692; }
        }
        28 => { current_block_82 = 10344325682565458692; }
        3 => {
            newValue =
        ...
        4 | 13 => {
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 = 15447629348493591490;
            } else { current_block_82 = 15860762930971098467; }
        }
        14 => { current_block_82 = 15860762930971098467; }
        5 => {
            newValue =
        ...
        6 | 15 => {
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 =
                    12064988696825172920; // FIXME magic numbers repeated in cli.c
            }
        }
        18 => { current_block_82 = 12064988696825172920; }
        7 | 16 => {
            newValue =
                constrain((*pidProfile).pid[PID_PITCH as libc::c_int as
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 =
                    3798389028432214594; // FIXME magic numbers repeated in cli.c
            }
        }
        19 => { current_block_82 = 3798389028432214594; }
        8 | 17 => {
            newValue =
                constrain((*pidProfile).pid[PID_PITCH as libc::c_int as
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 =
                    12062328661353973328; // FIXME magic numbers repeated in cli.c
            }
        }
        20 => {
            current_block_82 =
        ...
        22 | 30 => {
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 = 15447629348493591490;
            } else { current_block_82 = 11488365770885166050; }
        }
        31 => { current_block_82 = 11488365770885166050; }
        32 => {
            newValue =
 ...
 -> libc::c_int {
    ...
    match adjustmentFunction as libc::c_uint {
        1 | 25 => {
            ...
            } else { current_block_84 = 878534170763167826; }
        }
        26 => { current_block_84 = 878534170763167826; }
        2 | 27 => {
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                current_block_84 = 5265702136860997526;
            } else { current_block_84 = 12665871423917090251; }
        }
        28 => { current_block_84 = 12665871423917090251; }
        3 => {
            newValue = constrain(value, 0 as libc::c_int, 100 as libc::c_int);
            (*controlRateConfig).thrExpo8 = newValue as uint8_t;
            initRcProcessing();
        ...
        4 | 13 => {
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                current_block_84 = 5265702136860997526;
            } else { current_block_84 = 886928516155046653; }
        }
        14 => { current_block_84 = 886928516155046653; }
        5 => {
            newValue = constrain(value, 0 as libc::c_int, 255 as libc::c_int);
            (*controlRateConfig).rates[FD_YAW as libc::c_int as usize] =
                newValue as uint8_t;
        ...
        6 | 15 => {
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                // fall through for combined ADJUSTMENT_PITCH_ROLL_P
                current_block_84 =
                    12132559049519647463; // FIXME magic numbers repeated in cli.c
            }
        }
        18 => { current_block_84 = 12132559049519647463; }
        7 | 16 => {
            newValue = constrain(value, 0 as libc::c_int, 200 as libc::c_int);
            (*pidProfile).pid[PID_PITCH as libc::c_int as usize].I =
                newValue as uint8_t;
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                // fall through for combined ADJUSTMENT_PITCH_ROLL_I
                current_block_84 =
                    10675543179088812703; // FIXME magic numbers repeated in cli.c
            }
        }
        19 => { current_block_84 = 10675543179088812703; }
        8 | 17 => {
            newValue = constrain(value, 0 as libc::c_int, 200 as libc::c_int);
            (*pidProfile).pid[PID_PITCH as libc::c_int as usize].D =
                newValue as uint8_t;
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                // fall through for combined ADJUSTMENT_PITCH_ROLL_D
                current_block_84 =
                    4343963603030380271; // FIXME magic numbers repeated in cli.c
            }
        }
        20 => {
            current_block_84 =
        ...
        22 | 30 => {
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                current_block_84 = 5265702136860997526;
            } else { current_block_84 = 10717366180807105477; }
        }
        31 => { current_block_84 = 10717366180807105477; }
        32 => {
            newValue =
                constrain(value, 0 as libc::c_int, 2000 as libc::c_int);
            (*pidProfile).pid[PID_YAW as libc::c_int as usize].F =
    ...
    match current_block_84 {
        ...
        10675543179088812703 => {
            newValue = constrain(value, 0 as libc::c_int, 200 as libc::c_int);
            (*pidProfile).pid[PID_ROLL as libc::c_int as usize].I =
                newValue as uint8_t;
            blackboxLogInflightAdjustmentEvent(ADJUSTMENT_ROLL_I, newValue);
        }
        12132559049519647463 => {
            newValue = constrain(value, 0 as libc::c_int, 200 as libc::c_int);
            (*pidProfile).pid[PID_ROLL as libc::c_int as usize].P =
                newValue as uint8_t;
            blackboxLogInflightAdjustmentEvent(ADJUSTMENT_ROLL_P, newValue);
