...
pub const DMA2_ST5_HANDLER: C2RustUnnamed_0 = 14;
pub const DMA2_ST6_HANDLER: C2RustUnnamed_0 = 15;
pub const DMA2_ST2_HANDLER: C2RustUnnamed_0 = 11;
pub const DMA1_ST7_HANDLER: C2RustUnnamed_0 = 8;
pub const DMA1_ST1_HANDLER: C2RustUnnamed_0 = 2;
pub const DMA1_ST6_HANDLER: C2RustUnnamed_0 = 7;
pub const DMA1_ST2_HANDLER: C2RustUnnamed_0 = 3;
pub const DMA1_ST3_HANDLER: C2RustUnnamed_0 = 4;
pub const DMA1_ST0_HANDLER: C2RustUnnamed_0 = 1;
pub const DMA2_ST1_HANDLER: C2RustUnnamed_0 = 10;
pub const DMA2_ST3_HANDLER: C2RustUnnamed_0 = 12;
pub const DMA2_ST7_HANDLER: C2RustUnnamed_0 = 16;
pub const DMA2_ST4_HANDLER: C2RustUnnamed_0 = 13;
pub type C2RustUnnamed_0 = libc::c_uint;
pub const DMA_LAST_HANDLER: C2RustUnnamed_0 = 16;
pub const DMA2_ST0_HANDLER: C2RustUnnamed_0 = 9;
pub const DMA1_ST5_HANDLER: C2RustUnnamed_0 = 6;
pub const DMA1_ST4_HANDLER: C2RustUnnamed_0 = 5;
...
#[no_mangle]
pub static mut timerHardware: [timerHardware_t; 16] =
        ...
        [{
             let mut init =
                 timerHardware_s{tim:
                                 ...
                                 dmaRef: 0 as *mut DMA_Stream_TypeDef,
                                 dmaChannel: 0 as libc::c_uint,
                                 dmaIrqHandler: 0 as libc::c_int as uint8_t,
                                 dmaTimUPRef: 0 as *mut DMA_Stream_TypeDef,
                                 dmaTimUPChannel: 0 as libc::c_uint,
                                 dmaTimUPIrqHandler:
                                     0 as libc::c_int as uint8_t,};
             init
         },
         ...
         },
         {
             let mut init =
                 timerHardware_s{tim:
                                 ...
                                 dmaIrqHandler:
                                     DMA2_ST4_HANDLER as libc::c_int as
                                         uint8_t,
                                 dmaTimUPRef:
                                     (0x40000000 as
                                          libc::c_uint).wrapping_add(0x20000
                                          ...
                                          libc::c_uint).wrapping_add(0x20000
                                                                         ...
                                                                         libc::c_uint).wrapping_add(0x6000
                                                                                                        ...
                                                                                                        libc::c_uint).wrapping_add(0xa0
                                                                                                                                       ...
                                                                                                                                       libc::c_uint)
                                         as *mut DMA_Stream_TypeDef,
                                 dmaChannel: 0x6000000 as libc::c_uint,
                                 dmaIrqHandler:
                                     DMA1_ST6_HANDLER as libc::c_int as
                                         uint8_t,
                                 dmaTimUPRef:
                                          ...
                                          libc::c_uint).wrapping_add(0x20000
                                                                         ...
                                                                         libc::c_uint).wrapping_add(0x6000
                                                                                                        ...
                                                                                                        libc::c_uint).wrapping_add(0xb8
                                                                                                                                       ...
                                                                                                                                       libc::c_uint)
                                         as *mut DMA_Stream_TypeDef,
                                 dmaTimUPChannel: 0x6000000 as libc::c_uint,
                                 dmaTimUPIrqHandler:
                                     DMA1_ST7_HANDLER as libc::c_int as
                                         uint8_t,};
             init
                 ...
                 timerHardware_s{tim:
                                 ...
                                 tag:
                                     ((0 as libc::c_int + 1 as libc::c_int) <<
                                         ...
                                         as ioTag_t,
                                 channel: 0 as libc::c_uint as uint8_t,
                                 usageFlags: TIM_USE_TRANSPONDER,
                                 output:
                                     (TIMER_OUTPUT_NONE as libc::c_int |
                                          0 as libc::c_int) as uint8_t,
                                 alternateFunction:
