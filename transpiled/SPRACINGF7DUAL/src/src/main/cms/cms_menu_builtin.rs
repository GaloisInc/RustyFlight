 ...
 */
    #[no_mangle]
    static mut cmsx_menuOsd: CMS_Menu;
    /*
 * This file is part of Cleanflight and Betaflight.
 *
 * Cleanflight and Betaflight are free software. You can redistribute
 ...
 */
    #[no_mangle]
    static mut cmsx_menuVtxRTC6705: CMS_Menu;
    /*
 * This file is part of Cleanflight and Betaflight.
 *
 * Cleanflight and Betaflight are free software. You can redistribute
...
static mut infoTargetName: [libc::c_char; 15] =
    [83, 80, 82, 65, 67, 73, 78, 71, 70, 55, 68, 85, 65, 76, 0];
...
// Features
static mut menuFeaturesEntries: [OSD_Entry; 9] =
    unsafe {
        [{
             let mut init =
                 OSD_Entry{text:
                           ...
                           func:
                               Some(cmsMenuChange as
                                        unsafe extern "C" fn(_:
                                            ...
                                            -> libc::c_long),
                           data:
                               &cmsx_menuVtxRTC6705 as *const CMS_Menu as
                                   *mut CMS_Menu as *mut libc::c_void,
                           flags: 0 as libc::c_int as uint8_t,};
             init
         },
...
// Main
static mut menuMainEntries: [OSD_Entry; 10] =
    unsafe {
        [{
             let mut init =
                 OSD_Entry{text:
                           ...
                           func:
                               Some(cmsMenuChange as
                                        unsafe extern "C" fn(_:
                                            ...
                                            -> libc::c_long),
                           data:
                               &cmsx_menuOsd as *const CMS_Menu as
                                   *mut CMS_Menu as *mut libc::c_void,
                           flags: 0 as libc::c_int as uint8_t,};
             init
         },
