             ...
             box_s{boxId: BOXANTIGRAVITY as libc::c_int as uint8_t,
                   boxName:
                       b"ANTI GRAVITY\x00" as *const u8 as
                           *const libc::c_char,
                   permanentId: 4 as libc::c_int as uint8_t,};
         init
     },
     {
         let mut init =
     ...
     },
     {
         let mut init =
             box_s{boxId: BOXAIRMODE as libc::c_int as uint8_t,
                   ...
                   permanentId: 28 as libc::c_int as uint8_t,};
         init
     },
     {
         let mut init =
             box_s{boxId: BOX3D as libc::c_int as uint8_t,
                   boxName:
                       b"DISABLE / SWITCH 3D\x00" as *const u8 as
                           *const libc::c_char,
                   permanentId: 29 as libc::c_int as uint8_t,};
         init
     },
     {
         let mut init =
             box_s{boxId: BOXFPVANGLEMIX as libc::c_int as uint8_t,
                   boxName:
                       b"FPV ANGLE MIX\x00" as *const u8 as
                           *const libc::c_char,
                   permanentId: 30 as libc::c_int as uint8_t,};
         init
     },
     {
         let mut init =
             box_s{boxId: BOXBLACKBOXERASE as libc::c_int as uint8_t,
                   boxName:
                       b"BLACKBOX ERASE (>30s)\x00" as *const u8 as
                           *const libc::c_char,
                   permanentId: 31 as libc::c_int as uint8_t,};
         init
     },
     {
         let mut init =
             box_s{boxId: BOXCAMERA1 as libc::c_int as uint8_t,
                   boxName:
                       b"CAMERA CONTROL 1\x00" as *const u8 as
                           *const libc::c_char,
                   permanentId: 32 as libc::c_int as uint8_t,};
         init
     },
     {
         let mut init =
             box_s{boxId: BOXCAMERA2 as libc::c_int as uint8_t,
                   boxName:
                       b"CAMERA CONTROL 2\x00" as *const u8 as
                           *const libc::c_char,
                   permanentId: 33 as libc::c_int as uint8_t,};
         init
     },
     {
         let mut init =
             box_s{boxId: BOXCAMERA3 as libc::c_int as uint8_t,
                   boxName:
                       b"CAMERA CONTROL 3\x00" as *const u8 as
                           *const libc::c_char,
                   permanentId: 34 as libc::c_int as uint8_t,};
         init
     },
     {
         let mut init =
             box_s{boxId: BOXFLIPOVERAFTERCRASH as libc::c_int as uint8_t,
                   boxName:
                       b"FLIP OVER AFTER CRASH\x00" as *const u8 as
                           *const libc::c_char,
                   permanentId: 35 as libc::c_int as uint8_t,};
         init
     },
     {
         let mut init =
             box_s{boxId: BOXPREARM as libc::c_int as uint8_t,
                   ...
                   permanentId: 36 as libc::c_int as uint8_t,};
         init
     },
     {
         let mut init =
             box_s{boxId: BOXBEEPGPSCOUNT as libc::c_int as uint8_t,
                   boxName:
                       b"BEEP GPS SATELLITE COUNT\x00" as *const u8 as
                           *const libc::c_char,
                   permanentId: 37 as libc::c_int as uint8_t,};
         init
     },
     {
         let mut init =
             box_s{boxId: BOXVTXPITMODE as libc::c_int as uint8_t,
                   boxName:
                       b"VTX PIT MODE\x00" as *const u8 as
                           *const libc::c_char,
                   permanentId: 39 as libc::c_int as uint8_t,};
         init
     },
     {
         let mut init =
             box_s{boxId: BOXUSER1 as libc::c_int as uint8_t,
                   ...
                   permanentId: 40 as libc::c_int as uint8_t,};
         init
     },
     {
         let mut init =
             box_s{boxId: BOXUSER2 as libc::c_int as uint8_t,
                   ...
                   permanentId: 41 as libc::c_int as uint8_t,};
         init
     },
     {
         let mut init =
             box_s{boxId: BOXUSER3 as libc::c_int as uint8_t,
                   ...
                   permanentId: 42 as libc::c_int as uint8_t,};
         init
     },
     {
         let mut init =
             box_s{boxId: BOXUSER4 as libc::c_int as uint8_t,
                   ...
                   permanentId: 43 as libc::c_int as uint8_t,};
         init
     },
     {
         let mut init =
             box_s{boxId: BOXPIDAUDIO as libc::c_int as uint8_t,
                   ...
                   permanentId: 44 as libc::c_int as uint8_t,};
         init
     },
     {
         let mut init =
             box_s{boxId: BOXPARALYZE as libc::c_int as uint8_t,
                   ...
                   permanentId: 45 as libc::c_int as uint8_t,};
         init
     },
     {
         let mut init =
             box_s{boxId: BOXGPSRESCUE as libc::c_int as uint8_t,
                   ...
                   permanentId: 46 as libc::c_int as uint8_t,};
         init
     },
     {
         let mut init =
             box_s{boxId: BOXACROTRAINER as libc::c_int as uint8_t,
                   boxName:
                       b"ACRO TRAINER\x00" as *const u8 as
                           *const libc::c_char,
                   permanentId: 47 as libc::c_int as uint8_t,};
         init
     }];
...
unsafe extern "C" fn activeBoxIdGet(mut boxId: boxId_e) -> bool {
    if boxId as libc::c_ulong >
           (::core::mem::size_of::<boxBitmask_t>() as
                libc::c_ulong).wrapping_mul(8 as libc::c_int as libc::c_ulong)
       {
...
pub unsafe extern "C" fn serializeBoxReply(mut dst: *mut sbuf_t,
                                           mut page: libc::c_int,
                                           mut serializeBox:
                                               Option<serializeBoxFn>) {
    let mut boxIdx: libc::c_uint = 0 as libc::c_int as libc::c_uint;
    let mut pageStart: libc::c_uint =
        (page * 32 as libc::c_int) as libc::c_uint;
    let mut pageEnd: libc::c_uint =
        pageStart.wrapping_add(32 as libc::c_int as libc::c_uint);
...
pub unsafe extern "C" fn initActiveBoxIds() {
    ...
    memset(&mut ena as *mut boxBitmask_t as *mut libc::c_void,
           0 as libc::c_int,
    ...
    if feature(FEATURE_GPS as libc::c_int as uint32_t) {
        if !feature(FEATURE_3D as libc::c_int as uint32_t) {
            bitArraySet(&mut ena as *mut boxBitmask_t as *mut libc::c_void,
                        BOXGPSRESCUE as libc::c_int as libc::c_uint);
        }
        bitArraySet(&mut ena as *mut boxBitmask_t as *mut libc::c_void,
                    BOXBEEPGPSCOUNT as libc::c_int as libc::c_uint);
    }
    bitArraySet(&mut ena as *mut boxBitmask_t as *mut libc::c_void,
    ...
    bitArraySet(&mut ena as *mut boxBitmask_t as *mut libc::c_void,
                BOXPIDAUDIO as libc::c_int as libc::c_uint);
    if sensors(SENSOR_ACC as libc::c_int as uint32_t) {
        bitArraySet(&mut ena as *mut boxBitmask_t as *mut libc::c_void,
...
pub unsafe extern "C" fn getBoxIdState(mut boxid: boxId_e) -> bool {
    let boxIdToFlightModeMap: [uint8_t; 11] =
        [0,
         ((32 as libc::c_int *
               (ANGLE_MODE as libc::c_int as libc::c_long / 2 as libc::c_long
                    >> 31 as libc::c_int > 0 as libc::c_int as libc::c_long)
              ...
              ((16 as libc::c_int *
                    (ANGLE_MODE as libc::c_int as libc::c_long *
                         ...
                         16 as libc::c_int *
                             (ANGLE_MODE as libc::c_int as libc::c_long /
                                  2 as libc::c_long >> 31 as libc::c_int >
                         ...
                         16 as libc::c_int *
                             (ANGLE_MODE as libc::c_int as libc::c_long /
                                  2 as libc::c_long >> 31 as libc::c_int >
                                  0 as libc::c_int as libc::c_long) as
                                 libc::c_int > 65535 as libc::c_long) as
                                       ...
                                       16 as libc::c_int *
                                           (ANGLE_MODE as libc::c_int as
                                                ...
                                                0 as libc::c_int as
                                                    libc::c_long) as
                                               libc::c_int >
                                       65535 as libc::c_long) as libc::c_int >
         ...
         ((32 as libc::c_int *
             ...
             uint8_t,
         ((32 as libc::c_int *
               (MAG_MODE as libc::c_int as libc::c_long / 2 as libc::c_long >>
                    31 as libc::c_int > 0 as libc::c_int as libc::c_long) as
                   libc::c_int) as libc::c_long +
              ((16 as libc::c_int *
             ...
             uint8_t,
         ((32 as libc::c_int *
               (BARO_MODE as libc::c_int as libc::c_long / 2 as libc::c_long
                    >> 31 as libc::c_int > 0 as libc::c_int as libc::c_long)
                   as libc::c_int) as libc::c_long +
              ((16 as libc::c_int *
    ...
    if boxid as libc::c_uint == BOXARM as libc::c_int as libc::c_uint {
        ...
        return flightModeFlags as libc::c_int &
                   (1 as libc::c_int) <<
                       boxIdToFlightModeMap[boxid as usize] as libc::c_int !=
                   0
...
pub unsafe extern "C" fn packFlightModeFlags(mut mspFlightModeFlags:
 ...
 -> libc::c_int {
    ...
    memset(mspFlightModeFlags as *mut libc::c_void, 0 as libc::c_int,
           ::core::mem::size_of::<boxBitmask_t>() as libc::c_ulong);
