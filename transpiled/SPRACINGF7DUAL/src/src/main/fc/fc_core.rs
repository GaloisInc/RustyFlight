 ...
 */
    ...
    fn writeServos();
    #[no_mangle]
    static mut gpsRescueConfig_System: gpsRescueConfig_t;
}
...
pub const DSHOT_CMD_SPIN_DIRECTION_NORMAL: C2RustUnnamed_9 = 20;
pub const ARMED: C2RustUnnamed_6 = 1;
pub const ARMING_DELAYED_DISARMED: C2RustUnnamed_12 = 0;
...
pub const DSHOT_CMD_SPIN_DIRECTION_REVERSED: C2RustUnnamed_9 = 21;
pub const ARMING_DELAYED_CRASHFLIP: C2RustUnnamed_12 = 2;
pub const ARMING_DELAYED_NORMAL: C2RustUnnamed_12 = 1;
...
pub const GPS_FIX_HOME: C2RustUnnamed_7 = 1;
...
pub const SMALL_ANGLE: C2RustUnnamed_7 = 8;
...
pub const FAILSAFE_PROCEDURE_GPS_RESCUE: C2RustUnnamed_8 = 2;
// latitude * 1e+7
// longitude * 1e+7
// altitude in 0.01m
...
pub const PID_MAG: C2RustUnnamed_10 = 4;
...
pub const CALIBRATE_MAG: C2RustUnnamed_7 = 4;
pub type C2RustUnnamed_8 = libc::c_uint;
pub const FAILSAFE_PROCEDURE_DROP_IT: C2RustUnnamed_8 = 1;
pub const FAILSAFE_PROCEDURE_AUTO_LANDING: C2RustUnnamed_8 = 0;
pub type C2RustUnnamed_9 = libc::c_uint;
pub const DSHOT_CMD_MAX: C2RustUnnamed_9 = 47;
pub const DSHOT_CMD_SILENT_MODE_ON_OFF: C2RustUnnamed_9 = 31;
pub const DSHOT_CMD_AUDIO_STREAM_MODE_ON_OFF: C2RustUnnamed_9 = 30;
pub const DSHOT_CMD_LED3_OFF: C2RustUnnamed_9 = 29;
pub const DSHOT_CMD_LED2_OFF: C2RustUnnamed_9 = 28;
pub const DSHOT_CMD_LED1_OFF: C2RustUnnamed_9 = 27;
pub const DSHOT_CMD_LED0_OFF: C2RustUnnamed_9 = 26;
pub const DSHOT_CMD_LED3_ON: C2RustUnnamed_9 = 25;
pub const DSHOT_CMD_LED2_ON: C2RustUnnamed_9 = 24;
pub const DSHOT_CMD_LED1_ON: C2RustUnnamed_9 = 23;
pub const DSHOT_CMD_LED0_ON: C2RustUnnamed_9 = 22;
pub const DSHOT_CMD_SAVE_SETTINGS: C2RustUnnamed_9 = 12;
pub const DSHOT_CMD_SETTINGS_REQUEST: C2RustUnnamed_9 = 11;
pub const DSHOT_CMD_3D_MODE_ON: C2RustUnnamed_9 = 10;
pub const DSHOT_CMD_3D_MODE_OFF: C2RustUnnamed_9 = 9;
pub const DSHOT_CMD_SPIN_DIRECTION_2: C2RustUnnamed_9 = 8;
pub const DSHOT_CMD_SPIN_DIRECTION_1: C2RustUnnamed_9 = 7;
pub const DSHOT_CMD_ESC_INFO: C2RustUnnamed_9 = 6;
pub const DSHOT_CMD_BEACON5: C2RustUnnamed_9 = 5;
pub const DSHOT_CMD_BEACON4: C2RustUnnamed_9 = 4;
pub const DSHOT_CMD_BEACON3: C2RustUnnamed_9 = 3;
pub const DSHOT_CMD_BEACON2: C2RustUnnamed_9 = 2;
pub const DSHOT_CMD_BEACON1: C2RustUnnamed_9 = 1;
pub const DSHOT_CMD_MOTOR_STOP: C2RustUnnamed_9 = 0;
...
pub const PID_ITEM_COUNT: C2RustUnnamed_10 = 5;
pub const PID_LEVEL: C2RustUnnamed_10 = 3;
pub const PID_YAW: C2RustUnnamed_10 = 2;
pub const PID_PITCH: C2RustUnnamed_10 = 1;
pub const PID_ROLL: C2RustUnnamed_10 = 0;
...
pub const INPUT_SOURCE_COUNT: C2RustUnnamed_11 = 14;
pub const INPUT_GIMBAL_ROLL: C2RustUnnamed_11 = 13;
pub const INPUT_GIMBAL_PITCH: C2RustUnnamed_11 = 12;
pub const INPUT_RC_AUX4: C2RustUnnamed_11 = 11;
pub const INPUT_RC_AUX3: C2RustUnnamed_11 = 10;
pub const INPUT_RC_AUX2: C2RustUnnamed_11 = 9;
pub const INPUT_RC_AUX1: C2RustUnnamed_11 = 8;
pub const INPUT_RC_THROTTLE: C2RustUnnamed_11 = 7;
pub const INPUT_RC_YAW: C2RustUnnamed_11 = 6;
pub const INPUT_RC_PITCH: C2RustUnnamed_11 = 5;
pub const INPUT_RC_ROLL: C2RustUnnamed_11 = 4;
pub const INPUT_STABILIZED_THROTTLE: C2RustUnnamed_11 = 3;
pub const INPUT_STABILIZED_YAW: C2RustUnnamed_11 = 2;
pub const INPUT_STABILIZED_PITCH: C2RustUnnamed_11 = 1;
pub const INPUT_STABILIZED_ROLL: C2RustUnnamed_11 = 0;
...
#[no_mangle]
pub static mut inputSource_e: C2RustUnnamed_11 = INPUT_STABILIZED_ROLL;
#[inline]
...
pub unsafe extern "C" fn updateArmingStatus() {
    if armingFlags as libc::c_int & ARMED as libc::c_int != 0 {
        ...
        if isModeActivationConditionPresent(BOXGPSRESCUE) {
            if (*gpsRescueConfig()).minSats == 0 ||
                   stateFlags as libc::c_int & GPS_FIX_HOME as libc::c_int !=
                       0 ||
                   armingFlags as libc::c_int & WAS_EVER_ARMED as libc::c_int
                       != 0 {
                unsetArmingDisabled(ARMING_DISABLED_GPS);
            } else { setArmingDisabled(ARMING_DISABLED_GPS); }
        }
...
#[no_mangle]
pub unsafe extern "C" fn updateMagHold() {
    if ({
...
unsafe extern "C" fn canUpdateVTX() -> bool { return vtxRTC6705CanUpdate(); }
...
pub unsafe extern "C" fn processRx(mut currentTimeUs: timeUs_t) -> bool {
    ...
    if IS_RC_MODE_ACTIVE(BOXGPSRESCUE) as libc::c_int != 0 ||
           failsafeIsActive() as libc::c_int != 0 &&
               (*failsafeConfig()).failsafe_procedure as libc::c_int ==
                   FAILSAFE_PROCEDURE_GPS_RESCUE as libc::c_int {
        if flightModeFlags as libc::c_int & GPS_RESCUE_MODE as libc::c_int ==
               0 {
            enableFlightMode(GPS_RESCUE_MODE);
        }
    } else { disableFlightMode(GPS_RESCUE_MODE); }
    if flightModeFlags as libc::c_int & ANGLE_MODE as libc::c_int != 0 ||
...
unsafe extern "C" fn subTaskPidController(mut currentTimeUs: timeUs_t) {
    ...
    if isModeActivationConditionPresent(BOXPIDAUDIO) { pidAudioUpdate(); };
}
#[inline(never)]
unsafe extern "C" fn subTaskPidSubprocesses(mut currentTimeUs: timeUs_t) {
    ...
    if sensors(SENSOR_MAG as libc::c_int as uint32_t) { updateMagHold(); }
