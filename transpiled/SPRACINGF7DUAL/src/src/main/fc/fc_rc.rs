 ...
 */
    ...
    fn imuQuaternionHeadfreeTransformVectorEarthToBody(v:
                                                           *mut t_fp_vector_def);
    #[no_mangle]
    fn gpsRescueGetYawRate() -> libc::c_float;
    #[no_mangle]
...
unsafe extern "C" fn calculateSetpointRate(mut axis: libc::c_int) {
    ...
    if axis == FD_YAW as libc::c_int &&
        ...
        rcDeflection[axis as usize] = 0 as libc::c_int as libc::c_float;
        rcDeflectionAbs[axis as usize] = 0 as libc::c_int as libc::c_float
    } else {
...
pub unsafe extern "C" fn initRcProcessing() {
    ...
    match (*rxConfig()).rcInterpolationChannels as libc::c_int {
        2 => {
            ...
            current_block_22 = 13991627470345970972;
        }
        1 => { current_block_22 = 13991627470345970972; }
        0 => { current_block_22 = 6731630467879035050; }
        4 => {
            interpolationChannels =
                (interpolationChannels as libc::c_int |
                     (ROLL_FLAG as libc::c_int | PITCH_FLAG as libc::c_int))
                    as uint8_t;
            current_block_22 = 5158330972010679547;
        }
        3 => { current_block_22 = 5158330972010679547; }
        _ => { current_block_22 = 5689316957504528238; }
    }
    match current_block_22 {
        13991627470345970972 => {
            interpolationChannels =
                (interpolationChannels as libc::c_int |
                     YAW_FLAG as libc::c_int) as uint8_t;
            current_block_22 = 6731630467879035050;
        }
        5158330972010679547 => {
            interpolationChannels =
                (interpolationChannels as libc::c_int |
