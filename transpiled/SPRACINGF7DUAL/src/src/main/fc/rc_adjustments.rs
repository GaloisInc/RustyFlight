...
extern "C" {
    ...
    #[no_mangle]
    fn pidAudioGetMode() -> pidAudioModes_e;
    #[no_mangle]
    fn pidAudioSetMode(mode: pidAudioModes_e);
    #[no_mangle]
...
static mut adjustmentLabels: [*const libc::c_char; 32] =
    [b"RC RATE\x00" as *const u8 as *const libc::c_char,
     b"RC EXPO\x00" as *const u8 as *const libc::c_char,
     b"THROTTLE EXPO\x00" as *const u8 as *const libc::c_char,
     b"ROLL RATE\x00" as *const u8 as *const libc::c_char,
     b"YAW RATE\x00" as *const u8 as *const libc::c_char,
     b"PITCH/ROLL P\x00" as *const u8 as *const libc::c_char,
     b"PITCH/ROLL I\x00" as *const u8 as *const libc::c_char,
     b"PITCH/ROLL D\x00" as *const u8 as *const libc::c_char,
     b"YAW P\x00" as *const u8 as *const libc::c_char,
     b"YAW I\x00" as *const u8 as *const libc::c_char,
     b"YAW D\x00" as *const u8 as *const libc::c_char,
     b"RATE PROFILE\x00" as *const u8 as *const libc::c_char,
     b"PITCH RATE\x00" as *const u8 as *const libc::c_char,
     b"ROLL RATE\x00" as *const u8 as *const libc::c_char,
     b"PITCH P\x00" as *const u8 as *const libc::c_char,
     b"PITCH I\x00" as *const u8 as *const libc::c_char,
     b"PITCH D\x00" as *const u8 as *const libc::c_char,
     b"ROLL P\x00" as *const u8 as *const libc::c_char,
     b"ROLL I\x00" as *const u8 as *const libc::c_char,
     b"ROLL D\x00" as *const u8 as *const libc::c_char,
     b"RC RATE YAW\x00" as *const u8 as *const libc::c_char,
     b"PITCH/ROLL F\x00" as *const u8 as *const libc::c_char,
     b"FF TRANSITION\x00" as *const u8 as *const libc::c_char,
     b"HORIZON STRENGTH\x00" as *const u8 as *const libc::c_char,
     b"ROLL RC RATE\x00" as *const u8 as *const libc::c_char,
     b"PITCH RC RATE\x00" as *const u8 as *const libc::c_char,
     b"ROLL RC EXPO\x00" as *const u8 as *const libc::c_char,
     b"PITCH RC EXPO\x00" as *const u8 as *const libc::c_char,
     b"PID AUDIO\x00" as *const u8 as *const libc::c_char,
     b"PITCH F\x00" as *const u8 as *const libc::c_char,
     b"ROLL F\x00" as *const u8 as *const libc::c_char,
     b"YAW F\x00" as *const u8 as *const libc::c_char];
static mut adjustmentRangeNameIndex: libc::c_int = 0 as libc::c_int;
static mut adjustmentRangeValue: libc::c_int = -(1 as libc::c_int);
 ...
 -> libc::c_int {
    ...
    match adjustmentFunction as libc::c_int {
        1 | 25 => {
            ...
            } else { current_block_82 = 4107515373945892782; }
        }
        26 => { current_block_82 = 4107515373945892782; }
        2 | 27 => {
            newValue =
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 = 15447629348493591490;
            } else { current_block_82 = 16954902497165895845; }
        }
        28 => { current_block_82 = 16954902497165895845; }
        3 => {
            newValue =
        ...
        4 | 13 => {
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 = 15447629348493591490;
            } else { current_block_82 = 7589532838286807934; }
        }
        14 => { current_block_82 = 7589532838286807934; }
        5 => {
            newValue =
        ...
        6 | 15 => {
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 =
                    18349387451874334763; // FIXME magic numbers repeated in cli.c
            }
        }
        18 => { current_block_82 = 18349387451874334763; }
        7 | 16 => {
            newValue =
                constrain((*pidProfile).pid[PID_PITCH as libc::c_int as
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 =
                    2792375729730895464; // FIXME magic numbers repeated in cli.c
            }
        }
        19 => { current_block_82 = 2792375729730895464; }
        8 | 17 => {
            newValue =
                constrain((*pidProfile).pid[PID_PITCH as libc::c_int as
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 =
                    17727593705299502337; // FIXME magic numbers repeated in cli.c
            }
        }
        20 => {
            current_block_82 =
        ...
        22 | 30 => {
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 = 15447629348493591490;
            } else { current_block_82 = 14150969447535714108; }
        }
        31 => { current_block_82 = 14150969447535714108; }
        32 => {
            newValue =
 ...
 -> libc::c_int {
    ...
    match adjustmentFunction as libc::c_uint {
        1 | 25 => {
            ...
            } else { current_block_84 = 7646423785929600408; }
        }
        26 => { current_block_84 = 7646423785929600408; }
        2 | 27 => {
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                current_block_84 = 5265702136860997526;
            } else { current_block_84 = 2318274865904222187; }
        }
        28 => { current_block_84 = 2318274865904222187; }
        3 => {
            newValue = constrain(value, 0 as libc::c_int, 100 as libc::c_int);
            (*controlRateConfig).thrExpo8 = newValue as uint8_t;
            initRcProcessing();
        ...
        4 | 13 => {
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                current_block_84 = 5265702136860997526;
            } else { current_block_84 = 9961778104126966262; }
        }
        14 => { current_block_84 = 9961778104126966262; }
        5 => {
            newValue = constrain(value, 0 as libc::c_int, 255 as libc::c_int);
            (*controlRateConfig).rates[FD_YAW as libc::c_int as usize] =
                newValue as uint8_t;
        ...
        6 | 15 => {
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                // fall through for combined ADJUSTMENT_PITCH_ROLL_P
                current_block_84 =
                    11771197771985168922; // FIXME magic numbers repeated in cli.c
            }
        }
        18 => { current_block_84 = 11771197771985168922; }
        7 | 16 => {
            newValue = constrain(value, 0 as libc::c_int, 200 as libc::c_int);
            (*pidProfile).pid[PID_PITCH as libc::c_int as usize].I =
                newValue as uint8_t;
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                // fall through for combined ADJUSTMENT_PITCH_ROLL_I
                current_block_84 =
                    11203474414833709065; // FIXME magic numbers repeated in cli.c
            }
        }
        19 => { current_block_84 = 11203474414833709065; }
        8 | 17 => {
            newValue = constrain(value, 0 as libc::c_int, 200 as libc::c_int);
            (*pidProfile).pid[PID_PITCH as libc::c_int as usize].D =
                newValue as uint8_t;
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                // fall through for combined ADJUSTMENT_PITCH_ROLL_D
                current_block_84 =
                    842917942818245415; // FIXME magic numbers repeated in cli.c
            }
        }
        20 => {
            current_block_84 =
        ...
        22 | 30 => {
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                current_block_84 = 5265702136860997526;
            } else { current_block_84 = 2440161341920791720; }
        }
        31 => { current_block_84 = 2440161341920791720; }
        32 => {
            newValue =
                constrain(value, 0 as libc::c_int, 2000 as libc::c_int);
            (*pidProfile).pid[PID_YAW as libc::c_int as usize].F =
    ...
    match current_block_84 {
        ...
        11203474414833709065 => {
            newValue = constrain(value, 0 as libc::c_int, 200 as libc::c_int);
            (*pidProfile).pid[PID_ROLL as libc::c_int as usize].I =
                newValue as uint8_t;
            blackboxLogInflightAdjustmentEvent(ADJUSTMENT_ROLL_I, newValue);
        }
        11771197771985168922 => {
            newValue = constrain(value, 0 as libc::c_int, 200 as libc::c_int);
            (*pidProfile).pid[PID_ROLL as libc::c_int as usize].P =
                newValue as uint8_t;
            blackboxLogInflightAdjustmentEvent(ADJUSTMENT_ROLL_P, newValue);
...
unsafe extern "C" fn applySelectAdjustment(mut adjustmentFunction:
    ...
    match adjustmentFunction as libc::c_uint {
        ...
        29 => {
            let mut newMode: pidAudioModes_e =
                pidAudioPositionToModeMap[position as usize] as
                    pidAudioModes_e;
            if newMode as libc::c_uint != pidAudioGetMode() as libc::c_uint {
                ...
                if cmp32(now, (*adjustmentState).timeoutAt) >=
                    ...
                    adjustmentStateMask =
                        (adjustmentStateMask as libc::c_int &
                            ...
                            uint8_t;
                    adjustmentRangeValue = -(1 as libc::c_int)
                }
                if canUseRxData {
                        ...
                        if rcData[channelIndex as usize] as libc::c_int >
                            ...
                            delta =
                                (*(*adjustmentState).config).data.step as
                                    libc::c_int;
                            current_block_23 = 13472856163611868459;
                        ...
                        match current_block_23 {
                            ...
                            _ => {
                                if adjustmentStateMask as libc::c_int &
                                    ...
                                    current_block_23 = 17184638872671510253;
                                }
                            }
                        }
                    } else {
                    ...
                    match current_block_23 {
                        ...
                        _ => {
                            if newValue != -(1 as libc::c_int) &&
                                   (*(*adjustmentState).config).adjustmentFunction
                                       as libc::c_uint !=
                                       ADJUSTMENT_RATE_PROFILE as libc::c_int
                                           as libc::c_uint {
                                // Rate profile already has an OSD element
                                adjustmentRangeNameIndex =
                                    adjustmentFunction as libc::c_int;
...
#[no_mangle]
pub unsafe extern "C" fn getAdjustmentsRangeName() -> *const libc::c_char {
    if adjustmentRangeNameIndex > 0 as libc::c_int {
        return &*(*adjustmentLabels.as_ptr().offset((adjustmentRangeNameIndex
                                                         - 1 as libc::c_int)
                                                        as
                                                        isize)).offset(0 as
                                                                           libc::c_int
...
#[no_mangle]
pub unsafe extern "C" fn getAdjustmentsRangeValue() -> libc::c_int {
