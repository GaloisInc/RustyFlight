 ...
 */
    // OLED at address 0x3C in 7bit
    #[no_mangle]
    fn dashboardDisablePageCycling();
    #[no_mangle]
...
pub unsafe extern "C" fn processRcStickPositions() {
    ...
    if rcSticks as libc::c_int ==
           ((1 as libc::c_int) << 2 as libc::c_int * THROTTLE as libc::c_int)
               + ((3 as libc::c_int) << 2 as libc::c_int * YAW as libc::c_int)
               +
               ((2 as libc::c_int) << 2 as libc::c_int * PITCH as libc::c_int)
               +
               ((1 as libc::c_int) << 2 as libc::c_int * ROLL as libc::c_int)
       {
    ...
    if rcSticks as libc::c_int ==
           ((2 as libc::c_int) << 2 as libc::c_int * THROTTLE as libc::c_int)
               + ((1 as libc::c_int) << 2 as libc::c_int * YAW as libc::c_int)
               +
               ((3 as libc::c_int) << 2 as libc::c_int * PITCH as libc::c_int)
               +
               ((2 as libc::c_int) << 2 as libc::c_int * ROLL as libc::c_int)
       {
        vtxIncrementBand();
    ...
    if rcSticks as libc::c_int ==
           ((3 as libc::c_int) << 2 as libc::c_int * THROTTLE as libc::c_int)
               + ((2 as libc::c_int) << 2 as libc::c_int * YAW as libc::c_int)
               +
               ((3 as libc::c_int) << 2 as libc::c_int * PITCH as libc::c_int)
               +
               ((3 as libc::c_int) << 2 as libc::c_int * ROLL as libc::c_int)
       {
        ...
        rcDelayMs =
            (rcDelayMs as libc::c_int - 3 as libc::c_int * 50 as libc::c_int)
                as int16_t;
        doNotRepeat = 0 as libc::c_int != 0
    } else if rcSticks as libc::c_int ==
                  ((3 as libc::c_int) <<
        ...
        doNotRepeat = 0 as libc::c_int != 0
                  ...
                  ((1 as libc::c_int) <<
                      ...
                      ((3 as libc::c_int) <<
                           2 as libc::c_int * ROLL as libc::c_int) {
        cameraControlKeyPress(CAMERA_CONTROL_KEY_UP,
                              2000 as libc::c_int as uint32_t);
    };
}
#[no_mangle]
