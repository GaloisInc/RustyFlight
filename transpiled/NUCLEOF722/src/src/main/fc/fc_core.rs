...
pub const TASK_SELF: cfTaskId_e = 27;
pub const TASK_NONE: cfTaskId_e = 26;
pub const TASK_COUNT: cfTaskId_e = 26;
pub const TASK_PINIOBOX: cfTaskId_e = 25;
pub const TASK_ADC_INTERNAL: cfTaskId_e = 24;
...
pub const TASK_DASHBOARD: cfTaskId_e = 15;
