...
static mut srxlTelemetryNow: bool = 0 as libc::c_int != 0;
...
unsafe extern "C" fn srxlInitializeFrame(mut dst: *mut sbuf_t) {
    ...
    sbufWriteU8(dst, 0xa5 as libc::c_int as uint8_t);
    sbufWriteU8(dst, 0x80 as libc::c_int as uint8_t);
    sbufWriteU8(dst, 0x15 as libc::c_int as uint8_t);
}
unsafe extern "C" fn srxlFinalize(mut dst: *mut sbuf_t) {
    crc16_ccitt_sbuf_append(dst,
                            &mut *srxlFrame.as_mut_ptr().offset(3 as
                                                                    libc::c_int
                                                                    as
                                                                    isize));
...
pub unsafe extern "C" fn srxlFrameQos(mut dst: *mut sbuf_t,
    ...
    sbufWriteU8(dst, 0x7f as libc::c_int as uint8_t); // pulse leading edges
    sbufWriteU8(dst, 0 as libc::c_int as uint8_t); // vbat is in units of 0.1V
    sbufFill(dst, 0xff as libc::c_int as uint8_t,
             14 as libc::c_int); // temperature
    return 1 as libc::c_int != 0;
}
#[no_mangle]
pub unsafe extern "C" fn srxlFrameRpm(mut dst: *mut sbuf_t,
                                      mut currentTimeUs: timeUs_t) -> bool {
    sbufWriteU8(dst, 0x7e as libc::c_int as uint8_t);
    sbufWriteU8(dst, 0 as libc::c_int as uint8_t);
    sbufWriteU16BigEndian(dst, 0xffff as libc::c_int as uint16_t);
    sbufWriteU16BigEndian(dst,
                          (getBatteryVoltage() as libc::c_int *
                               10 as libc::c_int) as uint16_t);
    sbufWriteU16BigEndian(dst, 0x7fff as libc::c_int as uint16_t);
    sbufFill(dst, 0xff as libc::c_int as uint8_t, 8 as libc::c_int);
    return 1 as libc::c_int != 0;
}
// 2s
#[no_mangle]
pub unsafe extern "C" fn srxlFrameFlightPackCurrent(mut dst: *mut sbuf_t,
                                                    mut currentTimeUs:
                                                        timeUs_t) -> bool {
    let mut amps: uint16_t =
        (getAmperage() / 10 as libc::c_int) as uint16_t; // temp A
    ...
    static mut lastTimeSentFPmAh: timeUs_t = 0 as libc::c_int as timeUs_t;
    ...
    if amps as libc::c_int != sentAmps as libc::c_int ||
           ...
           keepAlive > 2000000 as libc::c_int as libc::c_uint {
        sbufWriteU8(dst, 0x34 as libc::c_int as uint8_t);
        sbufWriteU8(dst, 0 as libc::c_int as uint8_t);
        sbufWriteU16(dst, amps);
        sbufWriteU16(dst, mah);
        sbufWriteU16(dst, 0x7fff as libc::c_int as uint16_t);
        sbufWriteU16(dst, 0x7fff as libc::c_int as uint16_t);
        sbufWriteU16(dst, 0x7fff as libc::c_int as uint16_t);
        sbufWriteU16(dst, 0x7fff as libc::c_int as uint16_t);
        sbufWriteU16(dst, 0xffff as libc::c_int as uint16_t);
        sentAmps = amps;
        sentMah = mah;
...
pub unsafe extern "C" fn spektrumTmTextGenPutChar(mut col: uint8_t,
                                                  ...
                                                  mut c: libc::c_char)
 -> libc::c_int {
    if (row as libc::c_int) < 9 as libc::c_int &&
           (col as libc::c_int) < 12 as libc::c_int {
        ...
        if srxlTextBuff[row as usize][col as usize] as libc::c_int !=
            ...
            lineSent[row as usize] = 0 as libc::c_int != 0
        }
    }
...
pub unsafe extern "C" fn srxlFrameText(mut dst: *mut sbuf_t,
                                       mut currentTimeUs: timeUs_t) -> bool {
    static mut lineNo: uint8_t = 0 as libc::c_int as uint8_t;
    let mut lineCount: libc::c_int = 0 as libc::c_int;
    // Skip already sent lines...
    while lineSent[lineNo as usize] as libc::c_int != 0 &&
              lineCount < 9 as libc::c_int {
        lineNo =
            ((lineNo as libc::c_int + 1 as libc::c_int) % 9 as libc::c_int) as
                uint8_t;
        lineCount += 1
    }
    sbufWriteU8(dst, 0xc as libc::c_int as uint8_t);
    sbufWriteU8(dst, 0 as libc::c_int as uint8_t);
    sbufWriteU8(dst, lineNo);
    sbufWriteData(dst,
                  srxlTextBuff[lineNo as usize].as_mut_ptr() as
                      *const libc::c_void, 13 as libc::c_int);
    lineSent[lineNo as usize] = 1 as libc::c_int != 0;
    lineNo =
        ((lineNo as libc::c_int + 1 as libc::c_int) % 9 as libc::c_int) as
            uint8_t;
    ...
    if vtxDevice.is_null() ||
           !(vtxCommonGetBandAndChannel(vtxDevice, &mut (*vtx).band,
                 ...
                 vtxCommonGetPowerIndex(vtxDevice, &mut (*vtx).power) as
                     libc::c_int != 0) {
        (*vtx).band = 0 as libc::c_int as uint8_t;
        (*vtx).channel = 0 as libc::c_int as uint8_t;
        (*vtx).power = 0 as libc::c_int as uint8_t;
        (*vtx).pitMode = 0 as libc::c_int as uint8_t
    }
    (*vtx).powerValue = 0 as libc::c_int as uint16_t;
    (*vtx).region = 0xff as libc::c_int as uint8_t;
}
...
unsafe extern "C" fn convertVtxPower(mut vtx: *mut spektrumVtx_t) {
    ...
    match vtxDeviceType as libc::c_int {
        4 => {
            powerIndexTable = vtxTrampPi.as_ptr();
            (*vtx).powerValue =
                trampPowerTable[((*vtx).power as libc::c_int -
        ...
        1 => {
            powerIndexTable = vtxRTC6705Pi.as_ptr();
            // No power value table available.Hard code some "knowledge" here. Doh.
            (*vtx).powerValue =
                if (*vtx).power as libc::c_int == 2 as libc::c_int {
                    200 as libc::c_int
                } else { 25 as libc::c_int } as uint16_t
        }
        255 | 0 | _ => { }
...
unsafe extern "C" fn srxlFrameVTX(mut dst: *mut sbuf_t,
                                  mut currentTimeUs: timeUs_t) -> bool {
    static mut lastTimeSentVtx: timeUs_t = 0 as libc::c_int as timeUs_t;
    ...
    if vtxDeviceType as libc::c_int != VTXDEV_UNKNOWN as libc::c_int &&
        ...
        if memcmp(&mut vtxSent as *mut spektrumVtx_t as *const libc::c_void,
               ...
               currentTimeUs.wrapping_sub(lastTimeSentVtx) >
                   2000000 as libc::c_int as libc::c_uint {
            // Fill in the VTX tm structure
            sbufWriteU8(dst, 0xd as libc::c_int as uint8_t);
            sbufWriteU8(dst, 0 as libc::c_int as uint8_t);
            ...
            sbufFill(dst, 0xff as libc::c_int as uint8_t, 7 as libc::c_int);
...
unsafe extern "C" fn processSrxl(mut currentTimeUs: timeUs_t) {
    static mut srxlScheduleIndex: uint8_t = 0 as libc::c_int as uint8_t;
    static mut srxlScheduleUserIndex: uint8_t = 0 as libc::c_int as uint8_t;
    ...
    if (srxlScheduleIndex as libc::c_int) < 2 as libc::c_int {
        ...
        srxlScheduleUserIndex =
            ((srxlScheduleUserIndex as libc::c_int + 1 as libc::c_int) %
                 (1 as libc::c_int + 1 as libc::c_int + 1 as libc::c_int)) as
                uint8_t;
    ...
    srxlScheduleIndex =
        ((srxlScheduleIndex as libc::c_int + 1 as libc::c_int) %
...
pub unsafe extern "C" fn handleSrxlTelemetry(mut currentTimeUs: timeUs_t) {
    ...
    srxlTelemetryNow = 0 as libc::c_int != 0;
