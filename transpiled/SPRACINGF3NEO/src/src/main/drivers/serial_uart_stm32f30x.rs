...
#[no_mangle]
pub static mut uartHardware: [uartHardware_t; 5] =
         ...
         },
         {
             let mut init =
                 uartHardware_s{device: UARTDEV_4,
                                reg:
                                    (0x40000000 as libc::c_int as
                                         uint32_t).wrapping_add(0x4c00 as
                                                                    libc::c_int
                                                                    as
                                                                    libc::c_uint)
                                        as *mut USART_TypeDef,
                                ...
                                irqn: UART4_IRQn as libc::c_int as uint8_t,
                                txPriority:
                                    (((1 as libc::c_int) <<
                                          (4 as libc::c_int as
                                               libc::c_uint).wrapping_sub((7
         ...
         },
         {
             let mut init =
                 uartHardware_s{device: UARTDEV_5,
                                reg:
                                    (0x40000000 as libc::c_int as
                                         uint32_t).wrapping_add(0x5000 as
                                                                    libc::c_int
                                                                    as
                                                                    libc::c_uint)
                                        as *mut USART_TypeDef,
                                ...
                                rcc:
                                    (((RCC_APB1 as libc::c_int) <<
                                        ...
                                        as rccPeriphTag_t,
                                af: 0x5 as libc::c_int as uint8_t,
                                irqn: UART5_IRQn as libc::c_int as uint8_t,
                                txPriority:
                                    (((1 as libc::c_int) <<
                                          (4 as libc::c_int as
                                               libc::c_uint).wrapping_sub((7
