...
static mut vtxCLKPin: IO_t = 0 as *const libc::c_void as IO_t;
/* *
...
pub unsafe extern "C" fn rtc6705IOInit() {
    ...
    vtxCSPin =
        IOGetByTag(((5 as libc::c_int + 1 as libc::c_int) << 4 as libc::c_int
...
unsafe extern "C" fn rtc6705Transfer(mut command: uint32_t) {
    ...
    IOHi(vtxCLKPin);
    delayMicroseconds(5 as libc::c_int as timeUs_t);
    IOLo(vtxCSPin);
...
pub unsafe extern "C" fn rtc6705SetRFPower(mut rf_power: uint8_t) {
    rf_power =
        constrain(rf_power as libc::c_int, 0 as libc::c_int,
