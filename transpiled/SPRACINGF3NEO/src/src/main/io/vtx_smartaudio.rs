...
pub static mut saStat: smartAudioStat_t =
    {
        let mut init =
            smartAudioStat_s{pktsent: 0 as libc::c_int as uint16_t,
                             pktrcvd: 0 as libc::c_int as uint16_t,
                             badpre: 0 as libc::c_int as uint16_t,
                             badlen: 0 as libc::c_int as uint16_t,
                             crc: 0 as libc::c_int as uint16_t,
                             ooopresp: 0 as libc::c_int as uint16_t,
                             badcode: 0 as libc::c_int as uint16_t,};
        init
    };
#[no_mangle]
pub static mut saPowerTable: [saPowerTable_t; 4] =
    [{
         let mut init =
             saPowerTable_s{rfpower: 25 as libc::c_int,
                            valueV1: 7 as libc::c_int as int16_t,
                            valueV2: 0 as libc::c_int as int16_t,};
         init
     },
     {
         let mut init =
             saPowerTable_s{rfpower: 200 as libc::c_int,
                            valueV1: 16 as libc::c_int as int16_t,
                            valueV2: 1 as libc::c_int as int16_t,};
         init
     },
     {
         let mut init =
             saPowerTable_s{rfpower: 500 as libc::c_int,
                            valueV1: 25 as libc::c_int as int16_t,
                            valueV2: 2 as libc::c_int as int16_t,};
         init
     },
     {
         let mut init =
             saPowerTable_s{rfpower: 800 as libc::c_int,
                            valueV1: 40 as libc::c_int as int16_t,
                            valueV2: 3 as libc::c_int as int16_t,};
         init
     }];
...
pub static mut saDevice: smartAudioDevice_t =
    {
        let mut init =
            smartAudioDevice_s{version: 0 as libc::c_int as int8_t,
                               channel: -(1 as libc::c_int) as int8_t,
                               power: -(1 as libc::c_int) as int8_t,
                               mode: 0 as libc::c_int as int8_t,
                               freq: 0 as libc::c_int as uint16_t,
                               orfreq: 0 as libc::c_int as uint16_t,};
        init
    };
...
static mut saLockMode: uint8_t = 8 as libc::c_int as uint8_t;
// saCms variable?
// XXX Should be configurable by user?
#[no_mangle]
pub static mut saDeferred: bool = 1 as libc::c_int != 0;
static mut sa_rbuf: [uint8_t; 15] = [0; 15];
unsafe extern "C" fn CRC8(mut data: *const uint8_t, len: int8_t) -> uint8_t {
    let mut crc: uint8_t =
        0 as libc::c_int as
            uint8_t; /* start with 0 so first byte can be 'xored' in */
    ...
    while i < len as libc::c_int {
        ...
        while i_0 < 8 as libc::c_int {
            if crc as libc::c_int & 0x80 as libc::c_int != 0 as libc::c_int {
                crc =
                    ((crc as libc::c_int) << 1 as libc::c_int ^
                         0xd5 as libc::c_int) as uint8_t
            } else {
                crc = ((crc as libc::c_int) << 1 as libc::c_int) as uint8_t
            }
            i_0 += 1
        }
        i += 1
...
pub unsafe extern "C" fn saDacToPowerIndex(mut dac: libc::c_int)
 -> libc::c_int {
    let mut idx: libc::c_int = 3 as libc::c_int;
...
#[no_mangle]
pub static mut sa_smartbaud: uint16_t = 4800 as libc::c_int as uint16_t;
static mut sa_adjdir: libc::c_int = 1 as libc::c_int;
// -1=going down, 1=going up
static mut sa_baudstep: libc::c_int = 50 as libc::c_int;
unsafe extern "C" fn saAutobaud() {
    if (saStat.pktsent as libc::c_int) < 10 as libc::c_int {
        // Not enough samples collected
        return
    }
    if saStat.pktrcvd as libc::c_int * 100 as libc::c_int /
           saStat.pktsent as libc::c_int >= 70 as libc::c_int {
        // This is okay
        saStat.pktsent =
            0 as libc::c_int as uint16_t; // Should be more moderate?
        saStat.pktrcvd = 0 as libc::c_int as uint16_t;
        return
    }
    if sa_adjdir == 1 as libc::c_int &&
           sa_smartbaud as libc::c_int == 4950 as libc::c_int {
        sa_adjdir = -(1 as libc::c_int)
    } else if sa_adjdir == -(1 as libc::c_int) &&
                  sa_smartbaud as libc::c_int == 4800 as libc::c_int {
        sa_adjdir = 1 as libc::c_int
    }
    sa_smartbaud =
    ...
    (*(*smartAudioSerialPort).vTable).serialSetBaudRate.expect("non-null function pointer")(smartAudioSerialPort,
                                                                                            sa_smartbaud
                                                                                                as
                                                                                                uint32_t);
    saStat.pktsent = 0 as libc::c_int as uint16_t;
    saStat.pktrcvd = 0 as libc::c_int as uint16_t;
}
// Transport level variables
static mut sa_lastTransmissionMs: timeUs_t = 0 as libc::c_int as timeUs_t;
...
unsafe extern "C" fn saProcessResponse(mut buf: *mut uint8_t,
                                       mut len: libc::c_int) {
    let mut resp: uint8_t = *buf.offset(0 as libc::c_int as isize);
    ...
    match resp as libc::c_int {
        9 => {
            ...
            current_block_47 = 17046818828592838197;
        }
        1 => { current_block_47 = 17046818828592838197; }
        2 => {
            // Set Power
            ...
            if !(len < 7 as libc::c_int) {
                saDevice.version =
                    if *buf.offset(0 as libc::c_int as isize) as libc::c_int
                           == SA_CMD_GET_SETTINGS as libc::c_int {
                        1 as libc::c_int
                    } else { 2 as libc::c_int } as int8_t;
                saDevice.channel =
                    *buf.offset(2 as libc::c_int as isize) as int8_t;
                saDevice.power =
                    *buf.offset(3 as libc::c_int as isize) as int8_t;
                saDevice.mode =
                    *buf.offset(4 as libc::c_int as isize) as int8_t;
                saDevice.freq =
                    ((*buf.offset(5 as libc::c_int as isize) as libc::c_int)
                         << 8 as libc::c_int |
                         *buf.offset(6 as libc::c_int as isize) as
                             libc::c_int) as uint16_t;
                if debugMode as libc::c_int == DEBUG_SMARTAUDIO as libc::c_int
                   {
                    debug[0 as libc::c_int as usize] =
                        (saDevice.version as libc::c_int * 100 as libc::c_int
                             + saDevice.mode as libc::c_int) as int16_t
                }
                if debugMode as libc::c_int == DEBUG_SMARTAUDIO as libc::c_int
                   {
                    debug[1 as libc::c_int as usize] =
                        saDevice.channel as int16_t
                }
                if debugMode as libc::c_int == DEBUG_SMARTAUDIO as libc::c_int
                   {
                    debug[2 as libc::c_int as usize] =
                        saDevice.freq as int16_t
                }
                if debugMode as libc::c_int == DEBUG_SMARTAUDIO as libc::c_int
                   {
                    debug[3 as libc::c_int as usize] =
                        saDevice.power as int16_t
                }
            }
        }
        _ => { }
...
unsafe extern "C" fn saReceiveFramer(mut c: uint8_t) {
    ...
    match state as libc::c_uint {
        0 => {
            if c as libc::c_int == 0xaa as libc::c_int {
                state = S_WAITPRE2
            } else {
                state = S_WAITPRE1
        ...
        1 => {
            if c as libc::c_int == 0x55 as libc::c_int {
                state = S_WAITRESP
            } else {
        ...
        2 => { sa_rbuf[0 as libc::c_int as usize] = c; state = S_WAITLEN }
        3 => {
            sa_rbuf[1 as libc::c_int as usize] = c;
            len = c as libc::c_int;
            if len > 11 as libc::c_int - 2 as libc::c_int {
                saStat.badlen = saStat.badlen.wrapping_add(1);
                state = S_WAITPRE1
            } else if len == 0 as libc::c_int {
                state = S_WAITCRC
            } else { dlen = 0 as libc::c_int; state = S_DATA }
        }
        4 => {
            // XXX Should check buffer overflow (-> saerr_overflow)
            sa_rbuf[(2 as libc::c_int + dlen) as usize] = c;
            dlen += 1;
            if dlen == len { state = S_WAITCRC }
        }
        5 => {
            if CRC8(sa_rbuf.as_mut_ptr(), (2 as libc::c_int + len) as int8_t)
                   as libc::c_int == c as libc::c_int {
                // Got a response
                saProcessResponse(sa_rbuf.as_mut_ptr(),
                                  len +
                                      2 as
                                          libc::c_int); // Generate 1st start bit
                saStat.pktrcvd = saStat.pktrcvd.wrapping_add(1)
            } else if !(sa_rbuf[0 as libc::c_int as usize] as libc::c_int &
                            1 as libc::c_int != 0) {
...
unsafe extern "C" fn saSendFrame(mut buf: *mut uint8_t,
    ...
    match (*smartAudioSerialPort).identifier as libc::c_int {
        30 | 31 => { }
        _ => {
            serialWrite(smartAudioSerialPort, 0 as libc::c_int as uint8_t);
        }
    }
    let mut i: libc::c_int = 0 as libc::c_int;
    while i < len {
...
static mut sa_qhead: uint8_t = 0 as libc::c_int as uint8_t;
static mut sa_qtail: uint8_t = 0 as libc::c_int as uint8_t;
...
unsafe extern "C" fn saQueueFull() -> bool {
    return (sa_qhead as libc::c_int + 1 as libc::c_int) % 6 as libc::c_int ==
               sa_qtail as libc::c_int;
}
unsafe extern "C" fn saQueueCmd(mut buf: *mut uint8_t, mut len: libc::c_int) {
    ...
    sa_qhead =
        ((sa_qhead as libc::c_int + 1 as libc::c_int) % 6 as libc::c_int) as
            uint8_t;
}
unsafe extern "C" fn saSendQueue() {
    ...
    sa_qtail =
        ((sa_qtail as libc::c_int + 1 as libc::c_int) % 6 as libc::c_int) as
            uint8_t;
}
// Individual commands
unsafe extern "C" fn saGetSettings() {
    static mut bufGetSettings: [uint8_t; 5] =
        [0xaa as libc::c_int as uint8_t, 0x55 as libc::c_int as uint8_t,
         ((SA_CMD_GET_SETTINGS as libc::c_int) << 1 as libc::c_int |
              1 as libc::c_int) as uint8_t, 0 as libc::c_int as uint8_t,
         0x9f as libc::c_int as uint8_t];
    saQueueCmd(bufGetSettings.as_mut_ptr(), 5 as libc::c_int);
}
unsafe extern "C" fn saValidateFreq(mut freq: uint16_t) -> bool {
    return freq as libc::c_int >= 5000 as libc::c_int &&
               freq as libc::c_int <= 5999 as libc::c_int;
}
unsafe extern "C" fn saDoDevSetFreq(mut freq: uint16_t) {
    static mut buf: [uint8_t; 7] =
        [0xaa as libc::c_int as uint8_t, 0x55 as libc::c_int as uint8_t,
         ((SA_CMD_SET_FREQ as libc::c_int) << 1 as libc::c_int |
              1 as libc::c_int) as uint8_t, 2 as libc::c_int as uint8_t, 0, 0,
         0];
    static mut switchBuf: [uint8_t; 7] = [0; 7];
    if !(freq as libc::c_int & (1 as libc::c_int) << 14 as libc::c_int != 0) {
        (freq as libc::c_int & (1 as libc::c_int) << 15 as libc::c_int) != 0;
    }
    buf[4 as libc::c_int as usize] =
        (freq as libc::c_int >> 8 as libc::c_int & 0xff as libc::c_int) as
            uint8_t;
    buf[5 as libc::c_int as usize] =
        (freq as libc::c_int & 0xff as libc::c_int) as uint8_t;
    buf[6 as libc::c_int as usize] =
        CRC8(buf.as_mut_ptr(), 6 as libc::c_int as int8_t);
    ...
    if saDevice.mode as libc::c_int & 1 as libc::c_int == 0 as libc::c_int &&
        ...
        let switchFreq: uint16_t =
            (freq as libc::c_int +
                 (if freq as libc::c_int == 5999 as libc::c_int {
                      -(1 as libc::c_int)
                  } else { 1 as libc::c_int })) as uint16_t;
        switchBuf[4 as libc::c_int as usize] =
            (switchFreq as libc::c_int >> 8 as libc::c_int) as uint8_t;
        switchBuf[5 as libc::c_int as usize] =
            (switchFreq as libc::c_int & 0xff as libc::c_int) as uint8_t;
        switchBuf[6 as libc::c_int as usize] =
            CRC8(switchBuf.as_mut_ptr(), 6 as libc::c_int as int8_t);
        saQueueCmd(switchBuf.as_mut_ptr(), 7 as libc::c_int);
    }
    saQueueCmd(buf.as_mut_ptr(), 7 as libc::c_int);
}
#[no_mangle]
...
pub unsafe extern "C" fn saSetPitFreq(mut freq: uint16_t) {
    saDoDevSetFreq((freq as libc::c_int |
...
unsafe extern "C" fn saValidateBandAndChannel(mut band: uint8_t,
    ...
    return band as libc::c_int >= 1 as libc::c_int &&
...
unsafe extern "C" fn saDevSetBandAndChannel(mut band: uint8_t,
    ...
    static mut buf: [uint8_t; 6] =
        [0xaa as libc::c_int as uint8_t, 0x55 as libc::c_int as uint8_t,
         ((SA_CMD_SET_CHAN as libc::c_int) << 1 as libc::c_int |
              1 as libc::c_int) as uint8_t, 1 as libc::c_int as uint8_t, 0,
         0];
    buf[4 as libc::c_int as usize] =
        (band as libc::c_int * 8 as libc::c_int as uint8_t as libc::c_int +
             channel as libc::c_int) as uint8_t;
    buf[5 as libc::c_int as usize] =
        CRC8(buf.as_mut_ptr(), 5 as libc::c_int as int8_t);
    saQueueCmd(buf.as_mut_ptr(), 6 as libc::c_int);
}
#[no_mangle]
...
pub unsafe extern "C" fn saSetMode(mut mode: libc::c_int) {
    static mut buf: [uint8_t; 6] =
        [0xaa as libc::c_int as uint8_t, 0x55 as libc::c_int as uint8_t,
         ((SA_CMD_SET_MODE as libc::c_int) << 1 as libc::c_int |
              1 as libc::c_int) as uint8_t, 1 as libc::c_int as uint8_t, 0,
         0];
    buf[4 as libc::c_int as usize] =
        (mode & 0x3f as libc::c_int | saLockMode as libc::c_int) as uint8_t;
    buf[5 as libc::c_int as usize] =
        CRC8(buf.as_mut_ptr(), 5 as libc::c_int as int8_t);
    saQueueCmd(buf.as_mut_ptr(), 6 as libc::c_int);
}
unsafe extern "C" fn saDevSetPowerByIndex(mut index: uint8_t) {
    static mut buf: [uint8_t; 6] =
        [0xaa as libc::c_int as uint8_t, 0x55 as libc::c_int as uint8_t,
         ((SA_CMD_SET_POWER as libc::c_int) << 1 as libc::c_int |
              1 as libc::c_int) as uint8_t, 1 as libc::c_int as uint8_t, 0,
         0];
    ...
    if index as libc::c_int >= 4 as libc::c_int { return }
    buf[4 as libc::c_int as usize] =
    ...
    if !portConfig.is_null() {
        ...
        smartAudioSerialPort =
            openSerialPort((*portConfig).identifier, FUNCTION_VTX_SMARTAUDIO,
                           ...
                           4800 as libc::c_int as uint32_t, MODE_RXTX,
                           portOptions)
    }
    if smartAudioSerialPort.is_null() { return 0 as libc::c_int != 0 }
...
unsafe extern "C" fn vtxSAProcess(mut vtxDevice: *mut vtxDevice_t,
    ...
    static mut initPhase: libc::c_char = 0 as libc::c_int as libc::c_char;
    ...
    match initPhase as libc::c_int {
        0 => {
            saGetSettings();
            //saSendQueue();
            initPhase = 1 as libc::c_int as libc::c_char
        }
        1 => {
        ...
        // and put the device into user frequency mode with uninitialized freq.
            if saDevice.version != 0 {
                if saDevice.version as libc::c_int == 2 as libc::c_int {
                    saDoDevSetFreq(((1 as libc::c_int) << 14 as libc::c_int)
                                       as uint16_t);
                    initPhase = 2 as libc::c_int as libc::c_char
                } else { initPhase = 3 as libc::c_int as libc::c_char }
            }
        }
        2 => {
            if saDevice.orfreq != 0 {
                initPhase = 3 as libc::c_int as libc::c_char
            }
        }
        3 | _ => { }
    }
    ...
    static mut lastCommandSentMs: timeMs_t =
        0 as libc::c_int as timeMs_t; // Last non-GET_SETTINGS sent
    if sa_outstanding as libc::c_int != SA_CMD_NONE as libc::c_int &&
        ...
        saSendQueue();
        lastCommandSentMs = nowMs
    } else if nowMs.wrapping_sub(lastCommandSentMs) <
...
unsafe extern "C" fn vtxSASetBandAndChannel(mut vtxDevice: *mut vtxDevice_t,
    ...
    if saValidateBandAndChannel(band, channel) {
        saSetBandAndChannel((band as libc::c_int - 1 as libc::c_int) as
                                uint8_t,
                            (channel as libc::c_int - 1 as libc::c_int) as
                                uint8_t);
    };
}
unsafe extern "C" fn vtxSASetPowerByIndex(mut vtxDevice: *mut vtxDevice_t,
    ...
    saSetPowerByIndex((index as libc::c_int - 1 as libc::c_int) as uint8_t);
}
unsafe extern "C" fn vtxSASetPitMode(mut vtxDevice: *mut vtxDevice_t,
                                     mut onoff: uint8_t) {
    if !(vtxSAIsReady(vtxDevice) as libc::c_int != 0 &&
             saDevice.version as libc::c_int == 2 as libc::c_int) {
        return
    }
    if onoff != 0 {
    ...
    *pBand =
        if saDevice.mode as libc::c_int & 1 as libc::c_int != 0 {
            ...
            (saDevice.channel as libc::c_int /
                 8 as libc::c_int as uint8_t as libc::c_int) +
                1 as libc::c_int
        } as uint8_t;
    *pChannel =
        (saDevice.channel as libc::c_int %
             8 as libc::c_int as uint8_t as libc::c_int + 1 as libc::c_int) as
            uint8_t;
    return 1 as libc::c_int != 0;
}
unsafe extern "C" fn vtxSAGetPowerIndex(mut vtxDevice: *const vtxDevice_t,
    ...
    *pIndex =
        ((if saDevice.version as libc::c_int == 1 as libc::c_int {
          ...
          } else { saDevice.power as libc::c_int }) + 1 as libc::c_int) as
            uint8_t;
    return 1 as libc::c_int != 0;
}
