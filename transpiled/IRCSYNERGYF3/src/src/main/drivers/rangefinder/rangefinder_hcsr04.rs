...
pub unsafe extern "C" fn hcsr04Detect(mut dev: *mut rangefinderDev_t,
    ...
    let mut detected: bool = 0 as libc::c_int != 0; // XXX Do we need this?
    RCC_ClockCmd((((RCC_APB2 as libc::c_int) << 5 as libc::c_int) as
                      libc::c_long |
                      (16 as libc::c_int *
                           (0x1 as libc::c_int as uint32_t as libc::c_long >
                                65535 as libc::c_long) as libc::c_int) as
                          libc::c_long +
                          ((8 as libc::c_int *
    ...
    if detected {
        ...
        EXTIEnable(echoIO, 1 as libc::c_int != 0);
