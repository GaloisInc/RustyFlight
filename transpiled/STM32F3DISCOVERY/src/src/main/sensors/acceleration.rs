 ...
 */
    ...
    #[no_mangle]
    fn fakeAccDetect(acc_0: *mut accDev_s) -> bool;
    /*
 * This file is part of Cleanflight and Betaflight.
 *
 * Cleanflight and Betaflight are free software. You can redistribute
        ...
        match accHardwareToUse as libc::c_uint {
            0 | 3 => {
                ...
                if mpu6050AccDetect(dev) {
                    ...
                    current_block_26 = 12497913735442871383;
                } else { current_block_26 = 9432778447674680655; }
            }
            7 => { current_block_26 = 9432778447674680655; }
            9 => { current_block_26 = 3258101451345795692; }
            8 | 10 | 11 | 12 => { current_block_26 = 3012687679090050995; }
            15 => { current_block_26 = 9933386508993631253; }
            16 => { current_block_26 = 15111913988343244794; }
            1 | _ => { current_block_26 = 12074729406442941156; }
        }
        match current_block_26 {
            9432778447674680655 => {
                if mpu6000SpiAccDetect(dev) {
                    ...
                    current_block_26 = 12497913735442871383;
                } else { current_block_26 = 3258101451345795692; }
            }
            _ => { }
        }
        match current_block_26 {
            3258101451345795692 => {
                if mpu9250SpiAccDetect(dev) {
                    ...
                    current_block_26 = 12497913735442871383;
                } else { current_block_26 = 3012687679090050995; }
            }
            _ => { }
        }
        match current_block_26 {
            3012687679090050995 => {
                if mpu6500AccDetect(dev) as libc::c_int != 0 ||
                    ...
                    current_block_26 = 12497913735442871383;
                } else { current_block_26 = 9933386508993631253; }
            }
            _ => { }
        }
        match current_block_26 {
            9933386508993631253 => {
                if bmi160SpiAccDetect(dev) {
                    ...
                    current_block_26 = 12497913735442871383;
                } else { current_block_26 = 15111913988343244794; }
            }
            _ => { }
        }
        match current_block_26 {
            15111913988343244794 => {
                if fakeAccDetect(dev) {
                    accHardware = ACC_FAKE;
                    current_block_26 = 12497913735442871383;
                } else { current_block_26 = 12074729406442941156; }
            }
            _ => { }
        }
        match current_block_26 {
            12074729406442941156 => {
                // disable ACC
