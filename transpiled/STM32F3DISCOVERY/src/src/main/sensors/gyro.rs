    ...
    match gyroHardware as libc::c_uint {
        1 | 2 => {
            if mpu6050GyroDetect(dev) {
                ...
                current_block_29 = 5892776923941496671;
            } else { current_block_29 = 8608417946254211545; }
        }
        4 => { current_block_29 = 8608417946254211545; }
        6 => { current_block_29 = 5381297608968995174; }
        7 | 9 | 10 | 11 => { current_block_29 = 13816073395497979558; }
        8 => { current_block_29 = 15176476975632920360; }
        14 => { current_block_29 = 3733621521558651155; }
        15 => { current_block_29 = 14455231216035570027; }
        _ => { current_block_29 = 1360754249109831829; }
    }
    match current_block_29 {
        8608417946254211545 => {
            if mpu3050Detect(dev) {
                ...
                current_block_29 = 5892776923941496671;
            } else { current_block_29 = 5381297608968995174; }
        }
        _ => { }
    }
    match current_block_29 {
        5381297608968995174 => {
            if mpu6000SpiGyroDetect(dev) {
                ...
                current_block_29 = 5892776923941496671;
            } else { current_block_29 = 13816073395497979558; }
        }
        _ => { }
    }
    match current_block_29 {
        13816073395497979558 => {
            if mpu6500GyroDetect(dev) as libc::c_int != 0 ||
                ...
                (*dev).gyroAlign = CW270_DEG_FLIP;
                current_block_29 = 5892776923941496671;
            } else { current_block_29 = 15176476975632920360; }
        }
        _ => { }
    }
    match current_block_29 {
        15176476975632920360 => {
            if mpu9250SpiGyroDetect(dev) {
                ...
                current_block_29 = 5892776923941496671;
            } else { current_block_29 = 3733621521558651155; }
        }
        _ => { }
    }
    match current_block_29 {
        3733621521558651155 => {
            if bmi160SpiGyroDetect(dev) {
                ...
                current_block_29 = 5892776923941496671;
            } else { current_block_29 = 14455231216035570027; }
        }
        _ => { }
    }
    match current_block_29 {
        14455231216035570027 => {
            if fakeGyroDetect(dev) {
                ...
                current_block_29 = 5892776923941496671;
            } else { current_block_29 = 1360754249109831829; }
        }
        _ => { }
    }
    match current_block_29 {
        1360754249109831829 => { gyroHardware = GYRO_NONE }
        _ => { }
    }
