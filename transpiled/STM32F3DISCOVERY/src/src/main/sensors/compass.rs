...
// 3. Slave I2C device on SPI gyro
    ...
    (*compassConfig_0).mag_i2c_device =
        (I2CDEV_1 as libc::c_int + 1 as libc::c_int) as uint8_t;
    ...
    match (*compassConfig()).mag_hardware as libc::c_int {
        0 | 2 => {
            ...
            if hmc5883lDetect(dev) {
                ...
                current_block_48 = 9512719473022792396;
            } else { current_block_48 = 17837878976738342749; }
        }
        5 => { current_block_48 = 17837878976738342749; }
        3 => { current_block_48 = 15274472712294785679; }
        4 => { current_block_48 = 2691304467765545606; }
        1 => { current_block_48 = 13742718257385290886; }
        _ => { current_block_48 = 9512719473022792396; }
    }
    match current_block_48 {
        17837878976738342749 => {
            if (*busdev).bustype as libc::c_uint ==
                   BUSTYPE_I2C as libc::c_int as libc::c_uint {
                (*busdev).busdev_u.i2c.address =
                    (*compassConfig()).mag_i2c_address
            ...
            if qmc5883lDetect(dev) {
                ...
                current_block_48 = 9512719473022792396;
            } else { current_block_48 = 15274472712294785679; }
        }
        _ => { }
    }
    match current_block_48 {
        15274472712294785679 => {
            ...
            if ak8975Detect(dev) {
                ...
                current_block_48 = 9512719473022792396;
            } else { current_block_48 = 2691304467765545606; }
        }
        _ => { }
    }
    match current_block_48 {
        2691304467765545606 => {
            ...
            if ak8963Detect(dev) {
                ...
                current_block_48 = 9512719473022792396;
            } else { current_block_48 = 13742718257385290886; }
        }
        _ => { }
    }
    match current_block_48 {
        13742718257385290886 => { magHardware = MAG_NONE }
        _ => { }
    }
