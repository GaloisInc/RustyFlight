...
//
    ...
    #[no_mangle]
    static mut customMotorMixer_CopyArray: [motorMixer_t; 12];
    #[no_mangle]
    static mut customMotorMixer_SystemArray: [motorMixer_t; 12];
    #[no_mangle]
...
pub const TABLE_RANGEFINDER_HARDWARE: lookupTableIndex_e = 26;
...
unsafe extern "C" fn cliMotorMix(mut cmdline: *mut libc::c_char) {
    ...
    if isEmpty(cmdline) {
        ...
        if i_1 < 12 as libc::c_int as libc::c_uint {
            ptr = nextArg(ptr);
            if !ptr.is_null() {
     ...
     },
     {
         let mut init =
             cliResourceValue_t{owner: OWNER_MOTOR as libc::c_int as uint8_t,
                                ...
                                maxIndex: 12 as libc::c_int as uint8_t,};
         init
     },
     {
         let mut init =
        ...
        if strncasecmp(cmdline,
            ...
            while i <
                      (0xffff as libc::c_int -
                          ...
                          +
                          (0xff as libc::c_int -
                               (0xff as libc::c_int >> 1 as libc::c_int &
                                    0x77777777 as libc::c_int) -
                               (0xff as libc::c_int >> 2 as libc::c_int &
                                    0x33333333 as libc::c_int) -
                               (0xff as libc::c_int >> 3 as libc::c_int &
                                    0x11111111 as libc::c_int) +
                               (0xff as libc::c_int -
                                    (0xff as libc::c_int >> 1 as libc::c_int &
                                         0x77777777 as libc::c_int) -
