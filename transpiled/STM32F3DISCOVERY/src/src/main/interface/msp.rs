 ...
 */
    ...
    #[no_mangle]
    static mut motor: [libc::c_float; 12];
    #[no_mangle]
    static mut motor_disarmed: [libc::c_float; 12];
    #[no_mangle]
...
pub const MSP_REBOOT_BOOTLOADER: C2RustUnnamed_13 = 1;
pub const MSP_REBOOT_FIRMWARE: C2RustUnnamed_13 = 0;
pub const MSP_REBOOT_MSC: C2RustUnnamed_13 = 2;
pub const MSP_REBOOT_COUNT: C2RustUnnamed_13 = 3;
...
pub const MSP_FLASHFS_FLAG_SUPPORTED: C2RustUnnamed_14 = 2;
pub const MSP_FLASHFS_FLAG_READY: C2RustUnnamed_14 = 1;
...
pub const CURRENT_SENSOR_VIRTUAL: C2RustUnnamed_9 = 0;
pub const CURRENT_SENSOR_ADC: C2RustUnnamed_9 = 1;
pub const VOLTAGE_SENSOR_ADC_VBAT: C2RustUnnamed_11 = 0;
pub const VOLTAGE_SENSOR_TYPE_ADC_RESISTOR_DIVIDER: C2RustUnnamed_10 = 0;
...
pub const CURRENT_SENSOR_MSP: C2RustUnnamed_9 = 3;
pub const CURRENT_SENSOR_ESC: C2RustUnnamed_9 = 2;
pub type C2RustUnnamed_10 = libc::c_uint;
pub const VOLTAGE_SENSOR_TYPE_ESC: C2RustUnnamed_10 = 1;
    ...
    match escMode as libc::c_int {
        ...
        0 | 1 | 2 | 3 | 4 => {
            if (escPortIndex as libc::c_int) < getMotorCount() as libc::c_int
                ...
                current_block_16 = 18317007320854588510;
            } else { current_block_16 = 16670743294537819155; }
        }
        _ => { current_block_16 = 16670743294537819155; }
    }
    match current_block_16 {
        16670743294537819155 => {
    ...
    match cmdMSP as libc::c_int {
        ...
        104 => {
            ...
            while i_5 < 8 as libc::c_int as libc::c_uint {
                if i_5 >= 12 as libc::c_int as libc::c_uint ||
