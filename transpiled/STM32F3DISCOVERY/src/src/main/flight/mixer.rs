...
#[no_mangle]
pub static mut customMotorMixer_CopyArray: [motorMixer_t; 12] =
    [motorMixer_t{throttle: 0., roll: 0., pitch: 0., yaw: 0.,}; 12];
#[no_mangle]
pub static mut customMotorMixer_SystemArray: [motorMixer_t; 12] =
    [motorMixer_t{throttle: 0., roll: 0., pitch: 0., yaw: 0.,}; 12];
...
#[no_mangle]
pub static mut motor: [libc::c_float; 12] = [0.; 12];
#[no_mangle]
pub static mut motor_disarmed: [libc::c_float; 12] = [0.; 12];
#[no_mangle]
pub static mut currentMixerMode: mixerMode_e = 0 as mixerMode_e;
static mut currentMixer: [motorMixer_t; 12] =
    [motorMixer_t{throttle: 0., roll: 0., pitch: 0., yaw: 0.,}; 12];
...
pub unsafe extern "C" fn mixerConfigureOutput() {
    ...
    if currentMixerMode as libc::c_uint ==
        ...
        if motorCount as libc::c_int > 12 as libc::c_int {
            motorCount = 12 as libc::c_int as uint8_t
        }
...
pub unsafe extern "C" fn mixTable(mut currentTimeUs: timeUs_t,
    ...
    let mut motorMix: [libc::c_float; 12] =
        [0.; 12]; // Add voltage compensation
                ...
                pgRegistry_s{pgn:
                             ...
                             size:
                                 ((::core::mem::size_of::<motorMixer_t>() as
                                       libc::c_ulong).wrapping_mul(12 as
                                                                       libc::c_int
                                                                       as
                                                                       libc::c_ulong)
                                      |
                             ...
                             address:
                                 &mut customMotorMixer_SystemArray as
                                     *mut [motorMixer_t; 12] as *mut uint8_t,
                             copy:
