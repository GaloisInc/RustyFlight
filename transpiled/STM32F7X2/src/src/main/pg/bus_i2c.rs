...
static mut i2cDefaultConfig: [i2cDefaultConfig_t; 3] =
    [{
         let mut init =
             i2cDefaultConfig_s{device: I2CDEV_1,
                                ioTagScl: 0 as libc::c_int as ioTag_t,
                                ioTagSda: 0 as libc::c_int as ioTag_t,
     ...
     {
         let mut init =
             i2cDefaultConfig_s{device: I2CDEV_2,
                                ioTagScl: 0 as libc::c_int as ioTag_t,
                                ioTagSda: 0 as libc::c_int as ioTag_t,
                                overClock: 1 as libc::c_int != 0,
                                pullUp: 0 as libc::c_int != 0,};
     ...
     {
         let mut init =
             i2cDefaultConfig_s{device: I2CDEV_3,
                                ioTagScl: 0 as libc::c_int as ioTag_t,
                                ioTagSda: 0 as libc::c_int as ioTag_t,
                                overClock: 1 as libc::c_int != 0,
                                pullUp: 0 as libc::c_int != 0,};
...
pub unsafe extern "C" fn pgResetFn_i2cConfig(mut i2cConfig:
    ...
    while index <
              (::core::mem::size_of::<[i2cDefaultConfig_t; 3]>() as
