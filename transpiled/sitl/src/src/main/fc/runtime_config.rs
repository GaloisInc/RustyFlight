 ...
 */
#[no_mangle]
pub static mut armingFlags: uint8_t = 0i32 as uint8_t;
#[no_mangle]
pub static mut stateFlags: uint8_t = 0i32 as uint8_t;
#[no_mangle]
pub static mut flightModeFlags: uint16_t = 0i32 as uint16_t;
static mut enabledSensors: uint32_t = 0i32 as uint32_t;
