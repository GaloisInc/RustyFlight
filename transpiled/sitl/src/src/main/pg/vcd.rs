...
#[no_mangle]
pub static mut vcdProfile_System: vcdProfile_t =
    vcdProfile_t{video_system: 0, h_offset: 0, v_offset: 0,};
#[no_mangle]
pub static mut vcdProfile_Copy: vcdProfile_t =
    vcdProfile_t{video_system: 0, h_offset: 0, v_offset: 0,};
#[no_mangle]
#[link_section = ".pg_registry"]
#[used]
pub static mut vcdProfile_Registry: pgRegistry_t =
    unsafe {
        {
            let mut init =
                pgRegistry_s{pgn: (514i32 | 0i32 << 12i32) as pgn_t,
                             size:
                                 (::core::mem::size_of::<vcdProfile_t>() as
                                      libc::c_ulong |
                                      PGR_SIZE_SYSTEM_FLAG as libc::c_int as
                                          libc::c_ulong) as uint16_t,
                             address:
                                 &vcdProfile_System as *const vcdProfile_t as
                                     *mut vcdProfile_t as *mut uint8_t,
                             copy:
                                 &vcdProfile_Copy as *const vcdProfile_t as
                                     *mut vcdProfile_t as *mut uint8_t,
                             ptr:
