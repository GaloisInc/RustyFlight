 ...
 -> libc::c_int {
    ...
    match adjustmentFunction as libc::c_int {
        1 | 25 => {
            ...
            } else { current_block_82 = 11198266622936657545; }
        }
        26 => { current_block_82 = 11198266622936657545; }
        2 | 27 => {
            newValue =
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 = 15447629348493591490;
            } else { current_block_82 = 9733948080671261095; }
        }
        28 => { current_block_82 = 9733948080671261095; }
        3 => {
            newValue =
        ...
        4 | 13 => {
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 = 15447629348493591490;
            } else { current_block_82 = 11443780793236366716; }
        }
        14 => { current_block_82 = 11443780793236366716; }
        5 => {
            newValue =
        ...
        6 | 15 => {
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 =
                    4547712548467597444; // FIXME magic numbers repeated in cli.c
            }
        }
        18 => { current_block_82 = 4547712548467597444; }
        7 | 16 => {
            newValue =
                constrain((*pidProfile).pid[PID_PITCH as libc::c_int as
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 =
                    17300888816628707610; // FIXME magic numbers repeated in cli.c
            }
        }
        19 => { current_block_82 = 17300888816628707610; }
        8 | 17 => {
            newValue =
                constrain((*pidProfile).pid[PID_PITCH as libc::c_int as
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 =
                    11840383819209066357; // FIXME magic numbers repeated in cli.c
            }
        }
        20 => {
            current_block_82 =
        ...
        22 | 30 => {
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 = 15447629348493591490;
            } else { current_block_82 = 3773363480161371148; }
        }
        31 => { current_block_82 = 3773363480161371148; }
        32 => {
            newValue =
 ...
 -> libc::c_int {
    ...
    match adjustmentFunction as libc::c_uint {
        1 | 25 => {
            ...
            } else { current_block_84 = 13152404972814328410; }
        }
        ...
        2 | 27 => {
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                current_block_84 = 5265702136860997526;
            } else { current_block_84 = 11528884897872511888; }
        }
        ...
        4 | 13 => {
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                current_block_84 = 5265702136860997526;
            } else { current_block_84 = 11030179663568450934; }
        }
        ...
        6 | 15 => {
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                // fall through for combined ADJUSTMENT_PITCH_ROLL_P
                current_block_84 =
                    15138545843230131294; // FIXME magic numbers repeated in cli.c
            }
        }
        ...
        7 | 16 => {
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                // fall through for combined ADJUSTMENT_PITCH_ROLL_I
                current_block_84 =
                    18015659002152238837; // FIXME magic numbers repeated in cli.c
            }
        }
        ...
        8 | 17 => {
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                // fall through for combined ADJUSTMENT_PITCH_ROLL_D
                current_block_84 =
                    15516051897328206787; // FIXME magic numbers repeated in cli.c
            }
        }
        20 => {
            current_block_84 =
        ...
        22 | 30 => {
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                current_block_84 = 5265702136860997526;
            } else { current_block_84 = 6405530353954840407; }
        }
