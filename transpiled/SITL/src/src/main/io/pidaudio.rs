 ...
 * If not, see <http://www.gnu.org/licenses/>.
 */
static mut pidAudioEnabled: bool = 0 as libc::c_int != 0;
...
pub unsafe extern "C" fn pidAudioUpdate() {
    ...
    let mut tone: uint8_t =
        (64 as libc::c_int / 2 as libc::c_int + 0 as libc::c_int) as uint8_t;
    match pidAudioMode as libc::c_uint {
        1 => {
            ...
            tone =
                scaleRange(pidSumX as libc::c_int, 0 as libc::c_int,
                           500 as libc::c_int,
        ...
        2 => {
            ...
            tone =
                scaleRange(pidSumY as libc::c_int, 0 as libc::c_int,
                           500 as libc::c_int,
                           64 as libc::c_int - 1 as libc::c_int,
                           0 as libc::c_int) as uint8_t
        }
        3 => {
            ...
            tone =
                scaleRange(pidSumXY as libc::c_int, 0 as libc::c_int,
                           500 as libc::c_int,
                           64 as libc::c_int - 1 as libc::c_int,
                           0 as libc::c_int) as uint8_t
        }
