...
static mut buttonBPin: IO_t = 0 as *const libc::c_void as IO_t;
/*
 * This file is part of Cleanflight and Betaflight.
 *
 * Cleanflight and Betaflight are free software. You can redistribute
...
pub unsafe extern "C" fn buttonsInit() {
    ...
    IOInit(buttonBPin, OWNER_SYSTEM, 0 as libc::c_int as uint8_t);
    IOConfigGPIO(buttonBPin,
                 (GPIO_Mode_IN as libc::c_int |
                      (0 as libc::c_int) << 2 as libc::c_int |
                      (0 as libc::c_int) << 4 as libc::c_int |
                      (GPIO_PuPd_UP as libc::c_int) << 5 as libc::c_int) as
...
#[no_mangle]
pub unsafe extern "C" fn buttonBPressed() -> bool {
