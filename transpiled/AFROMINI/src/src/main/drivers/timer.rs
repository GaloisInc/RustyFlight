...
#[no_mangle]
pub static mut timerChannelInfo: [timerChannelInfo_t; 14] =
    [timerChannelInfo_t{type_0: TYPE_FREE,}; 14];
#[no_mangle]
...
pub unsafe extern "C" fn timerChInit(mut timHw: *const timerHardware_t,
    ...
    let mut channel: libc::c_uint =
        timHw.wrapping_offset_from(timerHardware.as_ptr()) as libc::c_long as
            libc::c_uint;
    if channel >= 14 as libc::c_int as libc::c_uint { return }
...
pub unsafe extern "C" fn timerInit() {
    ...
    while i_0 < 14 as libc::c_int as libc::c_uint {
