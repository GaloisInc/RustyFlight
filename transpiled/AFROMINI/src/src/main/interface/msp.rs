...
unsafe extern "C" fn mspProcessOutCommand(mut cmdMSP: uint8_t,
    ...
    match cmdMSP as libc::c_int {
        ...
        77 => {
            ...
            while i_11 < rxRuntimeConfig.channelCount as libc::c_int {
                sbufWriteU8(dst, (*rxFailsafeChannelConfigs(i_11)).mode);
                sbufWriteU16(dst,
                             (750 as libc::c_int +
                                  25 as libc::c_int *
                                      (*rxFailsafeChannelConfigs(i_11)).step
        ...
        54 => {
            ...
            while i_12 < 4 as libc::c_int {
                if serialIsPortAvailable((*serialConfig()).portConfigs[i_12 as
                                                                           usize].identifier)
                   {
                    sbufWriteU8(dst,
                                (*serialConfig()).portConfigs[i_12 as
                                                                  usize].identifier
                                    as uint8_t);
                    sbufWriteU16(dst,
                                 (*serialConfig()).portConfigs[i_12 as
        ...
        46 => {
            ...
            while i_13 < 16 as libc::c_int {
                let mut color: *const hsvColor_t =
                    &*(*(ledStripConfig as
                             unsafe extern "C" fn()
                                 ->
                                     *const ledStripConfig_t)()).colors.as_ptr().offset(i_13
                                                                                            as
                                                                                            isize)
                        as *const hsvColor_t;
        ...
        48 => {
            ...
            while i_14 < 32 as libc::c_int {
                let mut ledConfig: *const ledConfig_t =
                    &*(*(ledStripConfig as
                             unsafe extern "C" fn()
                                 ->
                                     *const ledStripConfig_t)()).ledConfigs.as_ptr().offset(i_14
                                                                                                as
                                                                                                isize)
        ...
        127 => {
            ...
            while i_15 < 6 as libc::c_int {
                let mut j: libc::c_int = 0 as libc::c_int;
                while j < 6 as libc::c_int {
                    sbufWriteU8(dst, i_15 as uint8_t);
                    sbufWriteU8(dst, j as uint8_t);
                    sbufWriteU8(dst,
                                (*ledStripConfig()).modeColors[i_15 as
                                                                   usize].color[j
                                                                                    as
                                                                                    usize]);
                    j += 1
