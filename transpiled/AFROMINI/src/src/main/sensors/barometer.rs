 ...
 -> bool {
    ...
    match baroHardware as libc::c_uint {
        0 | 2 | 3 => {
            ...
            } else { current_block_22 = 12180568866067053773; }
        }
        5 | 4 => { current_block_22 = 12180568866067053773; }
        6 | 1 => { current_block_22 = 916363241452857900; }
    ...
    match current_block_22 {
        12180568866067053773 => {
            if bmp280Detect(dev) {
                ...
                current_block_22 = 1538046216550696469;
            } else { current_block_22 = 916363241452857900; }
        }
        _ => { }
    }
    match current_block_22 {
