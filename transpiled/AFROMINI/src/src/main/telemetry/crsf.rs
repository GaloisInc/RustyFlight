...
pub const CRSF_ADDRESS_CRSF_TRANSMITTER: C2RustUnnamed_5 = 238;
pub const CRSF_ADDRESS_CRSF_RECEIVER: C2RustUnnamed_5 = 236;
pub const CRSF_ADDRESS_RADIO_TRANSMITTER: C2RustUnnamed_5 = 234;
pub const CRSF_ADDRESS_RACE_TAG: C2RustUnnamed_5 = 204;
pub const CRSF_ADDRESS_RESERVED2: C2RustUnnamed_5 = 202;
pub const CRSF_ADDRESS_FLIGHT_CONTROLLER: C2RustUnnamed_5 = 200;
pub const CRSF_ADDRESS_TBS_BLACKBOX: C2RustUnnamed_5 = 196;
pub const CRSF_ADDRESS_GPS: C2RustUnnamed_5 = 194;
pub const CRSF_ADDRESS_CURRENT_SENSOR: C2RustUnnamed_5 = 192;
pub const CRSF_ADDRESS_RESERVED1: C2RustUnnamed_5 = 138;
pub const CRSF_ADDRESS_TBS_CORE_PNP_PRO: C2RustUnnamed_5 = 128;
pub const CRSF_ADDRESS_USB: C2RustUnnamed_5 = 16;
pub const CRSF_ADDRESS_BROADCAST: C2RustUnnamed_5 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub const CRSF_FRAME_GPS_INDEX: C2RustUnnamed_7 = 3;
pub const CRSF_FRAME_FLIGHT_MODE_INDEX: C2RustUnnamed_7 = 2;
pub const CRSF_FRAME_BATTERY_SENSOR_INDEX: C2RustUnnamed_7 = 1;
pub const CRSF_FRAME_ATTITUDE_INDEX: C2RustUnnamed_7 = 0;
pub type C2RustUnnamed_7 = libc::c_uint;
pub const CRSF_SCHEDULE_COUNT_MAX: C2RustUnnamed_7 = 4;
pub const CRSF_FRAME_START_INDEX: C2RustUnnamed_7 = 0;
// latitude * 1e+7
// longitude * 1e+7
// altitude in 0.01m
// speed in 0.1m/s
...
unsafe extern "C" fn systemConfig() -> *const systemConfig_t {
    return &mut systemConfig_System; // start at byte 2, since CRC does not include device address and frame length
}
...
pub unsafe extern "C" fn handleCrsfTelemetry(mut currentTimeUs: timeUs_t) {
    ...
    if deviceInfoReplyPending {
        let mut crsfPayloadBuf: sbuf_t =
            sbuf_t{ptr: 0 as *mut uint8_t,
                   end:
                       0 as
                           *mut uint8_t,}; // reset telemetry timing due to ad-hoc request
        let mut dst: *mut sbuf_t = &mut crsfPayloadBuf;
        crsfInitializeFrame(dst);
