...
unsafe extern "C" fn mspSerialProcessReceivedCommand(mut msp: *mut mspPort_t,
 ...
 -> mspPostProcessFnPtr {
    static mut outBuf: [uint8_t; 1040] = [0; 1040];
                ...
                mspPacket_s{buf:
                                {
                                    let mut init =
                                        sbuf_s{ptr: outBuf.as_mut_ptr(),
                                                   ...
                                                   &mut *outBuf.as_mut_ptr().offset((::core::mem::size_of::<[uint8_t; 1040]>()
                                                                                         as
...
unsafe extern "C" fn mspEvaluateNonMspData(mut mspPort: *mut mspPort_t,
    ...
    if receivedChar as libc::c_int == '#' as i32 {
