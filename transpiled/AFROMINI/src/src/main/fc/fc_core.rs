...
pub const ARMING_DELAYED_DISARMED: C2RustUnnamed_8 = 0;
...
pub const ARMING_DELAYED_CRASHFLIP: C2RustUnnamed_8 = 2;
pub const ARMING_DELAYED_NORMAL: C2RustUnnamed_8 = 1;
#[inline]
