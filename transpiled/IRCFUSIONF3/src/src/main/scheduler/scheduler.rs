...
extern "C" {
    ...
    fn memset(_: *mut libc::c_void, _: libc::c_int, _: libc::c_ulong)
     -> *mut libc::c_void;
    #[no_mangle]
    static mut cfTasks: [cfTask_t; 20];
    #[no_mangle]
    fn micros() -> timeUs_t;
}
...
static mut taskQueueArray: [*mut cfTask_t; 21] =
    [0 as *const cfTask_t as *mut cfTask_t; 21];
...
pub unsafe extern "C" fn queueClear() {
    memset(taskQueueArray.as_mut_ptr() as *mut libc::c_void, 0 as libc::c_int,
           ::core::mem::size_of::<[*mut cfTask_t; 21]>() as libc::c_ulong);
