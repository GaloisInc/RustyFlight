...
pub const TASK_TELEMETRY: cfTaskId_e = 13;
pub const TASK_ALTITUDE: cfTaskId_e = 12;
pub const TASK_BARO: cfTaskId_e = 11;
    ...
    match escMode as libc::c_int {
        ...
        0 | 1 | 2 | 3 | 4 => {
            if (escPortIndex as libc::c_int) < getMotorCount() as libc::c_int
                ...
                current_block_16 = 18317007320854588510;
            } else { current_block_16 = 11412679543673842523; }
        }
        _ => { current_block_16 = 11412679543673842523; }
    }
