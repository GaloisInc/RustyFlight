    ...
    loop  {
        ...
        match accHardwareToUse as libc::c_uint {
            0 | 3 => {
                ...
                } else { current_block_15 = 6085358960596744341; }
            }
            8 | 10 | 11 | 12 => { current_block_15 = 6085358960596744341; }
            1 | _ => { current_block_15 = 6645080409601096633; }
        }
        match current_block_15 {
            6085358960596744341 => {
                if mpu6500AccDetect(dev) as libc::c_int != 0 ||
                    ...
                    current_block_15 = 15345278821338558188;
                } else { current_block_15 = 6645080409601096633; }
            }
            _ => { }
        }
        match current_block_15 {
