 ...
 */
    // Registers
    #[no_mangle]
    fn mpu3050Detect(gyro_0: *mut gyroDev_t) -> bool;
    #[no_mangle]
    fn mpu6050GyroDetect(gyro_0: *mut gyroDev_t) -> bool;
    #[no_mangle]
...
pub const GYRO_OVERFLOW_CHECK_ALL_AXES: C2RustUnnamed_5 = 2;
pub const GYRO_OVERFLOW_CHECK_YAW: C2RustUnnamed_5 = 1;
pub const GYRO_OVERFLOW_CHECK_NONE: C2RustUnnamed_5 = 0;
pub type C2RustUnnamed_6 = libc::c_uint;
pub const FILTER_LOWPASS2: C2RustUnnamed_6 = 1;
pub const FILTER_LOWPASS: C2RustUnnamed_6 = 0;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub const SENSOR_INDEX_GYRO: C2RustUnnamed_7 = 0;
...
pub const SENSOR_INDEX_COUNT: C2RustUnnamed_7 = 5;
pub const SENSOR_INDEX_RANGEFINDER: C2RustUnnamed_7 = 4;
pub const SENSOR_INDEX_MAG: C2RustUnnamed_7 = 3;
pub const SENSOR_INDEX_BARO: C2RustUnnamed_7 = 2;
pub const SENSOR_INDEX_ACC: C2RustUnnamed_7 = 1;
...
// 97.5% full scale (1950dps for 2000dps gyro)
...
pub static mut pgResetTemplate_gyroConfig: gyroConfig_t =
    {
        let mut init =
            gyroConfig_s{gyro_align: ALIGN_DEFAULT as libc::c_int as uint8_t,
                         ...
                         gyro_sync_denom: 8 as libc::c_int as uint8_t,
    ...
    match gyroHardware as libc::c_uint {
        1 | 2 => {
            if mpu6050GyroDetect(dev) {
                ...
                current_block_19 = 8704759739624374314;
            } else { current_block_19 = 864661324147184455; }
        }
        4 => { current_block_19 = 864661324147184455; }
        7 | 9 | 10 | 11 => { current_block_19 = 3209306692752010253; }
        _ => { current_block_19 = 16328609612221173635; }
    }
    match current_block_19 {
        864661324147184455 => {
            if mpu3050Detect(dev) {
                ...
                (*dev).gyroAlign = CW0_DEG;
                current_block_19 = 8704759739624374314;
            } else { current_block_19 = 3209306692752010253; }
        }
        _ => { }
    }
    match current_block_19 {
        3209306692752010253 => {
            if mpu6500GyroDetect(dev) as libc::c_int != 0 ||
                ...
                (*dev).gyroAlign = CW0_DEG;
                current_block_19 = 8704759739624374314;
            } else { current_block_19 = 16328609612221173635; }
        }
        _ => { }
    }
    match current_block_19 {
        16328609612221173635 => { gyroHardware = GYRO_NONE }
        _ => { }
    }
