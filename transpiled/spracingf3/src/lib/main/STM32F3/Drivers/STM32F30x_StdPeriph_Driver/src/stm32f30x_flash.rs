...
pub unsafe extern "C" fn FLASH_SetLatency(mut FLASH_Latency: uint32_t) {
    ...
    tmpreg &= !(0x3i32 as uint8_t as uint32_t);
    ...
    if NewState as libc::c_uint != DISABLE as libc::c_int as libc::c_uint {
        ...
        ::core::ptr::write_volatile(fresh0,
                                    (::core::ptr::read_volatile::<uint32_t>(fresh0
                                                                                ...
                                                                                *const uint32_t)
                                         as libc::c_uint |
                                         0x8i32 as uint8_t as libc::c_uint) as
        ...
        ::core::ptr::write_volatile(fresh1,
                                    (::core::ptr::read_volatile::<uint32_t>(fresh1
                                                                                ...
                                                                                *const uint32_t)
                                         as libc::c_uint &
                                         !(0x8i32 as uint8_t as uint32_t)) as
                                        uint32_t as uint32_t)
    };
}
/* *
    ...
    if NewState as libc::c_uint != DISABLE as libc::c_int as libc::c_uint {
        ...
        ::core::ptr::write_volatile(fresh3,
                                    (::core::ptr::read_volatile::<uint32_t>(fresh3
                                                                                ...
                                                                                *const uint32_t)
                                         as libc::c_uint &
                                         !(0x10i32 as uint8_t as uint32_t)) as
                                        uint32_t as uint32_t)
    };
}
/* *
    ...
    if (*((0x40000000i32 as
               uint32_t).wrapping_add(0x20000i32 as
                                          libc::c_uint).wrapping_add(0x2000i32
                                                                         as
                                                                         libc::c_uint)
              as *mut FLASH_TypeDef)).CR & 0x80i32 as uint32_t !=
...
pub unsafe extern "C" fn FLASH_Lock() {
    ...
    ::core::ptr::write_volatile(fresh4,
                                (::core::ptr::read_volatile::<uint32_t>(fresh4
                                                                            as
                                                                            *const uint32_t)
                                     as libc::c_uint | 0x80i32 as uint32_t) as
                                    uint32_t as uint32_t);
}
/* *
...
pub unsafe extern "C" fn FLASH_ErasePage(mut Page_Address: uint32_t)
 -> FLASH_Status {
    ...
    status = FLASH_WaitForLastOperation(0xb0000i32 as uint32_t);
    if status as libc::c_uint == FLASH_COMPLETE as libc::c_int as libc::c_uint
       {
        ...
        ::core::ptr::write_volatile(fresh6,
                                    (::core::ptr::read_volatile::<uint32_t>(fresh6
                                                                                ...
                                                                                *const uint32_t)
                                         as libc::c_uint |
                                         0x40i32 as uint32_t) as uint32_t as
                                        uint32_t);
        /* Wait for last operation to be completed */
        status = FLASH_WaitForLastOperation(0xb0000i32 as uint32_t);
        /* Disable the PER Bit */
    ...
    if status as libc::c_uint == FLASH_COMPLETE as libc::c_int as libc::c_uint
       {
        ...
        ::core::ptr::write_volatile(fresh10,
                                    (::core::ptr::read_volatile::<uint32_t>(fresh10
                                                                                ...
                                                                                *const uint32_t)
                                         as libc::c_uint &
                                         !(0x4i32 as uint32_t)) as uint32_t as
                                        uint32_t)
    }
    /* Return the Erase Status */
    return status;
    ...
    half word */
      ...
      half word */
            ::core::ptr::write_volatile(&mut tmp as *mut uint32_t,
                                        Address.wrapping_add(2i32 as
                                                                 libc::c_uint));
            ::core::ptr::write_volatile(tmp as *mut uint16_t,
                                        (Data >> 16i32) as uint16_t);
            /* Wait for last operation to be completed */
            status = FLASH_WaitForLastOperation(0xb0000i32 as uint32_t);
            /* Disable the PG Bit */
            let ref mut fresh12 =
    ...
    if (*((0x40000000i32 as
               uint32_t).wrapping_add(0x20000i32 as
                                          libc::c_uint).wrapping_add(0x2000i32
                                                                         as
                                                                         libc::c_uint)
              as *mut FLASH_TypeDef)).CR & 0x200i32 as uint32_t ==
           RESET as libc::c_int as libc::c_uint {
...
pub unsafe extern "C" fn FLASH_OB_Lock() {
    ...
    ::core::ptr::write_volatile(fresh16,
                                (::core::ptr::read_volatile::<uint32_t>(fresh16
                                                                            ...
                                                                            *const uint32_t)
                                     as libc::c_uint &
                                     !(0x200i32 as uint32_t)) as uint32_t as
                                    uint32_t);
}
/* *
...
pub unsafe extern "C" fn FLASH_OB_Launch() {
    ...
    ::core::ptr::write_volatile(fresh17,
                                (::core::ptr::read_volatile::<uint32_t>(fresh17
                                                                            as
                                                                            *const uint32_t)
                                     as libc::c_uint | 0x2000i32 as uint32_t)
                                    as uint32_t as uint32_t);
}
/* *
...
pub unsafe extern "C" fn FLASH_OB_Erase() -> FLASH_Status {
    let mut rdptmp: uint16_t = 0xaai32 as uint8_t as uint16_t;
    let mut status: FLASH_Status = FLASH_COMPLETE;
    /* Get the actual read protection Option Byte value */
    if FLASH_OB_GetRDP() as libc::c_uint !=
           RESET as libc::c_int as libc::c_uint {
        rdptmp = 0i32 as uint16_t
    }
    /* Wait for last operation to be completed */
    status = FLASH_WaitForLastOperation(0xb0000i32 as uint32_t);
    if status as libc::c_uint == FLASH_COMPLETE as libc::c_int as libc::c_uint
       {
        ...
        if status as libc::c_uint ==
            ...
            ::core::ptr::write_volatile(&mut (*(0x1ffff800i32 as uint32_t as
...
pub unsafe extern "C" fn FLASH_OB_EnableWRP(mut OB_WRP: uint32_t)
 -> FLASH_Status {
    let mut WRP0_Data: uint16_t = 0xffffi32 as uint16_t;
    let mut WRP1_Data: uint16_t = 0xffffi32 as uint16_t;
    let mut status: FLASH_Status = FLASH_COMPLETE;
    /* Check the parameters */
    OB_WRP = !OB_WRP;
    WRP0_Data = (OB_WRP & 0xffi32 as uint32_t) as uint16_t;
    WRP1_Data = ((OB_WRP & 0xff00i32 as uint32_t) >> 8i32) as uint16_t;
    /* Wait for last operation to be completed */
    status = FLASH_WaitForLastOperation(0xb0000i32 as uint32_t);
    if status as libc::c_uint == FLASH_COMPLETE as libc::c_int as libc::c_uint
       {
        ...
        ::core::ptr::write_volatile(fresh24,
                                    (::core::ptr::read_volatile::<uint32_t>(fresh24
                                        ...
                                        uint32_t);
        if WRP0_Data as libc::c_int != 0xffi32 {
            ::core::ptr::write_volatile(&mut (*(0x1ffff800i32 as uint32_t as
        ...
        if status as libc::c_uint ==
               FLASH_COMPLETE as libc::c_int as libc::c_uint &&
               WRP1_Data as libc::c_int != 0xffi32 {
            ::core::ptr::write_volatile(&mut (*(0x1ffff800i32 as uint32_t as
...
pub unsafe extern "C" fn FLASH_OB_UserConfig(mut OB_IWDG: uint8_t,
 ...
 -> FLASH_Status {
    ...
    ::core::ptr::write_volatile(&mut (*((0x40000000i32 as
                                    ...
                                    *mut uint32_t, 0x45670123i32 as uint32_t);
    ::core::ptr::write_volatile(&mut (*((0x40000000i32 as
                                             uint32_t).wrapping_add(0x20000i32
                                                                        as
                                                                        libc::c_uint).wrapping_add(0x2000i32
    ...
    if status as libc::c_uint == FLASH_COMPLETE as libc::c_int as libc::c_uint
       {
        ...
        ::core::ptr::write_volatile(&mut (*(0x1ffff800i32 as uint32_t as
                                    ...
                                    ((OB_IWDG as libc::c_int |
                                         ...
                                         as libc::c_int |
                                         (OB_STDBY as libc::c_int | 0xf8i32)
    ...
    if status as libc::c_uint == FLASH_COMPLETE as libc::c_int as libc::c_uint
       {
        ...
        ::core::ptr::write_volatile(&mut (*(0x1ffff800i32 as uint32_t as
                                                *mut OB_TypeDef)).USER as
                                        *mut uint16_t,
                                    (OB_BOOT1 as libc::c_int | 0xefi32) as
                                        uint16_t);
        /* Wait for last operation to be completed */
        status = FLASH_WaitForLastOperation(0xb0000i32 as uint32_t);
        if status as libc::c_uint !=
    ...
    if status as libc::c_uint == FLASH_COMPLETE as libc::c_int as libc::c_uint
       {
        ...
        ::core::ptr::write_volatile(&mut (*(0x1ffff800i32 as uint32_t as
                                                *mut OB_TypeDef)).USER as
                                        *mut uint16_t,
                                    (OB_VDDA_ANALOG as libc::c_int | 0xdfi32)
                                        as uint16_t);
        /* Wait for last operation to be completed */
        status = FLASH_WaitForLastOperation(0xb0000i32 as uint32_t);
        if status as libc::c_uint !=
    ...
    if status as libc::c_uint == FLASH_COMPLETE as libc::c_int as libc::c_uint
       {
        ...
        ::core::ptr::write_volatile(&mut (*(0x1ffff800i32 as uint32_t as
                                                *mut OB_TypeDef)).USER as
                                        *mut uint16_t,
                                    (OB_SRAM_Parity as libc::c_int | 0xbfi32)
                                        as uint16_t);
        /* Wait for last operation to be completed */
        status = FLASH_WaitForLastOperation(0xb0000i32 as uint32_t);
        if status as libc::c_uint !=
    ...
    if status as libc::c_uint == FLASH_COMPLETE as libc::c_int as libc::c_uint
       {
        ...
        ::core::ptr::write_volatile(&mut (*(0x1ffff800i32 as uint32_t as
                                                *mut OB_TypeDef)).USER as
                                        *mut uint16_t,
                                    (OB_USER as libc::c_int | 0x88i32) as
                                        uint16_t);
        /* Wait for last operation to be completed */
        status = FLASH_WaitForLastOperation(0xb0000i32 as uint32_t);
        if status as libc::c_uint !=
    ...
    return ((*((0x40000000i32 as
                    uint32_t).wrapping_add(0x20000i32 as
                                               libc::c_uint).wrapping_add(0x2000i32
                                                                              as
                                                                              libc::c_uint)
                   as *mut FLASH_TypeDef)).OBR >> 8i32) as uint8_t;
}
/* *
...
pub unsafe extern "C" fn FLASH_OB_GetRDP() -> FlagStatus {
    ...
    if ((*((0x40000000i32 as
            ...
            (0x2i32 as uint32_t | 0x4i32 as uint32_t)) as uint8_t as
           libc::c_int != RESET as libc::c_int {
        readstatus = SET
    ...
    if (*((0x40000000i32 as
               uint32_t).wrapping_add(0x20000i32 as
                                          libc::c_uint).wrapping_add(0x2000i32
                                                                         as
                                                                         libc::c_uint)
              as *mut FLASH_TypeDef)).SR & 0x1i32 as uint32_t ==
           0x1i32 as uint32_t {
        FLASHstatus = FLASH_BUSY
                      ...
                      uint32_t).wrapping_add(0x20000i32 as
                                                 libc::c_uint).wrapping_add(0x2000i32
                                                                                as
                                                                                libc::c_uint)
                     as *mut FLASH_TypeDef)).SR & 0x10i32 as uint32_t !=
                  0i32 as uint32_t {
        FLASHstatus = FLASH_ERROR_WRP
                      ...
                      uint32_t).wrapping_add(0x20000i32 as
                                                 libc::c_uint).wrapping_add(0x2000i32
                                                                                as
                                                                                libc::c_uint)
                     as *mut FLASH_TypeDef)).SR & 0x4i32 as uint32_t !=
                  0i32 as uint32_t {
...
pub unsafe extern "C" fn FLASH_WaitForLastOperation(mut Timeout: uint32_t)
 -> FLASH_Status {
    ...
    if Timeout == 0i32 as libc::c_uint { status = FLASH_TIMEOUT }
