    ...
    if USARTx ==
           (0x40000000i32 as
                uint32_t).wrapping_add(0x10000i32 as
                                           libc::c_uint).wrapping_add(0x3800i32
                                                                          as
                                                                          libc::c_uint)
               as *mut USART_TypeDef {
        RCC_APB2PeriphResetCmd(0x4000i32 as uint32_t, ENABLE);
        RCC_APB2PeriphResetCmd(0x4000i32 as uint32_t, DISABLE);
    } else if USARTx ==
                  (0x40000000i32 as
                       uint32_t).wrapping_add(0x4400i32 as libc::c_uint) as
                      *mut USART_TypeDef {
        RCC_APB1PeriphResetCmd(0x20000i32 as uint32_t, ENABLE);
        RCC_APB1PeriphResetCmd(0x20000i32 as uint32_t, DISABLE);
    } else if USARTx ==
                  (0x40000000i32 as
                       uint32_t).wrapping_add(0x4800i32 as libc::c_uint) as
                      *mut USART_TypeDef {
        RCC_APB1PeriphResetCmd(0x40000i32 as uint32_t, ENABLE);
        RCC_APB1PeriphResetCmd(0x40000i32 as uint32_t, DISABLE);
    } else if USARTx ==
                  (0x40000000i32 as
                       uint32_t).wrapping_add(0x4c00i32 as libc::c_uint) as
                      *mut USART_TypeDef {
        RCC_APB1PeriphResetCmd(0x80000i32 as uint32_t, ENABLE);
        RCC_APB1PeriphResetCmd(0x80000i32 as uint32_t, DISABLE);
    } else if USARTx ==
                  (0x40000000i32 as
                       uint32_t).wrapping_add(0x5000i32 as libc::c_uint) as
                      *mut USART_TypeDef {
        RCC_APB1PeriphResetCmd(0x100000i32 as uint32_t, ENABLE);
        RCC_APB1PeriphResetCmd(0x100000i32 as uint32_t, DISABLE);
    };
}
/* *
...
pub unsafe extern "C" fn USART_Init(mut USARTx: *mut USART_TypeDef,
    ...
    let mut divider: uint32_t = 0i32 as uint32_t;
    let mut apbclock: uint32_t = 0i32 as uint32_t;
  ...
  /* Set STOP[13:12] bits according to USART_StopBits value */
    ...
    tmpreg &=
        !(0x1000i32 as uint32_t | 0x400i32 as uint32_t | 0x200i32 as uint32_t
  ...
  /* Set TE and RE bits according to USART_Mode value */
    ...
    tmpreg &= !(0x100i32 as uint32_t | 0x200i32 as uint32_t);
  ...
  /* Configure the USART Baud Rate -------------------------------------------*/
    ...
    if (*USARTx).CR1 & 0x8000i32 as uint32_t != 0i32 as libc::c_uint {
    ...
    if tmpreg >=
           (*USART_InitStruct).USART_BaudRate.wrapping_div(2i32 as
                                                               libc::c_uint) {
    ...
    if (*USARTx).CR1 & 0x8000i32 as uint32_t != 0i32 as libc::c_uint {
        ...
        tmpreg = (divider & 0xfi32 as uint16_t as libc::c_uint) >> 1i32;
        /* update the divider value */
        divider = divider & 0xfff0i32 as uint16_t as libc::c_uint | tmpreg
    }
    /* Write to USART BRR */
...
pub unsafe extern "C" fn USART_StructInit(mut USART_InitStruct:
    ...
    (*USART_InitStruct).USART_BaudRate = 9600i32 as uint32_t;
    (*USART_InitStruct).USART_WordLength = 0i32 as uint32_t;
    (*USART_InitStruct).USART_StopBits = 0i32 as uint32_t;
    (*USART_InitStruct).USART_Parity = 0i32 as uint32_t;
    (*USART_InitStruct).USART_Mode = 0x4i32 as uint32_t | 0x8i32 as uint32_t;
    (*USART_InitStruct).USART_HardwareFlowControl = 0i32 as uint32_t;
}
/* *
...
pub unsafe extern "C" fn USART_ClockInit(mut USARTx: *mut USART_TypeDef,
    ...
    tmpreg &=
        !(0x800i32 as uint32_t | 0x400i32 as uint32_t | 0x200i32 as uint32_t |
...
pub unsafe extern "C" fn USART_ClockStructInit(mut USART_ClockInitStruct:
    ...
    (*USART_ClockInitStruct).USART_Clock = 0i32 as uint32_t;
    (*USART_ClockInitStruct).USART_CPOL = 0i32 as uint32_t;
    (*USART_ClockInitStruct).USART_CPHA = 0i32 as uint32_t;
    (*USART_ClockInitStruct).USART_LastBit = 0i32 as uint32_t;
}
/* *
       ...
       start bit by setting the MSBFIRST bit in the CR2 register */
        ::core::ptr::write_volatile(&mut (*USARTx).CR2 as *mut uint32_t,
                                    (::core::ptr::read_volatile::<uint32_t>(&(*USARTx).CR2
                                                                                ...
                                                                                *const uint32_t)
                                         as libc::c_uint |
                                         0x80000i32 as uint32_t) as uint32_t
                                        as uint32_t)
    } else {
       ...
       the CR2 register */
        ::core::ptr::write_volatile(&mut (*USARTx).CR2 as *mut uint32_t,
                                    (::core::ptr::read_volatile::<uint32_t>(&(*USARTx).CR2
                                                                                ...
                                                                                *const uint32_t)
                                         as libc::c_uint |
                                         0x40000i32 as uint32_t) as uint32_t
                                        as uint32_t)
    } else {
...
pub unsafe extern "C" fn USART_SetReceiverTimeOut(mut USARTx:
    ...
    ::core::ptr::write_volatile(&mut (*USARTx).RTOR as *mut uint32_t,
                                (::core::ptr::read_volatile::<uint32_t>(&(*USARTx).RTOR
                                                                            ...
                                                                            *const uint32_t)
                                     as libc::c_uint &
                                     !(0xffffffi32 as uint32_t)) as uint32_t
                                    as uint32_t);
...
pub unsafe extern "C" fn USART_SetPrescaler(mut USARTx: *mut USART_TypeDef,
    ...
    ::core::ptr::write_volatile(&mut (*USARTx).GTPR as *mut uint16_t,
                                (::core::ptr::read_volatile::<uint16_t>(&(*USARTx).GTPR
                                                                            ...
                                                                            *const uint16_t)
                                     as libc::c_int &
                                     0xff00i32 as uint16_t as libc::c_int) as
...
pub unsafe extern "C" fn USART_StopModeWakeUpSourceConfig(mut USARTx:
    ...
    ::core::ptr::write_volatile(&mut (*USARTx).CR3 as *mut uint32_t,
                                (::core::ptr::read_volatile::<uint32_t>(&(*USARTx).CR3
                                                                            ...
                                                                            *const uint32_t)
                                     as libc::c_uint &
                                     !(0x300000i32 as uint32_t)) as uint32_t
                                    as uint32_t);
    ::core::ptr::write_volatile(&mut (*USARTx).CR3 as *mut uint32_t,
                                (::core::ptr::read_volatile::<uint32_t>(&(*USARTx).CR3
                                                                            as
...
pub unsafe extern "C" fn USART_AutoBaudRateConfig(mut USARTx:
    ...
    ::core::ptr::write_volatile(&mut (*USARTx).CR2 as *mut uint32_t,
                                (::core::ptr::read_volatile::<uint32_t>(&(*USARTx).CR2
                                                                            ...
                                                                            *const uint32_t)
                                     as libc::c_uint &
                                     !(0x600000i32 as uint32_t)) as uint32_t
                                    as uint32_t);
    ::core::ptr::write_volatile(&mut (*USARTx).CR2 as *mut uint32_t,
                                (::core::ptr::read_volatile::<uint32_t>(&(*USARTx).CR2
                                                                            as
...
pub unsafe extern "C" fn USART_SendData(mut USARTx: *mut USART_TypeDef,
    ...
    ::core::ptr::write_volatile(&mut (*USARTx).TDR as *mut uint16_t,
                                (Data as libc::c_int &
                                     0x1ffi32 as uint16_t as libc::c_int) as
                                    uint16_t);
}
/* *
...
pub unsafe extern "C" fn USART_ReceiveData(mut USARTx: *mut USART_TypeDef)
 -> uint16_t {
    ...
    return ((*USARTx).RDR as libc::c_int &
                0x1ffi32 as uint16_t as libc::c_int) as uint16_t;
}
/* *
  * @}
  */
...
pub unsafe extern "C" fn USART_SetAddress(mut USARTx: *mut USART_TypeDef,
    ...
    ::core::ptr::write_volatile(&mut (*USARTx).CR2 as *mut uint32_t,
                                (::core::ptr::read_volatile::<uint32_t>(&(*USARTx).CR2
                                                                            as
                                                                            *const uint32_t)
                                     as libc::c_uint & !0xff000000u32) as
                                    uint32_t as uint32_t);
    ...
    ::core::ptr::write_volatile(&mut (*USARTx).CR2 as *mut uint32_t,
                                (::core::ptr::read_volatile::<uint32_t>(&(*USARTx).CR2
                                     ...
                                     (USART_Address as uint32_t) <<
                                         0x18i32 as uint32_t) as uint32_t as
                                    uint32_t);
}
/* *
    ...
    if NewState as libc::c_uint != DISABLE as libc::c_int as libc::c_uint {
        ...
        ::core::ptr::write_volatile(&mut (*USARTx).CR1 as *mut uint32_t,
                                    (::core::ptr::read_volatile::<uint32_t>(&(*USARTx).CR1
                                                                                ...
                                                                                *const uint32_t)
                                         as libc::c_uint |
                                         0x2000i32 as uint32_t) as uint32_t as
                                        uint32_t)
    } else {
        ...
        ::core::ptr::write_volatile(&mut (*USARTx).CR1 as *mut uint32_t,
                                    (::core::ptr::read_volatile::<uint32_t>(&(*USARTx).CR1
                                                                                ...
                                                                                *const uint32_t)
                                         as libc::c_uint &
                                         !(0x2000i32 as uint32_t)) as uint32_t
                                        as uint32_t)
    };
}
/* *
...
pub unsafe extern "C" fn USART_LINBreakDetectLengthConfig(mut USARTx:
    ...
    ::core::ptr::write_volatile(&mut (*USARTx).CR2 as *mut uint32_t,
                                (::core::ptr::read_volatile::<uint32_t>(&(*USARTx).CR2
                                                                            as
                                                                            *const uint32_t)
                                     as libc::c_uint & !(0x20i32 as uint32_t))
                                    as uint32_t as uint32_t);
    ::core::ptr::write_volatile(&mut (*USARTx).CR2 as *mut uint32_t,
                                (::core::ptr::read_volatile::<uint32_t>(&(*USARTx).CR2
                                                                            as
    ...
    if NewState as libc::c_uint != DISABLE as libc::c_int as libc::c_uint {
        ...
        ::core::ptr::write_volatile(&mut (*USARTx).CR3 as *mut uint32_t,
                                    (::core::ptr::read_volatile::<uint32_t>(&(*USARTx).CR3
                                                                                ...
                                                                                *const uint32_t)
                                         as libc::c_uint &
                                         !(0x8i32 as uint32_t)) as uint32_t as
                                        uint32_t)
    };
}
/* *
...
pub unsafe extern "C" fn USART_SetGuardTime(mut USARTx: *mut USART_TypeDef,
    ...
    ::core::ptr::write_volatile(&mut (*USARTx).GTPR as *mut uint16_t,
                                (::core::ptr::read_volatile::<uint16_t>(&(*USARTx).GTPR
                                                                            ...
                                                                            *const uint16_t)
                                     as libc::c_int &
                                     0xffi32 as uint16_t as libc::c_int) as
                                    uint16_t as uint16_t);
    ...
    if NewState as libc::c_uint != DISABLE as libc::c_int as libc::c_uint {
        ...
        ::core::ptr::write_volatile(&mut (*USARTx).CR3 as *mut uint32_t,
                                    (::core::ptr::read_volatile::<uint32_t>(&(*USARTx).CR3
                                                                                ...
                                                                                *const uint32_t)
                                         as libc::c_uint |
                                         0x20i32 as uint32_t) as uint32_t as
                                        uint32_t)
    } else {
        ...
        ::core::ptr::write_volatile(&mut (*USARTx).CR3 as *mut uint32_t,
                                    (::core::ptr::read_volatile::<uint32_t>(&(*USARTx).CR3
                                                                                ...
                                                                                *const uint32_t)
                                         as libc::c_uint &
                                         !(0x20i32 as uint32_t)) as uint32_t
                                        as uint32_t)
    };
}
/* *
    ...
    if NewState as libc::c_uint != DISABLE as libc::c_int as libc::c_uint {
        ...
        ::core::ptr::write_volatile(&mut (*USARTx).CR3 as *mut uint32_t,
                                    (::core::ptr::read_volatile::<uint32_t>(&(*USARTx).CR3
                                                                                ...
                                                                                *const uint32_t)
                                         as libc::c_uint |
                                         0x10i32 as uint32_t) as uint32_t as
                                        uint32_t)
    } else {
...
pub unsafe extern "C" fn USART_SetAutoRetryCount(mut USARTx:
    ...
    ::core::ptr::write_volatile(&mut (*USARTx).CR3 as *mut uint32_t,
                                (::core::ptr::read_volatile::<uint32_t>(&(*USARTx).CR3
                                                                            ...
                                                                            *const uint32_t)
                                     as libc::c_uint &
                                     !(0xe0000i32 as uint32_t)) as uint32_t as
                                    uint32_t);
    ...
    ::core::ptr::write_volatile(&mut (*USARTx).CR3 as *mut uint32_t,
                                (::core::ptr::read_volatile::<uint32_t>(&(*USARTx).CR3
                                                                            ...
                                                                            *const uint32_t)
                                     as libc::c_uint |
                                     (USART_AutoCount as uint32_t) << 0x11i32)
                                    as uint32_t as uint32_t);
}
/* *
    ...
    ::core::ptr::write_volatile(&mut (*USARTx).RTOR as *mut uint32_t,
                                (::core::ptr::read_volatile::<uint32_t>(&(*USARTx).RTOR
                                     ...
                                     (USART_BlockLength as uint32_t) <<
                                         0x18i32) as uint32_t as uint32_t);
}
/* *
  * @}
  */
...
pub unsafe extern "C" fn USART_SetDEAssertionTime(mut USARTx:
    ...
    ::core::ptr::write_volatile(&mut (*USARTx).CR1 as *mut uint32_t,
                                (::core::ptr::read_volatile::<uint32_t>(&(*USARTx).CR1
                                                                            ...
                                                                            *const uint32_t)
                                     as libc::c_uint &
                                     !(0x3e00000i32 as uint32_t)) as uint32_t
                                    as uint32_t);
    ...
    ::core::ptr::write_volatile(&mut (*USARTx).CR1 as *mut uint32_t,
                                (::core::ptr::read_volatile::<uint32_t>(&(*USARTx).CR1
                                     ...
                                     USART_DEAssertionTime <<
                                         0x15i32 as uint32_t) as uint32_t as
                                    uint32_t);
}
/* *
...
pub unsafe extern "C" fn USART_SetDEDeassertionTime(mut USARTx:
    ...
    ::core::ptr::write_volatile(&mut (*USARTx).CR1 as *mut uint32_t,
                                (::core::ptr::read_volatile::<uint32_t>(&(*USARTx).CR1
                                                                            ...
                                                                            *const uint32_t)
                                     as libc::c_uint &
                                     !(0x1f0000i32 as uint32_t)) as uint32_t
                                    as uint32_t);
...
pub unsafe extern "C" fn USART_ITConfig(mut USARTx: *mut USART_TypeDef,
                                        ...
                                        mut NewState: FunctionalState) {
    let mut usartreg: uint32_t = 0i32 as uint32_t;
    let mut itpos: uint32_t = 0i32 as uint32_t;
    let mut itmask: uint32_t = 0i32 as uint32_t;
    let mut usartxbase: uint32_t = 0i32 as uint32_t;
    /* Check the parameters */
    usartxbase = USARTx as uint32_t;
    /* Get the USART register index */
    usartreg = (USART_IT as uint16_t as libc::c_int >> 0x8i32) as uint32_t;
    /* Get the interrupt position */
    itpos = USART_IT & 0xffi32 as uint32_t;
    itmask = (0x1i32 as uint32_t) << itpos;
    if usartreg == 0x2i32 as libc::c_uint {
        /* The IT is in CR2 register */
        usartxbase =
            (usartxbase as libc::c_uint).wrapping_add(0x4i32 as libc::c_uint)
                as uint32_t as uint32_t
    } else if usartreg == 0x3i32 as libc::c_uint {
        /* The IT is in CR3 register */
        usartxbase =
            (usartxbase as libc::c_uint).wrapping_add(0x8i32 as libc::c_uint)
                as uint32_t as uint32_t
    }
    if NewState as libc::c_uint != DISABLE as libc::c_int as libc::c_uint {
...
pub unsafe extern "C" fn USART_GetITStatus(mut USARTx: *mut USART_TypeDef,
                                           mut USART_IT: uint32_t)
 -> ITStatus {
    let mut bitpos: uint32_t = 0i32 as uint32_t;
    let mut itmask: uint32_t = 0i32 as uint32_t;
    let mut usartreg: uint32_t = 0i32 as uint32_t;
    ...
    usartreg = (USART_IT as uint16_t as libc::c_int >> 0x8i32) as uint32_t;
    /* Get the interrupt position */
    itmask = USART_IT & 0xffi32 as uint32_t;
    itmask = (0x1i32 as uint32_t) << itmask;
    if usartreg == 0x1i32 as libc::c_uint {
        /* The IT  is in CR1 register */
        itmask &= (*USARTx).CR1
    } else if usartreg == 0x2i32 as libc::c_uint {
        /* The IT  is in CR2 register */
        itmask &= (*USARTx).CR2
    } else {
        /* The IT  is in CR3 register */
    ...
    bitpos = USART_IT >> 0x10i32;
    bitpos = (0x1i32 as uint32_t) << bitpos;
    bitpos &= (*USARTx).ISR;
...
pub unsafe extern "C" fn USART_ClearITPendingBit(mut USARTx:
    ...
    /* Check the parameters */
    bitpos = USART_IT >> 0x10i32;
    itmask = (0x1i32 as uint32_t) << bitpos;
