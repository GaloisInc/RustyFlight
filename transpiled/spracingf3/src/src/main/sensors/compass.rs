 ...
 */
    #[no_mangle]
    fn ak8975Detect(mag_0: *mut magDev_t) -> bool;
    /*
 * This file is part of Cleanflight and Betaflight.
 *
 * Cleanflight and Betaflight are free software. You can redistribute
 ...
 */
    #[no_mangle]
    fn hmc5883lDetect(mag_0: *mut magDev_t) -> bool;
    /*
 * This file is part of Cleanflight and Betaflight.
 *
 * Cleanflight and Betaflight are free software. You can redistribute
 ...
 */
    #[no_mangle]
    fn qmc5883lDetect(magDev_0: *mut magDev_t) -> bool;
    #[no_mangle]
...
// 3. Slave I2C device on SPI gyro
    (*compassConfig_0).mag_bustype = BUSTYPE_I2C as libc::c_int as uint8_t;
    (*compassConfig_0).mag_i2c_device =
        (I2CDEV_1 as libc::c_int + 1i32) as uint8_t;
    ...
    (*compassConfig_0).interruptTag =
        (2i32 + 1i32 << 4i32 | 14i32) as ioTag_t;
}
    ...
    match (*compassConfig()).mag_bustype as libc::c_int {
        1 => {
            ...
            (*busdev).busdev_u.i2c.device =
                ((*compassConfig()).mag_i2c_device as libc::c_int - 1i32) as
                    I2CDevice;
    ...
    match (*compassConfig()).mag_hardware as libc::c_int {
        0 | 2 => {
            ...
            if hmc5883lDetect(dev) {
                (*dev).magAlign = CW270_DEG;
                magHardware = MAG_HMC5883;
                current_block_33 = 1622411330066726685;
            } else { current_block_33 = 5994951606885230396; }
        }
        5 => { current_block_33 = 5994951606885230396; }
        3 => { current_block_33 = 4479530671447819272; }
        4 | 1 => { current_block_33 = 2691304467765545606; }
        _ => { current_block_33 = 1622411330066726685; }
    }
    match current_block_33 {
        5994951606885230396 => {
            ...
            if qmc5883lDetect(dev) {
                ...
                current_block_33 = 1622411330066726685;
            } else { current_block_33 = 4479530671447819272; }
        }
        _ => { }
    }
    match current_block_33 {
        4479530671447819272 => {
            ...
            if ak8975Detect(dev) {
                ...
                current_block_33 = 1622411330066726685;
            } else { current_block_33 = 2691304467765545606; }
        }
        _ => { }
    }
    match current_block_33 {
        2691304467765545606 => { magHardware = MAG_NONE }
        _ => { }
    }
