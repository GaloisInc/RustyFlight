...
extern "C" {
    ...
    #[no_mangle]
    fn bmp085Detect(config: *const bmp085Config_t, baro_0: *mut baroDev_t)
     -> bool;
    /*
 ...
 */
    ...
    #[no_mangle]
    fn ms5611Detect(baro_0: *mut baroDev_t) -> bool;
    #[no_mangle]
...
pub unsafe extern "C" fn pgResetFn_barometerConfig(mut barometerConfig_0:
    ...
    (*barometerConfig_0).baro_bustype = BUSTYPE_I2C as libc::c_int as uint8_t;
...
pub unsafe extern "C" fn baroDetect(mut dev: *mut baroDev_t,
 ...
 -> bool {
    ...
    match (*barometerConfig()).baro_bustype as libc::c_int {
        1 => {
            ...
            (*dev).busdev.busdev_u.i2c.device =
                ((*barometerConfig()).baro_i2c_device as libc::c_int - 1i32)
                    as I2CDevice;
    ...
    match baroHardware as libc::c_uint {
        0 | 2 => {
            let mut bmp085Config: *const bmp085Config_t =
                0 as *const bmp085Config_t;
            if bmp085Detect(bmp085Config, dev) {
                baroHardware = BARO_BMP085;
                current_block_23 = 11048769245176032998;
            } else { current_block_23 = 14124266958583189972; }
        }
        3 => { current_block_23 = 14124266958583189972; }
        5 | 4 => { current_block_23 = 15570335776229543684; }
        6 | 1 => { current_block_23 = 7455596087214207069; }
        _ => { current_block_23 = 11048769245176032998; }
    }
    match current_block_23 {
        14124266958583189972 => {
            if ms5611Detect(dev) {
                baroHardware = BARO_MS5611;
                current_block_23 = 11048769245176032998;
            } else { current_block_23 = 15570335776229543684; }
        }
        _ => { }
    }
    match current_block_23 {
        15570335776229543684 => {
            if bmp280Detect(dev) {
                ...
                current_block_23 = 11048769245176032998;
            } else { current_block_23 = 7455596087214207069; }
        }
        _ => { }
    }
    match current_block_23 {
        7455596087214207069 => { baroHardware = BARO_NONE }
        _ => { }
    }
