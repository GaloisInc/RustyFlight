        ...
        [{
                 ...
                 timerDef_s{TIMx:
                            ...
                            rcc:
                                (((RCC_APB1 as libc::c_int) << 5i32) as
                                     libc::c_long |
                                     (16i32 *
                                          (0x2i32 as uint32_t as libc::c_long
                                               > 65535i64) as libc::c_int) as
                                         libc::c_long +
                                         ((8i32 *
                                               (0x2i32 as uint32_t as
                                                    libc::c_long * 1i64 >>
                                                    16i32 *
                                                        (0x2i32 as uint32_t as
                                                             libc::c_long >
                 ...
                 timerDef_s{TIMx:
                            ...
                            rcc:
                                (((RCC_APB1 as libc::c_int) << 5i32) as
                                     libc::c_long |
                                     (16i32 *
                                          (0x4i32 as uint32_t as libc::c_long
                                               > 65535i64) as libc::c_int) as
                                         libc::c_long +
                                         ((8i32 *
                                               (0x4i32 as uint32_t as
                                                    libc::c_long * 1i64 >>
                                                    16i32 *
                                                        (0x4i32 as uint32_t as
                                                             libc::c_long >
         ...
         },
         {
             let mut init =
                 timerDef_s{TIMx:
                                (0x40000000i32 as
                                     uint32_t).wrapping_add(0x1000i32 as
                                                                libc::c_uint)
                                    as *mut TIM_TypeDef,
                            rcc:
                                (((RCC_APB1 as libc::c_int) << 5i32) as
                                     libc::c_long |
                                     (16i32 *
                                          (0x10i32 as uint32_t as libc::c_long
                                               > 65535i64) as libc::c_int) as
                                         libc::c_long +
                                         ((8i32 *
         ...
         },
         {
             let mut init =
                 timerDef_s{TIMx:
                                (0x40000000i32 as
                                     uint32_t).wrapping_add(0x1400i32 as
                                                                libc::c_uint)
                                    as *mut TIM_TypeDef,
                            rcc:
                                (((RCC_APB1 as libc::c_int) << 5i32) as
                                     libc::c_long |
                                     (16i32 *
                                          (0x20i32 as uint32_t as libc::c_long
                                               > 65535i64) as libc::c_int) as
                                         libc::c_long +
                                         ((8i32 *
