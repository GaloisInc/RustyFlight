...
unsafe extern "C" fn cmsx_Blackbox_GetDeviceStatus() {
    ...
    let mut storageFree: uint32_t = 0i32 as uint32_t;
...
unsafe extern "C" fn cmsx_EraseFlash(mut pDisplay: *mut displayPort_t,
 ...
 -> libc::c_long {
    if !flashfsIsSupported() { return 0i32 as libc::c_long }
...
static mut p_ratio_data: OSD_UINT16_t =
    unsafe {
        {
            let mut init =
                OSD_UINT16_t{val:
                                 &blackboxConfig_p_ratio as *const uint16_t as
                                     *mut uint16_t,
                             min: 1i32 as uint16_t,
                             max: 32767i32 as uint16_t,
                             step: 1i32 as uint16_t,};
            init
        }
    };
static mut cmsx_menuBlackboxEntries: [OSD_Entry; 9] =
    unsafe {
        [{
             let mut init =
                 OSD_Entry{text:
         ...
         },
         {
             let mut init =
                 OSD_Entry{text:
                               b"DEVICE\x00" as *const u8 as
                                   *const libc::c_char,
                           type_0: OME_TAB,
                           func: None,
                           data:
                               &cmsx_BlackboxDeviceTable as *const OSD_TAB_t
                                   as *mut OSD_TAB_t as *mut libc::c_void,
                           flags: 0i32 as uint8_t,};
             init
         },
         {
             let mut init =
                 OSD_Entry{text:
                           ...
                           func: None,
                           data:
                               &cmsx_BlackboxStatus as
                                   *const [libc::c_char; 8] as
                                   *mut [libc::c_char; 8] as
                                   *mut libc::c_void,
                           flags: 0i32 as uint8_t,};
             init
         },
         {
             let mut init =
                 OSD_Entry{text:
                               b"(USED)\x00" as *const u8 as
                                   *const libc::c_char,
                           type_0: OME_String,
                           func: None,
                           data:
                               &cmsx_BlackboxDeviceStorageUsed as
                                   *const [libc::c_char; 8] as
                                   *mut [libc::c_char; 8] as
                                   *mut libc::c_void,
                           flags: 0i32 as uint8_t,};
         ...
         },
         {
             let mut init =
                 OSD_Entry{text:
                               b"(FREE)\x00" as *const u8 as
                                   *const libc::c_char,
                           type_0: OME_String,
                           func: None,
                           data:
                               &cmsx_BlackboxDeviceStorageFree as
                                   *const [libc::c_char; 8] as
                                   *mut [libc::c_char; 8] as
                                   *mut libc::c_void,
                           flags: 0i32 as uint8_t,};
         ...
         },
         {
             let mut init =
                 OSD_Entry{text:
                               b"P RATIO\x00" as *const u8 as
                                   *const libc::c_char,
                           type_0: OME_UINT16,
                           func: None,
                           data:
                               &p_ratio_data as *const OSD_UINT16_t as
         ...
         },
         {
             let mut init =
                 OSD_Entry{text:
                               b"ERASE FLASH\x00" as *const u8 as
                                   *const libc::c_char,
                           type_0: OME_Funcall,
                           func:
                               Some(cmsx_EraseFlash as
