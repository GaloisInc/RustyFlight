...
static mut infoTargetName: [libc::c_char; 11] =
    [83, 80, 82, 65, 67, 73, 78, 71, 70, 51, 0];
unsafe extern "C" fn cmsx_InfoInit() -> libc::c_long {
    ...
    infoGitRev[i as usize] = 0i32 as libc::c_char;
