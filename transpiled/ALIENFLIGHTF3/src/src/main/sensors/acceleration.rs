    ...
    loop  {
        ...
        match accHardwareToUse as libc::c_uint {
            0 | 3 => {
                ...
                } else { current_block_15 = 18205988150906464193; }
            }
            8 | 10 | 11 | 12 => { current_block_15 = 18205988150906464193; }
            1 | _ => { current_block_15 = 18071914750955744041; }
        }
        match current_block_15 {
            18205988150906464193 => {
                if mpu6500AccDetect(dev) as libc::c_int != 0 ||
                    ...
                    current_block_15 = 15345278821338558188;
                } else { current_block_15 = 18071914750955744041; }
            }
            _ => { }
        }
        match current_block_15 {
