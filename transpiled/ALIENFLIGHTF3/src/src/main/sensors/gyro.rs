...
unsafe extern "C" fn gyroDetect(mut dev: *mut gyroDev_t) -> gyroSensor_e {
    ...
    match gyroHardware as libc::c_uint {
        1 | 2 => {
            ...
            } else { current_block_15 = 12830656272591906119; }
        }
        7 | 9 | 10 | 11 => { current_block_15 = 12830656272591906119; }
        _ => { current_block_15 = 714134998687897190; }
    }
    match current_block_15 {
        12830656272591906119 => {
            if mpu6500GyroDetect(dev) as libc::c_int != 0 ||
                ...
                (*dev).gyroAlign = CW270_DEG;
                current_block_15 = 14763689060501151050;
            } else { current_block_15 = 714134998687897190; }
        }
        _ => { }
    }
    match current_block_15 {
        714134998687897190 => { gyroHardware = GYRO_NONE }
        _ => { }
    }
