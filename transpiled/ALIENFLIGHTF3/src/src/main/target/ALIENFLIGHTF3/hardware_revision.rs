 ...
 */
#[no_mangle]
pub static mut hardwareRevision: uint8_t =
    AFF3_UNKNOWN as libc::c_int as uint8_t;
#[no_mangle]
pub static mut haveFrSkyRX: bool = 1 as libc::c_int != 0;
static mut HWDetectPin: IO_t = 0 as *const libc::c_void as IO_t;
static mut RXDetectPin: IO_t = 0 as *const libc::c_void as IO_t;
#[no_mangle]
pub unsafe extern "C" fn detectHardwareRevision() {
    HWDetectPin =
        IOGetByTag(((1 as libc::c_int + 1 as libc::c_int) << 4 as libc::c_int
                        | 2 as libc::c_int) as
                       ioTag_t); // allow configuration to settle
    IOInit(HWDetectPin, OWNER_SYSTEM, 0 as libc::c_int as uint8_t);
    IOConfigGPIO(HWDetectPin,
    ...
    IOInit(RXDetectPin, OWNER_SYSTEM, 0 as libc::c_int as uint8_t);
    IOConfigGPIO(RXDetectPin,
                 (GPIO_Mode_IN as libc::c_int |
                      (0 as libc::c_int) << 2 as libc::c_int |
                      (0 as libc::c_int) << 4 as libc::c_int |
                      (GPIO_PuPd_UP as libc::c_int) << 5 as libc::c_int) as
                     ioConfig_t);
    delayMicroseconds(40 as libc::c_int as timeUs_t);
    // Check hardware revision
    if IORead(HWDetectPin) {
        hardwareRevision = AFF3_REV_1 as libc::c_int as uint8_t
    } else { hardwareRevision = AFF3_REV_2 as libc::c_int as uint8_t }
    // Check for integrated OpenSky reciever
    if IORead(RXDetectPin) { haveFrSkyRX = 0 as libc::c_int != 0 };
}
#[no_mangle]
...
pub unsafe extern "C" fn selectMPUIntExtiConfigByHardwareRevision()
 -> ioTag_t {
    if hardwareRevision as libc::c_int == AFF3_REV_1 as libc::c_int {
        // MPU_INT output on V1 PA15
        return ((0 as libc::c_int + 1 as libc::c_int) << 4 as libc::c_int |
