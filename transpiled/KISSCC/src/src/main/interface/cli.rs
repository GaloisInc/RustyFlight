...
pub const LOOKUP_TABLE_COUNT: lookupTableIndex_e = 33;
pub const TABLE_RC_SMOOTHING_DERIVATIVE_TYPE: lookupTableIndex_e = 32;
pub const TABLE_RC_SMOOTHING_INPUT_TYPE: lookupTableIndex_e = 31;
pub const TABLE_RC_SMOOTHING_DEBUG: lookupTableIndex_e = 30;
pub const TABLE_RC_SMOOTHING_TYPE: lookupTableIndex_e = 29;
pub const TABLE_ACRO_TRAINER_DEBUG: lookupTableIndex_e = 28;
pub const TABLE_ITERM_RELAX_TYPE: lookupTableIndex_e = 27;
pub const TABLE_ITERM_RELAX: lookupTableIndex_e = 26;
...
pub const TASK_SELF: cfTaskId_e = 20;
pub const TASK_NONE: cfTaskId_e = 19;
pub const TASK_COUNT: cfTaskId_e = 19;
pub const TASK_PINIOBOX: cfTaskId_e = 18;
pub const TASK_RCDEVICE: cfTaskId_e = 17;
pub const TASK_CAMCTRL: cfTaskId_e = 16;
pub const TASK_VTXCTRL: cfTaskId_e = 15;
pub const TASK_CMS: cfTaskId_e = 14;
pub const TASK_ESC_SENSOR: cfTaskId_e = 13;
...
#[no_mangle]
pub static mut cmdTable: [clicmd_t; 40] =
    unsafe {
        [{
             let mut init =
                 clicmd_t{name:
...
unsafe extern "C" fn cliHelp(mut cmdline: *mut libc::c_char) {
    let mut i: uint32_t = 0 as libc::c_int as uint32_t;
    while (i as libc::c_ulong) <
              (::core::mem::size_of::<[clicmd_t; 40]>() as
...
pub unsafe extern "C" fn cliProcess() {
    ...
    while serialRxBytesWaiting(cliPort) != 0 {
        ...
        if c as libc::c_int == '\t' as i32 || c as libc::c_int == '?' as i32 {
            ...
            cmd = cmdTable.as_ptr();
            while cmd <
                      cmdTable.as_ptr().offset((::core::mem::size_of::<[clicmd_t; 40]>()
                                                    as
                                                    libc::c_ulong).wrapping_div(::core::mem::size_of::<clicmd_t>()
                                                                                    as
                                                                                    libc::c_ulong)
