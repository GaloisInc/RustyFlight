 ...
 */
static mut blackboxMainFields: [blackboxDeltaFieldDefinition_t; 42] =
    [{
         let mut init =
...
pub unsafe extern "C" fn blackboxFinish() {
    ...
    match blackboxState as libc::c_uint {
        ...
        10 | 9 => {
            ...
            current_block_3 = 3961283655115006010;
        }
        _ => { current_block_3 = 3961283655115006010; }
    }
    ...
    match blackboxState as libc::c_uint {
        ...
        4 => {
            ...
            if !sendFieldDefinition('I' as i32 as libc::c_char,
                                    ...
                                    (::core::mem::size_of::<[blackboxDeltaFieldDefinition_t; 42]>()
                                         as
