 ...
 -> libc::c_int {
    ...
    match adjustmentFunction as libc::c_int {
        1 | 25 => {
            ...
            } else { current_block_82 = 15211155096274814392; }
        }
        26 => { current_block_82 = 15211155096274814392; }
        2 | 27 => {
            newValue =
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 = 15447629348493591490;
            } else { current_block_82 = 16757453751534518735; }
        }
        28 => { current_block_82 = 16757453751534518735; }
        3 => {
            newValue =
        ...
        4 | 13 => {
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 = 15447629348493591490;
            } else { current_block_82 = 18182647392458684745; }
        }
        14 => { current_block_82 = 18182647392458684745; }
        5 => {
            newValue =
        ...
        6 | 15 => {
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 =
                    10232596816230876107; // FIXME magic numbers repeated in cli.c
            }
        }
        18 => { current_block_82 = 10232596816230876107; }
        7 | 16 => {
            newValue =
                constrain((*pidProfile).pid[PID_PITCH as libc::c_int as
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 =
                    6574189535816100301; // FIXME magic numbers repeated in cli.c
            }
        }
        19 => { current_block_82 = 6574189535816100301; }
        8 | 17 => {
            newValue =
                constrain((*pidProfile).pid[PID_PITCH as libc::c_int as
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 =
                    4514984082608315366; // FIXME magic numbers repeated in cli.c
            }
        }
        20 => {
            current_block_82 =
        ...
        22 | 30 => {
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 = 15447629348493591490;
            } else { current_block_82 = 230727090839634527; }
        }
        31 => { current_block_82 = 230727090839634527; }
        32 => {
            newValue =
 ...
 -> libc::c_int {
    ...
    match adjustmentFunction as libc::c_uint {
        1 | 25 => {
            ...
            } else { current_block_84 = 814940145932166828; }
        }
        26 => { current_block_84 = 814940145932166828; }
        2 | 27 => {
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                current_block_84 = 5265702136860997526;
            } else { current_block_84 = 1791482042073027215; }
        }
        28 => { current_block_84 = 1791482042073027215; }
        3 => {
            newValue = constrain(value, 0 as libc::c_int, 100 as libc::c_int);
            (*controlRateConfig).thrExpo8 = newValue as uint8_t;
            initRcProcessing();
        ...
        4 | 13 => {
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                current_block_84 = 5265702136860997526;
            } else { current_block_84 = 8970764619016188412; }
        }
        14 => { current_block_84 = 8970764619016188412; }
        5 => {
            newValue = constrain(value, 0 as libc::c_int, 255 as libc::c_int);
            (*controlRateConfig).rates[FD_YAW as libc::c_int as usize] =
                newValue as uint8_t;
        ...
        6 | 15 => {
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                // fall through for combined ADJUSTMENT_PITCH_ROLL_P
                current_block_84 =
                    17626382846982857742; // FIXME magic numbers repeated in cli.c
            }
        }
        18 => { current_block_84 = 17626382846982857742; }
        7 | 16 => {
            newValue = constrain(value, 0 as libc::c_int, 200 as libc::c_int);
            (*pidProfile).pid[PID_PITCH as libc::c_int as usize].I =
                newValue as uint8_t;
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                // fall through for combined ADJUSTMENT_PITCH_ROLL_I
                current_block_84 =
                    3637912971593881902; // FIXME magic numbers repeated in cli.c
            }
        }
        19 => { current_block_84 = 3637912971593881902; }
        8 | 17 => {
            newValue = constrain(value, 0 as libc::c_int, 200 as libc::c_int);
            (*pidProfile).pid[PID_PITCH as libc::c_int as usize].D =
                newValue as uint8_t;
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                // fall through for combined ADJUSTMENT_PITCH_ROLL_D
                current_block_84 =
                    16933369476311955416; // FIXME magic numbers repeated in cli.c
            }
        }
        20 => {
            current_block_84 =
        ...
        22 | 30 => {
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                current_block_84 = 5265702136860997526;
            } else { current_block_84 = 16910277020422043843; }
        }
        31 => { current_block_84 = 16910277020422043843; }
        32 => {
            newValue =
                constrain(value, 0 as libc::c_int, 2000 as libc::c_int);
            (*pidProfile).pid[PID_YAW as libc::c_int as usize].F =
