 ...
 * If not, see <http://www.gnu.org/licenses/>.
 */
static mut standardBoardAlignment: bool = 1 as libc::c_int != 0;
...
pub unsafe extern "C" fn initBoardAlignment(mut boardAlignment:
    ...
    standardBoardAlignment = 0 as libc::c_int != 0;
...
unsafe extern "C" fn alignBoard(mut vec: *mut libc::c_float) {
    ...
    *vec.offset(X as libc::c_int as isize) =
        boardRotation[0 as libc::c_int as usize][X as libc::c_int as usize] *
            x +
            boardRotation[1 as libc::c_int as
                              usize][X as libc::c_int as usize] * y +
            boardRotation[2 as libc::c_int as
                              usize][X as libc::c_int as usize] * z;
    *vec.offset(Y as libc::c_int as isize) =
        boardRotation[0 as libc::c_int as usize][Y as libc::c_int as usize] *
            x +
            boardRotation[1 as libc::c_int as
                              usize][Y as libc::c_int as usize] * y +
            boardRotation[2 as libc::c_int as
                              usize][Y as libc::c_int as usize] * z;
    *vec.offset(Z as libc::c_int as isize) =
        boardRotation[0 as libc::c_int as usize][Z as libc::c_int as usize] *
            x +
            boardRotation[1 as libc::c_int as
                              usize][Z as libc::c_int as usize] * y +
            boardRotation[2 as libc::c_int as
                              usize][Z as libc::c_int as usize] * z;
}
#[no_mangle]
