...
pub const DO_DIFF: C2RustUnnamed_14 = 16;
...
pub const DUMP_MASTER: C2RustUnnamed_14 = 1;
pub const SHOW_DEFAULTS: C2RustUnnamed_14 = 32;
#[derive(Copy, Clone)]
#[repr(C)]
...
pub const HIDE_UNUSED: C2RustUnnamed_14 = 64;
/*
 * This file is part of Cleanflight and Betaflight.
 *
 * Cleanflight and Betaflight are free software. You can redistribute
...
pub const DUMP_RATES: C2RustUnnamed_14 = 4;
pub const DUMP_PROFILE: C2RustUnnamed_14 = 2;
pub const DUMP_ALL: C2RustUnnamed_14 = 8;
...
pub const ESC_INFO_BLHELI32: C2RustUnnamed_15 = 2;
pub const ESC_INFO_KISS_V2: C2RustUnnamed_15 = 1;
pub const ESC_INFO_KISS_V1: C2RustUnnamed_15 = 0;
     ...
     },
     {
         let mut init =
             cliResourceValue_t{owner:
                                ...
                                pgn: 506 as libc::c_int as pgn_t,
                                stride: 0 as libc::c_int as uint8_t,
                                offset: 0 as libc::c_ulong as uint8_t,
                                maxIndex: 0 as libc::c_int as uint8_t,};
         init
...
#[no_mangle]
pub static mut cmdTable: [clicmd_t; 44] =
    unsafe {
        [{
             let mut init =
                 clicmd_t{name:
...
unsafe extern "C" fn cliHelp(mut cmdline: *mut libc::c_char) {
    let mut i: uint32_t = 0 as libc::c_int as uint32_t;
    while (i as libc::c_ulong) <
              (::core::mem::size_of::<[clicmd_t; 44]>() as
...
pub unsafe extern "C" fn cliProcess() {
    ...
    while serialRxBytesWaiting(cliPort) != 0 {
        ...
        if c as libc::c_int == '\t' as i32 || c as libc::c_int == '?' as i32 {
            ...
            cmd = cmdTable.as_ptr();
            while cmd <
                      cmdTable.as_ptr().offset((::core::mem::size_of::<[clicmd_t; 44]>()
                                                    as
                                                    libc::c_ulong).wrapping_div(::core::mem::size_of::<clicmd_t>()
                                                                                    as
                                                                                    libc::c_ulong)
