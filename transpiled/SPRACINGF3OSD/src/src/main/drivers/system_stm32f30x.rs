...
pub unsafe extern "C" fn systemResetToBootloader() {
    ...
    *(0x20009ffc as libc::c_int as *mut uint32_t) =
        0xdeadbeef as libc::c_uint; // 40KB SRAM STM32F30X
    systemReset(); // Leave JTAG pins alone
}
#[no_mangle]
pub unsafe extern "C" fn enableGPIOPowerUsageAndNoiseReductions() {
    RCC_AHBPeriphClockCmd(0x20000 as libc::c_int as uint32_t |
                              ...
                              0x400000 as libc::c_int as uint32_t, ENABLE);
    ...
    GPIO_InitStructure.GPIO_Pin =
        (0xffff as libc::c_int as uint16_t as libc::c_int &
...
pub unsafe extern "C" fn checkForBootLoaderRequest() {
    ...
    if *(0x20009ffc as libc::c_int as *mut uint32_t) ==
           0xdeadbeef as libc::c_uint {
        *(0x20009ffc as libc::c_int as *mut uint32_t) =
            0 as libc::c_int as uint32_t;
        __enable_irq();
        __set_MSP(*(0x1fffd800 as libc::c_int as *mut uint32_t));
        bootJump =
