 ...
 -> afatfsOperationStatus_e {
    ...
    match afatfs.cacheDescriptor[cacheSectorIndex as usize].state as
        ...
        0 => {
            ...
            current_block_36 = 6360098441468201773;
        }
        3 | 1 => { current_block_36 = 6360098441468201773; }
        4 => { current_block_36 = 3697734350124797939; }
        _ => {
        ...
        if afatfs_assert((*file).directoryEntryPos.entryIndex as libc::c_int
            ...
            match mode as libc::c_uint {
                ...
                2 => {
                    ...
                    current_block_8 = 5046805715809842820;
                }
                1 => { current_block_8 = 5046805715809842820; }
            ...
            match (*opState).phase as libc::c_int {
                ...
                3 => {
                    if (*file).mode as libc::c_int & 32 as libc::c_int !=
                        ...
                        break ;
                    } else { current_block = 6717214610478484138; break ; }
                }
                4 => {
                ...
                _ => { current_block = 12758904613967585247; break ; }
            }
        }
    match current_block {
        572715077006366937 =>
    ...
    match current_block {
        6717214610478484138 => {
            ...
            if (*file).cursorCluster == 0 as libc::c_int as libc::c_uint {
                ...
                } else { current_block = 2706659501864706830; }
            } else {
