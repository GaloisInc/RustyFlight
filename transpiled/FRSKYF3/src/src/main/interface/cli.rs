...
pub const LOOKUP_TABLE_COUNT: lookupTableIndex_e = 36;
pub const TABLE_RC_SMOOTHING_DERIVATIVE_TYPE: lookupTableIndex_e = 35;
pub const TABLE_RC_SMOOTHING_INPUT_TYPE: lookupTableIndex_e = 34;
pub const TABLE_RC_SMOOTHING_DEBUG: lookupTableIndex_e = 33;
pub const TABLE_RC_SMOOTHING_TYPE: lookupTableIndex_e = 32;
