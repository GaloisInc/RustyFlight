 ...
 */
    ...
    #[no_mangle]
    fn icm20689SpiAccDetect(acc_0: *mut accDev_t) -> bool;
    #[no_mangle]
        ...
        match accHardwareToUse as libc::c_uint {
            0 | 7 => {
                if mpu6000SpiAccDetect(dev) {
                    ...
                    current_block_19 = 14434620278749266018;
                } else { current_block_19 = 3692834471412389365; }
            }
            8 | 10 | 11 | 12 => { current_block_19 = 3692834471412389365; }
            14 => { current_block_19 = 3258101451345795692; }
            1 | _ => { current_block_19 = 9933386508993631253; }
        }
        match current_block_19 {
            3692834471412389365 => {
                if mpu6500AccDetect(dev) as libc::c_int != 0 ||
                    ...
                    current_block_19 = 14434620278749266018;
                } else { current_block_19 = 3258101451345795692; }
            }
            _ => { }
        }
        match current_block_19 {
            3258101451345795692 => {
                if icm20689SpiAccDetect(dev) {
                    ...
                    (*dev).accAlign = CW180_DEG;
                    current_block_19 = 14434620278749266018;
                } else { current_block_19 = 9933386508993631253; }
            }
            _ => { }
        }
        match current_block_19 {
