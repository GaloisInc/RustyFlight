 ...
 -> afatfsOperationStatus_e {
    ...
    match afatfs.cacheDescriptor[cacheSectorIndex as usize].state as
        ...
        0 => {
            ...
            current_block_36 = 3405502113825085733;
        }
        3 | 1 => { current_block_36 = 3405502113825085733; }
        4 => { current_block_36 = 2477171227625166794; }
        _ => {
        ...
        if afatfs_assert((*file).directoryEntryPos.entryIndex as libc::c_int
            ...
            match mode as libc::c_uint {
                ...
                2 => {
                    ...
                    current_block_8 = 8206493442991518448;
                }
                1 => { current_block_8 = 8206493442991518448; }
