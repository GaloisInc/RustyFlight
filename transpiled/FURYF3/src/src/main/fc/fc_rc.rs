...
pub unsafe extern "C" fn initRcProcessing() {
    ...
    match (*rxConfig()).rcInterpolationChannels as libc::c_int {
        2 => {
            ...
            current_block_22 = 17054658215455152302;
        }
        1 => { current_block_22 = 17054658215455152302; }
        0 => { current_block_22 = 13407498509347608683; }
        4 => {
            interpolationChannels =
                (interpolationChannels as libc::c_int |
                     (ROLL_FLAG as libc::c_int | PITCH_FLAG as libc::c_int))
                    as uint8_t;
            current_block_22 = 5953584490860659836;
        }
        3 => { current_block_22 = 5953584490860659836; }
    ...
    match current_block_22 {
        17054658215455152302 => {
            ...
            current_block_22 = 13407498509347608683;
        }
        5953584490860659836 => {
            interpolationChannels =
                (interpolationChannels as libc::c_int |
