...
pub unsafe extern "C" fn pgResetFn_adcConfig(mut adcConfig:
    ...
    (*adcConfig).external1.enabled = 1 as libc::c_int != 0;
    (*adcConfig).external1.ioTag = 0 as libc::c_int as ioTag_t;
    (*adcConfig).current.enabled = 1 as libc::c_int != 0;
    (*adcConfig).current.ioTag =
        ((0 as libc::c_int + 1 as libc::c_int) << 4 as libc::c_int |
             1 as libc::c_int) as ioTag_t;
    (*adcConfig).rssi.enabled = 1 as libc::c_int != 0;
    (*adcConfig).rssi.ioTag = 0 as libc::c_int as ioTag_t;
}
// USE_ADC
