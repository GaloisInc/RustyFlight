...
pub static mut lookupTables: [lookupTableEntry_t; 34] =
    [lookupTableEntry_t{values: 0 as *const *const libc::c_char,
                        valueCount: 0,}; 34];
#[no_mangle]
pub static mut valueTable: [clivalue_t; 248] =
    [{
         let mut init =
             clivalue_s{name:
     ...
     },
     {
         let mut init =
             clivalue_s{name:
                            b"frsky_spi_autobind\x00" as *const u8 as
                                *const libc::c_char,
                        type_0:
                            (VAR_UINT8 as libc::c_int |
                                 MASTER_VALUE as libc::c_int |
                        ...
                        pgn: 523 as libc::c_int as pgn_t,
                        offset: 0 as libc::c_ulong as uint16_t,};
         init
     },
     {
         let mut init =
             clivalue_s{name:
                            b"frsky_spi_tx_id\x00" as *const u8 as
                                *const libc::c_char,
                        type_0:
                            (VAR_UINT8 as libc::c_int |
                                 MASTER_VALUE as libc::c_int |
     ...
     },
     {
         let mut init =
             clivalue_s{name:
                            b"frsky_spi_offset\x00" as *const u8 as
                                *const libc::c_char,
                        type_0:
                            (VAR_INT8 as libc::c_int |
                                 MASTER_VALUE as libc::c_int) as uint8_t,
     ...
     },
     {
         let mut init =
             clivalue_s{name:
                            b"frsky_spi_bind_hop_data\x00" as *const u8 as
                                *const libc::c_char,
                        type_0:
                            (VAR_UINT8 as libc::c_int |
                                 MASTER_VALUE as libc::c_int |
     ...
     },
     {
         let mut init =
             clivalue_s{name:
                            b"frsky_x_rx_num\x00" as *const u8 as
                                *const libc::c_char,
                        type_0:
                            (VAR_UINT8 as libc::c_int |
                                 MASTER_VALUE as libc::c_int) as uint8_t,
     ...
     },
     {
         let mut init =
             clivalue_s{name:
                            b"frsky_spi_use_external_adc\x00" as *const u8 as
                                *const libc::c_char,
                        type_0:
                            (VAR_UINT8 as libc::c_int |
                                 MASTER_VALUE as libc::c_int |
                        ...
                        pgn: 523 as libc::c_int as pgn_t,
                        offset: 55 as libc::c_ulong as uint16_t,};
         init
     },
     {
         let mut init =
...
unsafe extern "C" fn run_static_initializers() {
    ...
    valueTableEntryCount =
        (::core::mem::size_of::<[clivalue_t; 248]>() as
