...
pub const MSP_SDCARD_STATE_FATAL: C2RustUnnamed_14 = 1;
...
pub const MSP_SDCARD_STATE_CARD_INIT: C2RustUnnamed_14 = 2;
pub const MSP_SDCARD_STATE_FS_INIT: C2RustUnnamed_14 = 3;
pub const AFATFS_FILESYSTEM_STATE_INITIALIZATION: afatfsFilesystemState_e = 2;
pub const MSP_SDCARD_STATE_READY: C2RustUnnamed_14 = 4;
pub const AFATFS_FILESYSTEM_STATE_READY: afatfsFilesystemState_e = 3;
pub type afatfsFilesystemState_e = libc::c_uint;
pub const MSP_SDCARD_STATE_NOT_PRESENT: C2RustUnnamed_14 = 0;
pub const MSP_SDCARD_FLAG_SUPPORTTED: C2RustUnnamed_15 = 1;
    ...
    match escMode as libc::c_int {
        ...
        0 | 1 | 2 | 3 | 4 => {
            if (escPortIndex as libc::c_int) < getMotorCount() as libc::c_int
                ...
                current_block_16 = 18317007320854588510;
            } else { current_block_16 = 2538189916056597439; }
        }
        _ => { current_block_16 = 2538189916056597439; }
    }
