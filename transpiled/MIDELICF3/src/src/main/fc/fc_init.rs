...
pub const RX_SPI_FRSKY_D: C2RustUnnamed_4 = 8;
// ADCDevice
/*
 * This file is part of Cleanflight and Betaflight.
 *
...
pub const RX_SPI_PROTOCOL_COUNT: C2RustUnnamed_4 = 13;
pub const RX_SPI_NRF24_KN: C2RustUnnamed_4 = 12;
pub const RX_SPI_A7105_FLYSKY_2A: C2RustUnnamed_4 = 11;
pub const RX_SPI_A7105_FLYSKY: C2RustUnnamed_4 = 10;
pub const RX_SPI_FRSKY_X: C2RustUnnamed_4 = 9;
pub const RX_SPI_NRF24_INAV: C2RustUnnamed_4 = 7;
pub const RX_SPI_NRF24_H8_3D: C2RustUnnamed_4 = 6;
pub const RX_SPI_NRF24_CX10A: C2RustUnnamed_4 = 5;
pub const RX_SPI_NRF24_CX10: C2RustUnnamed_4 = 4;
pub const RX_SPI_NRF24_SYMA_X5C: C2RustUnnamed_4 = 3;
pub const RX_SPI_NRF24_SYMA_X: C2RustUnnamed_4 = 2;
pub const RX_SPI_NRF24_V202_1M: C2RustUnnamed_4 = 1;
pub const RX_SPI_NRF24_V202_250K: C2RustUnnamed_4 = 0;
...
pub unsafe extern "C" fn init() {
    ...
    if !readSuccess || !isEEPROMVersionValid() ||
           strncasecmp((*systemConfig()).boardIdentifier.as_ptr(),
                       b"MIF3\x00" as *const u8 as *const libc::c_char,
...
// XXX And these no longer work properly as FEATURE_RANGEFINDER does control HCSR04 runtime configuration.
    ...
    let ref mut fresh0 = (*adcConfigMutable()).rssi.enabled;
    *fresh0 =
        (*fresh0 as libc::c_int |
             (feature(FEATURE_RX_SPI as libc::c_int as uint32_t) as
                  libc::c_int != 0 &&
                  (*rxSpiConfig()).rx_spi_protocol as libc::c_int ==
                      RX_SPI_FRSKY_D as libc::c_int) as libc::c_int) as bool;
    adcInit(adcConfig());
