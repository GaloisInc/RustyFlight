...
unsafe extern "C" fn gyroDetect(mut dev: *mut gyroDev_t) -> gyroSensor_e {
    ...
    match gyroHardware as libc::c_uint {
        1 | 6 => {
            ...
            } else { current_block_15 = 7867765481719854029; }
        }
        7 | 9 | 10 | 11 => { current_block_15 = 7867765481719854029; }
        _ => { current_block_15 = 5381297608968995174; }
    }
    match current_block_15 {
        7867765481719854029 => {
            if mpu6500GyroDetect(dev) as libc::c_int != 0 ||
                ...
                current_block_15 = 14763689060501151050;
            } else { current_block_15 = 5381297608968995174; }
        }
        _ => { }
    }
    match current_block_15 {
        5381297608968995174 => { gyroHardware = GYRO_NONE }
        _ => { }
    }
