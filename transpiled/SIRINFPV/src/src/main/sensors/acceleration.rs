    ...
    loop  {
        ...
        match accHardwareToUse as libc::c_uint {
            0 | 7 => {
                ...
                } else { current_block_15 = 15093231721318366004; }
            }
            8 | 10 | 11 | 12 => { current_block_15 = 15093231721318366004; }
            1 | _ => { current_block_15 = 3702701441878021084; }
        }
        match current_block_15 {
            15093231721318366004 => {
                if mpu6500AccDetect(dev) as libc::c_int != 0 ||
                    ...
                    current_block_15 = 15345278821338558188;
                } else { current_block_15 = 3702701441878021084; }
            }
            _ => { }
        }
        match current_block_15 {
