...
pub unsafe extern "C" fn TIM_TimeBaseInit(mut TIMx: *mut TIM_TypeDef,
    ...
    ::core::ptr::write_volatile(&mut (*TIMx).EGR as *mut uint32_t,
                                0x1 as libc::c_int as uint16_t as uint32_t);
}
/* *
...
pub unsafe extern "C" fn TIM_TimeBaseStructInit(mut TIM_TimeBaseInitStruct:
    ...
    (*TIM_TimeBaseInitStruct).TIM_Period = 0xffffffff as libc::c_uint;
...
pub unsafe extern "C" fn TIM_CounterModeConfig(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpcr1 =
        (tmpcr1 as libc::c_int &
             !(0x10 as libc::c_int as uint16_t as libc::c_int |
                   0x60 as libc::c_int as uint16_t as libc::c_int) as uint16_t
...
pub unsafe extern "C" fn TIM_OC1Init(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccmrx &= !(0x10070 as libc::c_int as uint32_t);
    tmpccmrx &= !(0x3 as libc::c_int as uint32_t);
    /* Select the Output Compare Mode */
    tmpccmrx |= (*TIM_OCInitStruct).TIM_OCMode;
    /* Reset the Output Polarity level */
    tmpccer &= !(0x2 as libc::c_int as uint32_t);
    ...
    if TIMx ==
        ...
        tmpccer &= !(0x8 as libc::c_int as uint32_t);
        /* Set the Output N Polarity */
        tmpccer |= (*TIM_OCInitStruct).TIM_OCNPolarity as libc::c_uint;
        /* Reset the Output N State */
        tmpccer &= !(0x4 as libc::c_int as uint32_t);
        /* Set the Output N State */
        tmpccer |= (*TIM_OCInitStruct).TIM_OutputNState as libc::c_uint;
        /* Reset the Output Compare and Output Compare N IDLE State */
        tmpcr2 &= !(0x100 as libc::c_int as uint32_t);
        tmpcr2 &= !(0x200 as libc::c_int as uint32_t);
...
pub unsafe extern "C" fn TIM_OC2Init(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccmrx &= !(0x1007000 as libc::c_int as uint32_t);
    tmpccmrx &= !(0x300 as libc::c_int as uint32_t);
    /* Select the Output Compare Mode */
    tmpccmrx |= (*TIM_OCInitStruct).TIM_OCMode << 8 as libc::c_int;
    /* Reset the Output Polarity level */
    tmpccer &= !(0x20 as libc::c_int as uint32_t);
    /* Set the Output Compare Polarity */
    tmpccer |=
        ((*TIM_OCInitStruct).TIM_OCPolarity as uint32_t) << 4 as libc::c_int;
    /* Set the Output State */
    tmpccer |=
        ((*TIM_OCInitStruct).TIM_OutputState as uint32_t) << 4 as libc::c_int;
    if TIMx ==
           (0x40000000 as libc::c_int as
                uint32_t).wrapping_add(0x10000 as libc::c_int as
                                           libc::c_uint).wrapping_add(0x2c00
           ...
           TIMx ==
               (0x40000000 as libc::c_int as
                   ...
                   as *mut TIM_TypeDef {
        /* Reset the Output N Polarity level */
        tmpccer &= !(0x80 as libc::c_int as uint32_t);
        /* Set the Output N Polarity */
        tmpccer |=
            ((*TIM_OCInitStruct).TIM_OCNPolarity as uint32_t) <<
                4 as libc::c_int;
        /* Reset the Output N State */
        tmpccer &= !(0x40 as libc::c_int as uint32_t);
        /* Set the Output N State */
        tmpccer |=
            ((*TIM_OCInitStruct).TIM_OutputNState as uint32_t) <<
                4 as libc::c_int;
        /* Reset the Output Compare and Output Compare N IDLE State */
        tmpcr2 &= !(0x400 as libc::c_int as uint32_t);
        tmpcr2 &= !(0x800 as libc::c_int as uint32_t);
        /* Set the Output Idle state */
        tmpcr2 |=
            ((*TIM_OCInitStruct).TIM_OCIdleState as uint32_t) <<
                2 as libc::c_int;
        /* Set the Output N Idle state */
        tmpcr2 |=
            ((*TIM_OCInitStruct).TIM_OCNIdleState as uint32_t) <<
                2 as libc::c_int
    }
    /* Write to TIMx CR2 */
    ::core::ptr::write_volatile(&mut (*TIMx).CR2 as *mut uint32_t, tmpcr2);
...
pub unsafe extern "C" fn TIM_OC3Init(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccmrx = (*TIMx).CCMR2;
    /* Reset the Output Compare mode and Capture/Compare selection Bits */
    tmpccmrx &= !(0x70 as libc::c_int as uint32_t);
    tmpccmrx &= !(0x3 as libc::c_int as uint32_t);
    /* Select the Output Compare Mode */
    tmpccmrx |= (*TIM_OCInitStruct).TIM_OCMode;
    /* Reset the Output Polarity level */
    tmpccer &= !(0x200 as libc::c_int as uint32_t);
    /* Set the Output Compare Polarity */
    tmpccer |=
        ((*TIM_OCInitStruct).TIM_OCPolarity as uint32_t) << 8 as libc::c_int;
    /* Set the Output State */
    tmpccer |=
        ((*TIM_OCInitStruct).TIM_OutputState as uint32_t) << 8 as libc::c_int;
    if TIMx ==
           (0x40000000 as libc::c_int as
                uint32_t).wrapping_add(0x10000 as libc::c_int as
                                           libc::c_uint).wrapping_add(0x2c00
           ...
           TIMx ==
               (0x40000000 as libc::c_int as
                   ...
                   as *mut TIM_TypeDef {
        /* Reset the Output N Polarity level */
        tmpccer &= !(0x800 as libc::c_int as uint32_t);
        /* Set the Output N Polarity */
        tmpccer |=
            ((*TIM_OCInitStruct).TIM_OCNPolarity as uint32_t) <<
                8 as libc::c_int;
        /* Reset the Output N State */
        tmpccer &= !(0x400 as libc::c_int as uint32_t);
        /* Set the Output N State */
        tmpccer |=
            ((*TIM_OCInitStruct).TIM_OutputNState as uint32_t) <<
                8 as libc::c_int;
        /* Reset the Output Compare and Output Compare N IDLE State */
        tmpcr2 &= !(0x1000 as libc::c_int as uint32_t);
        tmpcr2 &= !(0x2000 as libc::c_int as uint32_t);
        /* Set the Output Idle state */
        tmpcr2 |=
            ((*TIM_OCInitStruct).TIM_OCIdleState as uint32_t) <<
                4 as libc::c_int;
...
pub unsafe extern "C" fn TIM_OC4Init(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccmrx = (*TIMx).CCMR2;
    /* Reset the Output Compare mode and Capture/Compare selection Bits */
    tmpccmrx &= !(0x7000 as libc::c_int as uint32_t);
    tmpccmrx &= !(0x300 as libc::c_int as uint32_t);
    /* Select the Output Compare Mode */
    tmpccmrx |= (*TIM_OCInitStruct).TIM_OCMode << 8 as libc::c_int;
    /* Reset the Output Polarity level */
    tmpccer &= !(0x2000 as libc::c_int as uint32_t);
    /* Set the Output Compare Polarity */
    tmpccer |=
        ((*TIM_OCInitStruct).TIM_OCPolarity as uint32_t) << 12 as libc::c_int;
    /* Set the Output State */
    tmpccer |=
        ((*TIM_OCInitStruct).TIM_OutputState as uint32_t) <<
            12 as libc::c_int;
    if TIMx ==
           (0x40000000 as libc::c_int as
                uint32_t).wrapping_add(0x10000 as libc::c_int as
        ...
        tmpcr2 &= !(0x4000 as libc::c_int as uint32_t);
        /* Set the Output Idle state */
        tmpcr2 |=
            ((*TIM_OCInitStruct).TIM_OCIdleState as uint32_t) <<
                6 as libc::c_int
...
pub unsafe extern "C" fn TIM_OC5Init(mut TIMx: *mut TIM_TypeDef,
    ...
    ::core::ptr::write_volatile(&mut (*TIMx).CCER as *mut uint32_t,
                                (::core::ptr::read_volatile::<uint32_t>(&(*TIMx).CCER
                                    ...
                                    uint32_t as uint32_t); /* to be verified*/
    /* Get the TIMx CCER register value */
    tmpccer = (*TIMx).CCER;
    /* Get the TIMx CR2 register value */
    tmpcr2 = (*TIMx).CR2;
    ...
    tmpccmrx |= (*TIM_OCInitStruct).TIM_OCMode;
    /* Reset the Output Polarity level */
    tmpccer &= !(0x20000 as libc::c_int as uint32_t);
    /* Set the Output Compare Polarity */
    tmpccer |=
        ((*TIM_OCInitStruct).TIM_OCPolarity as uint32_t) << 16 as libc::c_int;
    /* Set the Output State */
    tmpccer |=
        ((*TIM_OCInitStruct).TIM_OutputState as uint32_t) <<
            16 as libc::c_int;
    if TIMx ==
           ...
           TIMx ==
               (0x40000000 as libc::c_int as
                   ...
                   as *mut TIM_TypeDef {
        /* Reset the Output Compare IDLE State */
        tmpcr2 &= !(0x10000 as libc::c_int as uint32_t);
        /* Set the Output Idle state */
        tmpcr2 |=
            ((*TIM_OCInitStruct).TIM_OCIdleState as uint32_t) <<
                16 as libc::c_int
...
pub unsafe extern "C" fn TIM_OC6Init(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccmrx |= (*TIM_OCInitStruct).TIM_OCMode << 8 as libc::c_int;
    /* Reset the Output Polarity level */
    tmpccer &= !(0x200000 as libc::c_int as uint32_t);
    /* Set the Output Compare Polarity */
    tmpccer |=
        ((*TIM_OCInitStruct).TIM_OCPolarity as uint32_t) << 20 as libc::c_int;
    /* Set the Output State */
    tmpccer |=
        ((*TIM_OCInitStruct).TIM_OutputState as uint32_t) <<
            20 as libc::c_int;
    if TIMx ==
           ...
           TIMx ==
               (0x40000000 as libc::c_int as
                   ...
                   as *mut TIM_TypeDef {
        /* Reset the Output Compare IDLE State */
        tmpcr2 &= !(0x20000 as libc::c_int as uint32_t);
        /* Set the Output Idle state */
        tmpcr2 |=
            (((*TIM_OCInitStruct).TIM_OCIdleState as libc::c_int) <<
                 18 as libc::c_int) as uint16_t as libc::c_uint
    }
    /* Write to TIMx CR2 */
    ::core::ptr::write_volatile(&mut (*TIMx).CR2 as *mut uint32_t, tmpcr2);
    /* Write to TIMx CCMR2 */
...
pub unsafe extern "C" fn TIM_OCStructInit(mut TIM_OCInitStruct:
                                              *mut TIM_OCInitTypeDef) {
    /* Set the default configuration */
    (*TIM_OCInitStruct).TIM_OCMode = 0 as libc::c_int as uint32_t;
    ...
    (*TIM_OCInitStruct).TIM_Pulse = 0 as libc::c_int as uint32_t;
...
pub unsafe extern "C" fn TIM_ForcedOC1Config(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccmr1 = (*TIMx).CCMR1;
    /* Reset the OC1M Bits */
    tmpccmr1 &= !(0x10070 as libc::c_int as uint32_t);
...
pub unsafe extern "C" fn TIM_ForcedOC2Config(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccmr1 = (*TIMx).CCMR1;
    /* Reset the OC2M Bits */
    tmpccmr1 &= !(0x1007000 as libc::c_int as uint32_t);
    /* Configure The Forced output Mode */
    tmpccmr1 |= (TIM_ForcedAction as uint32_t) << 8 as libc::c_int;
    /* Write to TIMx CCMR1 register */
    ::core::ptr::write_volatile(&mut (*TIMx).CCMR1 as *mut uint32_t,
                                tmpccmr1);
}
...
pub unsafe extern "C" fn TIM_ForcedOC3Config(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccmr2 = (*TIMx).CCMR2;
    /* Reset the OC1M Bits */
    tmpccmr2 &= !(0x70 as libc::c_int as uint32_t);
    /* Configure The Forced output Mode */
...
pub unsafe extern "C" fn TIM_ForcedOC4Config(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccmr2 = (*TIMx).CCMR2;
    /* Reset the OC2M Bits */
    tmpccmr2 &= !(0x7000 as libc::c_int as uint32_t);
    /* Configure The Forced output Mode */
    tmpccmr2 |= (TIM_ForcedAction as uint32_t) << 8 as libc::c_int;
    /* Write to TIMx CCMR2 register */
    ::core::ptr::write_volatile(&mut (*TIMx).CCMR2 as *mut uint32_t,
                                tmpccmr2);
}
...
pub unsafe extern "C" fn TIM_ForcedOC5Config(mut TIMx: *mut TIM_TypeDef,
                                             mut TIM_ForcedAction: uint16_t) {
    let mut tmpccmr3: uint32_t = 0 as libc::c_int as uint32_t;
    /* Check the parameters */
    tmpccmr3 = (*TIMx).CCMR3;
    /* Reset the OC5M Bits */
    tmpccmr3 &= !(0x70 as libc::c_int as uint32_t);
    /* Configure The Forced output Mode */
...
pub unsafe extern "C" fn TIM_ForcedOC6Config(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccmr3 = (*TIMx).CCMR3;
    /* Reset the OC6M Bits */
    tmpccmr3 &= !(0x7000 as libc::c_int as uint32_t);
    /* Configure The Forced output Mode */
    tmpccmr3 |= (TIM_ForcedAction as uint32_t) << 8 as libc::c_int;
    /* Write to TIMx CCMR3 register */
    ::core::ptr::write_volatile(&mut (*TIMx).CCMR3 as *mut uint32_t,
                                tmpccmr3);
}
...
pub unsafe extern "C" fn TIM_OC1PreloadConfig(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccmr1 = (*TIMx).CCMR1;
    /* Reset the OC1PE Bit */
    tmpccmr1 &= !(0x8 as libc::c_int as uint32_t);
...
pub unsafe extern "C" fn TIM_OC2PreloadConfig(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccmr1 = (*TIMx).CCMR1;
    /* Reset the OC2PE Bit */
    tmpccmr1 &= !(0x800 as libc::c_int as uint32_t);
    /* Enable or Disable the Output Compare Preload feature */
    tmpccmr1 |= (TIM_OCPreload as uint32_t) << 8 as libc::c_int;
    /* Write to TIMx CCMR1 register */
    ::core::ptr::write_volatile(&mut (*TIMx).CCMR1 as *mut uint32_t,
                                tmpccmr1);
}
...
pub unsafe extern "C" fn TIM_OC3PreloadConfig(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccmr2 = (*TIMx).CCMR2;
    /* Reset the OC3PE Bit */
    tmpccmr2 &= !(0x8 as libc::c_int as uint32_t);
    /* Enable or Disable the Output Compare Preload feature */
...
pub unsafe extern "C" fn TIM_OC4PreloadConfig(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccmr2 = (*TIMx).CCMR2;
    /* Reset the OC4PE Bit */
    tmpccmr2 &= !(0x800 as libc::c_int as uint32_t);
    /* Enable or Disable the Output Compare Preload feature */
    tmpccmr2 |= (TIM_OCPreload as uint32_t) << 8 as libc::c_int;
    /* Write to TIMx CCMR2 register */
    ::core::ptr::write_volatile(&mut (*TIMx).CCMR2 as *mut uint32_t,
                                tmpccmr2);
}
...
pub unsafe extern "C" fn TIM_OC5PreloadConfig(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccmr3 = (*TIMx).CCMR3;
    /* Reset the OC5PE Bit */
    tmpccmr3 &= !(0x8 as libc::c_int as uint32_t);
    /* Enable or Disable the Output Compare Preload feature */
...
pub unsafe extern "C" fn TIM_OC6PreloadConfig(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccmr3 = (*TIMx).CCMR3;
    /* Reset the OC5PE Bit */
    tmpccmr3 &= !(0x800 as libc::c_int as uint32_t);
    /* Enable or Disable the Output Compare Preload feature */
    tmpccmr3 |= (TIM_OCPreload as uint32_t) << 8 as libc::c_int;
    /* Write to TIMx CCMR3 register */
    ::core::ptr::write_volatile(&mut (*TIMx).CCMR3 as *mut uint32_t,
                                tmpccmr3);
}
...
pub unsafe extern "C" fn TIM_OC1FastConfig(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccmr1 = (*TIMx).CCMR1;
    /* Reset the OC1FE Bit */
    tmpccmr1 &= !(0x4 as libc::c_int as uint32_t);
...
pub unsafe extern "C" fn TIM_OC2FastConfig(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccmr1 = (*TIMx).CCMR1;
    /* Reset the OC2FE Bit */
    tmpccmr1 &= !(0x400 as libc::c_int as uint32_t);
    /* Enable or Disable the Output Compare Fast Bit */
    tmpccmr1 |= (TIM_OCFast as uint32_t) << 8 as libc::c_int;
    /* Write to TIMx CCMR1 */
    ::core::ptr::write_volatile(&mut (*TIMx).CCMR1 as *mut uint32_t,
                                tmpccmr1);
}
...
pub unsafe extern "C" fn TIM_OC3FastConfig(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccmr2 = (*TIMx).CCMR2;
    /* Reset the OC3FE Bit */
    tmpccmr2 &= !(0x4 as libc::c_int as uint32_t);
    /* Enable or Disable the Output Compare Fast Bit */
...
pub unsafe extern "C" fn TIM_OC4FastConfig(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccmr2 = (*TIMx).CCMR2;
    /* Reset the OC4FE Bit */
    tmpccmr2 &= !(0x400 as libc::c_int as uint32_t);
    /* Enable or Disable the Output Compare Fast Bit */
    tmpccmr2 |= (TIM_OCFast as uint32_t) << 8 as libc::c_int;
    /* Write to TIMx CCMR2 */
    ::core::ptr::write_volatile(&mut (*TIMx).CCMR2 as *mut uint32_t,
                                tmpccmr2);
}
...
pub unsafe extern "C" fn TIM_ClearOC1Ref(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccmr1 = (*TIMx).CCMR1;
    /* Reset the OC1CE Bit */
    tmpccmr1 &= !(0x80 as libc::c_int as uint32_t);
...
pub unsafe extern "C" fn TIM_ClearOC2Ref(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccmr1 = (*TIMx).CCMR1;
    /* Reset the OC2CE Bit */
    tmpccmr1 &= !(0x8000 as libc::c_int as uint32_t);
    /* Enable or Disable the Output Compare Clear Bit */
    tmpccmr1 |= (TIM_OCClear as uint32_t) << 8 as libc::c_int;
    /* Write to TIMx CCMR1 register */
    ::core::ptr::write_volatile(&mut (*TIMx).CCMR1 as *mut uint32_t,
                                tmpccmr1);
}
...
pub unsafe extern "C" fn TIM_ClearOC3Ref(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccmr2 = (*TIMx).CCMR2;
    /* Reset the OC3CE Bit */
    tmpccmr2 &= !(0x80 as libc::c_int as uint32_t);
    /* Enable or Disable the Output Compare Clear Bit */
...
pub unsafe extern "C" fn TIM_ClearOC4Ref(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccmr2 = (*TIMx).CCMR2;
    /* Reset the OC4CE Bit */
    tmpccmr2 &= !(0x8000 as libc::c_int as uint32_t);
    /* Enable or Disable the Output Compare Clear Bit */
    tmpccmr2 |= (TIM_OCClear as uint32_t) << 8 as libc::c_int;
    /* Write to TIMx CCMR2 register */
    ::core::ptr::write_volatile(&mut (*TIMx).CCMR2 as *mut uint32_t,
                                tmpccmr2);
}
...
pub unsafe extern "C" fn TIM_ClearOC5Ref(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccmr3 = (*TIMx).CCMR3;
    /* Reset the OC5CE Bit */
    tmpccmr3 &= !(0x80 as libc::c_int as uint32_t);
    /* Enable or Disable the Output Compare Clear Bit */
...
pub unsafe extern "C" fn TIM_ClearOC6Ref(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccmr3 = (*TIMx).CCMR3;
    /* Reset the OC5CE Bit */
    tmpccmr3 &= !(0x8000 as libc::c_int as uint32_t);
    /* Enable or Disable the Output Compare Clear Bit */
    tmpccmr3 |= (TIM_OCClear as uint32_t) << 8 as libc::c_int;
    /* Write to TIMx CCMR3 register */
    ::core::ptr::write_volatile(&mut (*TIMx).CCMR3 as *mut uint32_t,
                                tmpccmr3);
}
...
pub unsafe extern "C" fn TIM_OC2PolarityConfig(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccer &= !(0x20 as libc::c_int as uint32_t);
    tmpccer |= (TIM_OCPolarity as uint32_t) << 4 as libc::c_int;
    /* Write to TIMx CCER register */
    ::core::ptr::write_volatile(&mut (*TIMx).CCER as *mut uint32_t, tmpccer);
}
/* *
...
pub unsafe extern "C" fn TIM_OC2NPolarityConfig(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccer &= !(0x80 as libc::c_int as uint32_t);
    tmpccer |= (TIM_OCNPolarity as uint32_t) << 4 as libc::c_int;
    /* Write to TIMx CCER register */
    ::core::ptr::write_volatile(&mut (*TIMx).CCER as *mut uint32_t, tmpccer);
}
/* *
...
pub unsafe extern "C" fn TIM_OC3PolarityConfig(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccer &= !(0x200 as libc::c_int as uint32_t);
    tmpccer |= (TIM_OCPolarity as uint32_t) << 8 as libc::c_int;
    /* Write to TIMx CCER register */
    ::core::ptr::write_volatile(&mut (*TIMx).CCER as *mut uint32_t, tmpccer);
}
/* *
...
pub unsafe extern "C" fn TIM_OC3NPolarityConfig(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccer &= !(0x800 as libc::c_int as uint32_t);
    tmpccer |= (TIM_OCNPolarity as uint32_t) << 8 as libc::c_int;
    /* Write to TIMx CCER register */
    ::core::ptr::write_volatile(&mut (*TIMx).CCER as *mut uint32_t, tmpccer);
}
/* *
...
pub unsafe extern "C" fn TIM_OC4PolarityConfig(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccer &= !(0x2000 as libc::c_int as uint32_t);
    tmpccer |= (TIM_OCPolarity as uint32_t) << 12 as libc::c_int;
    /* Write to TIMx CCER register */
    ::core::ptr::write_volatile(&mut (*TIMx).CCER as *mut uint32_t, tmpccer);
}
/* *
...
pub unsafe extern "C" fn TIM_OC5PolarityConfig(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccer &= !(0x20000 as libc::c_int as uint32_t);
    tmpccer |= (TIM_OCPolarity as uint32_t) << 16 as libc::c_int;
    /* Write to TIMx CCER register */
    ::core::ptr::write_volatile(&mut (*TIMx).CCER as *mut uint32_t, tmpccer);
}
/* *
...
pub unsafe extern "C" fn TIM_OC6PolarityConfig(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccer &= !(0x200000 as libc::c_int as uint32_t);
    tmpccer |= (TIM_OCPolarity as uint32_t) << 20 as libc::c_int;
    /* Write to TIMx CCER register */
    ::core::ptr::write_volatile(&mut (*TIMx).CCER as *mut uint32_t, tmpccer);
}
/* *
...
pub unsafe extern "C" fn TIM_CCxNCmd(mut TIMx: *mut TIM_TypeDef,
    ...
    /* Check the parameters */
    tmp =
        (0x4 as libc::c_int as uint16_t as uint32_t) <<
            TIM_Channel as uint32_t;
    /* Reset the CCxNE Bit */
    ::core::ptr::write_volatile(&mut (*TIMx).CCER as *mut uint32_t,
                                (::core::ptr::read_volatile::<uint32_t>(&(*TIMx).CCER
...
pub unsafe extern "C" fn TIM_SetIC1Prescaler(mut TIMx: *mut TIM_TypeDef,
    ...
    ::core::ptr::write_volatile(&mut (*TIMx).CCMR1 as *mut uint32_t,
                                (::core::ptr::read_volatile::<uint32_t>(&(*TIMx).CCMR1
                                                                            ...
                                                                            *const uint32_t)
                                     as libc::c_uint &
                                     !(0xc as libc::c_int as uint32_t)) as
                                    uint32_t as uint32_t);
...
pub unsafe extern "C" fn TIM_SetIC2Prescaler(mut TIMx: *mut TIM_TypeDef,
    ...
    ::core::ptr::write_volatile(&mut (*TIMx).CCMR1 as *mut uint32_t,
                                (::core::ptr::read_volatile::<uint32_t>(&(*TIMx).CCMR1
                                                                            ...
                                                                            *const uint32_t)
                                     as libc::c_uint &
                                     !(0xc00 as libc::c_int as uint32_t)) as
                                    uint32_t as uint32_t);
...
pub unsafe extern "C" fn TIM_InternalClockConfig(mut TIMx: *mut TIM_TypeDef) {
    ...
    ::core::ptr::write_volatile(&mut (*TIMx).SMCR as *mut uint32_t,
                                (::core::ptr::read_volatile::<uint32_t>(&(*TIMx).SMCR
                                                                            ...
                                                                            *const uint32_t)
                                     as libc::c_uint &
                                     !(0x10007 as libc::c_int as uint32_t) as
                                         uint16_t as libc::c_uint) as uint32_t
                                    as uint32_t);
}
/* *
...
pub unsafe extern "C" fn TIM_ETRClockMode1Config(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpsmcr =
        (tmpsmcr as libc::c_int &
             !(0x10007 as libc::c_int as uint32_t) as uint16_t as libc::c_int)
            as uint16_t;
    /* Select the External clock mode1 */
    tmpsmcr =
        (tmpsmcr as libc::c_uint | 0x7 as libc::c_int as uint32_t) as
            uint16_t;
    /* Select the Trigger selection : ETRF */
    tmpsmcr =
        (tmpsmcr as libc::c_int &
             !(0x70 as libc::c_int as uint32_t) as uint16_t as libc::c_int) as
            uint16_t;
    tmpsmcr =
        (tmpsmcr as libc::c_int |
...
pub unsafe extern "C" fn TIM_SelectOutputTrigger(mut TIMx: *mut TIM_TypeDef,
    ...
    ::core::ptr::write_volatile(&mut (*TIMx).CR2 as *mut uint32_t,
                                (::core::ptr::read_volatile::<uint32_t>(&(*TIMx).CR2
                                                                            ...
                                                                            *const uint32_t)
                                     as libc::c_uint &
                                     !(0x70 as libc::c_int as uint32_t) as
                                         uint16_t as libc::c_uint) as uint32_t
                                    as uint32_t);
...
pub unsafe extern "C" fn TIM_EncoderInterfaceConfig(mut TIMx:
    ...
    tmpccmr1 =
        (tmpccmr1 as libc::c_int &
             (!(0x3 as libc::c_int as uint32_t) as uint16_t as libc::c_int &
                  !(0x300 as libc::c_int as uint32_t) as uint16_t as
                      libc::c_int)) as uint16_t;
    tmpccmr1 =
        (tmpccmr1 as libc::c_uint |
             (0x1 as libc::c_int as uint32_t |
                  0x100 as libc::c_int as uint32_t)) as uint16_t;
    /* Set the TI1 and the TI2 Polarities */
    tmpccer =
        (tmpccer as libc::c_int &
             (!(0x2 as libc::c_int as uint32_t) as uint16_t as libc::c_int &
                  !(0x20 as libc::c_int as uint32_t) as uint16_t as
                      libc::c_int)) as uint16_t;
    tmpccer =
        (tmpccer as libc::c_int |
...
unsafe extern "C" fn TI1_Config(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccmr1 |=
        TIM_ICSelection as libc::c_uint |
            (TIM_ICFilter as uint32_t) << 4 as libc::c_int;
    /* Select the Polarity and set the CC1E Bit */
    tmpccer &=
        !(0x2 as libc::c_int as uint32_t | 0x8 as libc::c_int as uint32_t);
    tmpccer |=
        TIM_ICPolarity as libc::c_uint | 0x1 as libc::c_int as uint32_t;
...
unsafe extern "C" fn TI2_Config(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccer = (*TIMx).CCER;
    tmp =
        ((TIM_ICPolarity as libc::c_int) << 4 as libc::c_int) as uint16_t as
            uint32_t;
    /* Select the Input and set the filter */
    tmpccmr1 &=
        !(0x300 as libc::c_int as uint32_t) &
            !(0xf000 as libc::c_int as uint32_t);
    tmpccmr1 |= (TIM_ICFilter as uint32_t) << 12 as libc::c_int;
    tmpccmr1 |= (TIM_ICSelection as uint32_t) << 8 as libc::c_int;
    /* Select the Polarity and set the CC2E Bit */
    tmpccer &=
        !(0x20 as libc::c_int as uint32_t | 0x80 as libc::c_int as uint32_t)
            as uint16_t as libc::c_uint;
    tmpccer |=
        (tmp | 0x10 as libc::c_int as uint32_t as uint16_t as libc::c_uint) as
    ...
    tmpccer =
        (tmpccer as libc::c_int &
             !(0x200 as libc::c_int as uint32_t |
                   0x800 as libc::c_int as uint32_t) as uint16_t as
                 libc::c_int) as uint16_t;
    tmpccer =
        (tmpccer as libc::c_int |
             (tmp as libc::c_int |
                  0x100 as libc::c_int as uint32_t as uint16_t as libc::c_int)
                 as uint16_t as libc::c_int) as uint16_t;
...
unsafe extern "C" fn TI4_Config(mut TIMx: *mut TIM_TypeDef,
    ...
    tmpccmr2 =
        (tmpccmr2 as libc::c_int &
             (!(0x300 as libc::c_int as uint32_t) as uint16_t as libc::c_int &
                  !(0xf000 as libc::c_int as uint32_t) as uint16_t as
                      libc::c_int)) as uint16_t;
    tmpccmr2 =
        (tmpccmr2 as libc::c_int |
    ...
    tmpccer =
        (tmpccer as libc::c_int &
             !(0x2000 as libc::c_int as uint32_t |
                   0x8000 as libc::c_int as uint32_t) as uint16_t as
                 libc::c_int) as uint16_t;
    tmpccer =
        (tmpccer as libc::c_int |
             (tmp as libc::c_int |
                  0x1000 as libc::c_int as uint32_t as uint16_t as
                      libc::c_int) as uint16_t as libc::c_int) as uint16_t;
    /* Write to TIMx CCMR2 and CCER registers */
    ::core::ptr::write_volatile(&mut (*TIMx).CCMR2 as *mut uint32_t,
                                tmpccmr2 as uint32_t);
