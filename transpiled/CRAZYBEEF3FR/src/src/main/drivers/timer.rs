...
#[no_mangle]
pub static mut timerConfig: [timerConfig_t; 3] =
    [timerConfig_t{edgeCallback:
                   ...
                   forcedOverflowTimerValue: 0,}; 3];
#[no_mangle]
pub static mut timerChannelInfo: [timerChannelInfo_t; 4] =
    [timerChannelInfo_t{type_0: TYPE_FREE,}; 4];
#[no_mangle]
pub static mut timerInfo: [timerInfo_t; 3] = [timerInfo_t{priority: 0,}; 3];
...
pub static mut timerNumbers: [int8_t; 3] =
    [2 as libc::c_int as int8_t, 8 as libc::c_int as int8_t,
...
pub unsafe extern "C" fn timerChInit(mut timHw: *const timerHardware_t,
    ...
    let mut channel: libc::c_uint =
        timHw.wrapping_offset_from(timerHardware.as_ptr()) as libc::c_long as
            libc::c_uint;
    if channel >= 4 as libc::c_int as libc::c_uint { return }
...
pub unsafe extern "C" fn timerInit() {
    memset(timerConfig.as_mut_ptr() as *mut libc::c_void, 0 as libc::c_int,
           ::core::mem::size_of::<[timerConfig_t; 3]>() as libc::c_ulong);
    ...
    while timerIndex < 4 as libc::c_int as libc::c_uint {
