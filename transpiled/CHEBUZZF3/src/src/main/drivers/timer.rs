...
#[no_mangle]
pub static mut timerChannelInfo: [timerChannelInfo_t; 18] =
    [timerChannelInfo_t{type_0: TYPE_FREE,}; 18];
#[no_mangle]
...
unsafe extern "C" fn lookupTimerIndex(mut tim: *const TIM_TypeDef)
 -> uint8_t {
    ...
    match tim as libc::c_uint >> 10 as libc::c_int {
        ...
        1048658 => {
            return (((((1 as libc::c_int) << 17 as libc::c_int) -
                          1 as libc::c_int &
                          ((1 as libc::c_int) << 1 as libc::c_int |
                               (1 as libc::c_int) << 2 as libc::c_int |
                               (1 as libc::c_int) << 3 as libc::c_int |
...
pub static mut timerNumbers: [int8_t; 8] =
    [1 as libc::c_int as int8_t, 2 as libc::c_int as int8_t,
     ...
     8 as libc::c_int as int8_t, 15 as libc::c_int as int8_t,
     16 as libc::c_int as int8_t, 17 as libc::c_int as int8_t];
#[no_mangle]
...
pub unsafe extern "C" fn timerChInit(mut timHw: *const timerHardware_t,
    ...
    let mut channel: libc::c_uint =
        timHw.wrapping_offset_from(timerHardware.as_ptr()) as libc::c_long as
            libc::c_uint;
    if channel >= 18 as libc::c_int as libc::c_uint { return }
...
pub unsafe extern "C" fn timerInit() {
    ...
    while i < 18 as libc::c_int as libc::c_uint {
    ...
    while timerIndex < 18 as libc::c_int as libc::c_uint {
    ...
    while i_0 < 18 as libc::c_int as libc::c_uint {
