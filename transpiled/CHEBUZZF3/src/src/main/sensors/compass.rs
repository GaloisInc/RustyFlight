...
pub unsafe extern "C" fn compassDetect(mut dev: *mut magDev_t) -> bool {
    ...
    match (*compassConfig()).mag_hardware as libc::c_int {
        0 | 2 | 5 | 3 => {
            ...
            } else { current_block_24 = 12655303181708784040; }
        }
        4 | 1 => { current_block_24 = 12655303181708784040; }
        _ => { current_block_24 = 11913429853522160501; }
    }
    match current_block_24 {
        12655303181708784040 => { magHardware = MAG_NONE }
        _ => { }
    }
