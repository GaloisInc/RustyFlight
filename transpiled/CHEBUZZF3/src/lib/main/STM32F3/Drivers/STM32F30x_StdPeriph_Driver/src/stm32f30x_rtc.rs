...
pub unsafe extern "C" fn RTC_DeInit() -> ErrorStatus {
    let mut wutcounter: uint32_t = 0 as libc::c_int as uint32_t;
    let mut wutwfstatus: uint32_t = 0 as libc::c_int as uint32_t;
    ...
    ::core::ptr::write_volatile(&mut (*((0x40000000 as libc::c_int as
                                    ...
                                    *mut uint32_t,
                                0xca as libc::c_int as uint32_t);
    ::core::ptr::write_volatile(&mut (*((0x40000000 as libc::c_int as
                                             uint32_t).wrapping_add(0x2800 as
                                                                        libc::c_int
                                                                        as
    ...
    if RTC_EnterInitMode() as libc::c_uint ==
        ...
        ::core::ptr::write_volatile(&mut (*((0x40000000 as libc::c_int as
                                        ...
                                        *mut uint32_t,
                                    0x2101 as libc::c_int as uint32_t);
        ...
        loop 
            ...
            if !(wutcounter != 0x2000 as libc::c_int as uint32_t &&
                     wutwfstatus == 0 as libc::c_int as libc::c_uint) {
                break ;
            }
        }
        if (*((0x40000000 as libc::c_int as
                   uint32_t).wrapping_add(0x2800 as libc::c_int as
                                              libc::c_uint) as
                  *mut RTC_TypeDef)).ISR & 0x4 as libc::c_int as uint32_t ==
            ...
            ::core::ptr::write_volatile(&mut (*((0x40000000 as libc::c_int as
                                            ...
                                            as *mut uint32_t,
                                        0x7f00ff as libc::c_int as uint32_t);
            ::core::ptr::write_volatile(&mut (*((0x40000000 as libc::c_int as
                                                     uint32_t).wrapping_add(0x2800
                                                                                as
                                                                                libc::c_int
...
pub unsafe extern "C" fn RTC_StructInit(mut RTC_InitStruct:
    ...
    (*RTC_InitStruct).RTC_HourFormat = 0 as libc::c_int as uint32_t;
    /* Initialize the RTC_AsynchPrediv member */
    (*RTC_InitStruct).RTC_AsynchPrediv = 0x7f as libc::c_int as uint32_t;
    /* Initialize the RTC_SynchPrediv member */
    (*RTC_InitStruct).RTC_SynchPrediv = 0xff as libc::c_int as uint32_t;
}
/* *
...
pub unsafe extern "C" fn RTC_EnterInitMode() -> ErrorStatus {
    let mut initcounter: uint32_t = 0 as libc::c_int as uint32_t;
    let mut status: ErrorStatus = ERROR;
    let mut initstatus: uint32_t = 0 as libc::c_int as uint32_t;
    /* Check if the Initialization mode is set */
    if (*((0x40000000 as libc::c_int as
               uint32_t).wrapping_add(0x2800 as libc::c_int as libc::c_uint)
              as *mut RTC_TypeDef)).ISR & 0x40 as libc::c_int as uint32_t ==
        ...
        loop 
            ...
            ::core::ptr::write_volatile(&mut initcounter as *mut uint32_t,
                                        ::core::ptr::read_volatile::<uint32_t>(&initcounter
                                                                                   as
                                                                                   *const uint32_t).wrapping_add(1));
            if !(initcounter != 0x2000 as libc::c_int as uint32_t &&
                     initstatus == 0 as libc::c_int as libc::c_uint) {
                break ;
            }
        }
        if (*((0x40000000 as libc::c_int as
                   uint32_t).wrapping_add(0x2800 as libc::c_int as
                                              libc::c_uint) as
                  *mut RTC_TypeDef)).ISR & 0x40 as libc::c_int as uint32_t !=
               RESET as libc::c_int as libc::c_uint {
            status = SUCCESS
        } else { status = ERROR }
    } else { status = SUCCESS }
...
pub unsafe extern "C" fn RTC_WaitForSynchro() -> ErrorStatus {
    let mut synchrocounter: uint32_t = 0 as libc::c_int as uint32_t;
    let mut status: ErrorStatus = ERROR;
    let mut synchrostatus: uint32_t = 0 as libc::c_int as uint32_t;
    if (*((0x40000000 as libc::c_int as
               uint32_t).wrapping_add(0x2800 as libc::c_int as libc::c_uint)
              as *mut RTC_TypeDef)).CR & 0x20 as libc::c_int as uint32_t !=
           RESET as libc::c_int as libc::c_uint {
        /* Bypass shadow mode */
        status = SUCCESS
    } else {
        ...
        loop 
            ...
            ::core::ptr::write_volatile(&mut synchrocounter as *mut uint32_t,
                                        ::core::ptr::read_volatile::<uint32_t>(&synchrocounter
                                                                                   as
                                                                                   *const uint32_t).wrapping_add(1));
            if !(synchrocounter != 0x8000 as libc::c_int as uint32_t &&
                     synchrostatus == 0 as libc::c_int as libc::c_uint) {
                break ;
            }
        }
        if (*((0x40000000 as libc::c_int as
                   uint32_t).wrapping_add(0x2800 as libc::c_int as
                                              libc::c_uint) as
                  *mut RTC_TypeDef)).ISR & 0x20 as libc::c_int as uint32_t !=
               RESET as libc::c_int as libc::c_uint {
            status = SUCCESS
        } else { status = ERROR }
        /* Enable the write protection for RTC registers */
...
pub unsafe extern "C" fn RTC_SetTime(mut RTC_Format: uint32_t,
 ...
 -> ErrorStatus {
    ...
    let mut status: ErrorStatus = ERROR;
    /* Check the parameters */
    if RTC_Format == 0 as libc::c_int as uint32_t {
        if !((*((0x40000000 as libc::c_int as
                     uint32_t).wrapping_add(0x2800 as libc::c_int as
                                                libc::c_uint) as
                    *mut RTC_TypeDef)).CR & 0x40 as libc::c_int as uint32_t !=
                 RESET as libc::c_int as uint32_t) {
            (*RTC_TimeStruct).RTC_H12 = 0 as libc::c_int as uint8_t
        }
    ...
    } else { (*RTC_TimeStruct).RTC_H12 = 0 as libc::c_int as uint8_t }
    /* Check the input parameters format */
    if RTC_Format != 0 as libc::c_int as uint32_t {
        tmpreg =
            ((*RTC_TimeStruct).RTC_Hours as uint32_t) << 16 as libc::c_int |
                ((*RTC_TimeStruct).RTC_Minutes as uint32_t) <<
                    8 as libc::c_int |
                (*RTC_TimeStruct).RTC_Seconds as uint32_t |
                ((*RTC_TimeStruct).RTC_H12 as uint32_t) << 16 as libc::c_int
    } else {
        tmpreg =
            (RTC_ByteToBcd2((*RTC_TimeStruct).RTC_Hours) as uint32_t) <<
                16 as libc::c_int |
    ...
    if RTC_EnterInitMode() as libc::c_uint ==
        ...
        if (*((0x40000000 as libc::c_int as
                   uint32_t).wrapping_add(0x2800 as libc::c_int as
                                              libc::c_uint) as
                  *mut RTC_TypeDef)).CR & 0x20 as libc::c_int as uint32_t ==
               RESET as libc::c_int as libc::c_uint {
            if RTC_WaitForSynchro() as libc::c_uint ==
                   ERROR as libc::c_int as libc::c_uint {
                status = ERROR
...
pub unsafe extern "C" fn RTC_TimeStructInit(mut RTC_TimeStruct:
    ...
    /* Time = 00h:00min:00sec */
    (*RTC_TimeStruct).RTC_H12 = 0 as libc::c_int as uint8_t;
    (*RTC_TimeStruct).RTC_Hours = 0 as libc::c_int as uint8_t;
    (*RTC_TimeStruct).RTC_Minutes = 0 as libc::c_int as uint8_t;
    (*RTC_TimeStruct).RTC_Seconds = 0 as libc::c_int as uint8_t;
}
/* *
...
pub unsafe extern "C" fn RTC_GetTime(mut RTC_Format: uint32_t,
    ...
    tmpreg =
        (*((0x40000000 as libc::c_int as
                uint32_t).wrapping_add(0x2800 as libc::c_int as libc::c_uint)
               as *mut RTC_TypeDef)).TR & 0x7f7f7f as libc::c_int as uint32_t;
    /* Fill the structure fields with the read parameters */
    (*RTC_TimeStruct).RTC_Hours =
        ((tmpreg &
              (0x300000 as libc::c_int as uint32_t |
                   0xf0000 as libc::c_int as uint32_t)) >> 16 as libc::c_int)
            as uint8_t;
    (*RTC_TimeStruct).RTC_Minutes =
        ((tmpreg &
              (0x7000 as libc::c_int as uint32_t |
                   0xf00 as libc::c_int as uint32_t)) >> 8 as libc::c_int) as
            uint8_t;
    (*RTC_TimeStruct).RTC_Seconds =
        (tmpreg &
             (0x70 as libc::c_int as uint32_t |
                  0xf as libc::c_int as uint32_t)) as uint8_t;
    (*RTC_TimeStruct).RTC_H12 =
        ((tmpreg & 0x400000 as libc::c_int as uint32_t) >> 16 as libc::c_int)
            as uint8_t;
    /* Check the input parameters format */
    if RTC_Format == 0 as libc::c_int as uint32_t {
...
pub unsafe extern "C" fn RTC_SetDate(mut RTC_Format: uint32_t,
 ...
 -> ErrorStatus {
    ...
    /* Check the parameters */
    if RTC_Format == 0 as libc::c_int as uint32_t &&
           (*RTC_DateStruct).RTC_Month as libc::c_int & 0x10 as libc::c_int ==
               0x10 as libc::c_int {
        (*RTC_DateStruct).RTC_Month =
            ((*RTC_DateStruct).RTC_Month as libc::c_uint &
                 !(0x10 as libc::c_int) as
                     uint32_t).wrapping_add(0xa as libc::c_int as
    ...
    if RTC_Format != 0 as libc::c_int as uint32_t {
        tmpreg =
            ((*RTC_DateStruct).RTC_Year as uint32_t) << 16 as libc::c_int |
                ((*RTC_DateStruct).RTC_Month as uint32_t) << 8 as libc::c_int
                | (*RTC_DateStruct).RTC_Date as uint32_t |
                ((*RTC_DateStruct).RTC_WeekDay as uint32_t) <<
                    13 as libc::c_int
    } else {
        tmpreg =
            (RTC_ByteToBcd2((*RTC_DateStruct).RTC_Year) as uint32_t) <<
                16 as libc::c_int |
    ...
    if RTC_EnterInitMode() as libc::c_uint ==
        ...
        ::core::ptr::write_volatile(&mut (*((0x40000000 as libc::c_int as
                                        ...
                                        *mut uint32_t,
                                    tmpreg &
                                        0xffff3f as libc::c_int as uint32_t);
        /* Exit Initialization mode */
        RTC_ExitInitMode();
        /* If  RTC_CR_BYPSHAD bit = 0, wait for synchro else this check is not needed */
        if (*((0x40000000 as libc::c_int as
...
pub unsafe extern "C" fn RTC_DateStructInit(mut RTC_DateStruct:
                                                *mut RTC_DateTypeDef) {
    /* Monday, January 01 xx00 */
    (*RTC_DateStruct).RTC_WeekDay = 0x1 as libc::c_int as uint8_t;
    (*RTC_DateStruct).RTC_Date = 1 as libc::c_int as uint8_t;
    (*RTC_DateStruct).RTC_Month = 0x1 as libc::c_int as uint8_t;
    (*RTC_DateStruct).RTC_Year = 0 as libc::c_int as uint8_t;
}
/* *
...
pub unsafe extern "C" fn RTC_GetDate(mut RTC_Format: uint32_t,
    ...
    tmpreg =
        (*((0x40000000 as libc::c_int as
                uint32_t).wrapping_add(0x2800 as libc::c_int as libc::c_uint)
               as *mut RTC_TypeDef)).DR & 0xffff3f as libc::c_int as uint32_t;
    /* Fill the structure fields with the read parameters */
    ...
    (*RTC_DateStruct).RTC_WeekDay =
        ((tmpreg & 0xe000 as libc::c_int as uint32_t) >> 13 as libc::c_int) as
            uint8_t;
    /* Check the input parameters format */
    if RTC_Format == 0 as libc::c_int as uint32_t {
        /* Convert the structure parameters to Binary format */
...
pub unsafe extern "C" fn RTC_SetAlarm(mut RTC_Format: uint32_t,
    ...
    if RTC_Format != 0 as libc::c_int as uint32_t {
        tmpreg =
            ((*RTC_AlarmStruct).RTC_AlarmTime.RTC_Hours as uint32_t) <<
                16 as libc::c_int |
                ...
                ((*RTC_AlarmStruct).RTC_AlarmTime.RTC_H12 as uint32_t) <<
                    16 as libc::c_int |
                ((*RTC_AlarmStruct).RTC_AlarmDateWeekDay as uint32_t) <<
                    24 as libc::c_int |
                (*RTC_AlarmStruct).RTC_AlarmDateWeekDaySel |
    ...
    if RTC_Alarm == 0x100 as libc::c_int as uint32_t {
        ::core::ptr::write_volatile(&mut (*((0x40000000 as libc::c_int as
                                                 uint32_t).wrapping_add(0x2800
                                                                            as
                                                                            libc::c_int
...
pub unsafe extern "C" fn RTC_AlarmStructInit(mut RTC_AlarmStruct:
    ...
    (*RTC_AlarmStruct).RTC_AlarmTime.RTC_H12 = 0 as libc::c_int as uint8_t;
    (*RTC_AlarmStruct).RTC_AlarmTime.RTC_Hours = 0 as libc::c_int as uint8_t;
    (*RTC_AlarmStruct).RTC_AlarmTime.RTC_Minutes =
        0 as libc::c_int as uint8_t;
    (*RTC_AlarmStruct).RTC_AlarmTime.RTC_Seconds =
        0 as libc::c_int as uint8_t;
    /* Alarm Date Settings : Date = 1st day of the month */
    (*RTC_AlarmStruct).RTC_AlarmDateWeekDaySel = 0 as libc::c_int as uint32_t;
    (*RTC_AlarmStruct).RTC_AlarmDateWeekDay = 1 as libc::c_int as uint8_t;
    /* Alarm Masks Settings : Mask =  all fields are not masked */
    (*RTC_AlarmStruct).RTC_AlarmMask = 0 as libc::c_int as uint32_t;
}
/* *
    ...
    (*RTC_AlarmStruct).RTC_AlarmDateWeekDay =
        ((tmpreg &
              (0x30000000 as libc::c_int as uint32_t |
                   0xf000000 as libc::c_int as uint32_t)) >>
             24 as libc::c_int) as uint8_t;
    (*RTC_AlarmStruct).RTC_AlarmDateWeekDaySel =
        tmpreg & 0x40000000 as libc::c_int as uint32_t;
    (*RTC_AlarmStruct).RTC_AlarmMask = tmpreg & 0x80808080 as libc::c_uint;
    if RTC_Format == 0 as libc::c_int as uint32_t {
        (*RTC_AlarmStruct).RTC_AlarmTime.RTC_Hours =
...
pub unsafe extern "C" fn RTC_AlarmCmd(mut RTC_Alarm: uint32_t,
 ...
 -> ErrorStatus {
    let mut alarmcounter: uint32_t = 0 as libc::c_int as uint32_t;
    let mut alarmstatus: uint32_t = 0 as libc::c_int as uint32_t;
    let mut status: ErrorStatus = ERROR;
    /* Check the parameters */
    /* Disable the write protection for RTC registers */
    ::core::ptr::write_volatile(&mut (*((0x40000000 as libc::c_int as
        ...
        loop 
            ...
            alarmstatus =
                (*((0x40000000 as libc::c_int as
                        uint32_t).wrapping_add(0x2800 as libc::c_int as
                                                   libc::c_uint) as
                       *mut RTC_TypeDef)).ISR & RTC_Alarm >> 8 as libc::c_int;
            ::core::ptr::write_volatile(&mut alarmcounter as *mut uint32_t,
                                        ::core::ptr::read_volatile::<uint32_t>(&alarmcounter
                                                                                   as
                                                                                   *const uint32_t).wrapping_add(1));
            if !(alarmcounter != 0x2000 as libc::c_int as uint32_t &&
                     alarmstatus == 0 as libc::c_int as libc::c_uint) {
                break ;
            }
        }
        if (*((0x40000000 as libc::c_int as
...
pub unsafe extern "C" fn RTC_GetWakeUpCounter() -> uint32_t {
    ...
    return (*((0x40000000 as libc::c_int as
                   uint32_t).wrapping_add(0x2800 as libc::c_int as
                                              libc::c_uint) as
                  *mut RTC_TypeDef)).WUTR & 0xffff as libc::c_int as uint32_t;
}
/* *
...
pub unsafe extern "C" fn RTC_GetStoreOperation() -> uint32_t {
    return (*((0x40000000 as libc::c_int as
                   uint32_t).wrapping_add(0x2800 as libc::c_int as
                                              libc::c_uint) as
                  *mut RTC_TypeDef)).CR & 0x40000 as libc::c_int as uint32_t;
}
/* *
  * @}
  */
...
pub unsafe extern "C" fn RTC_SmoothCalibConfig(mut RTC_SmoothCalibPeriod:
    ...
    let mut status: ErrorStatus = ERROR;
    let mut recalpfcount: uint32_t = 0 as libc::c_int as uint32_t;
    /* Check the parameters */
    /* Disable the write protection for RTC registers */
    ::core::ptr::write_volatile(&mut (*((0x40000000 as libc::c_int as
                                             uint32_t).wrapping_add(0x2800 as
    ...
    if (*((0x40000000 as libc::c_int as
               uint32_t).wrapping_add(0x2800 as libc::c_int as libc::c_uint)
              as *mut RTC_TypeDef)).ISR & 0x10000 as libc::c_int as uint32_t
           != RESET as libc::c_int as libc::c_uint {
        ...
        while (*((0x40000000 as libc::c_int as
                  ...
                  RESET as libc::c_int as libc::c_uint &&
                  recalpfcount != 0x1000 as libc::c_int as uint32_t {
...
pub unsafe extern "C" fn RTC_TimeStampCmd(mut RTC_TimeStampEdge: uint32_t,
    ...
    if NewState as libc::c_uint != DISABLE as libc::c_int as libc::c_uint {
        tmpreg |= RTC_TimeStampEdge | 0x800 as libc::c_int as uint32_t
...
pub unsafe extern "C" fn RTC_GetTimeStamp(mut RTC_Format: uint32_t,
                                          ...
                                          mut RTC_StampDateStruct:
                                              *mut RTC_DateTypeDef) {
    let mut tmptime: uint32_t = 0 as libc::c_int as uint32_t;
    let mut tmpdate: uint32_t = 0 as libc::c_int as uint32_t;
    /* Check the parameters */
    /* Get the TimeStamp time and date registers values */
    tmptime =
        (*((0x40000000 as libc::c_int as
                uint32_t).wrapping_add(0x2800 as libc::c_int as libc::c_uint)
               as *mut RTC_TypeDef)).TSTR &
            0x7f7f7f as libc::c_int as uint32_t;
    tmpdate =
        (*((0x40000000 as libc::c_int as
                uint32_t).wrapping_add(0x2800 as libc::c_int as libc::c_uint)
               as *mut RTC_TypeDef)).TSDR &
            0xffff3f as libc::c_int as uint32_t;
    ...
    (*RTC_StampTimeStruct).RTC_H12 =
        ((tmptime & 0x400000 as libc::c_int as uint32_t) >> 16 as libc::c_int)
            as uint8_t;
    /* Fill the Date structure fields with the read parameters */
    (*RTC_StampDateStruct).RTC_Year = 0 as libc::c_int as uint8_t;
    ...
    (*RTC_StampDateStruct).RTC_WeekDay =
        ((tmpdate & 0xe000 as libc::c_int as uint32_t) >> 13 as libc::c_int)
            as uint8_t;
    /* Check the input parameters format */
    if RTC_Format == 0 as libc::c_int as uint32_t {
...
pub unsafe extern "C" fn RTC_TamperTriggerConfig(mut RTC_Tamper: uint32_t,
    ...
    if RTC_TamperTrigger == 0 as libc::c_int as uint32_t {
...
pub unsafe extern "C" fn RTC_TamperFilterConfig(mut RTC_TamperFilter:
    ...
    ::core::ptr::write_volatile(fresh29,
                                (::core::ptr::read_volatile::<uint32_t>(fresh29
                                                                            ...
                                                                            *const uint32_t)
                                     as libc::c_uint &
                                     !(0x1800 as libc::c_int as uint32_t)) as
                                    uint32_t as uint32_t);
    /* Configure the RTC_TAFCR register */
    let ref mut fresh30 =
        (*((0x40000000 as libc::c_int as
...
pub unsafe extern "C" fn RTC_TamperSamplingFreqConfig(mut RTC_TamperSamplingFreq:
    ...
    ::core::ptr::write_volatile(fresh31,
                                (::core::ptr::read_volatile::<uint32_t>(fresh31
                                                                            ...
                                                                            *const uint32_t)
                                     as libc::c_uint &
                                     !(0x700 as libc::c_int as uint32_t)) as
                                    uint32_t as uint32_t);
    /* Configure the RTC_TAFCR register */
    let ref mut fresh32 =
        (*((0x40000000 as libc::c_int as
...
pub unsafe extern "C" fn RTC_TamperPinsPrechargeDuration(mut RTC_TamperPrechargeDuration:
    ...
    ::core::ptr::write_volatile(fresh33,
                                (::core::ptr::read_volatile::<uint32_t>(fresh33
                                                                            ...
                                                                            *const uint32_t)
                                     as libc::c_uint &
                                     !(0x6000 as libc::c_int as uint32_t)) as
                                    uint32_t as uint32_t);
    /* Configure the RTC_TAFCR register */
    let ref mut fresh34 =
        (*((0x40000000 as libc::c_int as
...
pub unsafe extern "C" fn RTC_WriteBackupRegister(mut RTC_BKP_DR: uint32_t,
    ...
    ::core::ptr::write_volatile(&mut tmp as *mut uint32_t,
                                (::core::ptr::read_volatile::<uint32_t>(&tmp
                                                                            ...
                                                                            *const uint32_t)
                                     as
                                     libc::c_uint).wrapping_add(RTC_BKP_DR.wrapping_mul(4
                                                                                            as
                                                                                            libc::c_int
                                                                                            as
                                                                                            libc::c_uint))
...
pub unsafe extern "C" fn RTC_SynchroShiftConfig(mut RTC_ShiftAdd1S: uint32_t,
 ...
 -> ErrorStatus {
    let mut status: ErrorStatus = ERROR;
    let mut shpfcount: uint32_t = 0 as libc::c_int as uint32_t;
    /* Check the parameters */
    /* Disable the write protection for RTC registers */
    ::core::ptr::write_volatile(&mut (*((0x40000000 as libc::c_int as
                                             uint32_t).wrapping_add(0x2800 as
    ...
    if (*((0x40000000 as libc::c_int as
               uint32_t).wrapping_add(0x2800 as libc::c_int as libc::c_uint)
              as *mut RTC_TypeDef)).ISR & 0x8 as libc::c_int as uint32_t !=
           RESET as libc::c_int as libc::c_uint {
        /* Wait until the shift is completed*/
        while (*((0x40000000 as libc::c_int as
                      uint32_t).wrapping_add(0x2800 as libc::c_int as
                                                 libc::c_uint) as
                     *mut RTC_TypeDef)).ISR & 0x8 as libc::c_int as uint32_t
                  != RESET as libc::c_int as libc::c_uint &&
                  shpfcount != 0x2000 as libc::c_int as uint32_t {
    ...
    if (*((0x40000000 as libc::c_int as
        ...
        if (*((0x40000000 as libc::c_int as
                   uint32_t).wrapping_add(0x2800 as libc::c_int as
                                              libc::c_uint) as
                  *mut RTC_TypeDef)).CR & 0x10 as libc::c_int as uint32_t ==
               RESET as libc::c_int as libc::c_uint {
...
pub unsafe extern "C" fn RTC_ClearFlag(mut RTC_FLAG: uint32_t) {
    ...
    ::core::ptr::write_volatile(&mut (*((0x40000000 as libc::c_int as
                                            ...
                                            as *mut RTC_TypeDef)).ISR as
                                    *mut uint32_t,
                                !((RTC_FLAG | 0x80 as libc::c_int as uint32_t)
                                      &
...
pub unsafe extern "C" fn RTC_GetITStatus(mut RTC_IT: uint32_t) -> ITStatus {
    ...
    tmpreg =
        (*((0x40000000 as libc::c_int as
                uint32_t).wrapping_add(0x2800 as libc::c_int as libc::c_uint)
               as *mut RTC_TypeDef)).TAFCR & 0x4 as libc::c_int as uint32_t;
    ...
    enablestatus =
        (*((0x40000000 as libc::c_int as
            ...
            tmpreg &
                RTC_IT >> (RTC_IT >> 18 as libc::c_int) >> 15 as libc::c_int;
    /* Get the Interrupt pending bit */
    tmpreg =
        (*((0x40000000 as libc::c_int as
                uint32_t).wrapping_add(0x2800 as libc::c_int as libc::c_uint)
               as *mut RTC_TypeDef)).ISR & RTC_IT >> 4 as libc::c_int;
    /* Get the status of the Interrupt */
    if enablestatus != RESET as libc::c_int as uint32_t &&
           tmpreg & 0xffff as libc::c_int as libc::c_uint !=
               RESET as libc::c_int as uint32_t {
        bitstatus = SET
    } else { bitstatus = RESET }
    return bitstatus;
...
pub unsafe extern "C" fn RTC_ClearITPendingBit(mut RTC_IT: uint32_t) {
    ...
    ::core::ptr::write_volatile(&mut (*((0x40000000 as libc::c_int as
                                            ...
                                            as *mut RTC_TypeDef)).ISR as
                                    *mut uint32_t,
                                !((tmpreg | 0x80 as libc::c_int as uint32_t) &
...
unsafe extern "C" fn RTC_ByteToBcd2(mut Value: uint8_t) -> uint8_t {
    let mut bcdhigh: uint8_t = 0 as libc::c_int as uint8_t;
    while Value as libc::c_int >= 10 as libc::c_int {
        bcdhigh = bcdhigh.wrapping_add(1);
        Value = (Value as libc::c_int - 10 as libc::c_int) as uint8_t
    }
    return (((bcdhigh as libc::c_int) << 4 as libc::c_int) as uint8_t as
                libc::c_int | Value as libc::c_int) as uint8_t;
}
/* *
...
unsafe extern "C" fn RTC_Bcd2ToByte(mut Value: uint8_t) -> uint8_t {
    ...
    tmp =
        (((Value as libc::c_int &
               0xf0 as libc::c_int as uint8_t as libc::c_int) as uint8_t as
              libc::c_int >> 0x4 as libc::c_int as uint8_t as libc::c_int) *
             10 as libc::c_int) as uint8_t;
    return (tmp as libc::c_int +
                (Value as libc::c_int &
                     0xf as libc::c_int as uint8_t as libc::c_int)) as
               uint8_t;
}
