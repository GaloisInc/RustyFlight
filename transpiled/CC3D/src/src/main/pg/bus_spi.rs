                 ...
                 reset:
                     C2RustUnnamed_0{ptr:
                                         0 as *const libc::c_void as
                                             *mut libc::c_void,},};
#[no_mangle]
pub static mut spiPinConfig_SystemArray: [spiPinConfig_t; 2] =
    [spiPinConfig_t{ioTagSck: 0, ioTagMiso: 0, ioTagMosi: 0,}; 2];
#[no_mangle]
pub static mut spiPinConfig_CopyArray: [spiPinConfig_t; 2] =
    [spiPinConfig_t{ioTagSck: 0, ioTagMiso: 0, ioTagMosi: 0,}; 2];
#[no_mangle]
                ...
                pgRegistry_s{pgn:
                             ...
                             address:
                                 &mut spiPinConfig_SystemArray as
                                     *mut [spiPinConfig_t; 2] as *mut uint8_t,
                             copy:
