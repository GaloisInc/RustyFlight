...
extern "C" {
    ...
    fn memset(_: *mut libc::c_void, _: libc::c_int, _: libc::c_ulong)
     -> *mut libc::c_void;
    #[no_mangle]
    fn GPIO_PinRemapConfig(GPIO_Remap: uint32_t, NewState: FunctionalState);
    #[no_mangle]
...
#[no_mangle]
pub static mut timerConfig: [timerConfig_t; 4] =
    [timerConfig_t{edgeCallback:
                   ...
                   forcedOverflowTimerValue: 0,}; 4];
#[no_mangle]
pub static mut timerChannelInfo: [timerChannelInfo_t; 12] =
    [timerChannelInfo_t{type_0: TYPE_FREE,}; 12];
#[no_mangle]
pub static mut timerInfo: [timerInfo_t; 4] = [timerInfo_t{priority: 0,}; 4];
...
#[no_mangle]
pub static mut usedTimers: [*mut TIM_TypeDef; 4] =
    [0 as *const TIM_TypeDef as *mut TIM_TypeDef; 4];
// Map timer index to timer number (Straight copy of usedTimers array)
#[no_mangle]
pub static mut timerNumbers: [int8_t; 4] =
...
pub unsafe extern "C" fn timerConfigure(mut timerHardwarePtr:
    ...
    match irq as libc::c_int {
        27 => { timerNVICConfigure(TIM1_UP_IRQn as libc::c_int as uint8_t); }
        _ => { }
    };
}
...
pub unsafe extern "C" fn timerChInit(mut timHw: *const timerHardware_t,
    ...
    let mut channel: libc::c_uint =
        timHw.wrapping_offset_from(timerHardware.as_ptr()) as libc::c_long as
            libc::c_uint;
    if channel >= 12 as libc::c_int as libc::c_uint { return }
...
pub unsafe extern "C" fn timerChICPolarity(mut timHw: *const timerHardware_t,
    ...
    tmpccer =
        (tmpccer as libc::c_int &
             !((0x2 as libc::c_int as uint16_t as libc::c_int) <<
                   (*timHw).channel as libc::c_int)) as timCCER_t;
    tmpccer =
        (tmpccer as libc::c_int |
             if polarityRising as libc::c_int != 0 {
                 ((0 as libc::c_int as uint16_t as libc::c_int)) <<
    ...
    ::core::ptr::write_volatile(&mut (*(*timHw).tim).CCER as *mut uint16_t,
                                tmpccer);
}
#[no_mangle]
pub unsafe extern "C" fn timerChCCRHi(mut timHw: *const timerHardware_t)
 -> *mut timCCR_t {
    return (&mut (*(*timHw).tim).CCR1 as *mut uint16_t as
...
pub unsafe extern "C" fn timerChConfigOC(mut timHw: *const timerHardware_t,
    ...
    if outEnable {
        TIM_OCInitStructure.TIM_OCMode = 0x20 as libc::c_int as uint16_t;
        ...
        TIM_OCInitStructure.TIM_OCPolarity =
            if stateHigh as libc::c_int != 0 {
                ...
                uint16_t
    } else { TIM_OCInitStructure.TIM_OCMode = 0 as libc::c_int as uint16_t }
...
unsafe extern "C" fn timCCxHandler(mut tim: *mut TIM_TypeDef,
    ...
    tim_status =
        ((*tim).SR as libc::c_int & (*tim).DIER as libc::c_int) as
            libc::c_uint;
    while tim_status != 0 {
        ...
        ::core::ptr::write_volatile(&mut (*tim).SR as *mut uint16_t,
                                    mask as uint16_t);
        tim_status &= mask;
        match bit {
            31 => {
...
#[no_mangle]
pub unsafe extern "C" fn TIM1_UP_IRQHandler() {
    timCCxHandler((0x40000000 as libc::c_int as
                       uint32_t).wrapping_add(0x10000 as libc::c_int as
                                                  libc::c_uint).wrapping_add(0x2c00
                                                                                 as
...
pub unsafe extern "C" fn timerInit() {
    memset(timerConfig.as_mut_ptr() as *mut libc::c_void, 0 as libc::c_int,
           ::core::mem::size_of::<[timerConfig_t; 4]>() as libc::c_ulong);
    GPIO_PinRemapConfig(0x1a0800 as libc::c_int as uint32_t, ENABLE);
    ...
    while i_0 < 12 as libc::c_int as libc::c_uint {
...
pub unsafe extern "C" fn timerForceOverflow(mut tim: *mut TIM_TypeDef) {
    ...
    while __ToDo != 0 {
        ...
        timerConfig[timerIndex as usize].forcedOverflowTimerValue =
            ((*tim).CNT as libc::c_int + 1 as libc::c_int) as uint32_t;
        // Force an overflow by setting the UG bit
        ::core::ptr::write_volatile(&mut (*tim).EGR as *mut uint16_t,
                                    (::core::ptr::read_volatile::<uint16_t>(&(*tim).EGR
                                                                                as
                                                                                *const uint16_t)
                                         as libc::c_int |
...
pub unsafe extern "C" fn timerCCR(mut tim: *mut TIM_TypeDef,
    ...
    return (&mut (*tim).CCR1 as *mut uint16_t as
    ...
    usedTimers =
        [(0x40000000 as libc::c_int as
         ...
         (0x40000000 as libc::c_int as
             ...
             *mut TIM_TypeDef,
         (0x40000000 as libc::c_int as
              uint32_t).wrapping_add(0x800 as libc::c_int as libc::c_uint) as
             *mut TIM_TypeDef]
}
#[used]
