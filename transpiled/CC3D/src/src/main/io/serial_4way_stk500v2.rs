    ...
    *bt = 0 as libc::c_int as uint8_t;
    ...
    loop  {
        ...
        if bit as libc::c_int == -(1 as libc::c_int) {
            current_block = 10115875025210543956;
            break ;
        }
        if bit as libc::c_int == 1 as libc::c_int {
            *bt =
    ...
    match current_block {
        10115875025210543956 => { return 0 as libc::c_int as uint8_t }
        _ => {
            ckSumIn =
    ...
    if !(waitcycl == 0 as libc::c_int as libc::c_uint) {
        ...
        loop  {
            ...
            if ReadBit() as libc::c_int == -(1 as libc::c_int) {
                current_block = 16830319482262729516;
                break ;
            }
            i = i.wrapping_add(1)
        }
        match current_block {
            ...
            _ => {
                ...
                loop  {
                    ...
                    if bit as libc::c_int == -(1 as libc::c_int) {
                        current_block = 16830319482262729516; // NumTX
                        break ; // NumRX
                    } // RxStartAdr
