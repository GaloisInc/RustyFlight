...
// 3. Slave I2C device on SPI gyro
    ...
    (*compassConfig_0).mag_i2c_device =
        (I2CDEV_2 as libc::c_int + 1 as libc::c_int) as uint8_t;
...
pub unsafe extern "C" fn compassDetect(mut dev: *mut magDev_t) -> bool {
    ...
    match (*compassConfig()).mag_hardware as libc::c_int {
        0 | 2 => {
            ...
            } else { current_block_48 = 17306805145068172297; }
        }
        5 => { current_block_48 = 17306805145068172297; }
        3 => { current_block_48 = 5110490827617222499; }
        4 => { current_block_48 = 5794645169575649106; }
        1 => { current_block_48 = 17592539310030730040; }
        _ => { current_block_48 = 9512719473022792396; }
    }
    match current_block_48 {
        17306805145068172297 => {
            if (*busdev).bustype as libc::c_uint ==
                   BUSTYPE_I2C as libc::c_int as libc::c_uint {
                (*busdev).busdev_u.i2c.address =
                    (*compassConfig()).mag_i2c_address
            ...
            if qmc5883lDetect(dev) {
                ...
                current_block_48 = 9512719473022792396;
            } else { current_block_48 = 5110490827617222499; }
        }
        _ => { }
    }
    match current_block_48 {
        5110490827617222499 => {
            ...
            if ak8975Detect(dev) {
                ...
                current_block_48 = 9512719473022792396;
            } else { current_block_48 = 5794645169575649106; }
        }
        _ => { }
    }
    match current_block_48 {
        5794645169575649106 => {
            ...
            if ak8963Detect(dev) {
                ...
                current_block_48 = 9512719473022792396;
            } else { current_block_48 = 17592539310030730040; }
        }
        _ => { }
    }
    match current_block_48 {
        17592539310030730040 => { magHardware = MAG_NONE }
        _ => { }
    }
