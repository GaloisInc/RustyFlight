...
unsafe extern "C" fn gyroDetect(mut dev: *mut gyroDev_t) -> gyroSensor_e {
    ...
    match gyroHardware as libc::c_uint {
        1 | 6 => {
            ...
            } else { current_block_15 = 10892540404157042304; }
        }
        7 | 9 | 10 | 11 => { current_block_15 = 10892540404157042304; }
        _ => { current_block_15 = 9932722462317761039; }
    }
    match current_block_15 {
        10892540404157042304 => {
            if mpu6500GyroDetect(dev) as libc::c_int != 0 ||
                ...
                (*dev).gyroAlign = CW270_DEG;
                current_block_15 = 14763689060501151050;
            } else { current_block_15 = 9932722462317761039; }
        }
        _ => { }
    }
    match current_block_15 {
        9932722462317761039 => { gyroHardware = GYRO_NONE }
        _ => { }
    }
