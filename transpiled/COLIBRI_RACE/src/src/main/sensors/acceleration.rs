    ...
    loop  {
        ...
        match accHardwareToUse as libc::c_uint {
            0 | 7 => {
                ...
                } else { current_block_15 = 10512167948584850697; }
            }
            8 | 10 | 11 | 12 => { current_block_15 = 10512167948584850697; }
            1 | _ => { current_block_15 = 1429036393514693534; }
        }
        match current_block_15 {
            10512167948584850697 => {
                if mpu6500AccDetect(dev) as libc::c_int != 0 ||
                    ...
                    current_block_15 = 15345278821338558188;
                } else { current_block_15 = 1429036393514693534; }
            }
            _ => { }
        }
        match current_block_15 {
