 ...
 */
    ...
    #[no_mangle]
    fn taskBstMasterProcess(currentTimeUs: timeUs_t);
}
...
pub unsafe extern "C" fn fcTasksInit() {
    ...
    setTaskEnabled(TASK_BST_MASTER_PROCESS, 1 as libc::c_int != 0);
    ...
    unsafe {
        [{
         ...
         },
         {
             let mut init =
                 cfTask_t{taskName:
                              b"BST_MASTER_PROCESS\x00" as *const u8 as
                                  *const libc::c_char,
                          subTaskName: 0 as *const libc::c_char,
                          checkFunc: None,
                          taskFunc:
                              Some(taskBstMasterProcess as
                                       unsafe extern "C" fn(_: timeUs_t)
                                           -> ()),
                          desiredPeriod:
                              1000000 as libc::c_int / 50 as libc::c_int,
