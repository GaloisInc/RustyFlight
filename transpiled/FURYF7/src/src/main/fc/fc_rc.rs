...
pub unsafe extern "C" fn initRcProcessing() {
    ...
    match (*rxConfig()).rcInterpolationChannels as libc::c_int {
        2 => {
            ...
            current_block_22 = 7173783506686787924;
        }
        1 => { current_block_22 = 7173783506686787924; }
        0 => { current_block_22 = 3761121136128276948; }
        4 => {
            interpolationChannels =
                (interpolationChannels as libc::c_int |
                     (ROLL_FLAG as libc::c_int | PITCH_FLAG as libc::c_int))
                    as uint8_t;
            current_block_22 = 4065037160345883075;
        }
        3 => { current_block_22 = 4065037160345883075; }
    ...
    match current_block_22 {
        7173783506686787924 => {
            ...
            current_block_22 = 3761121136128276948;
        }
        4065037160345883075 => {
            interpolationChannels =
                (interpolationChannels as libc::c_int |
