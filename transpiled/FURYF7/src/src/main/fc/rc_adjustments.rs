 ...
 -> libc::c_int {
    ...
    match adjustmentFunction as libc::c_int {
        1 | 25 => {
            ...
            } else { current_block_82 = 11031955772970475407; }
        }
        26 => { current_block_82 = 11031955772970475407; }
        2 | 27 => {
            newValue =
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 = 15447629348493591490;
            } else { current_block_82 = 11112958934374135912; }
        }
        28 => { current_block_82 = 11112958934374135912; }
        3 => {
            newValue =
        ...
        4 | 13 => {
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 = 15447629348493591490;
            } else { current_block_82 = 14280459541281142556; }
        }
        14 => { current_block_82 = 14280459541281142556; }
        5 => {
            newValue =
        ...
        6 | 15 => {
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 =
                    8965284786506546802; // FIXME magic numbers repeated in cli.c
            }
        }
        18 => { current_block_82 = 8965284786506546802; }
        7 | 16 => {
            newValue =
                constrain((*pidProfile).pid[PID_PITCH as libc::c_int as
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 =
                    12871766079310849952; // FIXME magic numbers repeated in cli.c
            }
        }
        19 => { current_block_82 = 12871766079310849952; }
        8 | 17 => {
            newValue =
                constrain((*pidProfile).pid[PID_PITCH as libc::c_int as
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 =
                    10939415261738465863; // FIXME magic numbers repeated in cli.c
            }
        }
        20 => {
            current_block_82 =
        ...
        22 | 30 => {
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 = 15447629348493591490;
            } else { current_block_82 = 1050641036744741012; }
        }
        31 => { current_block_82 = 1050641036744741012; }
        32 => {
            newValue =
 ...
 -> libc::c_int {
    ...
    match adjustmentFunction as libc::c_uint {
        1 | 25 => {
            ...
            } else { current_block_84 = 11796670028594213660; }
        }
        26 => { current_block_84 = 11796670028594213660; }
        2 | 27 => {
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                current_block_84 = 5265702136860997526;
            } else { current_block_84 = 10955445361815898936; }
        }
        28 => { current_block_84 = 10955445361815898936; }
        3 => {
            newValue = constrain(value, 0 as libc::c_int, 100 as libc::c_int);
            (*controlRateConfig).thrExpo8 = newValue as uint8_t;
            initRcProcessing();
        ...
        4 | 13 => {
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                current_block_84 = 5265702136860997526;
            } else { current_block_84 = 15522335386644043885; }
        }
        14 => { current_block_84 = 15522335386644043885; }
        5 => {
            newValue = constrain(value, 0 as libc::c_int, 255 as libc::c_int);
            (*controlRateConfig).rates[FD_YAW as libc::c_int as usize] =
                newValue as uint8_t;
        ...
        6 | 15 => {
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                // fall through for combined ADJUSTMENT_PITCH_ROLL_P
                current_block_84 =
                    10790108094560581325; // FIXME magic numbers repeated in cli.c
            }
        }
        18 => { current_block_84 = 10790108094560581325; }
        7 | 16 => {
            newValue = constrain(value, 0 as libc::c_int, 200 as libc::c_int);
            (*pidProfile).pid[PID_PITCH as libc::c_int as usize].I =
                newValue as uint8_t;
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                // fall through for combined ADJUSTMENT_PITCH_ROLL_I
                current_block_84 =
                    16629442725818564137; // FIXME magic numbers repeated in cli.c
            }
        }
        19 => { current_block_84 = 16629442725818564137; }
        8 | 17 => {
            newValue = constrain(value, 0 as libc::c_int, 200 as libc::c_int);
            (*pidProfile).pid[PID_PITCH as libc::c_int as usize].D =
                newValue as uint8_t;
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                // fall through for combined ADJUSTMENT_PITCH_ROLL_D
                current_block_84 =
                    11343749476819147856; // FIXME magic numbers repeated in cli.c
            }
        }
        20 => {
            current_block_84 =
        ...
        22 | 30 => {
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                current_block_84 = 5265702136860997526;
            } else { current_block_84 = 7806981814426768587; }
        }
        31 => { current_block_84 = 7806981814426768587; }
        32 => {
            newValue =
                constrain(value, 0 as libc::c_int, 2000 as libc::c_int);
            (*pidProfile).pid[PID_YAW as libc::c_int as usize].F =
    ...
    match current_block_84 {
        ...
        11343749476819147856 => {
            newValue = constrain(value, 0 as libc::c_int, 200 as libc::c_int);
            (*pidProfile).pid[PID_ROLL as libc::c_int as usize].D =
                newValue as uint8_t;
            blackboxLogInflightAdjustmentEvent(ADJUSTMENT_ROLL_D, newValue);
        }
        16629442725818564137 => {
            newValue = constrain(value, 0 as libc::c_int, 200 as libc::c_int);
            (*pidProfile).pid[PID_ROLL as libc::c_int as usize].I =
                newValue as uint8_t;
            blackboxLogInflightAdjustmentEvent(ADJUSTMENT_ROLL_I, newValue);
        }
        10790108094560581325 => {
            newValue = constrain(value, 0 as libc::c_int, 200 as libc::c_int);
            (*pidProfile).pid[PID_ROLL as libc::c_int as usize].P =
                newValue as uint8_t;
            blackboxLogInflightAdjustmentEvent(ADJUSTMENT_ROLL_P, newValue);
        }
        15522335386644043885 =>
        // fall through for combined ADJUSTMENT_PITCH_ROLL_RATE
        {
            newValue = constrain(value, 0 as libc::c_int, 255 as libc::c_int);
            (*controlRateConfig).rates[FD_ROLL as libc::c_int as usize] =
