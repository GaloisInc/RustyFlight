...
pub struct serialPinConfig_s {
    pub ioTagTx: [ioTag_t; 11],
    pub ioTagRx: [ioTag_t; 11],
    pub ioTagInverter: [ioTag_t; 11],
}
...
pub static mut serialPortIdentifiers: [serialPortIdentifier_e; 6] =
    [SERIAL_PORT_USB_VCP, SERIAL_PORT_USART1, SERIAL_PORT_USART3,
     SERIAL_PORT_UART5, SERIAL_PORT_USART6, SERIAL_PORT_SOFTSERIAL1];
...
pub unsafe extern "C" fn pgResetFn_serialConfig(mut serialConfig_0:
    ...
    let mut serialRxUartConfig: *mut serialPortConfig_t =
        serialFindPortConfiguration(SERIAL_PORT_USART6);
