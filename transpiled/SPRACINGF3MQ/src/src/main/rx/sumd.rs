...
static mut sumdFrameDone: bool = 0 as libc::c_int != 0;
...
unsafe extern "C" fn sumdDataReceive(mut c: uint16_t,
    ...
    sumdTime = micros();
    if sumdTime.wrapping_sub(sumdTimeLast) >
           4000 as libc::c_int as libc::c_uint {
        sumdIndex = 0 as libc::c_int as uint8_t
    }
    sumdTimeLast = sumdTime;
    if sumdIndex as libc::c_int == 0 as libc::c_int {
        if c as libc::c_int != 0xa8 as libc::c_int {
            return
        } else {
            sumdFrameDone = 0 as libc::c_int != 0;
            crc = 0 as libc::c_int as uint16_t
        }
    }
    if sumdIndex as libc::c_int == 2 as libc::c_int {
        sumdChannelCount = c as uint8_t
    }
    ...
    if (sumdIndex as libc::c_int) <
           sumdChannelCount as libc::c_int * 2 as libc::c_int +
               4 as libc::c_int {
        crc = crc16_ccitt(crc, c as uint8_t)
                  ...
                  sumdChannelCount as libc::c_int * 2 as libc::c_int +
                      5 as libc::c_int {
        sumdIndex = 0 as libc::c_int as uint8_t;
        sumdFrameDone = 1 as libc::c_int != 0
    };
}
unsafe extern "C" fn sumdFrameStatus(mut rxRuntimeConfig:
    ...
    if crc as libc::c_int !=
           (sumd[(2 as libc::c_int * sumdChannelCount as libc::c_int +
    ...
    match sumd[1 as libc::c_int as usize] as libc::c_int {
        129 => {
            frameStatus =
    ...
    if sumdChannelCount as libc::c_int > 16 as libc::c_int {
        sumdChannelCount = 16 as libc::c_int as uint8_t
    }
    ...
    while (channelIndex as libc::c_int) < sumdChannelCount as libc::c_int {
        sumdChannels[channelIndex as usize] =
            ((sumd[(2 as libc::c_int * channelIndex as libc::c_int +
                        3 as libc::c_int) as usize] as libc::c_int) <<
                 8 as libc::c_int |
                 sumd[(2 as libc::c_int * channelIndex as libc::c_int +
                           4 as libc::c_int) as usize] as libc::c_int) as
                uint16_t;
...
unsafe extern "C" fn sumdReadRawRC(mut rxRuntimeConfig:
    ...
    return (sumdChannels[chan as usize] as libc::c_int / 8 as libc::c_int) as
               uint16_t;
}
/*
 * This file is part of Cleanflight and Betaflight.
