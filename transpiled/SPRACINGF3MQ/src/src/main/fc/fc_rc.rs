...
pub unsafe extern "C" fn initRcProcessing() {
    ...
    match (*rxConfig()).rcInterpolationChannels as libc::c_int {
        2 => {
            ...
            current_block_22 = 6011427557308586267;
        }
        1 => { current_block_22 = 6011427557308586267; }
        0 => { current_block_22 = 1754583399387835727; }
        4 => {
            interpolationChannels =
                (interpolationChannels as libc::c_int |
                     (ROLL_FLAG as libc::c_int | PITCH_FLAG as libc::c_int))
                    as uint8_t;
            current_block_22 = 1776290020351736984;
        }
        3 => { current_block_22 = 1776290020351736984; }
    ...
    match current_block_22 {
        6011427557308586267 => {
            ...
            current_block_22 = 1754583399387835727;
        }
        1776290020351736984 => {
            interpolationChannels =
                (interpolationChannels as libc::c_int |
