    ...
    match (*compassConfig()).mag_hardware as libc::c_int {
        0 | 2 | 5 | 3 | 4 => {
            ...
            if ak8963Detect(dev) {
                ...
                current_block_38 = 16799951812150840583;
            } else { current_block_38 = 12060472940751469075; }
        }
        1 => { current_block_38 = 12060472940751469075; }
        _ => { current_block_38 = 16799951812150840583; }
    }
    match current_block_38 {
        12060472940751469075 => { magHardware = MAG_NONE }
        _ => { }
    }
