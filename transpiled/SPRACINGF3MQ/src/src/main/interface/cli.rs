...
pub const LOOKUP_TABLE_COUNT: lookupTableIndex_e = 32;
pub const TABLE_ACRO_TRAINER_DEBUG: lookupTableIndex_e = 31;
pub const TABLE_ITERM_RELAX_TYPE: lookupTableIndex_e = 30;
pub const TABLE_ITERM_RELAX: lookupTableIndex_e = 29;
...
pub const TABLE_BUS_TYPE: lookupTableIndex_e = 25;
pub const TABLE_CAMERA_CONTROL_MODE: lookupTableIndex_e = 24;
...
pub const TABLE_GYRO_32KHZ_HARDWARE_LPF: lookupTableIndex_e = 10;
...
pub const TASK_TRANSPONDER: cfTaskId_e = 17;
...
#[no_mangle]
pub static mut resourceTable: [cliResourceValue_t; 29] =
    [{
         let mut init =
...
unsafe extern "C" fn printResource(mut dumpMask: uint8_t) {
    ...
    while (i as libc::c_ulong) <
              (::core::mem::size_of::<[cliResourceValue_t; 29]>() as
