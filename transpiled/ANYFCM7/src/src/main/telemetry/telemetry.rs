 ...
 */
    ...
    fn initLtmTelemetry();
    #[no_mangle]
    fn handleLtmTelemetry();
    #[no_mangle]
    fn checkLtmTelemetryState();
    /*
 * This file is part of Cleanflight and Betaflight.
 *
 * Cleanflight and Betaflight are free software. You can redistribute
 ...
 */
    #[no_mangle]
    fn initJetiExBusTelemetry();
    #[no_mangle]
    fn checkJetiExBusTelemetryState();
    #[no_mangle]
    fn handleJetiExBusTelemetry();
    /*
 * This file is part of Cleanflight and Betaflight.
 *
 * Cleanflight and Betaflight are free software. You can redistribute
 ...
 */
    #[no_mangle]
    fn initMAVLinkTelemetry();
    #[no_mangle]
    fn handleMAVLinkTelemetry();
    #[no_mangle]
    fn checkMAVLinkTelemetryState();
    /*
 * This file is part of Cleanflight and Betaflight.
 *
 * Cleanflight and Betaflight are free software. You can redistribute
 ...
 */
    #[no_mangle]
    fn initCrsfTelemetry();
    #[no_mangle]
    fn checkCrsfTelemetryState() -> bool;
    #[no_mangle]
    fn handleCrsfTelemetry(currentTimeUs: timeUs_t);
    #[no_mangle]
    fn initCrsfMspBuffer();
    #[no_mangle]
    fn initSrxlTelemetry();
    #[no_mangle]
    fn checkSrxlTelemetryState() -> bool;
    #[no_mangle]
    fn handleSrxlTelemetry(currentTimeUs: timeUs_t);
    /*
 * This file is part of Cleanflight and Betaflight.
 *
 * Cleanflight and Betaflight are free software. You can redistribute
 ...
 */
    #[no_mangle]
    fn initIbusTelemetry();
    #[no_mangle]
    fn handleIbusTelemetry();
    #[no_mangle]
    fn checkIbusTelemetryState() -> bool;
    #[no_mangle]
    fn initSharedMsp();
}
...
pub const IBUS_SENSOR_TYPE_ACC_FULL: C2RustUnnamed_4 = 239;
pub const IBUS_SENSOR_TYPE_VOLT_FULL: C2RustUnnamed_4 = 240;
pub const IBUS_SENSOR_TYPE_GPS_FULL: C2RustUnnamed_4 = 253;
...
pub unsafe extern "C" fn telemetryCheckRxPortShared(mut portConfig:
 ...
 -> bool {
    ...
    if (*portConfig).functionMask as libc::c_int &
           FUNCTION_TELEMETRY_IBUS as libc::c_int != 0 &&
           (*portConfig).functionMask as libc::c_int &
               FUNCTION_RX_SERIAL as libc::c_int != 0 &&
           (*rxConfig()).serialrx_provider as libc::c_int ==
               SERIALRX_IBUS as libc::c_int {
