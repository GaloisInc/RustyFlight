    ...
    ::core::ptr::write_volatile(&mut (*((0x40000000 as libc::c_int as
                                             uint32_t).wrapping_add(0x10000 as
                                                                        ...
                                                                        libc::c_uint).wrapping_add(0
                                                                                                       ...
                                                                                                       libc::c_uint)
                                            as
                                            *mut SYSCFG_TypeDef)).EXTICR[0 as
                                                                             libc::c_int
                                                                             as
                                                                             usize]
                                    as *mut uint32_t,
    ...
    ::core::ptr::write_volatile(&mut (*((0x40000000 as libc::c_int as
                                             uint32_t).wrapping_add(0x10000 as
                                                                        ...
                                                                        libc::c_uint).wrapping_add(0
                                                                                                       ...
                                                                                                       libc::c_uint)
                                            as
                                            *mut SYSCFG_TypeDef)).EXTICR[1 as
                                                                             libc::c_int
                                                                             as
                                                                             usize]
                                    as *mut uint32_t,
    ...
    ::core::ptr::write_volatile(&mut (*((0x40000000 as libc::c_int as
                                             uint32_t).wrapping_add(0x10000 as
                                                                        ...
                                                                        libc::c_uint).wrapping_add(0
                                                                                                       ...
                                                                                                       libc::c_uint)
                                            as
                                            *mut SYSCFG_TypeDef)).EXTICR[2 as
                                                                             libc::c_int
                                                                             as
                                                                             usize]
                                    as *mut uint32_t,
    ...
    ::core::ptr::write_volatile(&mut (*((0x40000000 as libc::c_int as
                                             uint32_t).wrapping_add(0x10000 as
                                                                        ...
                                                                        libc::c_uint).wrapping_add(0
                                                                                                       ...
                                                                                                       libc::c_uint)
                                            as
                                            *mut SYSCFG_TypeDef)).EXTICR[3 as
                                                                             libc::c_int
                                                                             as
                                                                             usize]
                                    as *mut uint32_t,
...
pub unsafe extern "C" fn SYSCFG_MemoryRemapConfig(mut SYSCFG_MemoryRemap:
                                                      uint32_t) {
    let mut tmpcfgr1: uint32_t = 0 as libc::c_int as uint32_t;
    /* Check the parameter */
    ...
    tmpcfgr1 =
        (*((0x40000000 as libc::c_int as
               ...
               as *mut SYSCFG_TypeDef)).CFGR1;
    /* Clear MEM_MODE bits */
    tmpcfgr1 &= !(0x3 as libc::c_int as uint32_t);
...
pub unsafe extern "C" fn SYSCFG_DMAChannelRemapConfig(mut SYSCFG_DMARemap:
    ...
    if SYSCFG_DMARemap & 0x80000000 as libc::c_uint !=
...
pub unsafe extern "C" fn SYSCFG_TriggerRemapConfig(mut SYSCFG_TriggerRemap:
                                                   ...
                                                   mut NewState:
                                                       FunctionalState) {
    /* Check the parameters */
    if SYSCFG_TriggerRemap & 0x80000000 as libc::c_uint !=
           0x80000000 as libc::c_uint {
        if NewState as libc::c_uint != DISABLE as libc::c_int as libc::c_uint
           {
            /* Remap the trigger */
