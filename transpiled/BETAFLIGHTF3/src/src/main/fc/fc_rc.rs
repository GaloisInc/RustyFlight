...
pub unsafe extern "C" fn initRcProcessing() {
    ...
    match (*rxConfig()).rcInterpolationChannels as libc::c_int {
        2 => {
            ...
            current_block_22 = 16194126489807337798;
        }
        1 => { current_block_22 = 16194126489807337798; }
        0 => { current_block_22 = 7343776945037015585; }
        4 => {
            interpolationChannels =
                (interpolationChannels as libc::c_int |
                     (ROLL_FLAG as libc::c_int | PITCH_FLAG as libc::c_int))
                    as uint8_t;
            current_block_22 = 363674634625105402;
        }
        3 => { current_block_22 = 363674634625105402; }
    ...
    match current_block_22 {
        16194126489807337798 => {
            ...
            current_block_22 = 7343776945037015585;
        }
        363674634625105402 => {
            interpolationChannels =
                (interpolationChannels as libc::c_int |
