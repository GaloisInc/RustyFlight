...
#[no_mangle]
pub static mut timerChannelInfo: [timerChannelInfo_t; 10] =
    [timerChannelInfo_t{type_0: TYPE_FREE,}; 10];
#[no_mangle]
...
pub unsafe extern "C" fn timerChInit(mut timHw: *const timerHardware_t,
    ...
    let mut channel: libc::c_uint =
        timHw.wrapping_offset_from(timerHardware.as_ptr()) as libc::c_long as
            libc::c_uint;
    if channel >= 10 as libc::c_int as libc::c_uint { return }
...
pub unsafe extern "C" fn timerInit() {
    ...
    while timerIndex < 10 as libc::c_int as libc::c_uint {
    ...
    while i_0 < 10 as libc::c_int as libc::c_uint {
