            ...
            let mut init =
                I2C_InitTypeDef{I2C_Timing:
                                    if (*pDev).overClock as libc::c_int != 0 {
                                        0x500e30 as libc::c_int
                                    } else { 0xe0257a as libc::c_int } as
                                        uint32_t,
                                I2C_AnalogFilter:
                                    0 as libc::c_int as uint32_t,
                                I2C_DigitalFilter:
                                    0 as libc::c_int as uint32_t,
                                I2C_Mode: 0 as libc::c_int as uint32_t,
                                I2C_OwnAddress1: 0 as libc::c_int as uint32_t,
                                I2C_Ack: 0 as libc::c_int as uint32_t,
...
pub unsafe extern "C" fn i2cWrite(mut device: I2CDevice, mut addr_: uint8_t,
 ...
 -> bool {
    ...
    addr_ = ((addr_ as libc::c_int) << 1 as libc::c_int) as uint8_t;
    /* Test on BUSY Flag */
    i2cTimeout =
        (10 as libc::c_int as
             libc::c_uint).wrapping_mul(0x1000 as libc::c_int as uint32_t);
    while I2C_GetFlagStatus(I2Cx, 0x8000 as libc::c_int as uint32_t) as
    ...
    I2C_TransferHandling(I2Cx, addr_ as uint16_t, 1 as libc::c_int as uint8_t,
    ...
    i2cTimeout =
        (10 as libc::c_int as
             libc::c_uint).wrapping_mul(0x1000 as libc::c_int as uint32_t);
    while I2C_GetFlagStatus(I2Cx, 0x2 as libc::c_int as uint32_t) as
              libc::c_uint == RESET as libc::c_int as libc::c_uint {
    ...
    i2cTimeout =
        (10 as libc::c_int as
             libc::c_uint).wrapping_mul(0x1000 as libc::c_int as uint32_t);
    while I2C_GetFlagStatus(I2Cx, 0x80 as libc::c_int as uint32_t) as
              libc::c_uint == RESET as libc::c_int as libc::c_uint {
    ...
    i2cTimeout =
        (10 as libc::c_int as
             libc::c_uint).wrapping_mul(0x1000 as libc::c_int as uint32_t);
    while I2C_GetFlagStatus(I2Cx, 0x20 as libc::c_int as uint32_t) as
              libc::c_uint == RESET as libc::c_int as libc::c_uint {
    ...
    /* Clear STOPF flag */
    I2C_ClearFlag(I2Cx, 0x20 as libc::c_int as uint32_t);
...
pub unsafe extern "C" fn i2cRead(mut device: I2CDevice, mut addr_: uint8_t,
    ...
    while I2C_GetFlagStatus(I2Cx, 0x8000 as libc::c_int as uint32_t) as
        ...
        i2cTimeout = i2cTimeout.wrapping_sub(1);
        if fresh5 == 0 as libc::c_int as libc::c_uint {
            return i2cTimeoutUserCallback() != 0
        }
    }
    /* Configure slave address, nbytes, reload, end mode and start or stop generation */
    ...
    i2cTimeout =
        (10 as libc::c_int as
             libc::c_uint).wrapping_mul(0x1000 as libc::c_int as uint32_t);
    while I2C_GetFlagStatus(I2Cx, 0x40 as libc::c_int as uint32_t) as
              libc::c_uint == RESET as libc::c_int as libc::c_uint {
    ...
    while len != 0 {
        ...
        i2cTimeout =
            (10 as libc::c_int as
                 libc::c_uint).wrapping_mul(0x1000 as libc::c_int as
                                                uint32_t);
        while I2C_GetFlagStatus(I2Cx, 0x4 as libc::c_int as uint32_t) as
                  libc::c_uint == RESET as libc::c_int as libc::c_uint {
            let fresh8 = i2cTimeout;
            i2cTimeout = i2cTimeout.wrapping_sub(1);
            if fresh8 == 0 as libc::c_int as libc::c_uint {
                return i2cTimeoutUserCallback() != 0
            }
        }
        /* Read data from RXDR */
    ...
    while I2C_GetFlagStatus(I2Cx, 0x20 as libc::c_int as uint32_t) as
        ...
        i2cTimeout = i2cTimeout.wrapping_sub(1);
        if fresh9 == 0 as libc::c_int as libc::c_uint {
            return i2cTimeoutUserCallback() != 0
        }
    }
    /* Clear STOPF flag */
        ...
        [{
             let mut init =
                 i2cHardware_s{device: I2CDEV_1,
                               reg:
                                   (0x40000000 as libc::c_int as
                                        uint32_t).wrapping_add(0x5400 as
                                                                   libc::c_int
                                                                   as
                                                                   libc::c_uint)
                                       as *mut I2C_TypeDef,
