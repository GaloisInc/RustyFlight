...
/* * @addtogroup STM32F30x_System_Private_Includes
  ...
  */
#[no_mangle]
pub static mut hse_value: uint32_t = 12000000 as libc::c_int as uint32_t;
  ...
  /* Set HSION bit */
    ...
    ::core::ptr::write_volatile(fresh1,
                                (::core::ptr::read_volatile::<uint32_t>(fresh1
                                                                            ...
                                                                            *const uint32_t)
                                     as libc::c_uint &
                                     0xf87fc00c as libc::c_uint) as uint32_t
                                    as uint32_t);
    ...
    ::core::ptr::write_volatile(fresh5,
                                (::core::ptr::read_volatile::<uint32_t>(fresh5
                                                                            ...
                                                                            *const uint32_t)
                                     as libc::c_uint &
                                     0xfffffff0 as libc::c_uint) as uint32_t
                                    as uint32_t);
    ...
    ::core::ptr::write_volatile(fresh6,
                                (::core::ptr::read_volatile::<uint32_t>(fresh6
                                                                            ...
                                                                            *const uint32_t)
                                     as libc::c_uint &
                                     0xff00fccc as libc::c_uint) as uint32_t
                                    as uint32_t);
...
pub unsafe extern "C" fn SystemCoreClockUpdate() {
    ...
    match tmp {
        ...
        4 => {
            ...
            SystemCoreClock = 12000000 as libc::c_int as uint32_t
        }
        8 => {
...
pub unsafe extern "C" fn SetSysClock() {
    ...
    let mut HSEStatus: uint32_t = 0 as libc::c_int as uint32_t;
    /* *****************************************************************************/
...
/* *****************************************************************************/
  ...
  /* Enable HSE */
    ...
    loop 
        ...
        if !(HSEStatus == 0 as libc::c_int as libc::c_uint &&
                 StartUpCounter !=
    ...
    if HSEStatus == 0x1 as libc::c_int as uint32_t {
        ...
        ::core::ptr::write_volatile(fresh11,
                                    (::core::ptr::read_volatile::<uint32_t>(fresh11
                                        ...
                                        uint32_t);
        if 12000000 as libc::c_int == 12000000 as libc::c_int {
            let ref mut fresh12 =
                (*((0x40000000 as libc::c_int as
                        uint32_t).wrapping_add(0x20000 as libc::c_int as
                                                   libc::c_uint).wrapping_add(0x1000
