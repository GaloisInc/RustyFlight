...
pub const LOOKUP_TABLE_COUNT: lookupTableIndex_e = 34;
pub const TABLE_RC_SMOOTHING_DERIVATIVE_TYPE: lookupTableIndex_e = 33;
pub const TABLE_RC_SMOOTHING_INPUT_TYPE: lookupTableIndex_e = 32;
pub const TABLE_RC_SMOOTHING_DEBUG: lookupTableIndex_e = 31;
pub const TABLE_RC_SMOOTHING_TYPE: lookupTableIndex_e = 30;
pub const TABLE_ACRO_TRAINER_DEBUG: lookupTableIndex_e = 29;
pub const TABLE_ITERM_RELAX_TYPE: lookupTableIndex_e = 28;
pub const TABLE_ITERM_RELAX: lookupTableIndex_e = 27;
pub const TABLE_THROTTLE_LIMIT_TYPE: lookupTableIndex_e = 26;
pub const TABLE_RGB_GRB: lookupTableIndex_e = 25;
pub const TABLE_RATES_TYPE: lookupTableIndex_e = 24;
pub const TABLE_GYRO_OVERFLOW_CHECK: lookupTableIndex_e = 23;
pub const TABLE_BUS_TYPE: lookupTableIndex_e = 22;
pub const TABLE_CAMERA_CONTROL_MODE: lookupTableIndex_e = 21;
pub const TABLE_CRASH_RECOVERY: lookupTableIndex_e = 20;
pub const TABLE_FAILSAFE_SWITCH_MODE: lookupTableIndex_e = 19;
pub const TABLE_FAILSAFE: lookupTableIndex_e = 18;
pub const TABLE_ANTI_GRAVITY_MODE: lookupTableIndex_e = 17;
pub const TABLE_DTERM_LOWPASS_TYPE: lookupTableIndex_e = 16;
pub const TABLE_LOWPASS_TYPE: lookupTableIndex_e = 15;
pub const TABLE_RC_INTERPOLATION_CHANNELS: lookupTableIndex_e = 14;
pub const TABLE_RC_INTERPOLATION: lookupTableIndex_e = 13;
pub const TABLE_MOTOR_PWM_PROTOCOL: lookupTableIndex_e = 12;
pub const TABLE_DEBUG: lookupTableIndex_e = 11;
...
#[no_mangle]
pub static mut resourceTable: [cliResourceValue_t; 27] =
    [{
         let mut init =
     ...
     },
     {
         let mut init =
             cliResourceValue_t{owner:
                                    OWNER_TRANSPONDER as libc::c_int as
                                        uint8_t,
                                pgn: 17 as libc::c_int as pgn_t,
                                stride: 0 as libc::c_int as uint8_t,
...
unsafe extern "C" fn printResource(mut dumpMask: uint8_t) {
    ...
    while (i as libc::c_ulong) <
              (::core::mem::size_of::<[cliResourceValue_t; 27]>() as
