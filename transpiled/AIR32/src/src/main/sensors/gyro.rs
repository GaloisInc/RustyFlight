    ...
    match gyroHardware as libc::c_uint {
        1 | 2 => {
            if mpu6050GyroDetect(dev) {
                ...
                current_block_10 = 17833034027772472439;
            } else { current_block_10 = 5768530447596251282; }
        }
        6 => { current_block_10 = 5768530447596251282; }
        _ => { current_block_10 = 18215801603777940250; }
    }
    match current_block_10 {
        5768530447596251282 => {
            if mpu6000SpiGyroDetect(dev) {
                ...
                (*dev).gyroAlign = CW180_DEG;
                current_block_10 = 17833034027772472439;
            } else { current_block_10 = 18215801603777940250; }
        }
        _ => { }
    }
    match current_block_10 {
        18215801603777940250 => { gyroHardware = GYRO_NONE }
        _ => { }
    }
