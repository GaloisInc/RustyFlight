...
pub const FSSP_SENSOR_ID4: C2RustUnnamed_7 = 103;
pub const FSSP_SENSOR_ID3: C2RustUnnamed_7 = 52;
pub const FSSP_SENSOR_ID2: C2RustUnnamed_7 = 13;
...
pub const FSSP_SENSOR_ID1: C2RustUnnamed_7 = 27;
// MSP client frame
pub const FSSP_MSPS_FRAME: C2RustUnnamed_7 = 50;
// MSP client frame
pub const FSSP_MSPC_FRAME_FPORT: C2RustUnnamed_7 = 49;
pub const FSSP_MSPC_FRAME_SMARTPORT: C2RustUnnamed_7 = 48;
pub const FSSP_DATA_FRAME: C2RustUnnamed_7 = 16;
pub const FSSP_DLE_XOR: C2RustUnnamed_7 = 32;
pub const FSSP_DLE: C2RustUnnamed_7 = 125;
pub const FSSP_START_STOP: C2RustUnnamed_7 = 126;
#[derive(Copy, Clone)]
#[repr(C, packed)]
...
pub const TELEMETRY_STATE_INITIALIZED_SERIAL: C2RustUnnamed_9 = 1;
pub const TELEMETRY_STATE_UNINITIALIZED: C2RustUnnamed_9 = 0;
...
pub const FSSP_DATAID_VARIO: C2RustUnnamed_8 = 272;
pub const FSSP_DATAID_ALTITUDE: C2RustUnnamed_8 = 256;
pub const FSSP_DATAID_ACCZ: C2RustUnnamed_8 = 1824;
pub const FSSP_DATAID_ACCY: C2RustUnnamed_8 = 1808;
pub const FSSP_DATAID_ACCX: C2RustUnnamed_8 = 1792;
pub const FSSP_DATAID_HEADING: C2RustUnnamed_8 = 2112;
pub const FSSP_DATAID_FUEL: C2RustUnnamed_8 = 1536;
pub const FSSP_DATAID_CURRENT: C2RustUnnamed_8 = 512;
pub const FSSP_DATAID_A4: C2RustUnnamed_8 = 2320;
pub const FSSP_DATAID_VFAS: C2RustUnnamed_8 = 528;
pub const FSSP_DATAID_T2: C2RustUnnamed_8 = 1040;
pub const FSSP_DATAID_T1: C2RustUnnamed_8 = 1024;
pub const TELEMETRY_STATE_INITIALIZED_EXTERNAL: C2RustUnnamed_9 = 2;
/*
 * This file is part of Cleanflight and Betaflight.
 *
 * Cleanflight and Betaflight are free software. You can redistribute
...
pub const FSSP_DATAID_A3: C2RustUnnamed_8 = 2304;
pub const FSSP_DATAID_TEMP8: C2RustUnnamed_8 = 2936;
pub const FSSP_DATAID_TEMP7: C2RustUnnamed_8 = 2935;
pub const FSSP_DATAID_TEMP6: C2RustUnnamed_8 = 2934;
pub const FSSP_DATAID_TEMP5: C2RustUnnamed_8 = 2933;
pub const FSSP_DATAID_TEMP4: C2RustUnnamed_8 = 2932;
pub const FSSP_DATAID_TEMP3: C2RustUnnamed_8 = 2931;
pub const FSSP_DATAID_TEMP2: C2RustUnnamed_8 = 2930;
pub const FSSP_DATAID_TEMP1: C2RustUnnamed_8 = 2929;
pub const FSSP_DATAID_TEMP: C2RustUnnamed_8 = 2928;
pub const FSSP_DATAID_ASPD: C2RustUnnamed_8 = 2560;
pub const FSSP_DATAID_GPS_ALT: C2RustUnnamed_8 = 2080;
pub const FSSP_DATAID_HOME_DIST: C2RustUnnamed_8 = 1056;
pub const FSSP_DATAID_CELLS_LAST: C2RustUnnamed_8 = 783;
pub const FSSP_DATAID_CELLS: C2RustUnnamed_8 = 768;
pub const FSSP_DATAID_CAP_USED: C2RustUnnamed_8 = 1536;
pub const FSSP_DATAID_LATLONG: C2RustUnnamed_8 = 2048;
pub const FSSP_DATAID_ADC2: C2RustUnnamed_8 = 61699;
pub const FSSP_DATAID_ADC1: C2RustUnnamed_8 = 61698;
pub const FSSP_DATAID_RPM8: C2RustUnnamed_8 = 1288;
pub const FSSP_DATAID_RPM7: C2RustUnnamed_8 = 1287;
pub const FSSP_DATAID_RPM6: C2RustUnnamed_8 = 1286;
pub const FSSP_DATAID_RPM5: C2RustUnnamed_8 = 1285;
pub const FSSP_DATAID_RPM4: C2RustUnnamed_8 = 1284;
pub const FSSP_DATAID_RPM3: C2RustUnnamed_8 = 1283;
pub const FSSP_DATAID_RPM2: C2RustUnnamed_8 = 1282;
pub const FSSP_DATAID_RPM1: C2RustUnnamed_8 = 1281;
pub const FSSP_DATAID_RPM: C2RustUnnamed_8 = 1280;
pub const FSSP_DATAID_CURRENT8: C2RustUnnamed_8 = 520;
pub const FSSP_DATAID_CURRENT7: C2RustUnnamed_8 = 519;
pub const FSSP_DATAID_CURRENT6: C2RustUnnamed_8 = 518;
pub const FSSP_DATAID_CURRENT5: C2RustUnnamed_8 = 517;
pub const FSSP_DATAID_CURRENT4: C2RustUnnamed_8 = 516;
pub const FSSP_DATAID_CURRENT3: C2RustUnnamed_8 = 515;
pub const FSSP_DATAID_CURRENT2: C2RustUnnamed_8 = 514;
pub const FSSP_DATAID_CURRENT1: C2RustUnnamed_8 = 513;
pub const FSSP_DATAID_VFAS8: C2RustUnnamed_8 = 536;
pub const FSSP_DATAID_VFAS7: C2RustUnnamed_8 = 535;
pub const FSSP_DATAID_VFAS6: C2RustUnnamed_8 = 534;
pub const FSSP_DATAID_VFAS5: C2RustUnnamed_8 = 533;
pub const FSSP_DATAID_VFAS4: C2RustUnnamed_8 = 532;
pub const FSSP_DATAID_VFAS3: C2RustUnnamed_8 = 531;
pub const FSSP_DATAID_VFAS2: C2RustUnnamed_8 = 530;
pub const FSSP_DATAID_VFAS1: C2RustUnnamed_8 = 529;
pub const FSSP_DATAID_SPEED: C2RustUnnamed_8 = 2096;
...
pub unsafe extern "C" fn processSmartPortTelemetry(mut payload:
    ...
    while doRun as libc::c_int != 0 && *clearToSend as libc::c_int != 0 {
        ...
        match id as libc::c_int {
            ...
            512 => {
                smartPortSendPackage(id,
                                     (getAmperage() / 10 as libc::c_int) as
                                         uint32_t); // given in 10mA steps, unknown requested unit
                ::core::ptr::write_volatile(clearToSend,
                                            0 as libc::c_int != 0)
            }
            256 => {
                smartPortSendPackage(id,
                                     getEstimatedAltitude() as
            ...
            272 => {
                smartPortSendPackage(id,
                                     getEstimatedVario() as
                                         uint32_t); // unknown given unit but requested in 100 = 1m/s
                ::core::ptr::write_volatile(clearToSend,
                                            0 as libc::c_int != 0)
            }
            2112 => {
                ...
                smartPortSendPackage(id,
                                     lrintf(100 as libc::c_int as
                                                ...
                                                acc.dev.acc_1G as libc::c_int
                                                    as libc::c_float) as
                                         uint32_t); // Multiply by 100 to show as x.xx g on Taranis
                ::core::ptr::write_volatile(clearToSend,
                                            0 as libc::c_int != 0)
            }
            1808 => {
