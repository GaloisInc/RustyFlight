...
pub unsafe extern "C" fn initRcProcessing() {
    ...
    match (*rxConfig()).rcInterpolationChannels as libc::c_int {
        2 => {
            ...
            current_block_22 = 7114279629446095448;
        }
        1 => { current_block_22 = 7114279629446095448; }
        0 => { current_block_22 = 11138886231238063596; }
        4 => {
            interpolationChannels =
                (interpolationChannels as libc::c_int |
                     (ROLL_FLAG as libc::c_int | PITCH_FLAG as libc::c_int))
                    as uint8_t;
            current_block_22 = 17727474975294427382;
        }
        3 => { current_block_22 = 17727474975294427382; }
    ...
    match current_block_22 {
        7114279629446095448 => {
            ...
            current_block_22 = 11138886231238063596;
        }
        17727474975294427382 => {
            interpolationChannels =
                (interpolationChannels as libc::c_int |
                     THROTTLE_FLAG as libc::c_int) as uint8_t;
