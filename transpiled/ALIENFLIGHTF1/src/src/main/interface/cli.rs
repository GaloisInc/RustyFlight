...
pub const LOOKUP_TABLE_COUNT: lookupTableIndex_e = 26;
pub const TABLE_ACRO_TRAINER_DEBUG: lookupTableIndex_e = 25;
...
pub const DUMP_MASTER: C2RustUnnamed_10 = 1;
pub const DO_DIFF: C2RustUnnamed_10 = 16;
pub const SHOW_DEFAULTS: C2RustUnnamed_10 = 32;
...
pub const HIDE_UNUSED: C2RustUnnamed_10 = 64;
...
pub const DUMP_RATES: C2RustUnnamed_10 = 4;
pub const DUMP_PROFILE: C2RustUnnamed_10 = 2;
pub const DUMP_ALL: C2RustUnnamed_10 = 8;
...
#[no_mangle]
pub static mut resourceTable: [cliResourceValue_t; 15] =
    [{
         let mut init =
...
unsafe extern "C" fn printResource(mut dumpMask: uint8_t) {
    ...
    while (i as libc::c_ulong) <
              (::core::mem::size_of::<[cliResourceValue_t; 15]>() as
...
#[no_mangle]
pub static mut cmdTable: [clicmd_t; 36] =
    unsafe {
        [{
             let mut init =
                 clicmd_t{name:
...
unsafe extern "C" fn cliHelp(mut cmdline: *mut libc::c_char) {
    let mut i: uint32_t = 0 as libc::c_int as uint32_t;
    while (i as libc::c_ulong) <
              (::core::mem::size_of::<[clicmd_t; 36]>() as
...
pub unsafe extern "C" fn cliProcess() {
    ...
    while serialRxBytesWaiting(cliPort) != 0 {
        ...
        if c as libc::c_int == '\t' as i32 || c as libc::c_int == '?' as i32 {
            ...
            cmd = cmdTable.as_ptr();
            while cmd <
                      cmdTable.as_ptr().offset((::core::mem::size_of::<[clicmd_t; 36]>()
                                                    as
                                                    libc::c_ulong).wrapping_div(::core::mem::size_of::<clicmd_t>()
                                                                                    as
                                                                                    libc::c_ulong)
