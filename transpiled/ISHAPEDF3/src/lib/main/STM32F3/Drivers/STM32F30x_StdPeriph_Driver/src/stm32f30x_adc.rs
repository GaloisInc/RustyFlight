...
pub unsafe extern "C" fn ADC_DeInit(mut ADCx: *mut ADC_TypeDef) {
    ...
    if ADCx ==
           (0x40000000 as libc::c_int as
                uint32_t).wrapping_add(0x10000000 as libc::c_int as
        ...
        RCC_AHBPeriphResetCmd(0x10000000 as libc::c_int as uint32_t, ENABLE);
        /* Release ADC1/ADC2 from reset state */
        RCC_AHBPeriphResetCmd(0x10000000 as libc::c_int as uint32_t, DISABLE);
    } else if ADCx ==
                  (0x40000000 as libc::c_int as
                       uint32_t).wrapping_add(0x10000000 as libc::c_int as
                  ...
                  ADCx ==
                      (0x40000000 as libc::c_int as
                           uint32_t).wrapping_add(0x10000000 as libc::c_int as
                                                      libc::c_uint).wrapping_add(0x500
                                                                                     as
                                                                                     libc::c_int
                                                                                     as
                                                                                     libc::c_uint)
        ...
        RCC_AHBPeriphResetCmd(0x20000000 as libc::c_int as uint32_t, ENABLE);
        /* Release ADC3/ADC4 from reset state */
        RCC_AHBPeriphResetCmd(0x20000000 as libc::c_int as uint32_t, DISABLE);
    };
}
/* *
...
pub unsafe extern "C" fn ADC_Init(mut ADCx: *mut ADC_TypeDef,
  ...
  /* Get the ADCx CFGR value */
    tmpreg1 = (*ADCx).CFGR;
    /* Clear SCAN bit */
    tmpreg1 &= 0xfdffc007 as libc::c_uint;
  ...
  /* Get the ADCx SQR1 value */
    tmpreg1 = (*ADCx).SQR1;
    /* Clear L bits */
    tmpreg1 &= !(0xf as libc::c_int as uint32_t);
    /* Configure ADCx: regular channel sequence length */
  /* Set L bits according to ADC_NbrOfRegChannel value */
    tmpreg1 |=
        ((*ADC_InitStruct).ADC_NbrOfRegChannel as libc::c_int -
...
pub unsafe extern "C" fn ADC_StructInit(mut ADC_InitStruct:
    ...
    (*ADC_InitStruct).ADC_Resolution = 0 as libc::c_int as uint32_t;
    (*ADC_InitStruct).ADC_ExternalTrigConvEvent =
    ...
    (*ADC_InitStruct).ADC_NbrOfRegChannel = 1 as libc::c_int as uint8_t;
}
/* *
  * @brief  Initializes the ADCx peripheral according to the specified parameters
  *         in the ADC_InitStruct.
...
pub unsafe extern "C" fn ADC_InjectedInit(mut ADCx: *mut ADC_TypeDef,
  ...
  /* Get the ADCx JSQR value */
    tmpreg1 = (*ADCx).JSQR;
    /* Clear L bits */
    tmpreg1 &= 0 as libc::c_int as uint32_t;
  ...
  */
    tmpreg1 =
        ((*ADC_InjectedInitStruct).ADC_NbrOfInjecChannel as libc::c_int -
             1 as libc::c_int as uint8_t as libc::c_int) as libc::c_uint |
            (*ADC_InjectedInitStruct).ADC_ExternalTrigInjecConvEvent |
            (*ADC_InjectedInitStruct).ADC_ExternalTrigInjecEventEdge |
            (*ADC_InjectedInitStruct).ADC_InjecSequence1 << 8 as libc::c_int |
            (*ADC_InjectedInitStruct).ADC_InjecSequence2 << 14 as libc::c_int
            |
            (*ADC_InjectedInitStruct).ADC_InjecSequence3 << 20 as libc::c_int
            |
            (*ADC_InjectedInitStruct).ADC_InjecSequence4 << 26 as libc::c_int;
    /* Write to ADCx SQR1 */
...
pub unsafe extern "C" fn ADC_InjectedStructInit(mut ADC_InjectedInitStruct:
    ...
    (*ADC_InjectedInitStruct).ADC_ExternalTrigInjecEventEdge =
        0 as libc::c_int as uint16_t as uint32_t;
    (*ADC_InjectedInitStruct).ADC_NbrOfInjecChannel =
        1 as libc::c_int as uint8_t;
    (*ADC_InjectedInitStruct).ADC_InjecSequence1 =
        0x1 as libc::c_int as uint8_t as uint32_t;
...
pub unsafe extern "C" fn ADC_CommonInit(mut ADCx: *mut ADC_TypeDef,
    ...
    if ADCx ==
        ...
        tmpreg1 =
            (*((0x40000000 as libc::c_int as
                    uint32_t).wrapping_add(0x10000000 as libc::c_int as
                                               libc::c_uint).wrapping_add(0x300
                                                                              as
                                                                              libc::c_int
                                                                              as
                                                                              libc::c_uint)
        ...
        tmpreg1 &= 0xfffc10e0 as libc::c_uint
    } else {
        /* Get the ADC CCR value */
        tmpreg1 =
            (*((0x40000000 as libc::c_int as
                    uint32_t).wrapping_add(0x10000000 as libc::c_int as
                                               libc::c_uint).wrapping_add(0x700
                                                                              as
                                                                              libc::c_int
                                                                              as
                                                                              libc::c_uint)
  ...
  /* Set DELAY bits according to ADC_TwoSamplingDelay value */
    tmpreg1 |=
        (*ADC_CommonInitStruct).ADC_Mode | (*ADC_CommonInitStruct).ADC_Clock |
            ...
            (*ADC_CommonInitStruct).ADC_DMAMode << 12 as libc::c_int |
    ...
    if ADCx ==
        ...
        ::core::ptr::write_volatile(&mut (*((0x40000000 as libc::c_int as
                                                 uint32_t).wrapping_add(0x10000000
                                                                            as
                                                                            libc::c_int
                                                                            as
                                                                            libc::c_uint).wrapping_add(0x300
...
pub unsafe extern "C" fn ADC_CommonStructInit(mut ADC_CommonInitStruct:
    ...
    (*ADC_CommonInitStruct).ADC_Mode = 0 as libc::c_int as uint32_t;
    /* initialize the ADC_Clock member */
    (*ADC_CommonInitStruct).ADC_Clock = 0 as libc::c_int as uint32_t;
    /* Initialize the ADC_DMAAccessMode member */
    (*ADC_CommonInitStruct).ADC_DMAAccessMode = 0 as libc::c_int as uint32_t;
    /* Initialize the ADC_DMAMode member */
    (*ADC_CommonInitStruct).ADC_DMAMode = 0 as libc::c_int as uint32_t;
...
pub unsafe extern "C" fn ADC_GetCalibrationStatus(mut ADCx: *mut ADC_TypeDef)
 -> FlagStatus {
    ...
    if (*ADCx).CR & 0x80000000 as libc::c_uint !=
...
pub unsafe extern "C" fn ADC_GetDisableCmdStatus(mut ADCx: *mut ADC_TypeDef)
 -> FlagStatus {
    ...
    if (*ADCx).CR & 0x2 as libc::c_int as uint32_t !=
           RESET as libc::c_int as uint32_t {
        /* ADDIS bit is set */
        bitstatus = SET
    } else {
...
pub unsafe extern "C" fn ADC_AnalogWatchdog1ThresholdsConfig(mut ADCx:
    ...
    ::core::ptr::write_volatile(&mut (*ADCx).TR1 as *mut uint32_t,
                                (::core::ptr::read_volatile::<uint32_t>(&(*ADCx).TR1
                                                                            ...
                                                                            *const uint32_t)
                                     as libc::c_uint &
                                     !(0xfff as libc::c_int as uint32_t)) as
                                    uint32_t as uint32_t);
    ::core::ptr::write_volatile(&mut (*ADCx).TR1 as *mut uint32_t,
                                (::core::ptr::read_volatile::<uint32_t>(&(*ADCx).TR1
                                                                            as
...
pub unsafe extern "C" fn ADC_AnalogWatchdog2ThresholdsConfig(mut ADCx:
    ...
    ::core::ptr::write_volatile(&mut (*ADCx).TR2 as *mut uint32_t,
                                (::core::ptr::read_volatile::<uint32_t>(&(*ADCx).TR2
                                                                            ...
                                                                            *const uint32_t)
                                     as libc::c_uint &
                                     !(0xff as libc::c_int as uint32_t)) as
                                    uint32_t as uint32_t);
    ::core::ptr::write_volatile(&mut (*ADCx).TR2 as *mut uint32_t,
                                (::core::ptr::read_volatile::<uint32_t>(&(*ADCx).TR2
                                                                            as
...
pub unsafe extern "C" fn ADC_AnalogWatchdog1SingleChannelConfig(mut ADCx:
    ...
    tmpreg &= !(0x7c000000 as libc::c_int as uint32_t);
    /* Set the Analog watchdog channel */
    tmpreg |= (ADC_Channel as uint32_t) << 26 as libc::c_int;
    /* Store the new register value */
    ::core::ptr::write_volatile(&mut (*ADCx).CFGR as *mut uint32_t, tmpreg);
}
/* *
...
pub unsafe extern "C" fn ADC_AnalogWatchdog2SingleChannelConfig(mut ADCx:
    ...
    tmpreg = (*ADCx).AWD2CR;
    /* Clear the Analog watchdog channel select bits */
    tmpreg &= !(0x7fffe as libc::c_int as uint32_t);
    /* Set the Analog watchdog channel */
    tmpreg |= (1 as libc::c_int as uint32_t) << ADC_Channel as libc::c_int;
    /* Store the new register value */
...
pub unsafe extern "C" fn ADC_RegularChannelConfig(mut ADCx: *mut ADC_TypeDef,
  ...
  /* For Rank 1 to 4 */
    if (Rank as libc::c_int) < 5 as libc::c_int {
        /* Get the old register value */
        tmpreg1 = (*ADCx).SQR1;
        /* Calculate the mask to clear */
        tmpreg2 =
            ((0x1f as libc::c_int) << 6 as libc::c_int * Rank as libc::c_int)
                as uint32_t;
        ...
        tmpreg2 =
            (ADC_Channel as uint32_t) <<
                6 as libc::c_int * Rank as libc::c_int;
        /* Set the SQx bits for the selected rank */
        tmpreg1 |= tmpreg2;
        /* Store the new register value */
        ::core::ptr::write_volatile(&mut (*ADCx).SQR1 as *mut uint32_t,
                                    tmpreg1)
    } else if (Rank as libc::c_int) < 10 as libc::c_int {
        /* For Rank 5 to 9 */
        /* Get the old register value */
        tmpreg1 = (*ADCx).SQR2;
        /* Calculate the mask to clear */
        tmpreg2 =
            (0x1f as libc::c_int as uint32_t) <<
                6 as libc::c_int * (Rank as libc::c_int - 5 as libc::c_int);
        /* Clear the old SQx bits for the selected rank */
        tmpreg1 &= !tmpreg2;
        /* Calculate the mask to set */
        tmpreg2 =
        ...
        ::core::ptr::write_volatile(&mut (*ADCx).SQR2 as *mut uint32_t,
                                    tmpreg1)
    } else if (Rank as libc::c_int) < 15 as libc::c_int {
        /* For Rank 10 to 14 */
        /* Get the old register value */
        tmpreg1 = (*ADCx).SQR3;
        /* Calculate the mask to clear */
        tmpreg2 =
            (0x1f as libc::c_int as uint32_t) <<
                6 as libc::c_int * (Rank as libc::c_int - 10 as libc::c_int);
        /* Clear the old SQx bits for the selected rank */
        tmpreg1 &= !tmpreg2;
        /* Calculate the mask to set */
        tmpreg2 =
        ...
        tmpreg2 =
            (0x1f as libc::c_int as uint32_t) <<
                6 as libc::c_int * (Rank as libc::c_int - 15 as libc::c_int);
        /* Clear the old SQx bits for the selected rank */
        tmpreg1 &= !tmpreg2;
        /* Calculate the mask to set */
        tmpreg2 =
    ...
    if ADC_Channel as libc::c_int >
        ...
        tmpreg2 =
            (0x38 as libc::c_int as uint32_t) <<
                3 as libc::c_int *
                    (ADC_Channel as libc::c_int - 1 as libc::c_int);
...
pub unsafe extern "C" fn ADC_RegularChannelSequencerLengthConfig(mut ADCx:
    ...
    ::core::ptr::write_volatile(&mut (*ADCx).SQR1 as *mut uint32_t,
                                (::core::ptr::read_volatile::<uint32_t>(&(*ADCx).SQR1
                                                                            ...
                                                                            *const uint32_t)
                                     as libc::c_uint &
                                     !(0xf as libc::c_int as uint32_t)) as
                                    uint32_t as uint32_t);
    ::core::ptr::write_volatile(&mut (*ADCx).SQR1 as *mut uint32_t,
                                (::core::ptr::read_volatile::<uint32_t>(&(*ADCx).SQR1
                                                                            as
...
pub unsafe extern "C" fn ADC_ExternalTriggerConfig(mut ADCx: *mut ADC_TypeDef,
    ...
    ::core::ptr::write_volatile(&mut (*ADCx).CFGR as *mut uint32_t,
                                (::core::ptr::read_volatile::<uint32_t>(&(*ADCx).CFGR
                                                                            ...
                                                                            *const uint32_t)
                                     as libc::c_uint &
                                     !(0xc00 as libc::c_int as uint32_t |
...
pub unsafe extern "C" fn ADC_GetStartConversionStatus(mut ADCx:
 ...
 -> FlagStatus {
    ...
    if (*ADCx).CR & 0x4 as libc::c_int as uint32_t !=
           RESET as libc::c_int as uint32_t {
        /* ADSTART bit is set */
        bitstatus = SET
    } else {
...
pub unsafe extern "C" fn ADC_DiscModeChannelCountConfig(mut ADCx:
    ...
    tmpreg1 &= !(0xe0000 as libc::c_int as uint32_t);
    /* Set the discontinuous mode channel count */
    tmpreg2 = (Number as libc::c_int - 1 as libc::c_int) as uint32_t;
    tmpreg1 |= tmpreg2 << 17 as libc::c_int;
    /* Store the new register value */
    ::core::ptr::write_volatile(&mut (*ADCx).CFGR as *mut uint32_t, tmpreg1);
}
/* *
...
pub unsafe extern "C" fn ADC_SetChannelOffset1(mut ADCx: *mut ADC_TypeDef,
    ...
    ::core::ptr::write_volatile(&mut (*ADCx).OFR1 as *mut uint32_t,
                                (::core::ptr::read_volatile::<uint32_t>(&(*ADCx).OFR1
                                                                            ...
                                                                            *const uint32_t)
                                     as libc::c_uint &
                                     !(0x7c000000 as libc::c_int as uint32_t))
                                    as uint32_t as uint32_t);
    ::core::ptr::write_volatile(&mut (*ADCx).OFR1 as *mut uint32_t,
                                (::core::ptr::read_volatile::<uint32_t>(&(*ADCx).OFR1
                                                                            as
                                     ...
                                     as libc::c_uint |
                                     (ADC_Channel as uint32_t) <<
                                         26 as libc::c_int) as uint32_t as
                                    uint32_t);
    /* Set the data offset */
    ::core::ptr::write_volatile(&mut (*ADCx).OFR1 as *mut uint32_t,
                                (::core::ptr::read_volatile::<uint32_t>(&(*ADCx).OFR1
...
pub unsafe extern "C" fn ADC_InjectedChannelSampleTimeConfig(mut ADCx:
  ...
  /* if ADC_InjectedChannel_10 ... ADC_InjectedChannel_18 is selected */
    if ADC_InjectedChannel as libc::c_int >
           0x9 as libc::c_int as uint8_t as libc::c_int {
        /* Calculate the mask to clear */
        tmpreg1 =
            (0x7 as libc::c_int as uint32_t) <<
                3 as libc::c_int *
                    (ADC_InjectedChannel as libc::c_int - 10 as libc::c_int);
        /* Clear the old channel sample time */
        ::core::ptr::write_volatile(&mut (*ADCx).SMPR2 as *mut uint32_t,
                                    (::core::ptr::read_volatile::<uint32_t>(&(*ADCx).SMPR2
                                                                                as
        ...
        tmpreg1 =
            (0x38 as libc::c_int as uint32_t) <<
                3 as libc::c_int *
                    (ADC_InjectedChannel as libc::c_int - 1 as libc::c_int);
        ::core::ptr::write_volatile(&mut (*ADCx).SMPR1 as *mut uint32_t,
                                    (::core::ptr::read_volatile::<uint32_t>(&(*ADCx).SMPR1
                                                                                as
                                                                                *const uint32_t)
...
pub unsafe extern "C" fn ADC_GetStartInjectedConversionStatus(mut ADCx:
 ...
 -> FlagStatus {
    ...
    if (*ADCx).CR & 0x8 as libc::c_int as uint32_t !=
           RESET as libc::c_int as uint32_t {
        /* JADSTART bit is set */
        bitstatus = SET
    } else {
