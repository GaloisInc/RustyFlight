...
pub const OSD_G_FORCE: C2RustUnnamed_2 = 42;
...
pub const OSD_ESC_RPM: C2RustUnnamed_2 = 36;
pub const OSD_ESC_TMP: C2RustUnnamed_2 = 35;
pub const OSD_NUMERICAL_VARIO: C2RustUnnamed_2 = 33;
pub const OSD_NUMERICAL_HEADING: C2RustUnnamed_2 = 32;
pub const OSD_DISARMED: C2RustUnnamed_2 = 29;
pub const OSD_MAIN_BATT_USAGE: C2RustUnnamed_2 = 28;
pub const OSD_ROLL_ANGLE: C2RustUnnamed_2 = 27;
pub const OSD_PITCH_ANGLE: C2RustUnnamed_2 = 26;
pub const OSD_AVG_CELL_VOLTAGE: C2RustUnnamed_2 = 22;
pub const OSD_WARNINGS: C2RustUnnamed_2 = 21;
pub const OSD_PIDRATE_PROFILE: C2RustUnnamed_2 = 20;
pub const OSD_POWER: C2RustUnnamed_2 = 19;
pub const OSD_DEBUG: C2RustUnnamed_2 = 25;
pub const OSD_YAW_PIDS: C2RustUnnamed_2 = 18;
pub const OSD_PITCH_PIDS: C2RustUnnamed_2 = 17;
pub const OSD_ROLL_PIDS: C2RustUnnamed_2 = 16;
pub const OSD_ALTITUDE: C2RustUnnamed_2 = 15;
pub const OSD_COMPASS_BAR: C2RustUnnamed_2 = 34;
pub const OSD_HOME_DIST: C2RustUnnamed_2 = 31;
pub const OSD_HOME_DIR: C2RustUnnamed_2 = 30;
pub const OSD_GPS_SATS: C2RustUnnamed_2 = 14;
pub const OSD_GPS_LAT: C2RustUnnamed_2 = 24;
pub const OSD_GPS_LON: C2RustUnnamed_2 = 23;
pub const OSD_GPS_SPEED: C2RustUnnamed_2 = 13;
pub const OSD_MAH_DRAWN: C2RustUnnamed_2 = 12;
pub const OSD_CURRENT_DRAW: C2RustUnnamed_2 = 11;
pub const OSD_ARTIFICIAL_HORIZON: C2RustUnnamed_2 = 3;
pub const OSD_HORIZON_SIDEBARS: C2RustUnnamed_2 = 4;
pub const OSD_CROSSHAIRS: C2RustUnnamed_2 = 2;
pub const OSD_THROTTLE_POS: C2RustUnnamed_2 = 9;
pub const OSD_ITEM_TIMER_1: C2RustUnnamed_2 = 5;
pub const OSD_RSSI_VALUE: C2RustUnnamed_2 = 0;
pub const OSD_VTX_CHANNEL: C2RustUnnamed_2 = 10;
pub const OSD_FLYMODE: C2RustUnnamed_2 = 7;
pub const OSD_ITEM_TIMER_2: C2RustUnnamed_2 = 6;
pub const OSD_MAIN_BATT_VOLTAGE: C2RustUnnamed_2 = 1;
pub const OSD_CRAFT_NAME: C2RustUnnamed_2 = 8;
...
pub const OSD_ITEM_COUNT: C2RustUnnamed_2 = 43;
pub const OSD_ANTI_GRAVITY: C2RustUnnamed_2 = 41;
pub const OSD_CORE_TEMPERATURE: C2RustUnnamed_2 = 40;
pub const OSD_ADJUSTMENT_RANGE: C2RustUnnamed_2 = 39;
pub const OSD_RTC_DATETIME: C2RustUnnamed_2 = 38;
pub const OSD_REMAINING_TIME_ESTIMATE: C2RustUnnamed_2 = 37;
#[inline]
...
pub unsafe extern "C" fn targetConfiguration() {
    ...
    *customMotorMixerMutable(3 as libc::c_int) =
    ...
    strcpy((*pilotConfigMutable()).name.as_mut_ptr(),
           b"BeeBrain V2\x00" as *const u8 as *const libc::c_char);
    ...
    *fresh32 =
    ...
    (*modeActivationConditionsMutable(0 as libc::c_int)).range.endStep =
        ((constrain(2100 as libc::c_int, 900 as libc::c_int,
             ...
             25 as libc::c_int) as uint8_t;
    // DSM version
    let mut rxRangeIndex: uint8_t = 0 as libc::c_int as uint8_t;
    while (rxRangeIndex as libc::c_int) < 4 as libc::c_int {
        let mut channelRangeConfig: *mut rxChannelRangeConfig_t =
            rxChannelRangeConfigsMutable(rxRangeIndex as libc::c_int);
        (*channelRangeConfig).min = 1160 as libc::c_int as uint16_t;
        (*channelRangeConfig).max = 1840 as libc::c_int as uint16_t;
        rxRangeIndex = rxRangeIndex.wrapping_add(1)
    };
}
