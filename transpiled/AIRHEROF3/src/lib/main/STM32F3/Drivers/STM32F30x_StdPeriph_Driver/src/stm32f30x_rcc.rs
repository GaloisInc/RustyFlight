...
static mut ADCPrescTable: [uint16_t; 16] =
    [1 as libc::c_int as uint16_t, 2 as libc::c_int as uint16_t,
     4 as libc::c_int as uint16_t, 6 as libc::c_int as uint16_t,
     8 as libc::c_int as uint16_t, 10 as libc::c_int as uint16_t,
     12 as libc::c_int as uint16_t, 16 as libc::c_int as uint16_t,
     32 as libc::c_int as uint16_t, 64 as libc::c_int as uint16_t,
     128 as libc::c_int as uint16_t, 256 as libc::c_int as uint16_t,
...
pub unsafe extern "C" fn RCC_DeInit() {
    ...
    ::core::ptr::write_volatile(fresh1,
                                (::core::ptr::read_volatile::<uint32_t>(fresh1
                                                                            ...
                                                                            *const uint32_t)
                                     as libc::c_uint &
                                     0xf8ffc000 as libc::c_uint) as uint32_t
                                    as uint32_t);
    ...
    ::core::ptr::write_volatile(fresh5,
                                (::core::ptr::read_volatile::<uint32_t>(fresh5
                                                                            ...
                                                                            *const uint32_t)
                                     as libc::c_uint &
                                     0xffffc000 as libc::c_uint) as uint32_t
                                    as uint32_t);
    ...
    ::core::ptr::write_volatile(fresh6,
                                (::core::ptr::read_volatile::<uint32_t>(fresh6
                                                                            ...
                                                                            *const uint32_t)
                                     as libc::c_uint &
                                     0xf00eccc as libc::c_int as uint32_t) as
                                    uint32_t as uint32_t);
...
pub unsafe extern "C" fn RCC_HSEConfig(mut RCC_HSE: uint8_t) {
    ...
    ::core::ptr::write_volatile(0x40021002 as libc::c_int as uint32_t as
                                    *mut uint8_t,
...
pub unsafe extern "C" fn RCC_WaitForHSEStartUp() -> ErrorStatus {
    ...
    loop 
         ...
         {
        HSEStatus = RCC_GetFlagStatus(0x11 as libc::c_int as uint8_t);
        ...
        if !(StartUpCounter !=
                 0x5000 as libc::c_int as uint16_t as libc::c_uint &&
                 HSEStatus as libc::c_uint ==
                     RESET as libc::c_int as libc::c_uint) {
            break ;
        }
    }
    if RCC_GetFlagStatus(0x11 as libc::c_int as uint8_t) as libc::c_uint !=
           RESET as libc::c_int as libc::c_uint {
        status = SUCCESS
    } else { status = ERROR }
    return status;
...
pub unsafe extern "C" fn RCC_AdjustHSICalibrationValue(mut HSICalibrationValue:
    ...
    tmpreg &= !(0xf8 as libc::c_int as uint32_t);
...
pub unsafe extern "C" fn RCC_PREDIV1Config(mut RCC_PREDIV1_Div: uint32_t) {
    ...
    tmpreg &= !(0xf as libc::c_int as uint32_t);
...
pub unsafe extern "C" fn RCC_MCOConfig(mut RCC_MCOSource: uint8_t) {
    ...
    /* Clear MCO[3:0] bits */
    tmpreg &=
        !(0x7000000 as libc::c_int as uint32_t | 0x80000000 as libc::c_uint);
    /* Set the RCC_MCOSource */
    tmpreg |=
        ((RCC_MCOSource as libc::c_int) << 24 as libc::c_int) as libc::c_uint;
    /* Store the new value */
    ::core::ptr::write_volatile(&mut (*((0x40000000 as libc::c_int as
                                             uint32_t).wrapping_add(0x20000 as
                                                                        libc::c_int
...
pub unsafe extern "C" fn RCC_HCLKConfig(mut RCC_SYSCLK: uint32_t) {
    ...
    tmpreg =
        (*((0x40000000 as libc::c_int as
               ...
               as *mut RCC_TypeDef)).CFGR;
    /* Clear HPRE[3:0] bits */
    tmpreg &= !(0xf0 as libc::c_int as uint32_t);
...
pub unsafe extern "C" fn RCC_PCLK1Config(mut RCC_HCLK: uint32_t) {
    ...
    tmpreg &= !(0x700 as libc::c_int as uint32_t);
...
pub unsafe extern "C" fn RCC_PCLK2Config(mut RCC_HCLK: uint32_t) {
    ...
    tmpreg &= !(0x3800 as libc::c_int as uint32_t);
...
pub unsafe extern "C" fn RCC_GetClocksFreq(mut RCC_Clocks:
    ...
    let mut prediv1factor: uint32_t = 0 as libc::c_int as uint32_t;
    let mut presc: uint32_t = 0 as libc::c_int as uint32_t;
    let mut pllclk: uint32_t = 0 as libc::c_int as uint32_t;
    let mut apb2presc: uint32_t = 0 as libc::c_int as uint32_t;
    let mut ahbpresc: uint32_t = 0 as libc::c_int as uint32_t;
    /* Get SYSCLK source -------------------------------------------------------*/
    tmp =
        (*((0x40000000 as libc::c_int as
                uint32_t).wrapping_add(0x20000 as libc::c_int as
    ...
    match tmp {
        ...
        4 => {
            ...
            (*RCC_Clocks).SYSCLK_Frequency =
                12000000 as libc::c_int as uint32_t
        }
        8 => {
                ...
                prediv1factor =
                    ((*((0x40000000 as libc::c_int as
                         ...
                         0xf as libc::c_int as
                             uint32_t).wrapping_add(1 as libc::c_int as
                                                        libc::c_uint);
                /* HSE oscillator clock selected as PREDIV1 clock entry */
                pllclk =
                    (12000000 as libc::c_int as
  ...
  /* Get HCLK prescaler */
        ...
        (*((0x40000000 as libc::c_int as
                uint32_t).wrapping_add(0x20000 as libc::c_int as
                                           libc::c_uint).wrapping_add(0x1000
                                                                          ...
                                                                          as
                                                                          libc::c_uint)
               as *mut RCC_TypeDef)).CFGR2 & 0x1f0 as libc::c_int as uint32_t;
    tmp = tmp >> 4 as libc::c_int;
    presc =
        ADCPrescTable[(tmp & 0xf as libc::c_int as libc::c_uint) as usize] as
            uint32_t;
    if tmp & 0x10 as libc::c_int as libc::c_uint !=
           0 as libc::c_int as libc::c_uint &&
           presc != 0 as libc::c_int as libc::c_uint {
        ...
        (*((0x40000000 as libc::c_int as
                uint32_t).wrapping_add(0x20000 as libc::c_int as
                                           libc::c_uint).wrapping_add(0x1000
                                                                          ...
                                                                          libc::c_uint)
               as *mut RCC_TypeDef)).CFGR2 &
            0x3e00 as libc::c_int as uint32_t;
    tmp = tmp >> 9 as libc::c_int;
    presc =
        ADCPrescTable[(tmp & 0xf as libc::c_int as libc::c_uint) as usize] as
            uint32_t;
    if tmp & 0x10 as libc::c_int as libc::c_uint !=
    ...
    if (*((0x40000000 as libc::c_int as
               uint32_t).wrapping_add(0x20000 as libc::c_int as
                                          libc::c_uint).wrapping_add(0x1000 as
                                                                         ...
                                                                         as
                                                                         libc::c_uint)
              as *mut RCC_TypeDef)).CFGR3 & 0x10 as libc::c_int as uint32_t !=
           0x10 as libc::c_int as uint32_t {
        /* I2C1 Clock is HSI Osc. */
        (*RCC_Clocks).I2C1CLK_Frequency = 8000000 as libc::c_int as uint32_t
    } else {
    ...
    if (*((0x40000000 as libc::c_int as
               uint32_t).wrapping_add(0x20000 as libc::c_int as
                                          libc::c_uint).wrapping_add(0x1000 as
                                                                         ...
                                                                         as
                                                                         libc::c_uint)
              as *mut RCC_TypeDef)).CFGR3 & 0x20 as libc::c_int as uint32_t !=
           0x20 as libc::c_int as uint32_t {
        /* I2C2 Clock is HSI Osc. */
        (*RCC_Clocks).I2C2CLK_Frequency = 8000000 as libc::c_int as uint32_t
    } else {
    ...
    if (*((0x40000000 as libc::c_int as
               uint32_t).wrapping_add(0x20000 as libc::c_int as
                                          libc::c_uint).wrapping_add(0x1000 as
                                                                         ...
                                                                         as
                                                                         libc::c_uint)
              as *mut RCC_TypeDef)).CFGR3 & 0x40 as libc::c_int as uint32_t !=
           0x40 as libc::c_int as uint32_t {
        /* I2C3 Clock is HSI Osc. */
        (*RCC_Clocks).I2C3CLK_Frequency = 8000000 as libc::c_int as uint32_t
    } else {
    ...
    if (*((0x40000000 as libc::c_int as
               uint32_t).wrapping_add(0x20000 as libc::c_int as
                                          libc::c_uint).wrapping_add(0x1000 as
                                                                         ...
                                                                         as
                                                                         libc::c_uint)
              as *mut RCC_TypeDef)).CFGR3 & 0x1000 as libc::c_int as uint32_t
    ...
    if (*((0x40000000 as libc::c_int as
               uint32_t).wrapping_add(0x20000 as libc::c_int as
                                          libc::c_uint).wrapping_add(0x1000 as
                                                                         ...
                                                                         as
                                                                         libc::c_uint)
              as *mut RCC_TypeDef)).CFGR3 & 0x200 as libc::c_int as uint32_t
    ...
    if (*((0x40000000 as libc::c_int as
               uint32_t).wrapping_add(0x20000 as libc::c_int as
                                          libc::c_uint).wrapping_add(0x1000 as
                                                                         ...
                                                                         as
                                                                         libc::c_uint)
              as *mut RCC_TypeDef)).CFGR3 & 0x400 as libc::c_int as uint32_t
    ...
    if (*((0x40000000 as libc::c_int as
               uint32_t).wrapping_add(0x20000 as libc::c_int as
                                          libc::c_uint).wrapping_add(0x1000 as
                                                                         ...
                                                                         as
                                                                         libc::c_uint)
              as *mut RCC_TypeDef)).CFGR3 & 0x800 as libc::c_int as uint32_t
    ...
    if (*((0x40000000 as libc::c_int as
               uint32_t).wrapping_add(0x20000 as libc::c_int as
                                          libc::c_uint).wrapping_add(0x1000 as
                                                                         ...
                                                                         as
                                                                         libc::c_uint)
              as *mut RCC_TypeDef)).CFGR3 & 0x2000 as libc::c_int as uint32_t
    ...
    if (*((0x40000000 as libc::c_int as
               uint32_t).wrapping_add(0x20000 as libc::c_int as
                                          libc::c_uint).wrapping_add(0x1000 as
                                                                         ...
                                                                         as
                                                                         libc::c_uint)
              as *mut RCC_TypeDef)).CFGR3 & 0x3 as libc::c_int as uint32_t ==
           0 as libc::c_int as libc::c_uint {
        ...
        (*RCC_Clocks).USART1CLK_Frequency = 32768 as libc::c_int as uint32_t
    } else if (*((0x40000000 as libc::c_int as
                      uint32_t).wrapping_add(0x20000 as libc::c_int as
                                                 libc::c_uint).wrapping_add(0x1000
                                                                                as
        ...
        (*RCC_Clocks).USART1CLK_Frequency = 8000000 as libc::c_int as uint32_t
    }
    ...
    if (*((0x40000000 as libc::c_int as
               uint32_t).wrapping_add(0x20000 as libc::c_int as
                                          libc::c_uint).wrapping_add(0x1000 as
                                                                         ...
                                                                         as
                                                                         libc::c_uint)
              as *mut RCC_TypeDef)).CFGR3 & 0x30000 as libc::c_int as uint32_t
           == 0 as libc::c_int as libc::c_uint {
        /* USART Clock is PCLK */
        ...
        /* USART Clock is LSE Osc. */
        (*RCC_Clocks).USART2CLK_Frequency = 32768 as libc::c_int as uint32_t
    } else if (*((0x40000000 as libc::c_int as
                      uint32_t).wrapping_add(0x20000 as libc::c_int as
                                                 libc::c_uint).wrapping_add(0x1000
                                                                                as
                  ...
                  0x30000 as libc::c_int as uint32_t {
        /* USART Clock is HSI Osc. */
        (*RCC_Clocks).USART2CLK_Frequency = 8000000 as libc::c_int as uint32_t
    }
    ...
    if (*((0x40000000 as libc::c_int as
               uint32_t).wrapping_add(0x20000 as libc::c_int as
                                          libc::c_uint).wrapping_add(0x1000 as
                                                                         ...
                                                                         as
                                                                         libc::c_uint)
              as *mut RCC_TypeDef)).CFGR3 & 0xc0000 as libc::c_int as uint32_t
           == 0 as libc::c_int as libc::c_uint {
        /* USART Clock is PCLK */
        ...
        /* USART Clock is LSE Osc. */
        (*RCC_Clocks).USART3CLK_Frequency = 32768 as libc::c_int as uint32_t
    } else if (*((0x40000000 as libc::c_int as
                      uint32_t).wrapping_add(0x20000 as libc::c_int as
                                                 libc::c_uint).wrapping_add(0x1000
                                                                                as
                  ...
                  0xc0000 as libc::c_int as uint32_t {
        /* USART Clock is HSI Osc. */
        (*RCC_Clocks).USART3CLK_Frequency = 8000000 as libc::c_int as uint32_t
    }
    ...
    if (*((0x40000000 as libc::c_int as
        ...
        /* USART Clock is LSE Osc. */
        (*RCC_Clocks).UART4CLK_Frequency = 32768 as libc::c_int as uint32_t
    } else if (*((0x40000000 as libc::c_int as
                      uint32_t).wrapping_add(0x20000 as libc::c_int as
                                                 libc::c_uint).wrapping_add(0x1000
                                                                                as
                  ...
                  0x300000 as libc::c_int as uint32_t {
        /* USART Clock is HSI Osc. */
        (*RCC_Clocks).UART4CLK_Frequency = 8000000 as libc::c_int as uint32_t
    }
    ...
    if (*((0x40000000 as libc::c_int as
        ...
        /* USART Clock is LSE Osc. */
        (*RCC_Clocks).UART5CLK_Frequency = 32768 as libc::c_int as uint32_t
    } else if (*((0x40000000 as libc::c_int as
                      uint32_t).wrapping_add(0x20000 as libc::c_int as
                                                 libc::c_uint).wrapping_add(0x1000
                                                                                as
                  ...
                  0xc00000 as libc::c_int as uint32_t {
        /* USART Clock is HSI Osc. */
        (*RCC_Clocks).UART5CLK_Frequency = 8000000 as libc::c_int as uint32_t
    };
}
/* *
  * @}
...
pub unsafe extern "C" fn RCC_ADCCLKConfig(mut RCC_PLLCLK: uint32_t) {
    let mut tmp: uint32_t = 0 as libc::c_int as uint32_t;
    /* Check the parameters */
    tmp = RCC_PLLCLK >> 28 as libc::c_int;
    /* Clears ADCPRE34 bits */
    if tmp != 0 as libc::c_int as libc::c_uint {
        let ref mut fresh14 =
            (*((0x40000000 as libc::c_int as
                    uint32_t).wrapping_add(0x20000 as libc::c_int as
                                               libc::c_uint).wrapping_add(0x1000
...
pub unsafe extern "C" fn RCC_I2CCLKConfig(mut RCC_I2CCLK: uint32_t) {
    let mut tmp: uint32_t = 0 as libc::c_int as uint32_t;
    /* Check the parameters */
    tmp = RCC_I2CCLK >> 28 as libc::c_int;
    /* Clear I2CSW bit */
    match tmp {
        0 => {
            let ref mut fresh17 =
...
pub unsafe extern "C" fn RCC_TIMCLKConfig(mut RCC_TIMCLK: uint32_t) {
    let mut tmp: uint32_t = 0 as libc::c_int as uint32_t;
    /* Check the parameters */
    tmp = RCC_TIMCLK >> 28 as libc::c_int;
    /* Clear TIMSW bit */
    match tmp {
        0 => {
            let ref mut fresh21 =
...
pub unsafe extern "C" fn RCC_USARTCLKConfig(mut RCC_USARTCLK: uint32_t) {
    let mut tmp: uint32_t = 0 as libc::c_int as uint32_t;
    /* Check the parameters */
    tmp = RCC_USARTCLK >> 28 as libc::c_int;
            ...
            (*((0x40000000 as libc::c_int as
                    uint32_t).wrapping_add(0x20000 as libc::c_int as
                                               libc::c_uint).wrapping_add(0x1000
                                                                              ...
                                                                              libc::c_uint)
                   as *mut RCC_TypeDef)).CR
    } else if tmp == 1 as libc::c_int as libc::c_uint {
            ...
            (*((0x40000000 as libc::c_int as
                    uint32_t).wrapping_add(0x20000 as libc::c_int as
                                               libc::c_uint).wrapping_add(0x1000
                                                                              ...
                                                                              libc::c_uint)
                   as *mut RCC_TypeDef)).BDCR
    } else if tmp == 4 as libc::c_int as libc::c_uint {
