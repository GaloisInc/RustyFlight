    ...
    match baroHardware as libc::c_uint {
        0 | 2 | 3 | 5 | 4 => {
            if bmp280Detect(dev) {
                ...
                current_block_18 = 15925075030174552612;
            } else { current_block_18 = 17760584797385305199; }
        }
        6 | 1 => { current_block_18 = 17760584797385305199; }
        _ => { current_block_18 = 15925075030174552612; }
    }
