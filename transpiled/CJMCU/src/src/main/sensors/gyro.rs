...
pub unsafe extern "C" fn gyroMpuDetectionResult()
 -> *const mpuDetectionResult_s {
    return &mut gyroSensor1.gyroDev.mpuDetectionResult; // must be set after mpuDetect
}
unsafe extern "C" fn gyroDetect(mut dev: *mut gyroDev_t) -> gyroSensor_e {
    ...
    match gyroHardware as libc::c_uint {
        1 | 2 => {
            ...
            } else { current_block_5 = 864661324147184455; }
        }
        _ => { current_block_5 = 864661324147184455; }
    }
    match current_block_5 {
        864661324147184455 => { gyroHardware = GYRO_NONE }
        _ => { }
    }
