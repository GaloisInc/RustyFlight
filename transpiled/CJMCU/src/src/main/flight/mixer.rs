                 ...
                 reset:
                     C2RustUnnamed_1{ptr:
                                         0 as *const libc::c_void as
                                             *mut libc::c_void,},};
#[no_mangle]
pub static mut customMotorMixer_CopyArray: [motorMixer_t; 4] =
    [motorMixer_t{throttle: 0., roll: 0., pitch: 0., yaw: 0.,}; 4];
#[no_mangle]
pub static mut customMotorMixer_SystemArray: [motorMixer_t; 4] =
    [motorMixer_t{throttle: 0., roll: 0., pitch: 0., yaw: 0.,}; 4];
static mut motorCount: uint8_t = 0;
static mut motorMixRange: libc::c_float = 0.;
#[no_mangle]
pub static mut motor: [libc::c_float; 4] = [0.; 4];
#[no_mangle]
pub static mut motor_disarmed: [libc::c_float; 4] = [0.; 4];
#[no_mangle]
pub static mut currentMixerMode: mixerMode_e = 0 as mixerMode_e;
static mut currentMixer: [motorMixer_t; 4] =
    [motorMixer_t{throttle: 0., roll: 0., pitch: 0., yaw: 0.,}; 4];
...
pub unsafe extern "C" fn mixerConfigureOutput() {
    motorCount = 4 as libc::c_int as uint8_t;
    let mut i: libc::c_int = 0 as libc::c_int;
    while i < motorCount as libc::c_int {
        currentMixer[i as usize] = mixerQuadX[i as usize];
        i += 1
    }
...
pub unsafe extern "C" fn mixTable(mut currentTimeUs: timeUs_t,
    ...
    let mut motorMix: [libc::c_float; 4] =
        [0.; 4]; // Add voltage compensation
                ...
                pgRegistry_s{pgn:
                             ...
                             address:
                                 &mut customMotorMixer_SystemArray as
                                     *mut [motorMixer_t; 4] as *mut uint8_t,
                             copy:
