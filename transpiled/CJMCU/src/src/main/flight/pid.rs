...
pub const ANTI_GRAVITY_STEP: C2RustUnnamed_7 = 1;
pub const ANTI_GRAVITY_SMOOTH: C2RustUnnamed_7 = 0;
pub type C2RustUnnamed_8 = libc::c_uint;
pub const ITERM_RELAX_RPY_INC: C2RustUnnamed_8 = 4;
pub const ITERM_RELAX_RP_INC: C2RustUnnamed_8 = 3;
pub const ITERM_RELAX_RPY: C2RustUnnamed_8 = 2;
pub const ITERM_RELAX_RP: C2RustUnnamed_8 = 1;
pub const ITERM_RELAX_OFF: C2RustUnnamed_8 = 0;
pub type C2RustUnnamed_9 = libc::c_uint;
pub const ITERM_RELAX_SETPOINT: C2RustUnnamed_9 = 1;
pub const ITERM_RELAX_GYRO: C2RustUnnamed_9 = 0;
...
pub static mut pgResetTemplate_pidConfig: pidConfig_t =
    {
        let mut init =
            pidConfig_s{pid_process_denom: 1 as libc::c_int as uint8_t,
                        runaway_takeoff_prevention: 0,
                        runaway_takeoff_deactivate_delay: 0,
                        runaway_takeoff_deactivate_throttle: 0,};
        init
                 ...
                 reset:
                     C2RustUnnamed_3{ptr:
                                         0 as *const libc::c_void as
                                             *mut libc::c_void,},};
#[no_mangle]
pub static mut pidProfiles_SystemArray: [pidProfile_t; 2] =
    [pidProfile_t{yaw_lowpass_hz: 0,
                  ...
                  abs_control_gain: 0,
                  abs_control_limit: 0,
                  abs_control_error_limit: 0,}; 2];
#[no_mangle]
pub static mut pidProfiles_CopyArray: [pidProfile_t; 2] =
    [pidProfile_t{yaw_lowpass_hz: 0,
                  dterm_lowpass_hz: 0,
                  dterm_notch_hz: 0,
                  dterm_notch_cutoff: 0,
...
pub unsafe extern "C" fn pidController(mut pidProfile: *const pidProfile_t,
    ...
    while axis_0 <= FD_YAW as libc::c_int {
        ...
        let mut errorRate: libc::c_float =
            currentPidSetpoint - gyroRate; // r - y
        ...
        if feedforwardGain > 0 as libc::c_int as libc::c_float {
            ...
            pidData[axis_0 as usize].F =
                feedforwardGain * transition * pidSetpointDelta * pidFrequency
        } else {
                ...
                pgRegistry_s{pgn:
                             ...
                             address:
                                 &mut pidProfiles_SystemArray as
                                     *mut [pidProfile_t; 2] as *mut uint8_t,
                             copy:
