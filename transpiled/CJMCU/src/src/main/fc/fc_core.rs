...
pub const ARMING_DELAYED_DISARMED: C2RustUnnamed_7 = 0;
...
pub const ARMING_DELAYED_CRASHFLIP: C2RustUnnamed_7 = 2;
pub const ARMING_DELAYED_NORMAL: C2RustUnnamed_7 = 1;
#[inline]
