 ...
 -> libc::c_int {
    ...
    match adjustmentFunction as libc::c_int {
        1 | 25 => {
            ...
            } else { current_block_82 = 3599935182195471646; }
        }
        26 => { current_block_82 = 3599935182195471646; }
        2 | 27 => {
            newValue =
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 = 15447629348493591490;
            } else { current_block_82 = 16962691580232133891; }
        }
        28 => { current_block_82 = 16962691580232133891; }
        3 => {
            newValue =
        ...
        4 | 13 => {
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 = 15447629348493591490;
            } else { current_block_82 = 15265927775913471373; }
        }
        14 => { current_block_82 = 15265927775913471373; }
        5 => {
            newValue =
        ...
        6 | 15 => {
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 =
                    6007793718039871892; // FIXME magic numbers repeated in cli.c
            }
        }
        18 => { current_block_82 = 6007793718039871892; }
        7 | 16 => {
            newValue =
                constrain((*pidProfile).pid[PID_PITCH as libc::c_int as
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 =
                    1200635655562821254; // FIXME magic numbers repeated in cli.c
            }
        }
        19 => { current_block_82 = 1200635655562821254; }
        8 | 17 => {
            newValue =
                constrain((*pidProfile).pid[PID_PITCH as libc::c_int as
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 =
                    17134128841435001667; // FIXME magic numbers repeated in cli.c
            }
        }
        20 => {
            current_block_82 =
        ...
        22 | 30 => {
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 = 15447629348493591490;
            } else { current_block_82 = 14288451560950719525; }
        }
        31 => { current_block_82 = 14288451560950719525; }
        32 => {
            newValue =
