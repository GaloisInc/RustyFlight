 ...
 */
    ...
    // return to home
    #[no_mangle]
    fn rxSpiInit(rxSpiConfig_0: *const rxSpiConfig_t,
...
pub const RX_FAILSAFE_MODE_INVALID: C2RustUnnamed_4 = 3;
...
pub unsafe extern "C" fn rxInit() {
    ...
    if feature(FEATURE_RX_SPI as libc::c_int as uint32_t) {
        let enabled: bool = rxSpiInit(rxSpiConfig(), &mut rxRuntimeConfig);
        if !enabled {
