...
extern "C" {
    ...
    #[no_mangle]
    static mut motor: [libc::c_float; 4];
    #[no_mangle]
    ...
    match cmdMSP as libc::c_int {
        ...
        104 => {
            ...
            while i_3 < 8 as libc::c_int as libc::c_uint {
                if i_3 >= 4 as libc::c_int as libc::c_uint ||
        ...
        111 => {
            ...
            } // Blackbox not supported
            sbufWriteU8(dst,
                        (*currentControlRateProfile).dynThrPID); // was pidProfile.yaw_p_limit
            sbufWriteU8(dst,
                        (*currentControlRateProfile).thrMid8); // reserved
            sbufWriteU8(dst,
                        (*currentControlRateProfile).thrExpo8); // was low byte of currentPidProfile->dtermSetpointWeight
            sbufWriteU16(dst,
            ...
            sbufWriteU8(dst,
                        (*currentControlRateProfile).rcExpo[FD_PITCH as
                                                                libc::c_int as
                                                                usize]); // was currentPidProfile->dtermSetpointWeight
        }
        112 => {
 ...
 -> mspResult_e {
    ...
    match cmdMSP as libc::c_int {
        210 => {
            ...
            if value as libc::c_int & (1 as libc::c_int) << 7 as libc::c_int
                ...
                if armingFlags as libc::c_int & ARMED as libc::c_int == 0 {
                    if value as libc::c_int >= 2 as libc::c_int {
        ...
        99 => {
            ...
            } else { unsetArmingDisabled(ARMING_DISABLED_MSP); }
        }
        37 => {
            // USE_GPS
        ...
        11 => {
            ...
            while i_4 <
                ...
                (*pilotConfigMutable()).name[i_4 as usize] =
