...
extern "C" {
    ...
    #[no_mangle]
    fn gpsRescueGetThrottle() -> libc::c_float;
    #[no_mangle]
...
pub const GPS_RESCUE_MODE: C2RustUnnamed_7 = 2048;
pub const FAILSAFE_MODE: C2RustUnnamed_7 = 1024;
pub const PASSTHRU_MODE: C2RustUnnamed_7 = 256;
pub const HEADFREE_MODE: C2RustUnnamed_7 = 64;
pub const GPS_HOLD_MODE: C2RustUnnamed_7 = 32;
pub const GPS_HOME_MODE: C2RustUnnamed_7 = 16;
pub const BARO_MODE: C2RustUnnamed_7 = 8;
pub const MAG_MODE: C2RustUnnamed_7 = 4;
pub const HORIZON_MODE: C2RustUnnamed_7 = 2;
pub const ANGLE_MODE: C2RustUnnamed_7 = 1;
...
pub unsafe extern "C" fn pgResetFn_motorConfig(mut motorConfig_0:
    ...
    (*motorConfig_0).dev.useBurstDshot = 1 as libc::c_int as uint8_t;
