...
unsafe extern "C" fn Get_SerialNum() {
    ...
    deviceserial0 = *(0x1ff07a10 as libc::c_int as *mut uint32_t);
    deviceserial1 = *(0x1ff07a14 as libc::c_int as *mut uint32_t);
    deviceserial2 = *(0x1ff07a18 as libc::c_int as *mut uint32_t);
    deviceserial0 =
