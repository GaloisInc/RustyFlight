    ...
    loop  {
        ...
        match accHardwareToUse as libc::c_uint {
            0 | 3 => {
                ...
                } else { current_block_12 = 9295097331052855228; }
            }
            7 => { current_block_12 = 9295097331052855228; }
            8 | 10 | 11 | 12 | 1 | _ => {
                current_block_12 = 18071914750955744041;
            }
        }
        match current_block_12 {
            9295097331052855228 => {
                if mpu6000SpiAccDetect(dev) {
                    ...
                    current_block_12 = 2668756484064249700;
                } else { current_block_12 = 18071914750955744041; }
            }
            _ => { }
        }
        match current_block_12 {
