...
pub const TELEMETRY_STATE_INITIALIZED_SERIAL: C2RustUnnamed_2 = 1;
pub const TELEMETRY_STATE_UNINITIALIZED: C2RustUnnamed_2 = 0;
pub const TELEMETRY_STATE_INITIALIZED_EXTERNAL: C2RustUnnamed_2 = 2;
