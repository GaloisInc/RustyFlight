 ...
 -> libc::c_int {
    ...
    match adjustmentFunction as libc::c_int {
        1 | 25 => {
            ...
            } else { current_block_82 = 5405868585544072297; }
        }
        26 => { current_block_82 = 5405868585544072297; }
        2 | 27 => {
            newValue =
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 = 15447629348493591490;
            } else { current_block_82 = 1839618019415382039; }
        }
        28 => { current_block_82 = 1839618019415382039; }
        3 => {
            newValue =
        ...
        4 | 13 => {
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 = 15447629348493591490;
            } else { current_block_82 = 13479402153619724873; }
        }
        14 => { current_block_82 = 13479402153619724873; }
        5 => {
            newValue =
        ...
        6 | 15 => {
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 =
                    5948173907487546429; // FIXME magic numbers repeated in cli.c
            }
        }
        18 => { current_block_82 = 5948173907487546429; }
        7 | 16 => {
            newValue =
                constrain((*pidProfile).pid[PID_PITCH as libc::c_int as
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 =
                    17054658215455152302; // FIXME magic numbers repeated in cli.c
            }
        }
        19 => { current_block_82 = 17054658215455152302; }
        8 | 17 => {
            newValue =
                constrain((*pidProfile).pid[PID_PITCH as libc::c_int as
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 =
                    4300798992881639963; // FIXME magic numbers repeated in cli.c
            }
        }
        20 => {
            current_block_82 =
        ...
        22 | 30 => {
            ...
            if adjustmentFunction as libc::c_int ==
                ...
                current_block_82 = 15447629348493591490;
            } else { current_block_82 = 11934984557441853882; }
        }
        31 => { current_block_82 = 11934984557441853882; }
        32 => {
            newValue =
 ...
 -> libc::c_int {
    ...
    match adjustmentFunction as libc::c_uint {
        1 | 25 => {
            ...
            } else { current_block_84 = 1058394197473802228; }
        }
        26 => { current_block_84 = 1058394197473802228; }
        2 | 27 => {
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                current_block_84 = 5265702136860997526;
            } else { current_block_84 = 9508531699884183423; }
        }
        28 => { current_block_84 = 9508531699884183423; }
        3 => {
            newValue = constrain(value, 0 as libc::c_int, 100 as libc::c_int);
            (*controlRateConfig).thrExpo8 = newValue as uint8_t;
            initRcProcessing();
        ...
        4 | 13 => {
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                current_block_84 = 5265702136860997526;
            } else { current_block_84 = 11239732194576282906; }
        }
        14 => { current_block_84 = 11239732194576282906; }
        5 => {
            newValue = constrain(value, 0 as libc::c_int, 255 as libc::c_int);
            (*controlRateConfig).rates[FD_YAW as libc::c_int as usize] =
                newValue as uint8_t;
        ...
        6 | 15 => {
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                // fall through for combined ADJUSTMENT_PITCH_ROLL_P
                current_block_84 =
                    1432322269928448905; // FIXME magic numbers repeated in cli.c
            }
        }
        18 => { current_block_84 = 1432322269928448905; }
        7 | 16 => {
            newValue = constrain(value, 0 as libc::c_int, 200 as libc::c_int);
            (*pidProfile).pid[PID_PITCH as libc::c_int as usize].I =
                newValue as uint8_t;
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                // fall through for combined ADJUSTMENT_PITCH_ROLL_I
                current_block_84 =
                    15857602148807820308; // FIXME magic numbers repeated in cli.c
            }
        }
        19 => { current_block_84 = 15857602148807820308; }
        8 | 17 => {
            newValue = constrain(value, 0 as libc::c_int, 200 as libc::c_int);
            (*pidProfile).pid[PID_PITCH as libc::c_int as usize].D =
                newValue as uint8_t;
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                // fall through for combined ADJUSTMENT_PITCH_ROLL_D
                current_block_84 =
                    9864813445357401046; // FIXME magic numbers repeated in cli.c
            }
        }
        20 => {
            current_block_84 =
        ...
        22 | 30 => {
            ...
            if adjustmentFunction as libc::c_uint ==
                ...
                current_block_84 = 5265702136860997526;
            } else { current_block_84 = 15370445274224965566; }
        }
        31 => { current_block_84 = 15370445274224965566; }
        32 => {
            newValue =
                constrain(value, 0 as libc::c_int, 2000 as libc::c_int);
            (*pidProfile).pid[PID_YAW as libc::c_int as usize].F =
