...
pub const MSP_FLASHFS_FLAG_SUPPORTED: C2RustUnnamed_12 = 2;
pub const MSP_FLASHFS_FLAG_READY: C2RustUnnamed_12 = 1;
...
pub const TASK_SELF: cfTaskId_e = 17;
pub const TASK_NONE: cfTaskId_e = 16;
pub const TASK_COUNT: cfTaskId_e = 16;
...
unsafe extern "C" fn serializeDataflashReadReply(mut dst: *mut sbuf_t,
    ...
    let compressionMethod: uint8_t = NO_COMPRESSION as libc::c_int as uint8_t;
...
unsafe extern "C" fn mspCommonProcessOutCommand(mut cmdMSP: uint8_t,
 ...
 -> bool {
    match cmdMSP as libc::c_int {
        1 => {
            sbufWriteU8(dst, 0 as libc::c_int as uint8_t); // 0 == FC
        ...
        160 => {
            sbufWriteU32(dst, *(0x1ffff7e8 as libc::c_int as *mut uint32_t));
            sbufWriteU32(dst, *(0x1ffff7ec as libc::c_int as *mut uint32_t));
            sbufWriteU32(dst, *(0x1ffff7f0 as libc::c_int as *mut uint32_t));
        }
        ...
        // specialist configuration requirements.
            ...
            sbufWriteU8(dst, adcSensorSubframeLength_0); // no providers
            sbufWriteU8(dst,
...
unsafe extern "C" fn mspProcessOutCommand(mut cmdMSP: uint8_t,
    ...
    match cmdMSP as libc::c_int {
        ...
        104 => {
            ...
            while i_3 < 8 as libc::c_int as libc::c_uint {
                if i_3 >= 8 as libc::c_int as libc::c_uint ||
                       !(*pwmGetMotors().offset(i_3 as isize)).enabled {
                    sbufWriteU16(dst, 0 as libc::c_int as uint16_t);
                } else {
                    sbufWriteU16(dst,
                                 convertMotorToExternal(motor[i_3 as usize]));
                }
        ...
        105 => {
            ...
            while i_4 < rxRuntimeConfig.channelCount as libc::c_int {
                sbufWriteU16(dst, rcData[i_4 as usize] as uint16_t);
                i_4 += 1
            }
        }
        108 => {
        ...
        111 => {
            ...
            while i_5 < 3 as libc::c_int {
                sbufWriteU8(dst,
                            (*currentControlRateProfile).rates[i_5 as usize]);
                i_5 += 1
        ...
        112 => {
            let mut i_6: libc::c_int =
                0 as
                    libc::c_int; // was currentPidProfile->dtermSetpointWeight
            while i_6 < PID_ITEM_COUNT as libc::c_int {
                sbufWriteU8(dst, (*currentPidProfile).pid[i_6 as usize].P);
                sbufWriteU8(dst, (*currentPidProfile).pid[i_6 as usize].I);
                sbufWriteU8(dst, (*currentPidProfile).pid[i_6 as usize].D);
                i_6 += 1
            }
        }
        117 => {
        ...
        34 => {
            ...
            while i_7 < 20 as libc::c_int {
                let mut mac: *const modeActivationCondition_t =
                    modeActivationConditions(i_7);
        ...
        52 => {
            ...
            while i_8 < 15 as libc::c_int {
                let mut adjRange: *const adjustmentRange_t =
                    adjustmentRanges(i_8);
        ...
        77 => {
            ...
            while i_9 < rxRuntimeConfig.channelCount as libc::c_int {
                sbufWriteU8(dst, (*rxFailsafeChannelConfigs(i_9)).mode);
                sbufWriteU16(dst,
                             (750 as libc::c_int +
                                  25 as libc::c_int *
                                      (*rxFailsafeChannelConfigs(i_9)).step as
        ...
        54 => {
            ...
            while i_10 < 4 as libc::c_int {
                if serialIsPortAvailable((*serialConfig()).portConfigs[i_10 as
                                                                           usize].identifier)
                   {
                    sbufWriteU8(dst,
                                (*serialConfig()).portConfigs[i_10 as
                                                                  usize].identifier
                                    as uint8_t);
                    sbufWriteU16(dst,
                                 (*serialConfig()).portConfigs[i_10 as
        ...
        46 => {
            ...
            while i_11 < 16 as libc::c_int {
                let mut color: *const hsvColor_t =
                    &*(*(ledStripConfig as
                             unsafe extern "C" fn()
                                 ->
                                     *const ledStripConfig_t)()).colors.as_ptr().offset(i_11
                                                                                            as
                                                                                            isize)
                        as *const hsvColor_t;
        ...
        48 => {
            ...
            while i_12 < 32 as libc::c_int {
                let mut ledConfig: *const ledConfig_t =
                    &*(*(ledStripConfig as
                             unsafe extern "C" fn()
                                 ->
                                     *const ledStripConfig_t)()).ledConfigs.as_ptr().offset(i_12
                                                                                                as
                                                                                                isize)
        ...
        127 => {
            ...
            while i_13 < 6 as libc::c_int {
                ...
                while j < 6 as libc::c_int {
                    sbufWriteU8(dst, i_13 as uint8_t);
                    sbufWriteU8(dst, j as uint8_t);
                    sbufWriteU8(dst,
                                (*ledStripConfig()).modeColors[i_13 as
                                                                   usize].color[j
                                                                                    as
                                                                                    usize]);
                    j += 1
