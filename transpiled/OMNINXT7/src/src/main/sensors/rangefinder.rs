 ...
 */
    #[no_mangle]
    fn lidarTFminiDetect(dev: *mut rangefinderDev_t) -> bool;
    #[no_mangle]
    fn lidarTF02Detect(dev: *mut rangefinderDev_t) -> bool;
    #[no_mangle]
...
pub static mut pgResetTemplate_sonarConfig: sonarConfig_t =
    {
        let mut init =
            sonarConfig_s{triggerTag: 0 as libc::c_int as ioTag_t,
                          echoTag: 0 as libc::c_int as ioTag_t,};
        init
    };
/*
    ...
    match rangefinderHardwareToUse as libc::c_int {
        ...
        2 => {
            if lidarTFminiDetect(dev) {
                ...
                rescheduleTask(TASK_RANGEFINDER,
                               (10 as libc::c_int * 1000 as libc::c_int) as
                                   uint32_t);
            }
        }
        3 => {
